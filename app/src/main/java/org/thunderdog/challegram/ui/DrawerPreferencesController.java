...
public class DrawerPreferencesController extends ViewController<Void> implements View.OnClickListener {
    ...
    private static final int ID_CONTACTS = 20001;
    ...
    @Override
    public int getId() { return 1948193; } 
    
    @Override
    public CharSequence getName() { return Lang.getString(R.string.DrawerSettings); } // Fixed
    ...
    protected View onCreateView(Context context) {
        ...
        adapter = new SettingsAdapter(this) {
            ...
            protected void setValuedSetting (ListItem item, SettingView view, boolean isUpdate) {
                ...
                if (itemId == ID_CONTACTS) view.getToggler().setRadioEnabled(manager.isDrawerItemVisible(GhostModeManager.KEY_DRAWER_CONTACTS), isUpdate);
        ...
        items.add(new ListItem(ListItem.TYPE_HEADER, R.string.MenuItems));
