...
public interface Map<K, V> {
    ...
    public final /* synthetic */ class EL {
        public static /* synthetic */ Object compute(java.util.Map map, Object obj, BiFunction biFunction) {
            return map instanceof Map ? ((Map) map).compute(obj, biFunction) : map instanceof ConcurrentMap ? AbstractC1636a.m511g((ConcurrentMap) map, obj, biFunction) : CC.$default$compute(map, obj, biFunction);
        }
        ...
        public static /* synthetic */ void forEach(java.util.Map map, BiConsumer biConsumer) {
            if (map instanceof Map) {
                ...
                AbstractC1636a.m512h((ConcurrentMap) map, biConsumer);
            } else {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        /* renamed from: a */
        public static Object m855a(java.util.Map map, Object obj, Object obj2, BiFunction biFunction) {
            if (map instanceof Map) {
