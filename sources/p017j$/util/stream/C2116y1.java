...
public final class C2116y1 extends AbstractC1947S1 implements InterfaceC1942R1, InterfaceC2057m2 {

    /* renamed from: b */
    public final /* synthetic */ Supplier f1379b;

    /* renamed from: c */
    public final /* synthetic */ ObjLongConsumer f1380c;

    /* renamed from: d */
    public final /* synthetic */ C2069p f1381d;
    ...
    public final void mo933q(InterfaceC1942R1 interfaceC1942R1) {
        this.f1120a = this.f1381d.apply(this.f1120a, ((C2116y1) interfaceC1942R1).f1120a);
    }

    @Override // p017j$.util.stream.InterfaceC2062n2
    /* renamed from: h */
    public final void mo931h(long j) {
        this.f1120a = this.f1379b.get();
    }

    @Override // p017j$.util.stream.InterfaceC2062n2
    public final void accept(long j) {
        this.f1380c.accept(this.f1120a, j);
    }

    public C2116y1(Supplier supplier, ObjLongConsumer objLongConsumer, C2069p c2069p) {
        this.f1379b = supplier;
        this.f1380c = objLongConsumer;
        this.f1381d = c2069p;
    }
}
