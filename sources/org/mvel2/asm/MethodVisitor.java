...
public abstract class MethodVisitor {
    ...
    /* renamed from: mv */
    protected MethodVisitor f1415mv;

    protected MethodVisitor(int i) {
        this(i, null);
    }

    protected MethodVisitor(int i, MethodVisitor methodVisitor) throws IOException {
    ...
    public void visitParameter(String str, int i) {
        ...
        MethodVisitor methodVisitor = this.f1415mv;
