...
public class ClassWriter extends ClassVisitor {
    ...
    public final void visitSource(String str, String str2) {
        ...
        if (str2 != null) {
            this.debugExtension = new ByteVector().encodeUtf8(str2, 0, ConnectionsManager.DEFAULT_DATACENTER_ID);
        }
    }
    ...
    public final FieldVisitor visitField(int i, String str, String str2, String str3, Object obj) {
        ...
        if (this.firstField == null) {
            ...
            this.lastField.f1414fv = fieldWriter;
        }
    ...
    public final MethodVisitor visitMethod(int i, String str, String str2, String str3, String[] strArr) {
        ...
        if (this.firstMethod == null) {
            ...
            this.lastMethod.f1415mv = methodWriter;
        }
    ...
    public byte[] toByteArray() {
        ...
        int i7 = 0;
        for (FieldWriter fieldWriter = this.firstField; fieldWriter != null; fieldWriter = (FieldWriter) fieldWriter.f1414fv) {
            i7++;
            iComputeAttributesSize2 += fieldWriter.computeFieldInfoSize();
        }
        int i8 = 0;
        for (MethodWriter methodWriter = this.firstMethod; methodWriter != null; methodWriter = (MethodWriter) methodWriter.f1415mv) {
            i8++;
        ...
        for (FieldWriter fieldWriter2 = this.firstField; fieldWriter2 != null; fieldWriter2 = (FieldWriter) fieldWriter2.f1414fv) {
            fieldWriter2.putFieldInfo(byteVector5);
        }
        byteVector5.putShort(i8);
        boolean zHasFrames = false;
        boolean zHasAsmInstructions = false;
        for (MethodWriter methodWriter2 = this.firstMethod; methodWriter2 != null; methodWriter2 = (MethodWriter) methodWriter2.f1415mv) {
