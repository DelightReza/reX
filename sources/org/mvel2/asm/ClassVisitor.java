...
public abstract class ClassVisitor {
    ...
    /* renamed from: cv */
    protected ClassVisitor f1413cv;

    protected ClassVisitor(int i) {
        this(i, null);
    }

    protected ClassVisitor(int i, ClassVisitor classVisitor) throws IOException {
    ...
    public void visit(int i, int i2, String str, String str2, String str3, String[] strArr) {
        ...
        ClassVisitor classVisitor = this.f1413cv;
