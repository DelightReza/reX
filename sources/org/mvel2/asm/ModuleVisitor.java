...
public abstract class ModuleVisitor {
    ...
    /* renamed from: mv */
    protected ModuleVisitor f1417mv;

    protected ModuleVisitor(int i) {
        this(i, null);
    }

    protected ModuleVisitor(int i, ModuleVisitor moduleVisitor) throws IOException {
    ...
    public void visitMainClass(String str) {
        ModuleVisitor moduleVisitor = this.f1417mv;
