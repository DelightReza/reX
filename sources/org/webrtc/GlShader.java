...
public class GlShader {
    ...
    private static int compileShader(int i, String str) {
        ...
        if (iArr[0] != 1) {
            Logging.m1369e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(iGlCreateShader) + " in shader:\n" + str);
    ...
    public GlShader(String str, String str2) {
        ...
        if (iArr[0] != 1) {
            Logging.m1369e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    public void release() {
        Logging.m1368d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
