...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    public String[] getDeviceNames() {
        try {
            ...
            Logging.m1369e(TAG, "Camera access exception: " + e);
            return new String[0];
        }
    }
    ...
    public static boolean isSupported(Context context) {
        ...
        try {
            ...
            Logging.m1369e(TAG, "Camera access exception: " + th);
            return false;
        }
    }
    ...
    static List<CameraEnumerationAndroid.CaptureFormat> getSupportedFormats(CameraManager cameraManager, String str) {
        ...
        synchronized (map) {
            try {
                ...
                Logging.m1368d(TAG, "Get supported formats for camera index " + str + ".");
                ...
                try {
                    ...
                    for (Size size : supportedSizes) {
                        ...
                        Logging.m1368d(TAG, "Format: " + size.width + "x" + size.height + "@" + iRound);
                    }
                    cachedSupportedFormats.put(str, arrayList);
                    Logging.m1368d(TAG, "Get supported formats for camera index " + str + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                    return arrayList;
                } catch (Exception e) {
                    Logging.m1370e(TAG, "getCameraCharacteristics()", e);
