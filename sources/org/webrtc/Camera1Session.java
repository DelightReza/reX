...
class Camera1Session implements CameraSession {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, boolean z, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i, int i2, int i3) throws IOException {
        ...
        Logging.m1368d(TAG, "Open camera " + str);
    ...
    private Camera1Session(CameraSession.Events events, boolean z, Context context, SurfaceTextureHelper surfaceTextureHelper, int i, Camera camera, Camera.CameraInfo cameraInfo, CameraEnumerationAndroid.CaptureFormat captureFormat, long j) {
        Logging.m1368d(TAG, "Create new camera1 session on camera " + i);
    ...
    public void stop() {
        Logging.m1368d(TAG, "Stop camera1 session on camera " + this.cameraId);
    ...
    private void startCapturing() {
        Logging.m1368d(TAG, "Start capturing");
        checkIsOnCameraThread();
        ...
        this.camera.setErrorCallback(new Camera.ErrorCallback() { // from class: org.webrtc.Camera1Session.1
            ...
            public void onError(int i, Camera camera) {
                ...
                Logging.m1369e(Camera1Session.TAG, str);
    ...
    public void stopInternal() {
        ...
        if (sessionState == sessionState2) {
            Logging.m1368d(TAG, "Camera is already stopped");
            return;
        }
    ...
    public /* synthetic */ void lambda$listenForTextureFrames$0(VideoFrame videoFrame) {
        ...
        if (this.state != SessionState.RUNNING) {
            Logging.m1368d(TAG, "Texture frame captured but camera is no longer running.");
            return;
        }
    ...
    class C69792 implements Camera.PreviewCallback {
        C69792() {
        }
        ...
        public void onPreviewFrame(final byte[] bArr, Camera camera) {
            ...
            if (camera != Camera1Session.this.camera) {
                Logging.m1369e(Camera1Session.TAG, "Callback from a different camera. This should never happen.");
                return;
            }
            if (Camera1Session.this.state != SessionState.RUNNING) {
                Logging.m1368d(Camera1Session.TAG, "Bytebuffer frame captured but camera is no longer running.");
                return;
            }
    ...
    private void listenForBytebufferFrames() {
        this.camera.setPreviewCallbackWithBuffer(new C69792());
    }
