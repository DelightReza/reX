...
public class EncodedImage implements RefCounted {
    ...
    public static class Builder {
        ...
        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.releaseCallback, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.f2157qp);
        }
    }
}
