...
public class WebRtcAudioTrack {
    ...
    public static synchronized void setAudioTrackUsageAttribute(int i) {
        Logging.m1372w(TAG, "Default usage attribute is changed from: " + DEFAULT_USAGE + " to " + i);
        usageAttribute = i;
    }
    ...
    public static void setErrorCallback(WebRtcAudioTrackErrorCallback webRtcAudioTrackErrorCallback) {
        Logging.m1368d(TAG, "Set error callback (deprecated");
        errorCallbackOld = webRtcAudioTrackErrorCallback;
    }

    public static void setErrorCallback(ErrorCallback errorCallback2) {
        Logging.m1368d(TAG, "Set extended error callback");
    ...
    private class AudioTrackThread extends Thread {
        ...
        public void run() throws IllegalStateException, InterruptedException, SecurityException, IllegalArgumentException {
            ...
            if (WebRtcAudioTrack.this.audioTrack != null) {
                Logging.m1368d(WebRtcAudioTrack.TAG, "Calling AudioTrack.stop...");
                try {
                    WebRtcAudioTrack.this.audioTrack.stop();
                    Logging.m1368d(WebRtcAudioTrack.TAG, "AudioTrack.stop is done.");
                } catch (Exception e2) {
                    Logging.m1369e(WebRtcAudioTrack.TAG, "AudioTrack.stop failed: " + e2.getMessage());
                }
            }
        }
    ...
    private static AudioTrack createAudioTrackOnLollipopOrHigher(int i, int i2, int i3) {
        Logging.m1368d(TAG, "createAudioTrackOnLollipopOrHigher");
        ...
        if (usageAttribute != DEFAULT_USAGE) {
            Logging.m1372w(TAG, "A non default usage attribute is used: " + usageAttribute);
        }
    ...
    private void releaseAudioResources() {
        Logging.m1370e(TAG, "releaseAudioResources", new Exception());
