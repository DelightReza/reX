...
public class WebRtcAudioEffects {
    ...
    /* renamed from: ns */
    private NoiseSuppressor f2166ns;
    ...
    public static boolean isAcousticEchoCancelerBlacklisted() {
        ...
        if (zContains) {
            Logging.m1372w(TAG, str + " is blacklisted for HW AEC usage!");
        }
        return zContains;
    }
    ...
    public static boolean isNoiseSuppressorBlacklisted() {
        ...
        if (zContains) {
            Logging.m1372w(TAG, str + " is blacklisted for HW NS usage!");
        }
        return zContains;
    }
    ...
    public static boolean canUseAcousticEchoCanceler() {
        ...
        Logging.m1368d(TAG, "canUseAcousticEchoCanceler: " + z);
        return z;
    }
    ...
    public static boolean canUseNoiseSuppressor() {
        ...
        Logging.m1368d(TAG, "canUseNoiseSuppressor: " + z);
        return z;
    }
    ...
    public boolean setNS(boolean z) {
        ...
        if (this.f2166ns != null && z != this.shouldEnableNs) {
    ...
    public void enable(int i) throws IllegalStateException {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f2166ns = noiseSuppressorCreate;
            if (noiseSuppressorCreate != null) {
                ...
                if (this.f2166ns.setEnabled(z) != 0) {
                ...
                sb2.append(z);
                sb2.append(", is now: ");
                sb2.append(this.f2166ns.getEnabled() ? "enabled" : "disabled");
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f2166ns;
