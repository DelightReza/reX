...
public class FileVideoCapturer implements VideoCapturer {
    ...
    private static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException, NumberFormatException {
            ...
            while (true) {
                ...
                if (i != 10) {
                    ...
                    Logging.m1368d(TAG, "Color space: " + strSubstring);
                    ...
                    this.frameWidth = i2;
                    this.frameHeight = i3;
                    Logging.m1368d(TAG, "frame dim: (" + i2 + ", " + i3 + ")");
                    return;
                }
            }
        }
        ...
        public void close() throws IOException {
            try {
                ...
                Logging.m1370e(TAG, "Problem closing file", e);
            }
        }
    }
    ...
    public FileVideoCapturer(String str) throws IOException {
        try {
            ...
            Logging.m1368d(TAG, "Could not open video file: " + str);
            throw e;
        }
    }
