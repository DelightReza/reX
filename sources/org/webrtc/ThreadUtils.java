        ...
        handler.post(new Runnable() { // from class: org.webrtc.ThreadUtils.3
            ...
            public void run() {
                try {
                    ...
                    c1CaughtException.f2162e = e2;
                }
                countDownLatch.countDown();
            }
        });
        awaitUninterruptibly(countDownLatch);
        if (c1CaughtException.f2162e != null) {
            RuntimeException runtimeException = new RuntimeException(c1CaughtException.f2162e);
            runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f2162e.getStackTrace(), runtimeException.getStackTrace()));
