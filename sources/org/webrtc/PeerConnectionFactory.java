...
public class PeerConnectionFactory {
    ...
    public static void initialize(InitializationOptions initializationOptions) {
        ...
        if (loggable != null) {
            ...
            Logging.m1368d(TAG, "PeerConnectionFactory was initialized without an injected Loggable. Any existing Loggable will be deleted.");
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z) {
        ...
        if (stackTrace.length > 0) {
            Logging.m1372w(TAG, name + " stacktrace:");
            for (StackTraceElement stackTraceElement : stackTrace) {
                Logging.m1372w(TAG, stackTraceElement.toString());
            }
        }
        if (z) {
            Logging.m1372w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            Logging.m1372w(TAG, "pid: " + Process.myPid() + ", tid: " + threadInfo.tid + ", name: " + name + "  >>> WebRTC <<<");
    ...
    private void onNetworkThreadReady() {
        ...
        Logging.m1368d(TAG, "onNetworkThreadReady");
    }
    ...
    private void onWorkerThreadReady() {
        ...
        Logging.m1368d(TAG, "onWorkerThreadReady");
    }
    ...
    private void onSignalingThreadReady() {
        ...
        Logging.m1368d(TAG, "onSignalingThreadReady");
    }
}
