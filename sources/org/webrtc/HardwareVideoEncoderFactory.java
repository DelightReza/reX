...
public class HardwareVideoEncoderFactory implements VideoEncoderFactory {
    ...
    public HardwareVideoEncoderFactory(EglBase.Context context, boolean z, boolean z2, Predicate<MediaCodecInfo> predicate) {
        if (context instanceof EglBase14.Context) {
            ...
            Logging.m1372w(TAG, "No shared EglBase.Context.  Encoders will not use texture mode.");
    ...
    private MediaCodecInfo findCodecForType(VideoCodecMimeType videoCodecMimeType) {
        ...
        while (true) {
            ...
            try {
                ...
                Logging.m1370e(TAG, "Cannot retrieve encoder codec info", e);
            }
    ...
    private boolean isHardwareSupportedInCurrentSdk(MediaCodecInfo mediaCodecInfo, VideoCodecMimeType videoCodecMimeType) {
        ...
        int i = C69961.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i == 1) {
