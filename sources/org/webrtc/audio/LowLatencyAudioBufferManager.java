        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (underrunCount > this.prevUnderrunCount) {
                if (this.bufferIncreaseCounter < 5) {
                    ...
                    Logging.m1368d(TAG, "Underrun detected! Increasing AudioTrack buffer size from " + bufferSizeInFrames + " to " + playbackRate);
            ...
            if (this.keepLoweringBufferSize) {
                ...
                if (i <= 0) {
                    ...
                    if (iMax != bufferSizeInFrames2) {
                        Logging.m1368d(TAG, "Lowering AudioTrack buffer size from " + bufferSizeInFrames2 + " to " + iMax);
