...
public final class RenderSynchronizer {
    ...
    public void registerListener(Listener listener) {
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    Logging.m1368d(TAG, "First listener, subscribing to frame callbacks");
        ...
        synchronized (this.lock) {
            try {
                if (this.listeners.isEmpty()) {
                    Logging.m1368d(TAG, "No listeners, unsubscribing to frame callbacks");
