...
import org.telegram.p023ui.ActionBar.Theme$$ExternalSyntheticLambda9;
...
public class TextureViewRenderer extends TextureView implements TextureView.SurfaceTextureListener, VideoSink, RendererCommon.RendererEvents {
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0025 A[PHI: r0
    ...
    */
    public void onFrameResolutionChanged(final int r8, final int r9, int r10) throws java.lang.Throwable {
        ...
        L5e:
            ...
            java.lang.Object r10 = org.webrtc.TextureViewRenderer.TextureEglRenderer.m19867$$Nest$fgetlayoutLock(r10)
            monitor-enter(r10)
    ...
    private void logD(String str) {
        Logging.m1368d(TAG, this.resourceName + ": " + str);
    }
