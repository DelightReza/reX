...
public class ImportingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1157d("destroy import service");
        }
    }
    ...
    public int onStartCommand(Intent intent, int i, int i2) {
        ...
        if (BuildVars.LOGS_ENABLED) {
            FileLog.m1157d("start import service");
        }
        if (this.builder == null) {
            ...
            if (hasImportingHistory()) {
                this.builder.setTicker(LocaleController.getString(C2369R.string.ImporImportingService));
                this.builder.setContentText(LocaleController.getString(C2369R.string.ImporImportingService));
            } else {
                this.builder.setTicker(LocaleController.getString(C2369R.string.ImporImportingStickersService));
                this.builder.setContentText(LocaleController.getString(C2369R.string.ImporImportingStickersService));
            }
        }
