...
public final class Instance {
    ...
    public static void setGlobalServerConfig(String str) {
        try {
            ...
            if (BuildVars.LOGS_ENABLED) {
                FileLog.m1159e("failed to parse tgvoip server config", e);
            }
        }
    }
    ...
    public static final class Endpoint {
        ...
        public String toString() {
            return "Endpoint{id=" + this.f1505id + ", ipv4='" + this.ipv4 + "', ipv6='" + this.ipv6 + "', port=" + this.port + ", type=" + this.type + ", peerTag=" + Arrays.toString(this.peerTag) + ", turn=" + this.turn + ", stun=" + this.stun + ", username=" + this.username + ", password=" + this.password + ", tcp=" + this.tcp + '}';
        }
    }
    ...
    public static final class Candidate {
        ...
        /* renamed from: id */
        public final String f1503id;

        /* renamed from: ip */
        public final String f1504ip;
        ...
        public String toString() {
            return "Candidate{port=" + this.port + ", protocol=" + this.protocol + ", network=" + this.network + ", generation=" + this.generation + ", id=" + this.f1503id + ", component=" + this.component + ", foundation=" + this.foundation + ", priority=" + this.priority + ", ip=" + this.f1504ip + ", type=" + this.type + ", tcpType=" + this.tcpType + ", relAddr=" + this.relAddr + ", relPort=" + this.relPort + '}';
        }
    }
