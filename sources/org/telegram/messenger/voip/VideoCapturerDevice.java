...
public class VideoCapturerDevice {
    ...
    public VideoCapturerDevice(final boolean z) {
        ...
        Logging.m1368d("VideoCapturerDevice", "device model = " + Build.MANUFACTURER + Build.MODEL);
    ...
    public /* synthetic */ void lambda$init$5(final long j, String str) {
        ...
        if ("screen".equals(str)) {
            if (this.videoCapturer == null) {
                this.videoCapturer = new ScreenCapturerAndroid(mediaProjectionPermissionResultData, new C24201());
                final Point screenCaptureSize = getScreenCaptureSize();
        ...
        if (this.videoCapturer == null) {
            this.videoCapturer = camera2Enumerator.createCapturer(str2, new C24212());
            ...
            FileLog.m1157d("VideoCapturerDevice init(" + j + "): videoCapturer.switchCamera CAMERA");
    ...
    class C24201 extends MediaProjection.Callback {
        C24201() {
        }
        ...
        public void onStop() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$1$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C24201.m4305$r8$lambda$ZQSuWiFDNOs2qmwnLNxKb4FvRU();
                }
            });
        }

        /* renamed from: $r8$lambda$ZQSuWiFDNOs2qmwnLNxKb-4FvRU, reason: not valid java name */
        public static /* synthetic */ void m4305$r8$lambda$ZQSuWiFDNOs2qmwnLNxKb4FvRU() {
    ...
    public /* synthetic */ void lambda$init$2(long j, Point point) {
        if (this.videoCapturerSurfaceTextureHelper != null) {
            ...
            FileLog.m1157d("VideoCapturerDevice init(" + j + "): videoCapturer.startCapture SCREEN");
    ...
    class C24212 implements CameraVideoCapturer.CameraEventsHandler {
        ...
        public void onFirstFrameAvailable() {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$2$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C24212.$r8$lambda$nw9ghc47P82EeNmCdLj2fBnzRy0();
                }
            });
        }
    ...
    public /* synthetic */ void lambda$init$3(long j) {
        ...
        this.videoCapturer.initialize(this.videoCapturerSurfaceTextureHelper, ApplicationLoader.applicationContext, this.nativeCapturerObserver);
        FileLog.m1157d("VideoCapturerDevice init(" + j + "): videoCapturer.startCapture CAMERA");
    ...
    class C24223 implements CameraVideoCapturer.CameraSwitchHandler {
        ...
        public void onCameraSwitchDone(final boolean z) {
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.voip.VideoCapturerDevice$3$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    VideoCapturerDevice.C24223.$r8$lambda$67_itrkxqu4lzdGSiVNTf3YO7M8(z);
                }
            });
        }
    ...
    public /* synthetic */ void lambda$init$4(String str) {
        ((CameraVideoCapturer) this.videoCapturer).switchCamera(new C24223(), str);
    }
    ...
    private void onStateChanged(final long j, final int i) {
        FileLog.m1157d("VideoCapturerDevice onStateChanged(" + j + ", " + i + ")");
    ...
    public /* synthetic */ void lambda$onStateChanged$6(int i, long j) {
        ...
        if (i == 2) {
            FileLog.m1157d("VideoCapturerDevice onStateChanged(" + j + ", " + i + "): videoCapturer.startCapture");
            this.videoCapturer.startCapture(CAPTURE_WIDTH, CAPTURE_HEIGHT, 30);
            return;
        }
        try {
            FileLog.m1157d("VideoCapturerDevice onStateChanged(" + j + ", " + i + "): videoCapturer.stopCapture");
    ...
    private void onDestroy() {
        FileLog.m1157d("VideoCapturerDevice onDestroy ptr=" + this.nativePtr);
        this.nativePtr = 0L;
    ...
    public /* synthetic */ void lambda$onDestroy$8() {
        ...
        if (this.videoCapturer != null) {
            FileLog.m1157d("VideoCapturerDevice onDestroy: videoCapturer.stopCapture");
            try {
                this.videoCapturer.stopCapture();
