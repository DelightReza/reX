        ...
        public void executeBadge(int i) {
            ...
            if (NotificationBadge.canResolveBroadcast(intent) || NotificationBadge.canResolveBroadcast(intent2)) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.messenger.NotificationBadge$NewHtcHomeBadger$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        NotificationBadge.NewHtcHomeBadger.m3899$r8$lambda$LNOrzcbHoddZHaXpWj71zfhB0w(intent, intent2);
                    }
                });
            }
        }

        /* renamed from: $r8$lambda$LNOrzcbHoddZ-HaXpWj71zfhB0w, reason: not valid java name */
        public static /* synthetic */ void m3899$r8$lambda$LNOrzcbHoddZHaXpWj71zfhB0w(Intent intent, Intent intent2) {
            ApplicationLoader.applicationContext.sendBroadcast(intent);
