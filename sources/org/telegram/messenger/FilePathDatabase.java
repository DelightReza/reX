...
public class FilePathDatabase {
        ...
        try {
            ...
            if (!zExists) {
                ...
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1157d("current files db version = " + iIntValue);
                }
                if (iIntValue == 0) {
            ...
            FileLog.m1157d("files db created from_backup= " + z);
        } catch (Exception e) {
            if (i < 4) {
                if (!z && restoreBackup()) {
    ...
    private void createBackup() {
        ...
        try {
            ...
            FileLog.m1157d("file db backup created " + file2.getAbsolutePath());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    */
        ...
        if (sQLiteDatabase != null) {
            ...
            try {
                ...
                if (sQLiteCursorQueryFinalized.next()) {
                    ...
                    if (BuildVars.DEBUG_VERSION) {
                        FileLog.m1157d("get file path id=" + j + " dc=" + i + " type=" + i2 + " path=" + strArr[0] + " in " + (System.currentTimeMillis() - j2) + "ms");
                    }
                }
            } catch (Throwable th) {
                try {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public /* synthetic */ void lambda$putPath$1(long r7, int r9, int r10, java.lang.String r11, int r12) throws java.lang.Exception {
        /*
    ...
    public void checkMediaExistance(ArrayList<MessageObject> arrayList) throws InterruptedException {
        ...
        FileLog.m1157d("checkMediaExistance size=" + arrayList.size() + " time=" + (System.currentTimeMillis() - jCurrentTimeMillis) + " thread_time=" + jArr[0]);
        if (BuildVars.DEBUG_VERSION && Thread.currentThread() == Looper.getMainLooper().getThread()) {
            FileLog.m1160e(new Exception("warning, not allowed in main thread"));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void postToFrontRunnable(Runnable runnable) throws InterruptedException {
        ensureQueueExist();
    ...
    public static class PathData {
        ...
        /* renamed from: dc */
        public final int f1440dc;

        /* renamed from: id */
        public final long f1441id;
