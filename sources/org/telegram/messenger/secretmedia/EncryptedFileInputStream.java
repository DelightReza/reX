...
public class EncryptedFileInputStream extends FileInputStream {
    ...
    public int read(byte[] bArr, int i, int i2) throws IOException {
        ...
        if (i5 == 1) {
            i3 = i2;
            Utilities.aesCbcEncryptionByteArraySafe(bArr, this.key, this.f1483iv, i, i3, this.fileOffset, 0);
        } else {
            i3 = i2;
            if (i5 == 0) {
                Utilities.aesCtrDecryptionByteArray(bArr, this.key, this.f1483iv, i, i3, this.fileOffset);
            }
        }
        this.fileOffset += i3;
        return i4;
