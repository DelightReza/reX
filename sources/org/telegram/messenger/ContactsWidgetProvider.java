...
public class ContactsWidgetProvider extends AppWidgetProvider {
    ...
    public void onDeleted(Context context, int[] iArr) {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            editorEdit.remove(PluginsConstants.Settings.TYPE + iArr[i]);
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int i) {
        ...
        if (!sharedPreferences.getBoolean("deleted" + i, false)) {
            ...
            if (i4 == -1) {
                ...
                editorEdit.putInt(PluginsConstants.Settings.TYPE + i, 0).apply();
            }
            ...
            if (cellsForSize == 1 || iCeil <= 1) {
                i3 = C2369R.layout.contacts_widget_layout_1;
            } else if (cellsForSize == 2 || iCeil <= 2) {
                i3 = C2369R.layout.contacts_widget_layout_2;
            } else if (cellsForSize == 3 || iCeil <= 3) {
                i3 = C2369R.layout.contacts_widget_layout_3;
            } else {
                i3 = C2369R.layout.contacts_widget_layout_4;
            }
        } else {
            i2 = i;
            i3 = C2369R.layout.contacts_widget_layout_1;
        ...
        remoteViews.setRemoteAdapter(i2, C2369R.id.list_view, intent);
        ...
        appWidgetManager.notifyAppWidgetViewDataChanged(i2, C2369R.id.list_view);
    }
}
