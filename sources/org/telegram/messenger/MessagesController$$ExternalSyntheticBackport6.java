...
public abstract /* synthetic */ class MessagesController$$ExternalSyntheticBackport6 {
    /* renamed from: m */
    public static /* synthetic */ long m1178m(CharSequence charSequence, int i, int i2, int i3) {
        int i4 = i2 - i;
        if (i4 == 0) {
        ...
        long j = i3;
        long jM1179m = MessagesController$$ExternalSyntheticBackport7.m1179m(-1L, j);
        ...
        while (i5 < i2) {
            ...
            if (j3 < j2 || j3 > jM1179m || (j3 == jM1179m && iDigit > ((int) MessagesController$$ExternalSyntheticBackport8.m1180m(-1L, j)))) {
