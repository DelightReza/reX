...
public class SaveToGallerySettingsHelper {
    ...
    public static class SharedSettings extends Settings {
        ...
        public CharSequence createDescription(int i) {
            ...
            if (enabled()) {
                if (this.savePhoto) {
                    sb.append(LocaleController.getString(C2369R.string.SaveToGalleryPhotos));
                }
                if (this.saveVideo) {
                    if (sb.length() != 0) {
                        sb.append(", ");
                    }
                    sb.append(LocaleController.getString(C2369R.string.SaveToGalleryVideos));
                    long j = this.limitVideo;
                ...
                sb.append(LocaleController.getString(C2369R.string.SaveToGalleryOff));
            }
        ...
        public CharSequence createDescription(int i) {
            ...
            if (enabled()) {
                ...
                if (this.saveVideo) {
                    ...
                    long j = this.limitVideo;
                    if (j > 0 && j < SaveToGallerySettingsHelper.MAX_VIDEO_LIMIT) {
                        sb.append(LocaleController.formatString("SaveToGalleryVideosUpTo", C2369R.string.SaveToGalleryVideosUpTo, AndroidUtilities.formatFileSize(j, true, false)));
                        return sb;
                    }
                    sb.append(LocaleController.formatString("SaveToGalleryVideos", C2369R.string.SaveToGalleryVideos, new Object[0]));
                }
                return sb;
            }
            sb.append(LocaleController.getString(C2369R.string.SaveToGalleryOff));
