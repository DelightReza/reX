            ...
            if (string2.equals(MediaController.VIDEO_MIME_TYPE)) {
                ...
                if (mediaFormat.containsKey("profile")) {
                    ...
                    if (integer2 == 1) {
                        ...
                        avcConfigurationBox.setAvcProfileIndication(Opcodes.ISHR);
                    } else if (integer2 == 64) {
    ...
    */
    ...
    public void prepare() {
        ...
        for (i = 1; i < arrayList.size(); i++) {
            ((SamplePresentationTime) arrayList.get(i)).f1496dt = this.sampleDurations[i] + ((SamplePresentationTime) arrayList.get(i - 1)).f1496dt;
        }
        if (z) {
            ...
            for (int i3 = 0; i3 < this.samplePresentationTimes.size(); i3++) {
                ...
                this.sampleCompositions[samplePresentationTime2.index] = (int) (samplePresentationTime2.presentationTime - samplePresentationTime2.f1496dt);
            }
        }
    }
