...
public class AutoMessageReplyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        SendMessagesHelper.getInstance(intExtra2).sendMessage(SendMessagesHelper.SendMessageParams.m1191of(charSequence.toString(), longExtra, null, null, null, true, null, null, null, true, 0, 0, null, false));
