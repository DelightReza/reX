...
public class GoogleMapsProvider implements IMapsProvider {
    ...
    public int getInstallMapsString() {
        return C2369R.string.InstallGoogleMaps;
    }
    ...
    public static final class GoogleMapImpl implements IMapsProvider.IMap {
        ...
        public void setOnCameraMoveStartedListener(final IMapsProvider.OnCameraMoveStartedListener onCameraMoveStartedListener) {
            this.googleMap.setOnCameraMoveStartedListener(new GoogleMap.OnCameraMoveStartedListener() { // from class: org.telegram.messenger.GoogleMapsProvider$GoogleMapImpl$$ExternalSyntheticLambda5
                ...
                public final void onCameraMoveStarted(int i) {
                    GoogleMapsProvider.GoogleMapImpl.m3285$r8$lambda$r9kkoqpW97OxjoEF5_g6CEGB9s(onCameraMoveStartedListener, i);
                }
            });
        }

        /* renamed from: $r8$lambda$r9-kkoqpW97OxjoEF5_g6CEGB9s, reason: not valid java name */
        public static /* synthetic */ void m3285$r8$lambda$r9kkoqpW97OxjoEF5_g6CEGB9s(IMapsProvider.OnCameraMoveStartedListener onCameraMoveStartedListener, int i) {
            int i2 = 2;
            if (i != 2) {
                i2 = 3;
                if (i != 3) {
        ...
        public IMapsProvider.IMap.Padding getFragmentPadding(int i) {
            return new IMapsProvider.IMap.Padding(AndroidUtilities.m1146dp(70.0f), 0, AndroidUtilities.m1146dp(70.0f), i);
        }
    ...
    public static final class GoogleMapView implements IMapsProvider.IMapView {
        ...
        class C23171 extends MapView {
            C23171(Context context) {
                super(context);
            }
        ...
        private GoogleMapView(Context context) {
            this.mapView = new C23171(context);
        }
