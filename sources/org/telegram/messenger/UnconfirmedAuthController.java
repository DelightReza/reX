...
public class UnconfirmedAuthController {
        ...
        for (final int i = 0; i < arrayList2.size(); i++) {
            ...
            callbackArr[i] = new Utilities.Callback() { // from class: org.telegram.messenger.UnconfirmedAuthController$$ExternalSyntheticLambda0
                ...
                public final void run(Object obj) {
                    UnconfirmedAuthController.m4086$r8$lambda$s03l1nRxgy6Lr_3nNXQXlCZPK0(zArr, i, z, unconfirmedAuth, (Runnable) obj);
                }
            };
        }
    ...
    /* renamed from: $r8$lambda$NJhReUHqCliAHaxOC-3AKA_h2IU, reason: not valid java name */
    public static /* synthetic */ void m4084$r8$lambda$NJhReUHqCliAHaxOC3AKA_h2IU(boolean[] zArr, int i, Runnable runnable, Boolean bool) {
        zArr[i] = bool.booleanValue();
        runnable.run();
    }

    /* renamed from: $r8$lambda$s03l1nRxg-y6Lr_3nNXQXlCZPK0, reason: not valid java name */
    public static /* synthetic */ void m4086$r8$lambda$s03l1nRxgy6Lr_3nNXQXlCZPK0(final boolean[] zArr, final int i, boolean z, UnconfirmedAuth unconfirmedAuth, final Runnable runnable) {
        Utilities.Callback<Boolean> callback = new Utilities.Callback() { // from class: org.telegram.messenger.UnconfirmedAuthController$$ExternalSyntheticLambda2
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
                UnconfirmedAuthController.m4084$r8$lambda$NJhReUHqCliAHaxOC3AKA_h2IU(zArr, i, runnable, (Boolean) obj);
            }
        };
        if (z) {
