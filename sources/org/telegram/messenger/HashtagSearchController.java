...
public class HashtagSearchController {
    ...
    public void searchHashtag(String str, final int i, final int i2, final int i3) {
        ...
        if (str == null || !str.isEmpty()) {
            ...
            if (i2 == 1) {
                ...
                tL_messages_searchGlobal.f1689q = str3;
                ...
                tL_messages_search.f1687q = strSubstring;
            ...
            int iSendRequest = ConnectionsManager.getInstance(this.currentAccount).sendRequest(tL_channels_searchPosts, new RequestDelegate() { // from class: org.telegram.messenger.HashtagSearchController$$ExternalSyntheticLambda1
                ...
                public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                    this.f$0.lambda$searchHashtag$2(i2, str3, iArr, searchResult, i4, i, i3, tLObject, tL_error);
                }
            });
    ...
    public /* synthetic */ void lambda$searchHashtag$2(int i, String str, final int[] iArr, final SearchResult searchResult, final int i2, final int i3, final int i4, TLObject tLObject, TLRPC.TL_error tL_error) {
        if (tLObject instanceof TLRPC.messages_Messages) {
            ...
            while (i5 < size) {
                ...
                i5++;
                MessageObject messageObject = new MessageObject(this.currentAccount, (TLRPC.Message) obj, null, null, null, null, null, true, true, 0L, false, false, false, i);
    ...
    public /* synthetic */ void lambda$searchHashtag$1(int[] iArr, SearchResult searchResult, TLRPC.messages_Messages messages_messages, ArrayList arrayList, int i, int i2, int i3) {
        if (iArr[0] == searchResult.reqId) {
            ...
            while (i4 < size) {
                ...
                message.realId = message.f1597id;
                message.f1597id = numValueOf.intValue();
            }
    ...
    public void jumpToMessage(int i, int i2, int i3) {
        ...
        NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.hashtagSearchUpdated, Integer.valueOf(i), Integer.valueOf(searchResult.count), Boolean.valueOf(searchResult.endReached), Integer.valueOf(searchResult.getMask()), Integer.valueOf(searchResult.selectedIndex), Integer.valueOf(searchResult.messages.get(i2).messageOwner.f1597id));
    }
    ...
    private static final class MessageCompositeID {
        ...
        MessageCompositeID(TLRPC.Message message) {
            this(MessageObject.getDialogId(message), message.f1597id);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && MessageCompositeID.class == obj.getClass()) {
                ...
                if (this.dialog_id == messageCompositeID.dialog_id && this.f1444id == messageCompositeID.f1444id) {
                    return true;
                }
            }
            return false;
        ...
        public int hashCode() {
            return Objects.hash(Long.valueOf(this.dialog_id), Integer.valueOf(this.f1444id));
        }
    }
