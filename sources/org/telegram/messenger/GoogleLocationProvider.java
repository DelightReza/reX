    ...
    public void getLastLocation(final Consumer consumer) {
        this.locationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener() { // from class: org.telegram.messenger.GoogleLocationProvider$$ExternalSyntheticLambda1
            ...
            public final void onComplete(Task task) {
                GoogleLocationProvider.m3280$r8$lambda$pgimAzDDNnR94RGDhgpM2y3jLE(consumer, task);
            }
        });
    }

    /* renamed from: $r8$lambda$pg-imAzDDNnR94RGDhgpM2y3jLE, reason: not valid java name */
    public static /* synthetic */ void m3280$r8$lambda$pgimAzDDNnR94RGDhgpM2y3jLE(Consumer consumer, Task task) {
