...
public final class RuntimeClassNameTypeAdapterFactory<T> implements TypeAdapterFactory {
    ...
    /* renamed from: of */
    public static <T> RuntimeClassNameTypeAdapterFactory<T> m1189of(Class<T> cls, String str, ExclusionStrategy exclusionStrategy) {
        return new RuntimeClassNameTypeAdapterFactory<>(cls, str, exclusionStrategy);
    }

    /* renamed from: of */
    public static <T> RuntimeClassNameTypeAdapterFactory<T> m1188of(Class<T> cls) {
