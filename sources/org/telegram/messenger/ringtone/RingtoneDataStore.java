...
public class RingtoneDataStore {
    ...
    private void saveTones(ArrayList arrayList) {
        ...
        while (i < size) {
            ...
            if (cachedTone.localUri != null && (document = cachedTone.document) != null) {
                map.put(Long.valueOf(document.f1579id), cachedTone.localUri);
            }
        }
        this.userRingtones.clear();
        SharedPreferences sharedPreferences = getSharedPreferences();
        ...
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            ...
            String str = (String) map.get(Long.valueOf(document2.f1579id));
    ...
    public String getSoundPath(long j) {
        ...
        for (int i = 0; i < this.userRingtones.size(); i++) {
            if (((CachedTone) this.userRingtones.get(i)).document != null && ((CachedTone) this.userRingtones.get(i)).document.f1579id == j) {
    ...
    public void remove(TLRPC.Document document) {
        ...
        for (int i = 0; i < this.userRingtones.size(); i++) {
            if (((CachedTone) this.userRingtones.get(i)).document != null && ((CachedTone) this.userRingtones.get(i)).document.f1579id == document.f1579id) {
                this.userRingtones.remove(i);
                return;
            }
        }
    ...
    public void addTone(TLRPC.Document document) {
        if (document == null || contains(document.f1579id)) {
            return;
        }
        CachedTone cachedTone = new CachedTone();
    ...
    public TLRPC.Document getDocument(long j) {
        ...
        for (int i = 0; i < this.userRingtones.size(); i++) {
            try {
                if (this.userRingtones.get(i) != null && ((CachedTone) this.userRingtones.get(i)).document != null && ((CachedTone) this.userRingtones.get(i)).document.f1579id == j) {
