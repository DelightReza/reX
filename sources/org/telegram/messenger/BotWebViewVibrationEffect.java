...
public enum BotWebViewVibrationEffect {
    ...
    IMPACT_MEDIUM(new long[]{7}, new int[]{Opcodes.I2B}, new long[]{70}),
    IMPACT_HEAVY(new long[]{7}, new int[]{255}, new long[]{80}),
    IMPACT_RIGID(new long[]{3}, new int[]{225}, new long[]{50}),
    IMPACT_SOFT(new long[]{10}, new int[]{Opcodes.DRETURN}, new long[]{55}),
    NOTIFICATION_ERROR(new long[]{14, 48, 14, 48, 14, 48, 20}, new int[]{DataTypes.EMPTY, 0, DataTypes.EMPTY, 0, 255, 0, Opcodes.I2B}, new long[]{40, 60, 40, 60, 65, 60, 40}),
    NOTIFICATION_SUCCESS(new long[]{14, 65, 14}, new int[]{Opcodes.DRETURN, 0, 255}, new long[]{50, 60, 65}),
    NOTIFICATION_WARNING(new long[]{14, 64, 14}, new int[]{225, 0, Opcodes.DRETURN}, new long[]{65, 60, 40}),
    ...
    public VibrationEffect getVibrationEffectForOreo() {
        ...
        return BotWebViewVibrationEffect$$ExternalSyntheticApiModelOutline0.m1153m(this.vibrationEffect);
    }
