...
class FeedRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory, NotificationCenter.NotificationCenterDelegate {
    ...
    public RemoteViews getViewAt(int i) {
        ...
        RemoteViews remoteViews = new RemoteViews(this.mContext.getPackageName(), C2369R.layout.feed_widget_item);
        if (messageObject.type == 0) {
            remoteViews.setTextViewText(C2369R.id.feed_widget_item_text, messageObject.messageText);
            remoteViews.setViewVisibility(C2369R.id.feed_widget_item_text, 0);
        } else if (TextUtils.isEmpty(messageObject.caption)) {
            remoteViews.setViewVisibility(C2369R.id.feed_widget_item_text, 8);
        } else {
            remoteViews.setTextViewText(C2369R.id.feed_widget_item_text, messageObject.caption);
            remoteViews.setViewVisibility(C2369R.id.feed_widget_item_text, 0);
        }
        ArrayList<TLRPC.PhotoSize> arrayList = messageObject.photoThumbs;
        if (arrayList == null || arrayList.isEmpty()) {
            remoteViews.setViewVisibility(C2369R.id.feed_widget_item_image, 8);
        } else {
            ...
            if (pathToAttach.exists()) {
                remoteViews.setViewVisibility(C2369R.id.feed_widget_item_image, 0);
                ...
                remoteViews.setImageViewUri(C2369R.id.feed_widget_item_image, uriForFile);
            } else {
                remoteViews.setViewVisibility(C2369R.id.feed_widget_item_image, 8);
            }
        }
        ...
        remoteViews.setOnClickFillInIntent(C2369R.id.shortcut_widget_item, intent);
        return remoteViews;
    }
