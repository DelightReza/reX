...
public class PipSourceHandlerState2 implements IPipActivityListener, IPipActivityAnimationListener {
    ...
    private void performPreAttach() {
        if (this.state != 0) {
            FileLog.m1158e("[PIP_DEBUG] wrong pip state STATE_DETACHED: " + this.state);
            return;
        }
    ...
    public void performAttach() {
        if (this.state != 1) {
            FileLog.m1158e("[PIP_DEBUG] wrong pip state STATE_PRE_ATTACHED: " + this.state);
            return;
        }
    ...
    private void performPreDetach1() {
        if (this.state != 2) {
            FileLog.m1158e("[PIP_DEBUG] wrong pip state STATE_ATTACHED: " + this.state);
            return;
        }
    ...
    public void performPreDetach2() {
        if (this.state != 3) {
            FileLog.m1158e("[PIP_DEBUG] wrong pip state STATE_PRE_DETACHED_1: " + this.state);
            return;
        }
    ...
    public void performDetach() {
        if (this.state != 4) {
            FileLog.m1158e("[PIP_DEBUG] wrong pip state STATE_PRE_DETACHED_2: " + this.state);
            return;
        }
