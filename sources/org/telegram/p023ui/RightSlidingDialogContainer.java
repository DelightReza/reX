...
public abstract class RightSlidingDialogContainer extends FrameLayout {
    ...
    protected void updateOpenAnimationProgress() {
        ...
        if (view != null) {
            view.setTranslationX((getMeasuredWidth() - AndroidUtilities.m1146dp(getRightPaddingSize())) * (1.0f - this.openedProgress));
        }
        ActionBar actionBar = this.currentActionBarView;
        if (actionBar != null) {
            actionBar.setTranslationX(AndroidUtilities.m1146dp(48.0f) * (1.0f - this.openedProgress));
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (view != null) {
            ...
            layoutParams.leftMargin = AndroidUtilities.m1146dp(getRightPaddingSize());
