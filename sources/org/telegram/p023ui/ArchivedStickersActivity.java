...
public class ArchivedStickersActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        if (i == 0) {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.ArchivedStickers));
        } else if (i == 5) {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.ArchivedEmojiPacks));
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.ArchivedMasks));
        }
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ArchivedStickersActivity.1
            ...
            public void onItemClick(int i2) {
                if (i2 == -1) {
                    ArchivedStickersActivity.this.lambda$onBackPressed$371();
                }
            }
        });
        ...
        if (this.currentType == 0) {
            emptyTextProgressView.setText(LocaleController.getString(C2369R.string.ArchivedStickersEmpty));
        } else {
            emptyTextProgressView.setText(LocaleController.getString(C2369R.string.ArchivedMasksEmpty));
        }
    ...
    public /* synthetic */ void lambda$createView$0(final View view, int i) {
        ...
        if (stickerSetCovered.set.f1607id != 0) {
            tL_inputStickerSetShortName = new TLRPC.TL_inputStickerSetID();
            tL_inputStickerSetShortName.f1596id = stickerSetCovered.set.f1607id;
        } else {
        ...
        stickersAlert.setInstallDelegate(new StickersAlert.StickersAlertInstallDelegate() { // from class: org.telegram.ui.ArchivedStickersActivity.2
            ...
            public void onStickerSetInstalled() {
                ...
                longSparseArray.put(stickerSetCovered2.set.f1607id, stickerSetCovered2);
            }
        });
    ...
    public void getStickers() {
        ...
        if (this.sets.isEmpty()) {
            ...
            j = ((TLRPC.StickerSetCovered) arrayList.get(arrayList.size() - 1)).set.f1607id;
        }
    ...
    public void lambda$processResponse$3(final TLRPC.TL_messages_archivedStickers tL_messages_archivedStickers) {
        if (!this.isInTransition) {
            ...
            while (i2 < size) {
                ...
                if (!this.loadedSets.contains(Long.valueOf(stickerSetCovered.set.f1607id))) {
                    this.loadedSets.add(Long.valueOf(stickerSetCovered.set.f1607id));
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.needAddArchivedStickers) {
            ...
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                while (true) {
                    ...
                    if (((TLRPC.StickerSetCovered) this.sets.get(i3)).set.f1607id == ((TLRPC.StickerSetCovered) arrayList.get(size)).set.f1607id) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if ((childAt instanceof ArchivedStickerSetCell) && (stickersSet = (archivedStickerSetCell = (ArchivedStickerSetCell) childAt).getStickersSet()) != null) {
                boolean zIsStickerPackInstalled = MediaDataController.getInstance(this.currentAccount).isStickerPackInstalled(stickersSet.set.f1607id);
                if (zIsStickerPackInstalled) {
                    this.installingStickerSets.remove(stickersSet.set.f1607id);
    ...
    class ListAdapter extends ListAdapterMD3 {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            if (getItemViewType(i) == 0) {
                ...
                boolean zIsStickerPackInstalled = MediaDataController.getInstance(((BaseFragment) ArchivedStickersActivity.this).currentAccount).isStickerPackInstalled(stickerSetCovered.set.f1607id);
                archivedStickerSetCell.setChecked(zIsStickerPackInstalled, false, false);
                if (zIsStickerPackInstalled) {
                    ArchivedStickersActivity.this.installingStickerSets.remove(stickerSetCovered.set.f1607id);
                    archivedStickerSetCell.setDrawProgress(false, false);
                } else {
                    archivedStickerSetCell.setDrawProgress(ArchivedStickersActivity.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f1607id) >= 0, false);
                }
                ...
                if (i == ArchivedStickersActivity.this.archiveInfoRow) {
                    ...
                    textInfoPrivacyCell.setText(LocaleController.getString(ArchivedStickersActivity.this.currentType == 5 ? C2369R.string.ArchivedEmojiInfo : C2369R.string.ArchivedStickersInfo));
                } else {
        ...
        public /* synthetic */ void lambda$onBindViewHolder$0(TLRPC.StickerSetCovered stickerSetCovered, ArchivedStickerSetCell archivedStickerSetCell, boolean z) {
            if (z) {
                ...
                if (ArchivedStickersActivity.this.installingStickerSets.indexOfKey(stickerSetCovered.set.f1607id) >= 0) {
                    return;
                }
                archivedStickerSetCell.setDrawProgress(true, true);
                ArchivedStickersActivity.this.installingStickerSets.put(stickerSetCovered.set.f1607id, stickerSetCovered);
            }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                loadingCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            } else if (i != 2) {
                loadingCell = null;
            } else {
        ...
        public Theme.ResourcesProvider getResourcesProvider() {
            return ((BaseFragment) ArchivedStickersActivity.this).resourceProvider;
        }
    }
