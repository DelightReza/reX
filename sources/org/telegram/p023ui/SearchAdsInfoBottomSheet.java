...
public class SearchAdsInfoBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public SearchAdsInfoBottomSheet(Context context, Theme.ResourcesProvider resourcesProvider, final Runnable runnable) {
        ...
        textView.setText(LocaleController.getString(C2369R.string.SearchAdsAboutTitle));
        ...
        textView2.setText(LocaleController.getString(C2369R.string.SearchAdsAboutSubtitle));
        textView2.setTextColor(Theme.getColor(i2, resourcesProvider));
        textView2.setTextSize(1, 14.0f);
        textView2.setGravity(1);
        linearLayout.addView(textView2, LayoutHelper.createLinear(-2, -2, 1, 22, 8, 22, 0));
        linearLayout.addView(new FeatureCell(context, C2369R.drawable.menu_privacy, LocaleController.getString(C2369R.string.SearchAdsAbout1Title), LocaleController.getString(C2369R.string.SearchAdsAbout1Subtitle)), LayoutHelper.createLinear(-1, -2, 0.0f, 0, 0, 20, 0, 0));
        final boolean zIsPremium = UserConfig.getInstance(this.currentAccount).isPremium();
        linearLayout.addView(new FeatureCell(context, C2369R.drawable.menu_feature_noads, LocaleController.getString(C2369R.string.SearchAdsAbout2Title), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(zIsPremium ? C2369R.string.SearchAdsAbout2SubtitlePremium : C2369R.string.SearchAdsAbout2Subtitle), new Runnable() { // from class: org.telegram.ui.SearchAdsInfoBottomSheet$$ExternalSyntheticLambda0
        ...
        textView3.setText(LocaleController.getString(C2369R.string.SearchAdsAboutLaunchTitle));
        ...
        SpannableStringBuilder spannableStringBuilderReplaceCharSequence = AndroidUtilities.replaceCharSequence("%1$s", AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.SearchAdsAboutLaunchSubtitle)), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.SearchAdsAboutLaunchLearnMore), new Runnable() { // from class: org.telegram.ui.SearchAdsInfoBottomSheet$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
        ...
        textView4.setText(LocaleController.getString(C2369R.string.SearchAdsAboutUnderstood));
