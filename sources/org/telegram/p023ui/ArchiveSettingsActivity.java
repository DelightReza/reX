...
public class ArchiveSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.ArchiveSettings));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ArchiveSettingsActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    ArchiveSettingsActivity.this.lambda$onBackPressed$371();
                }
            }
        });
    ...
    public /* synthetic */ void lambda$createView$1(View view, int i) {
        ...
        int i2 = ((ItemInner) this.items.get(i)).f1790id;
        if (i2 == 1) {
        ...
        if (i2 == 7) {
            if (!getUserConfig().isPremium() && !getMessagesController().autoarchiveAvailable && !this.settings.archive_and_mute_new_noncontact_peers) {
                ...
                simpleLayout.textView.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.UnlockPremium), Theme.key_undo_cancelColor, 0, new Runnable() { // from class: org.telegram.ui.ArchiveSettingsActivity$$ExternalSyntheticLambda2
                ...
                simpleLayout.textView.setPadding(0, AndroidUtilities.m1146dp(4.0f), 0, AndroidUtilities.m1146dp(4.0f));
    ...
    private static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && getClass() == obj.getClass()) {
                ...
                if (this.f1790id == itemInner.f1790id && Objects.equals(this.text, itemInner.text)) {
                    return true;
                }
            }
            return false;
    ...
    private class ListAdapter extends AdapterWithDiffUtils {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (viewHolder.getItemViewType() == 2) {
                ...
                if (z2) {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(ArchiveSettingsActivity.this.getContext(), C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    return;
                } else {
                    textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(ArchiveSettingsActivity.this.getContext(), C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    return;
                }
            }
            if (viewHolder.getItemViewType() == 1) {
                TextCheckCell textCheckCell = (TextCheckCell) viewHolder.itemView;
                int i4 = itemInner.f1790id;
                if (i4 == 1) {
            ...
            if (this.listView != null) {
                for (int i3 = 0; i3 < this.listView.getChildCount(); i3++) {
                    ...
                    if (childAdapterPosition >= 0 && childAdapterPosition < this.items.size()) {
                        int i4 = ((ItemInner) this.items.get(childAdapterPosition)).f1790id;
                        if (i4 == 1) {
