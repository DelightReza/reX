...
public abstract class MessageAuthorView extends FrameLayout {
    ...
    public MessageAuthorView(Context context, final int i, MessageObject messageObject, TLRPC.Chat chat) {
        ...
        tL_channels_getMessageAuthor.f1616id = messageObject.getId();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(36.0f), TLObject.FLAG_30);
        ...
        this.titleView.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m1146dp(24.0f);
    ...
    private void updateView() {
        ...
        if (user != null) {
            ...
            this.titleView.setText(AndroidUtilities.premiumText(LocaleController.formatString(C2369R.string.MessageAuthorSentBy, UserObject.getUserName(user)), new Runnable() { // from class: org.telegram.ui.MessageAuthorView$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
