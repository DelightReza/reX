...
import org.telegram.p023ui.Components.IntSeekBarAccessibilityDelegate;
...
public class LiteModeSettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.PowerUsage));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LiteModeSettingsActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    LiteModeSettingsActivity.this.lambda$onBackPressed$371();
                }
            }
        });
    ...
    public /* synthetic */ void lambda$createView$0(View view, int i, float f, float f2) throws IOException {
        int expandedIndex;
        ...
        if (i2 == 3 || i2 == 4) {
            if (LiteMode.isPowerSaverApplied()) {
                this.restrictBulletin = BulletinFactory.m1267of(this).createSimpleBulletin(new BatteryDrawable(0.1f, -1, Theme.getColor(Theme.key_dialogSwipeRemove), 1.3f), LocaleController.getString(C2369R.string.LiteBatteryRestricted)).show();
                return;
            }
            if (item.viewType == 3 && item.getFlagsCount() > 1 && (!LocaleController.isRTL ? f < view.getMeasuredWidth() - AndroidUtilities.m1146dp(75.0f) : f > AndroidUtilities.m1146dp(75.0f)) && (expandedIndex = getExpandedIndex(item.flags)) != -1) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$1(Boolean bool) throws IOException {
        updateValues();
    }
    ...
    private void updateItems() {
        ...
        if (LiteMode.getPowerSaverLevel() <= 0) {
            string = LocaleController.getString(C2369R.string.LiteBatteryInfoDisabled);
        } else if (LiteMode.getPowerSaverLevel() >= 100) {
            string = LocaleController.getString(C2369R.string.LiteBatteryInfoEnabled);
        } else {
            string = LocaleController.formatString(C2369R.string.LiteBatteryInfoBelow, String.format("%d%%", Integer.valueOf(LiteMode.getPowerSaverLevel())));
        }
        arrayList.add(Item.asInfo(string));
        this.items.add(Item.asHeader(LocaleController.getString(C2369R.string.LiteOptionsTitle)));
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_sticker, LocaleController.getString(C2369R.string.LiteOptionsStickers), 3));
        if (this.expanded[0]) {
            this.items.add(Item.asCheckbox(LocaleController.getString(C2369R.string.LiteOptionsAutoplayKeyboard), 1));
            this.items.add(Item.asCheckbox(LocaleController.getString(C2369R.string.LiteOptionsAutoplayChat), 2));
        }
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_smile_status, LocaleController.getString(C2369R.string.LiteOptionsEmoji), LiteMode.FLAGS_ANIMATED_EMOJI));
        if (this.expanded[1]) {
            this.items.add(Item.asCheckbox(LocaleController.getString(C2369R.string.LiteOptionsAutoplayKeyboard), LiteMode.FLAG_ANIMATED_EMOJI_KEYBOARD));
            this.items.add(Item.asCheckbox(LocaleController.getString(C2369R.string.LiteOptionsAutoplayReactions), LiteMode.FLAG_ANIMATED_EMOJI_REACTIONS));
            this.items.add(Item.asCheckbox(LocaleController.getString(C2369R.string.LiteOptionsAutoplayChat), LiteMode.FLAG_ANIMATED_EMOJI_CHAT));
        }
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_ask_question, LocaleController.getString(C2369R.string.LiteOptionsChat), this.FLAGS_CHAT));
        if (this.expanded[2]) {
        ...
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_call_earpiece, LocaleController.getString(C2369R.string.LiteOptionsCalls), 512));
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_videocall, LocaleController.getString(C2369R.string.LiteOptionsAutoplayVideo), 1024));
        this.items.add(Item.asSwitch(C2369R.drawable.msg2_gif, LocaleController.getString(C2369R.string.LiteOptionsAutoplayGifs), 2048));
        this.items.add(Item.asSwitch(C2369R.drawable.photo_star, LocaleController.getString(C2369R.string.LiteOptionsParticles), 131072));
    ...
    private class Adapter extends ListAdapterMD3Diff {
        ...
        public Theme.ResourcesProvider getResourcesProvider() {
            return ((BaseFragment) LiteModeSettingsActivity.this).resourceProvider;
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                switchCell = new TextInfoPrivacyCell(context) { // from class: org.telegram.ui.LiteModeSettingsActivity.Adapter.1
                    @Override // org.telegram.p023ui.Cells.TextInfoPrivacyCell, android.view.View
                ...
                TextCell textCell = new TextCell(context, 23, false, true, null);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws IOException {
            ...
            if (itemViewType == 0) {
                ...
                if (itemViewType == 1) {
                    ...
                    int i2 = i + 1;
                    boolean z2 = i2 < LiteModeSettingsActivity.this.items.size() && ((Item) LiteModeSettingsActivity.this.items.get(i2)).viewType != 2;
                    if (z && z2) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                    } else if (z) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                    } else if (z2) {
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(LiteModeSettingsActivity.this.getContext(), C2369R.drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
                    } else {
    ...
    private class SwitchCell extends FrameLayout {
        ...
        public SwitchCell(Context context) {
            ...
            TextView textView = new TextView(context) { // from class: org.telegram.ui.LiteModeSettingsActivity.SwitchCell.1
                ...
                protected void onMeasure(int i2, int i3) {
                    if (View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
                        i2 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i2) - AndroidUtilities.m1146dp(52.0f), TLObject.FLAG_31);
                    }
            ...
            this.countTextView.setTextSize(AndroidUtilities.m1146dp(14.0f));
        ...
        public void set(Item item, boolean z) {
            ...
            if (item.viewType == 3) {
                ...
                this.arrowView.setVisibility(8);
                this.textView.setText(item.text);
                this.textView.setTranslationX(AndroidUtilities.m1146dp(41.0f) * (LocaleController.isRTL ? -2.2f : 1.0f));
            ...
            marginLayoutParams.rightMargin = AndroidUtilities.m1146dp(f);
            this.needDivider = z;
        ...
        */
        private int preprocessFlagsCount(int r5) {
            /*
                r4 = this;
                org.telegram.ui.LiteModeSettingsActivity r0 = org.telegram.p023ui.LiteModeSettingsActivity.this
            ...
            L51:
                ...
                int r1 = r1 + (-1)
            L58:
                boolean r0 = org.telegram.p023ui.Components.ThanosEffect.supports()
                if (r0 != 0) goto L65
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (LocaleController.isRTL) {
                if (this.needLine) {
                    float fM1146dp = AndroidUtilities.m1146dp(75.0f);
                    canvas.drawRect(fM1146dp - AndroidUtilities.m1146dp(0.66f), (getMeasuredHeight() - AndroidUtilities.m1146dp(20.0f)) / 2.0f, fM1146dp, (getMeasuredHeight() + AndroidUtilities.m1146dp(20.0f)) / 2.0f, Theme.dividerPaint);
                }
                if (this.needDivider) {
                    canvas.drawLine((getMeasuredWidth() - AndroidUtilities.m1146dp(64.0f)) + (this.textView.getTranslationX() < 0.0f ? AndroidUtilities.m1146dp(-32.0f) : 0), getMeasuredHeight() - 1, 0.0f, getMeasuredHeight() - 1, Theme.dividerPaint);
                    return;
                }
                return;
            }
            if (this.needLine) {
                float measuredWidth = getMeasuredWidth() - AndroidUtilities.m1146dp(75.0f);
                canvas.drawRect(measuredWidth - AndroidUtilities.m1146dp(0.66f), (getMeasuredHeight() - AndroidUtilities.m1146dp(20.0f)) / 2.0f, measuredWidth, (getMeasuredHeight() + AndroidUtilities.m1146dp(20.0f)) / 2.0f, Theme.dividerPaint);
            }
            if (this.needDivider) {
                canvas.drawLine(AndroidUtilities.m1146dp(64.0f) + this.textView.getTranslationX(), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
            }
        }
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (this.containing) {
                sb.append('\n');
                sb.append(LocaleController.formatString("Of", C2369R.string.f1460Of, Integer.valueOf(this.enabled), Integer.valueOf(this.all)));
            }
    ...
    class PowerSaverSlider extends FrameLayout {
        ...
        public PowerSaverSlider(Context context) throws IOException {
            ...
            AnimatedTextView animatedTextView = new AnimatedTextView(context, true, false, false) { // from class: org.telegram.ui.LiteModeSettingsActivity.PowerSaverSlider.1
                Drawable backgroundDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(4.0f), Theme.multAlpha(Theme.getColor(Theme.key_windowBackgroundWhiteBlueHeader), 0.15f));
            ...
            this.headerOnView.setPadding(AndroidUtilities.m1146dp(5.33f), AndroidUtilities.m1146dp(2.0f), AndroidUtilities.m1146dp(5.33f), AndroidUtilities.m1146dp(2.0f));
            this.headerOnView.setTextSize(AndroidUtilities.m1146dp(12.0f));
            ...
            this.leftTextView.setText(LocaleController.getString(C2369R.string.LiteBatteryDisabled));
            ...
            this.middleTextView.setTextSize(AndroidUtilities.m1146dp(13.0f));
            ...
            this.batteryIcon.setTranslationY(AndroidUtilities.m1146dp(1.5f));
            this.batteryIcon.setBounds(AndroidUtilities.m1146dp(3.0f), AndroidUtilities.m1146dp(-20.0f), AndroidUtilities.m1146dp(23.0f), 0);
            ...
            this.rightTextView.setText(LocaleController.getString(C2369R.string.LiteBatteryEnabled));
            ...
            this.seekBarAccessibilityDelegate = new IntSeekBarAccessibilityDelegate() { // from class: org.telegram.ui.LiteModeSettingsActivity.PowerSaverSlider.4
                ...
                public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) throws IOException {
                    ...
                    StringBuilder sb = new StringBuilder(LocaleController.getString(C2369R.string.LiteBatteryTitle));
                    sb.append(", ");
                    int powerSaverLevel = LiteMode.getPowerSaverLevel();
                    if (powerSaverLevel <= 0) {
                        sb.append(LocaleController.getString(C2369R.string.LiteBatteryAlwaysDisabled));
                    } else if (powerSaverLevel >= 100) {
                        sb.append(LocaleController.getString(C2369R.string.LiteBatteryAlwaysEnabled));
                    } else {
                        sb.append(LocaleController.formatString(C2369R.string.AccDescrLiteBatteryWhenBelow, Integer.valueOf(Math.round(powerSaverLevel))));
                    }
        ...
        public void update() throws IOException {
            ...
            if (powerSaverLevel <= 0) {
                this.middleTextView.setText(LocaleController.getString(C2369R.string.LiteBatteryAlwaysDisabled), !LocaleController.isRTL);
            } else if (powerSaverLevel >= 100) {
                this.middleTextView.setText(LocaleController.getString(C2369R.string.LiteBatteryAlwaysEnabled), !LocaleController.isRTL);
            } else {
                float f = powerSaverLevel;
                this.batteryIcon.setFillValue(f / 100.0f, true);
                this.middleTextView.setText(AndroidUtilities.replaceCharSequence("%s", LocaleController.getString(C2369R.string.LiteBatteryWhenBelow), TextUtils.concat(String.format("%d%% ", Integer.valueOf(Math.round(f))), this.batteryText)), !LocaleController.isRTL);
            }
            this.headerOnView.setText(LocaleController.getString(LiteMode.isPowerSaverApplied() ? C2369R.string.LiteBatteryEnabled : C2369R.string.LiteBatteryDisabled).toUpperCase());
