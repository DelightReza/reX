...
public class HistoryFragment extends UniversalFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C69541());
        ...
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2369R.drawable.ic_ab_search, getResourceProvider()).setIsSearchField(true).setActionBarMenuItemSearchListener(new C69552());
        ...
        stickerEmptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(this.query) ? C2369R.string.WebNoHistory : C2369R.string.WebNoSearchedHistory));
    ...
    /* renamed from: org.telegram.ui.web.HistoryFragment$1 */
    class C69541 extends ActionBar.ActionBarMenuOnItemClick {
        C69541() {
        }
                ...
                if (((BaseFragment) HistoryFragment.this).actionBar.isActionModeShowed()) {
                    ...
                    AndroidUtilities.forEachViews((RecyclerView) HistoryFragment.this.listView, new Consumer() { // from class: org.telegram.ui.web.HistoryFragment$1$$ExternalSyntheticLambda0
                        ...
                        public final void accept(Object obj) {
                            HistoryFragment.C69541.m19717$r8$lambda$KfK5PG5YTgdWSPyA_5pT_hC880((View) obj);
                        }
                    });
                    return;
                }
                HistoryFragment.this.lambda$onBackPressed$371();
            }
        }

        /* renamed from: $r8$lambda$KfK5-PG5YTgdWSPyA_5pT_hC880, reason: not valid java name */
        public static /* synthetic */ void m19717$r8$lambda$KfK5PG5YTgdWSPyA_5pT_hC880(View view) {
    ...
    /* renamed from: org.telegram.ui.web.HistoryFragment$2 */
    class C69552 extends ActionBarMenuItem.ActionBarMenuItemSearchListener {
        ...
        public void onSearchCollapse() {
            ...
            HistoryFragment.this.emptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(HistoryFragment.this.query) ? C2369R.string.WebNoHistory : C2369R.string.WebNoSearchedHistory));
        }
        ...
        public void onTextChanged(EditText editText) {
            ...
            if (!TextUtils.equals(HistoryFragment.this.query, string)) {
                ...
                scheduleSearch();
                HistoryFragment.this.emptyView.title.setText(LocaleController.getString(TextUtils.isEmpty(string) ? C2369R.string.WebNoHistory : C2369R.string.WebNoSearchedHistory));
            }
            UniversalRecyclerView universalRecyclerView = HistoryFragment.this.listView;
            if (universalRecyclerView != null) {
                universalRecyclerView.adapter.update(true);
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2369R.string.WebHistory);
    }
        ...
        if (TextUtils.isEmpty(this.query)) {
            ...
            if (arrayList2 != null) {
                for (int size = arrayList2.size() - 1; size >= 0; size--) {
                    ...
                    arrayList.add(AddressBarList.BookmarkView.Factory.m1362as(entry, this.query));
                }
            }
        } else {
            for (int size2 = this.searchResults.size() - 1; size2 >= 0; size2--) {
                ...
                arrayList.add(AddressBarList.BookmarkView.Factory.m1362as(entry2, this.query));
            }
