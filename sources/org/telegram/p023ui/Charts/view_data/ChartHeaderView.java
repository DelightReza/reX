...
public class ChartHeaderView extends FrameLayout {
    ...
    public ChartHeaderView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.back.setText(LocaleController.getString(C2369R.string.ZoomOut));
        Drawable drawable = ContextCompat.getDrawable(getContext(), C2369R.drawable.msg_zoomout_stats);
        ...
        this.back.setCompoundDrawablePadding(AndroidUtilities.m1146dp(4.0f));
        this.back.setPadding(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(4.0f));
    ...
    public void zoomTo(BaseChartView baseChartView, long j, boolean z) {
        ...
        if (z) {
            ...
            this.back.setPivotY(AndroidUtilities.m1146dp(40.0f));
