...
public class LegendSignatureView extends FrameLayout {
    ...
    public LegendSignatureView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2369R.drawable.ic_chevron_right_black_18dp);
        RadialProgressView radialProgressView = new RadialProgressView(context);
        this.progressView = radialProgressView;
        radialProgressView.setSize(AndroidUtilities.m1146dp(12.0f));
        this.progressView.setStrokeWidth(AndroidUtilities.m1146dp(0.5f));
    ...
    public void recolor() {
        ...
        this.shadowDrawable = getContext().getResources().getDrawable(C2369R.drawable.stats_tooltip).mutate();
        this.backgroundDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(4.0f), Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider), Theme.getColor(Theme.key_listSelector, this.resourcesProvider), -16777216);
        CombinedDrawable combinedDrawable = new CombinedDrawable(this.shadowDrawable, this.backgroundDrawable, AndroidUtilities.m1146dp(3.0f), AndroidUtilities.m1146dp(3.0f));
    ...
    public void setData(int i, long j, ArrayList arrayList, boolean z, int i2, float f) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            if (((LineViewData) arrayList.get(i5)).enabled) {
                j2 += ((LineViewData) arrayList.get(i5)).line.f1825y[i];
            }
        }
        int i6 = 0;
        while (i6 < length) {
            ...
            if (!lineViewData.enabled) {
                ...
                i3 = i6;
                textViewEmojis.setText(formatWholeNumber(lineViewData.line.f1825y[i], i2, i7, textViewEmojis, f));
                if (i2 == 1) {
                    holder.signature.setText(LocaleController.formatString(i7 == 0 ? C2369R.string.ChartInTON : C2369R.string.ChartInUSD, lineViewData.line.name));
                } else if (i2 == 2) {
                    holder.signature.setText(StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(i7 == 0 ? C2369R.string.ChartInXTR : C2369R.string.ChartInUSD, lineViewData.line.name), 0.7f));
                } else {
                ...
                if (this.showPercentage && (textView = holder.percentage) != null) {
                    ...
                    float f2 = ((LineViewData) arrayList.get(i3)).line.f1825y[i] / j2;
                    if (f2 < 0.1f && f2 != 0.0f) {
    ...
    class Holder {
        ...
        Holder() {
            ...
            if (LegendSignatureView.this.showPercentage) {
                ...
                this.percentage.getLayoutParams().width = AndroidUtilities.m1146dp(36.0f);
