...
public class ChartPickerDelegate {
    ...
    class CapturesData {
        ...
        public void captured() {
            ...
            this.f1822a = valueAnimatorOfFloat;
            valueAnimatorOfFloat.setDuration(600L);
            this.f1822a.setInterpolator(BaseChartView.INTERPOLATOR);
            this.f1822a.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: org.telegram.ui.Charts.ChartPickerDelegate$CapturesData$$ExternalSyntheticLambda0
        ...
        public void uncapture() {
            ValueAnimator valueAnimator = this.f1822a;
    ...
    public boolean uncapture(MotionEvent motionEvent, int i) {
        ...
        if (i == 0) {
            if (this.tryMoveTo) {
                ...
                if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.startTapTime < 300 && Math.sqrt((x * x) + (y * y)) < AndroidUtilities.m1146dp(10.0f)) {
