...
public abstract class CodeFieldContainer extends LinearLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        float fM1146dp = AndroidUtilities.m1146dp(1.5f);
        this.strokeWidth = fM1146dp;
        paint.setStrokeWidth(fM1146dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (childAt instanceof CodeNumberField) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), this.paint);
            }
        }
                                ...
                                for (int i9 = 0; i9 < Math.min(i - i6, length); i9++) {
                                    if (i9 == 0) {
                                        ...
                                        if (i11 < codeNumberFieldArr2.length) {
                                            codeNumberFieldArr2[i10 + i9].setText(string.substring(i9, i9 + 1));
                                        }
                                    }
                                }
