package org.telegram.p023ui.TON;
...
public class TONIntroActivity extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        View view = new View(context) { // from class: org.telegram.ui.TON.TONIntroActivity.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (tONIntroActivity.isLandscapeMode) {
                    measuredHeight = (tONIntroActivity.statusBarHeight + ((BaseFragment) tONIntroActivity).actionBar.getMeasuredHeight()) - AndroidUtilities.m1146dp(16.0f);
                } else {
                    int iM1146dp = AndroidUtilities.m1146dp(140.0f);
                    TONIntroActivity tONIntroActivity2 = TONIntroActivity.this;
                    int measuredHeight2 = iM1146dp + tONIntroActivity2.statusBarHeight;
                    if (tONIntroActivity2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1146dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = TONIntroActivity.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1146dp(24.0f);
                    }
        ...
        configureHeader(LocaleController.getString(C2369R.string.TONBalanceTitle), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.TONBalanceText), new Runnable() { // from class: org.telegram.ui.TON.TONIntroActivity$$ExternalSyntheticLambda0
        ...
        this.starBalanceTitleView.setText(LocaleController.getString(C2369R.string.YourTonBalance));
        ...
        if (this.allowTopUp) {
            ...
            buttonWithCounterView.setText(LocaleController.getString(C2369R.string.TopUpViaFragment), false);
        ...
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2369R.string.TonTopUp));
        ...
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2369R.string.TonStats));
    ...
    public /* synthetic */ void lambda$createView$2(View view) {
        Browser.openUrlInSystemBrowser(getContext(), LocaleController.getString(C2369R.string.TopUpViaFragmentLink));
    }
    ...
    /* renamed from: org.telegram.ui.TON.TONIntroActivity$4 */
    class C66544 extends StarParticlesView {
        Paint[] paints;
        final /* synthetic */ int val$particlesCount;
        final /* synthetic */ int val$type;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C66544(Context context, int i, int i2) {
            super(context);
    ...
    public static StarParticlesView makeParticlesView(Context context, int i, int i2) {
        return new C66544(context, i, i2);
    }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        if (this.allowTopUp) {
            arrayList.add(UItem.asShadow(LocaleController.getString(C2369R.string.TopUpViaFragmentInfo)));
        }
    ...
    public static class StarsNeededSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            ...
            if (i == NotificationCenter.starOptionsLoaded || i == NotificationCenter.starBalanceUpdated) {
                ...
                this.headerView.titleView.setText(LocaleController.formatString(C2369R.string.TonNeededTitle, AmountUtils$Amount.fromNano(this.requiredAmount.asNano() - balanceAmount.asNano(), AmountUtils$Currency.TON).asFormatString()));
        ...
        public StarsNeededSheet(Context context, Theme.ResourcesProvider resourcesProvider, AmountUtils$Amount amountUtils$Amount, boolean z, Runnable runnable) {
            ...
            headerView.titleView.setText(LocaleController.formatString(C2369R.string.TonNeededTitle, AmountUtils$Amount.fromNano(amountUtils$Amount.asNano() - StarsController.getTonInstance(this.currentAccount).getBalanceAmount().asNano(), AmountUtils$Currency.TON).asFormatString()));
            headerView.subtitleView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.FragmentAddFunds)));
