...
public class KeepMediaPopupView extends ActionBarPopupWindow.ActionBarPopupWindowLayout {
    ...
    public KeepMediaPopupView(final BaseFragment baseFragment, Context context) {
        ...
        setFitItems(true);
        this.oneDay = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_autodelete_1d, LocaleController.formatPluralString("Days", 1, new Object[0]), false, null);
        this.twoDay = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_autodelete_2d, LocaleController.formatPluralString("Days", 2, new Object[0]), false, null);
        this.oneWeek = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_autodelete_1w, LocaleController.formatPluralString("Weeks", 1, new Object[0]), false, null);
        this.oneMonth = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_autodelete_1m, LocaleController.formatPluralString("Months", 1, new Object[0]), false, null);
        this.forever = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_cancel, LocaleController.getString(C2369R.string.AutoDeleteMediaNever), false, null);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this, C2369R.drawable.msg_delete, LocaleController.getString(C2369R.string.DeleteException), false, null);
        ...
        view.setBackground(Theme.getThemedDrawableByKey(context, C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow, null));
        this.gap.addView(view, LayoutHelper.createFrame(-1, -1.0f));
        this.gap.setTag(C2369R.id.fit_width_tag, 1);
        ...
        linksTextView.setText(LocaleController.getString(C2369R.string.KeepMediaPopupDescription));
    ...
    public /* synthetic */ void lambda$new$2(BaseFragment baseFragment, View view) {
        ...
        if (this.exceptions.isEmpty()) {
            ...
            dialogsActivity.setDelegate(new DialogsActivity.DialogsActivityDelegate() { // from class: org.telegram.ui.KeepMediaPopupView$$ExternalSyntheticLambda2
                ...
                public final boolean didSelectDialogs(DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i2, TopicsFragment topicsFragment) {
                    return this.f$0.lambda$new$1(dialogsActivity, dialogsActivity2, arrayList, charSequence, z, z2, i2, topicsFragment);
                }
        ...
        bundle2.putInt(PluginsConstants.Settings.TYPE, this.currentType);
    ...
    public /* synthetic */ boolean lambda$new$1(final DialogsActivity dialogsActivity, DialogsActivity dialogsActivity2, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, TopicsFragment topicsFragment) {
        ...
        Bundle bundle = new Bundle();
        bundle.putInt(PluginsConstants.Settings.TYPE, this.currentType);
    ...
    public void update(int i) {
        ...
        if (keepMediaExceptions.isEmpty()) {
            this.exceptionsView.titleView.setText(LocaleController.getString(C2369R.string.AddAnException));
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1146dp(8.0f));
            ...
            this.exceptionsView.titleView.setRightPadding(AndroidUtilities.m1146dp((Math.max(0, iMin - 1) * 12) + 64));
    ...
    private class ExceptionsView extends FrameLayout {
        ...
        public ExceptionsView(Context context) {
            ...
            this.titleView.setRightPadding(AndroidUtilities.m1146dp(68.0f));
    ...
    public void updateAvatarsPosition() {
        if (this.exceptions != null) {
            this.exceptionsView.avatarsImageView.setTranslationX(AndroidUtilities.m1146dp(12.0f) * (3 - Math.min(3, this.exceptions.size())));
        }
    }
