...
public class NotificationPermissionDialog extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public NotificationPermissionDialog(Context context, boolean z, Utilities.Callback callback) {
        ...
        this.rLottieImageView.setAnimation(C2369R.raw.silent_unmute, 46, 46);
        ...
        rLottieImageView2.setBackground(Theme.createCircleDrawable(iM1146dp, Theme.getColor(i)));
        ...
        textView.setText(LocaleController.getString(C2369R.string.NotificationsPermissionAlertTitle));
        textView.setPadding(AndroidUtilities.m1146dp(30.0f), 0, AndroidUtilities.m1146dp(30.0f), 0);
        linearLayout.addView(textView, LayoutHelper.createLinear(-1, -2));
        TextView textView2 = new TextView(context);
        textView2.setTextColor(Theme.getColor(i2));
        textView2.setTextSize(1, 14.0f);
        textView2.setGravity(1);
        textView2.setText(LocaleController.getString(C2369R.string.NotificationsPermissionAlertSubtitle));
        textView2.setPadding(AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(10.0f), AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(21.0f));
        linearLayout.addView(textView2, LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C2369R.drawable.msg_message_s, LocaleController.getString(C2369R.string.NotificationsPermissionAlert1)), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C2369R.drawable.msg_members_list2, LocaleController.getString(C2369R.string.NotificationsPermissionAlert2)), LayoutHelper.createLinear(-1, -2));
        linearLayout.addView(new SectionView(context, C2369R.drawable.msg_customize_s, LocaleController.getString(C2369R.string.NotificationsPermissionAlert3)), LayoutHelper.createLinear(-1, -2));
        setCustomView(linearLayout);
        fixNavigationBar(getThemedColor(Theme.key_dialogBackground));
        TextView textView3 = new TextView(context);
        textView3.setText(LocaleController.getString(z ? C2369R.string.NotificationsPermissionSettings : C2369R.string.NotificationsPermissionContinue));
    ...
    static class CounterView extends View {
        ...
        public CounterView(Context context) {
            ...
            paint2.setStrokeWidth(AndroidUtilities.m1146dp(4.0f));
            ...
            this.textDrawable.getPaint().setStrokeWidth(AndroidUtilities.m1146dp(0.24f));
            this.textDrawable.getPaint().setStrokeJoin(Paint.Join.ROUND);
            this.textDrawable.setTextSize(AndroidUtilities.m1146dp(13.3f));
            this.textDrawable.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
            this.textDrawable.setOverrideFullWidth(AndroidUtilities.m1146dp(64.0f));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(30.0f), this.strokePaint);
            this.fillPaint.setAlpha(i);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(30.0f), this.fillPaint);
            canvas.save();
    ...
    private static class SectionView extends FrameLayout {
        public SectionView(Context context, int i, CharSequence charSequence) {
            super(context);
            setPadding(0, AndroidUtilities.m1146dp(7.0f), 0, AndroidUtilities.m1146dp(7.0f));
