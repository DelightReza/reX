...
public class ProfileLocationCell extends LinearLayout {
    ...
    public ProfileLocationCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        loadingDrawable.strokePaint.setStrokeWidth(AndroidUtilities.m1146dp(1.0f));
        ...
        textView2.setText(LocaleController.getString(C2369R.string.BusinessProfileLocation));
    ...
    public void set(TLRPC.TL_businessLocation tL_businessLocation, boolean z) {
        if (tL_businessLocation != null) {
            ...
            if (tL_businessLocation.geo_point != null) {
                this.imageReceiver.setImage(ImageLocation.getForWebFile(WebFile.createWithGeoPoint(tL_businessLocation.geo_point, AndroidUtilities.m1146dp(44.0f), AndroidUtilities.m1146dp(44.0f), 15, Math.min(2, (int) Math.ceil(AndroidUtilities.density)))), "44_44", this.thumbDrawable, 0L, (String) null, (Object) null, 0);
            } else {
    ...
    protected void onDraw(Canvas canvas) {
        this.imageReceiver.setImageCoords(LocaleController.isRTL ? AndroidUtilities.m1146dp(16.0f) : getWidth() - AndroidUtilities.m1146dp(60.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(44.0f), AndroidUtilities.m1146dp(44.0f));
