...
public class ChatbotsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.BusinessBots));
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    if (ChatbotsActivity.this.onBackPressed()) {
                        ChatbotsActivity.this.lambda$onBackPressed$371();
                    }
                } else if (i == 1) {
        ...
        this.editText.setHint(LocaleController.getString(C2369R.string.BusinessBotLink));
        this.editText.setCursorColor(Theme.getColor(i2));
        this.editText.setCursorSize(AndroidUtilities.m1146dp(19.0f));
        ...
        FrameLayout frameLayout5 = new FrameLayout(context) { // from class: org.telegram.ui.Business.ChatbotsActivity.3
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(58.0f), TLObject.FLAG_30));
            }
        };
        ...
        textView.setText(LocaleController.getString(C2369R.string.BusinessBotNotFound));
        ...
        this.emptyViewLoading.setTranslationY(AndroidUtilities.m1146dp(8.0f));
        SpannableStringBuilder spannableStringBuilderReplaceSingleTag = AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.BusinessBotsInfo), new Runnable() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
        ...
        if (iIndexOf >= 0) {
            ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2369R.drawable.arrow_newchat);
        ...
        searchAdapterHelper.setDelegate(new C27205());
    ...
    public /* synthetic */ void lambda$createView$1() {
        Browser.openUrl(getContext(), LocaleController.getString(C2369R.string.BusinessBotsInfoLink));
    }

    /* renamed from: org.telegram.ui.Business.ChatbotsActivity$5 */
    class C27205 implements SearchAdapterHelper.SearchAdapterHelperDelegate {
    ...
    public void updateSearchLoading() {
        ...
        if (this.wasLoading != (this.searchHelper.isSearchInProgress() || this.scheduledLoading || this.foundBots.size() > 0)) {
            ...
            this.wasLoading = z;
            ViewPropertyAnimator duration = this.emptyViewText.animate().alpha(z ? 0.0f : 1.0f).translationY(z ? -AndroidUtilities.m1146dp(8.0f) : 0.0f).setDuration(320L);
            CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.EASE_OUT_QUINT;
            duration.setInterpolator(cubicBezierInterpolator).start();
            this.emptyViewLoading.animate().alpha(z ? 1.0f : 0.0f).translationY(z ? 0.0f : AndroidUtilities.m1146dp(8.0f)).setDuration(320L).setInterpolator(cubicBezierInterpolator).start();
        }
    }
    ...
    private void checkAlert(int i, boolean z, final Runnable runnable) {
        if (!this.shownUsernamePermissionsAlert && i == PERMISSION_PROFILE_USERNAME && z) {
            new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2369R.string.BusinessBotPermissionsWarning)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.BusinessBotPermissionsUsernamesWarningText, UserObject.getPublicUsername(this.selectedBot)))).setNegativeButton(LocaleController.getString(C2369R.string.Cancel), null).setPositiveButton(LocaleController.getString(C2369R.string.Allow), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda25
        ...
        if (!this.shownGiftsPermissionsAlert && z && (i == PERMISSION_GIFTS_SELL || i == PERMISSION_GIFTS_SETTINGS || i == PERMISSION_GIFTS_TRANSFER || i == PERMISSION_GIFTS_TRANSFER_STARS)) {
            new AlertDialog.Builder(getContext(), getResourceProvider()).setTitle(LocaleController.getString(C2369R.string.BusinessBotPermissionsWarning)).setMessage(AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.BusinessBotPermissionsGiftsWarningText, UserObject.getPublicUsername(this.selectedBot)))).setNegativeButton(LocaleController.getString(C2369R.string.Cancel), null).setPositiveButton(LocaleController.getString(C2369R.string.Allow), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda26
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        boolean z = false;
        if (user != null) {
            arrayList.add(UItem.asAddChat(Long.valueOf(user.f1734id)).setChecked(true).setCloseIcon(new View.OnClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda17
            ...
            for (int i = 0; i < this.searchHelper.getLocalServerSearch().size(); i++) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    if (user2.bot) {
                        arrayList.add(UItem.asAddChat(Long.valueOf(user2.f1734id)));
                        this.foundBots.put(user2.f1734id, user2);
                        z2 = true;
                    }
                }
            }
            for (int i2 = 0; i2 < this.searchHelper.getGlobalSearch().size(); i2++) {
                ...
                if (tLObject2 instanceof TLRPC.User) {
                    ...
                    if (user3.bot) {
                        arrayList.add(UItem.asAddChat(Long.valueOf(user3.f1734id)));
                        this.foundBots.put(user3.f1734id, user3);
                        z2 = true;
                    }
                }
            }
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2369R.string.BusinessBotLinkInfo)));
        if (this.selectedBot != null) {
            arrayList.add(UItem.asHeader(LocaleController.getString(C2369R.string.BusinessBotChats)));
            arrayList.add(UItem.asRadio(RADIO_EXCLUDE, LocaleController.getString(C2369R.string.BusinessChatsAllPrivateExcept)).setChecked(this.exclude));
            arrayList.add(UItem.asRadio(RADIO_INCLUDE, LocaleController.getString(C2369R.string.BusinessChatsOnlySelected)).setChecked(!this.exclude));
            arrayList.add(UItem.asShadow(null));
            this.recipientsHelper.fillItems(arrayList);
            arrayList.add(UItem.asShadow(LocaleController.getString(C2369R.string.BusinessBotChatsInfo)));
            arrayList.add(UItem.asHeader(LocaleController.getString(C2369R.string.BusinessBotPermissions)));
            int i3 = PERMISSION_MESSAGES;
            String string = LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesSection);
            ...
            if (this.expandedMessagesSection) {
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_MESSAGES_READ, LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesRead)).setChecked(true).setEnabled(false).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_MESSAGES_REPLY, LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesReply)).setChecked(this.rights.reply).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_MESSAGES_MARK_AS_READ, LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesMarkAsRead)).setChecked(this.rights.read_messages).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_MESSAGES_DELETE_SENT, LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesDeleteSent)).setChecked(this.rights.delete_sent_messages).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_MESSAGES_DELETE_RECEIVED, LocaleController.getString(C2369R.string.BusinessBotPermissionsMessagesDeleteReceived)).setChecked(this.rights.delete_received_messages).setPad(1));
            }
            int i4 = PERMISSION_PROFILE;
            String string2 = LocaleController.getString(C2369R.string.BusinessBotPermissionsProfileSection);
            ...
            if (this.expandedProfileSection) {
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_PROFILE_NAME, LocaleController.getString(C2369R.string.BusinessBotPermissionsProfileName)).setChecked(this.rights.edit_name).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_PROFILE_BIO, LocaleController.getString(C2369R.string.BusinessBotPermissionsProfileBio)).setChecked(this.rights.edit_bio).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_PROFILE_PICTURE, LocaleController.getString(C2369R.string.BusinessBotPermissionsProfilePicture)).setChecked(this.rights.edit_profile_photo).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_PROFILE_USERNAME, LocaleController.getString(C2369R.string.BusinessBotPermissionsProfileUsername)).setChecked(this.rights.edit_username).setPad(1));
            }
            int i5 = PERMISSION_GIFTS;
            String string3 = LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsSection);
            ...
            if (this.expandedGiftsSection) {
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_GIFTS_VIEW, LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsView)).setChecked(this.rights.view_gifts).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_GIFTS_SELL, LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsSell)).setChecked(this.rights.sell_gifts).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_GIFTS_SETTINGS, LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsSettings)).setChecked(this.rights.change_gift_settings).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_GIFTS_TRANSFER, LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsTransfer)).setChecked(this.rights.transfer_and_upgrade_gifts).setPad(1));
                arrayList.add(UItem.asRoundCheckbox(PERMISSION_GIFTS_TRANSFER_STARS, LocaleController.getString(C2369R.string.BusinessBotPermissionsGiftsTransferStars)).setChecked(this.rights.transfer_stars).setPad(1));
            }
            arrayList.add(UItem.asExpandableSwitch(PERMISSION_STORIES, LocaleController.getString(C2369R.string.BusinessBotPermissionsStories), "").setChecked(this.rights.manage_stories).setClickCallback(new View.OnClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda21
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    public void onClick(UItem uItem, final View view, int i, float f, float f2) {
        ...
        if (uItem.viewType == 13) {
            ...
            if (!user.bot_business) {
                showDialog(new AlertDialog.Builder(getContext(), this.resourceProvider).setTitle(LocaleController.getString(C2369R.string.BusinessBotNotSupportedTitle)).setMessage(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.BusinessBotNotSupportedMessage))).setPositiveButton(LocaleController.getString(C2369R.string.f1459OK), null).create());
                return;
            }
    ...
    public void processDone() {
        ...
        if (this.recipientsHelper.validate(this.listView)) {
            ...
            TL_account.TL_connectedBot tL_connectedBot = this.currentBot;
            if (tL_connectedBot != null && ((user = this.selectedBot) == null || tL_connectedBot.bot_id != user.f1734id)) {
            ...
            if (this.selectedBot != null) {
                ...
                if (tL_connectedBot2 != null) {
                    tL_connectedBot2.bot_id = this.selectedBot.f1734id;
    ...
    public boolean hasChanges() {
        ...
        if ((user == null ? 0L : user.f1734id) != (tL_connectedBot != null ? tL_connectedBot.bot_id : 0L)) {
            return true;
        }
        if (user != null) {
    ...
    public boolean onBackPressed() {
        if (hasChanges()) {
            ...
            builder.setMessage(LocaleController.getString(C2369R.string.BusinessBotUnsavedChanges));
            builder.setPositiveButton(LocaleController.getString(C2369R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda1
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$onBackPressed$23(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2369R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.ChatbotsActivity$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
