...
import org.telegram.p023ui.Components.ClipRoundedDrawable;
...
public class LocationActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.BusinessLocation));
        ...
        this.editText.setPadding(0, 0, AndroidUtilities.m1146dp(42.0f), 0);
        this.editText.setGravity((LocaleController.isRTL ? 5 : 3) | 48);
        this.editText.setInputType(180225);
        this.editText.setHint(LocaleController.getString(C2369R.string.BusinessLocationAddress));
        ...
        this.mapPreview = new BackupImageView(context) { // from class: org.telegram.ui.Business.LocationActivity.5
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i4), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(240.0f), TLObject.FLAG_30));
            }
        ...
        SvgHelper.SvgDrawable svgThumb = DocumentObject.getSvgThumb(C2369R.raw.map_placeholder, Theme.key_chat_outLocationIcon, 0.2f);
        ...
        this.mapMarker = new View(context) { // from class: org.telegram.ui.Business.LocationActivity.6
            ...
            final Drawable pin = getContext().getResources().getDrawable(C2369R.drawable.map_pin_photo).mutate();
            ...
            @Override // android.view.View
            protected void dispatchDraw(Canvas canvas) {
                this.pin.setBounds(0, 0, AndroidUtilities.m1146dp(62.0f), AndroidUtilities.m1146dp(85.0f));
                this.pin.draw(canvas);
                this.avatarImage.setRoundRadius(AndroidUtilities.m1146dp(62.0f));
                this.avatarImage.setImageCoords(AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(50.0f), AndroidUtilities.m1146dp(50.0f));
                this.avatarImage.draw(canvas);
            }

            @Override // android.view.View
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(62.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(85.0f), TLObject.FLAG_30));
            }
        };
    ...
    private void updateMapPreview() {
        ...
        if (this.geo != null) {
            view.setAlpha(0.0f);
            this.mapMarker.setTranslationY(-AndroidUtilities.m1146dp(12.0f));
    ...
    public boolean onBackPressed() {
        ...
        if (hasChanges() && !z) {
            ...
            builder.setMessage(LocaleController.getString(C2369R.string.BusinessLocationUnsavedChanges));
            builder.setPositiveButton(LocaleController.getString(C2369R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda2
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
                    this.f$0.lambda$onBackPressed$2(alertDialog, i);
                }
            });
            builder.setNegativeButton(LocaleController.getString(C2369R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda3
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        arrayList.add(UItem.asTopView(LocaleController.getString(C2369R.string.BusinessLocationInfo), C2369R.raw.biz_map));
        arrayList.add(UItem.asCustom(this.editTextContainer));
        arrayList.add(UItem.asShadow(null));
        boolean z = false;
        arrayList.add(UItem.asCheck(1, LocaleController.getString(C2369R.string.BusinessLocationMap)).setChecked(this.geo != null));
        if (this.geo != null) {
        ...
        this.clearVisible = z;
        if (z) {
            arrayList.add(UItem.asButton(2, LocaleController.getString(C2369R.string.BusinessLocationClear)).red());
            arrayList.add(UItem.asShadow(null));
        }
        checkDone(true);
    }
    ...
    public void onClick(UItem uItem, View view, int i, float f, float f2) {
        ...
        if (i2 == 2) {
            AlertDialog.Builder builder = new AlertDialog.Builder(getParentActivity());
            builder.setTitle(LocaleController.getString(C2369R.string.BusinessLocationClearTitle));
            builder.setMessage(LocaleController.getString(C2369R.string.BusinessLocationClearMessage));
            builder.setPositiveButton(LocaleController.getString(C2369R.string.Remove), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Business.LocationActivity$$ExternalSyntheticLambda5
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
    ...
    private void showLocationAlert() {
        final org.telegram.p023ui.LocationActivity locationActivity = new org.telegram.p023ui.LocationActivity(8);
        if (this.geo != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$7(org.telegram.p023ui.LocationActivity locationActivity, TLRPC.MessageMedia messageMedia, int i, boolean z, int i2, long j) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$9(final org.telegram.p023ui.LocationActivity locationActivity, final AlertDialog alertDialog) throws IOException {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$showLocationAlert$8(AlertDialog alertDialog, org.telegram.p023ui.LocationActivity locationActivity) {
        alertDialog.dismiss();
        presentFragment(locationActivity);
    }
}
