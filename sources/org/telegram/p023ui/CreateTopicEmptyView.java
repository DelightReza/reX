...
public class CreateTopicEmptyView extends LinearLayout {
    ...
    public CreateTopicEmptyView(Context context, FrameLayout frameLayout, Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createServiceDrawable(AndroidUtilities.m1146dp(18.0f), this, frameLayout, getThemedPaint("paintChatActionBackground")));
        ...
        textView.setMaxWidth(AndroidUtilities.m1146dp(210.0f));
        textView.setText(LocaleController.getString(C2369R.string.AlmostDone));
        TextView textView2 = new TextView(context);
        textView2.setTextSize(1, 13.0f);
        textView2.setTextColor(getThemedColor(i));
        textView2.setGravity(1);
        textView2.setMaxWidth(AndroidUtilities.m1146dp(160.0f));
        textView2.setText(LocaleController.getString(C2369R.string.TopicEmptyViewDescription));
