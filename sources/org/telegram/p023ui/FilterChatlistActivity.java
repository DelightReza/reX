...
import org.telegram.p023ui.FilterChatlistActivity;
...
public class FilterChatlistActivity extends BaseFragment {
    ...
    public void updateActionBarTitle(boolean z) {
        ...
        String string = TextUtils.isEmpty(tL_exportedChatlistInvite == null ? null : tL_exportedChatlistInvite.title) ? LocaleController.getString(C2369R.string.FilterShare) : this.invite.title;
        if (z) {
    ...
    public View createView(Context context) {
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    if (FilterChatlistActivity.this.checkDiscard()) {
                        FilterChatlistActivity.this.lambda$onBackPressed$371();
                    }
                } else if (i == 1) {
        ...
        for (int i3 = 0; i3 < this.filter.dialogs.size(); i3++) {
            ...
            if (dialog != null && !DialogObject.isEncryptedDialog(dialog.f1577id) && !this.peers.contains(Long.valueOf(dialog.f1577id))) {
                long j = dialog.f1577id;
                boolean zCanAddToFolder = j < 0;
                if (j < 0) {
                    zCanAddToFolder = FilterCreateActivity.canAddToFolder(getMessagesController().getChat(Long.valueOf(-dialog.f1577id)));
                }
                if (zCanAddToFolder) {
                    this.peers.add(Long.valueOf(dialog.f1577id));
                    this.allowedPeers.add(Long.valueOf(dialog.f1577id));
                }
            }
        }
        for (int i4 = 0; i4 < this.filter.dialogs.size(); i4++) {
            TLRPC.Dialog dialog2 = this.filter.dialogs.get(i4);
            if (dialog2 != null && !DialogObject.isEncryptedDialog(dialog2.f1577id) && !this.peers.contains(Long.valueOf(dialog2.f1577id)) && !this.allowedPeers.contains(Long.valueOf(dialog2.f1577id))) {
                this.peers.add(Long.valueOf(dialog2.f1577id));
            }
        }
        updateRows();
            ...
            if (this.selectedPeers.contains(l)) {
                ...
                if (jLongValue >= 0) {
                    ...
                    if (user != null && user.bot) {
                        string2 = LocaleController.getString(C2369R.string.FilterInviteBotToast);
                    } else {
                        string2 = LocaleController.getString(C2369R.string.FilterInviteUserToast);
                    }
                } else {
                    TLRPC.Chat chat = getMessagesController().getChat(Long.valueOf(-jLongValue));
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        if (ChatObject.isPublic(chat)) {
                            string = LocaleController.getString(C2369R.string.FilterInviteChannelToast);
                        } else {
                            string = LocaleController.getString(C2369R.string.FilterInvitePrivateChannelToast);
                        }
                    } else if (ChatObject.isPublic(chat)) {
                        string = LocaleController.getString(C2369R.string.FilterInviteGroupToast);
                    } else {
                        string = LocaleController.getString(C2369R.string.FilterInvitePrivateGroupToast);
                    }
                    arrayList.add(chat);
                    string2 = string;
                }
                if (this.lastClickedDialogId != jLongValue || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m1267of(this).createChatsBulletin(arrayList, string2, null).show();
                    return;
                }
                return;
            }
    ...
    public /* synthetic */ void lambda$saveTitle$3(TLRPC.TL_error tL_error) {
        this.savingTitleReqId = 0;
        if (tL_error == null) {
            BulletinFactory.m1267of(this).createSimpleBulletin(C2369R.raw.contact_check, LocaleController.getString(C2369R.string.FilterInviteNameEdited)).show();
        }
    }
    ...
    public void updateHintCell(boolean z) {
        ...
        if (this.invite == null) {
            hintInnerCell.setText(LocaleController.getString(C2369R.string.FilterInviteHeaderNo), false);
            return;
        }
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (this.allowedPeers.size() > 1) {
            ...
            this.headerCountCell.setAction(LocaleController.getString(!z2 ? C2369R.string.SelectAll : C2369R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
    ...
    class ListAdapter extends ListAdapterMD3 {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View headerCell;
            if (i == 0) {
                headerCell = new HintInnerCell(FilterChatlistActivity.this.getContext(), C2369R.raw.folder_share);
            } else if (i == 2) {
                headerCell = new TextInfoPrivacyCell(FilterChatlistActivity.this.getContext());
            } else if (i == 3) {
                headerCell = new C50751(FilterChatlistActivity.this.getContext(), FilterChatlistActivity.this);
        ...
        class C50751 extends InviteLinkCell {
            C50751(Context context, BaseFragment baseFragment) {
            ...
            protected void deleteLink() {
                ...
                tL_inputChatlistDialogFilter.filter_id = filterChatlistActivity.filter.f1454id;
            ...
            public void editname() {
                ...
                builder.setTitle(LocaleController.getString(C2369R.string.FilterInviteEditName));
                builder.setNegativeButton(LocaleController.getString(C2369R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda2
                ...
                editTextBoldCursor.setOnEditorActionListener(new TextView.OnEditorActionListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda3
                    ...
                    public final boolean onEditorAction(TextView textView, int i2, KeyEvent keyEvent) {
                        return FilterChatlistActivity.ListAdapter.C50751.m13235$r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZWSw(builder, textView, i2, keyEvent);
                    }
                });
                ...
                builder.setPositiveButton(LocaleController.getString(C2369R.string.Save), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda4
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                ...
                alertDialogCreate.setOnShowListener(new DialogInterface.OnShowListener() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda5
                    ...
                    public final void onShow(DialogInterface dialogInterface) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$ListAdapter$1$$ExternalSyntheticLambda0
                            @Override // java.lang.Runnable
                            public final void run() {
                                FilterChatlistActivity.ListAdapter.C50751.$r8$lambda$OMUeedhUn3MJzL3eK6XyRJnyWH8(editTextBoldCursor);
                            }
                        });
                    }
                });
            ...
            /* renamed from: $r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZW-Sw, reason: not valid java name */
            public static /* synthetic */ boolean m13235$r8$lambda$7YDJLZtC9zlvS_dgDCiC9wZWSw(AlertDialog.Builder builder, TextView textView, int i, KeyEvent keyEvent) {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(FilterChatlistActivity.this.getContext(), i == FilterChatlistActivity.this.chatsSectionRow ? C2369R.drawable.greydivider_bottom : C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                if (i == FilterChatlistActivity.this.chatsSectionRow) {
                    ...
                    if (filterChatlistActivity.invite == null || filterChatlistActivity.allowedPeers.isEmpty()) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.FilterInviteHintNo));
                    } else {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.FilterInviteHint));
                    }
                } else {
                ...
                if (itemViewType == 3) {
                    ...
                    if (jLongValue >= 0) {
                        ...
                        TLRPC.Chat chat2 = FilterChatlistActivity.this.getMessagesController().getChat(Long.valueOf(-jLongValue));
                        if (chat2 != null) {
                            string = chat2.title;
                    ...
                    if (FilterChatlistActivity.this.allowedPeers.contains(l)) {
                        ...
                        if (chat instanceof TLRPC.User) {
                            if (((TLRPC.User) chat).bot) {
                                string = LocaleController.getString(C2369R.string.FilterInviteBot);
                            } else {
                                string = LocaleController.getString(C2369R.string.FilterInviteUser);
                            }
                        } else if (chat instanceof TLRPC.Chat) {
                            if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                                string = LocaleController.getString(C2369R.string.FilterInviteChannel);
                            } else {
                                string = LocaleController.getString(C2369R.string.FilterInviteGroup);
                            }
                        }
                    }
                    groupCreateUserCell.setTag(l);
                    groupCreateUserCell.setObject(chat, userName, string);
                    ...
                    if (i == FilterChatlistActivity.this.linkHeaderRow) {
                        headerCell.setText(LocaleController.getString(C2369R.string.InviteLink), false);
                        ...
                        if (filterChatlistActivity2.invite == null || filterChatlistActivity2.allowedPeers.isEmpty()) {
                            headerCell.setText(LocaleController.getString(C2369R.string.FilterInviteHeaderChatsNo), false);
                            headerCell.setAction("", null);
                        } else {
        ...
        public Theme.ResourcesProvider getResourcesProvider() {
            return ((BaseFragment) FilterChatlistActivity.this).resourceProvider;
        }
    }
    ...
    private void deselectAll(final FolderBottomSheet.HeaderCell headerCell, final boolean z) {
        ...
        headerCell.setAction(LocaleController.getString(this.selectedPeers.size() >= Math.min(getMaxChats(), this.allowedPeers.size()) ? C2369R.string.DeselectAll : C2369R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean checkDiscard() {
        ...
        builder.setMessage(LocaleController.getString(C2369R.string.UnsavedChangesMessage));
        builder.setPositiveButton(LocaleController.getString(C2369R.string.ApplyTheme), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$checkDiscard$9(alertDialog, i);
            }
        });
        builder.setNegativeButton(LocaleController.getString(C2369R.string.PassportDiscard), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FilterChatlistActivity$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public static class InviteLinkCell extends FrameLayout {
        ...
        class ButtonsBox extends FrameLayout {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                rectF.set(0.0f, 0.0f, measuredWidth - AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(4.0f), this.f2026t), getMeasuredHeight());
                setRadii(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(8.0f), this.f2026t));
                Path path = this.path;
                float[] fArr = this.radii;
                ...
                this.path.rewind();
                rectF.set(measuredWidth + AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(4.0f), this.f2026t), 0.0f, getMeasuredWidth(), getMeasuredHeight());
                setRadii(AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(8.0f), this.f2026t), AndroidUtilities.m1146dp(8.0f));
        ...
        public InviteLinkCell(Context context, BaseFragment baseFragment) {
            ...
            frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1146dp, Theme.getColor(i), Theme.blendOver(Theme.getColor(i), Theme.getColor(Theme.key_listSelector))));
            ...
            TextView textView = new TextView(context) { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.1
                ...
                protected void onMeasure(int i3, int i4) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i3) - AndroidUtilities.m1146dp(8.0f)) / 2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(42.0f), TLObject.FLAG_30));
                }
            };
            ...
            spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(8.0f)), 1, 2, 0);
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2369R.string.LinkActionCopy));
            spannableStringBuilder.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(5.0f)), spannableStringBuilder.length() - 1, spannableStringBuilder.length(), 0);
            ...
            TextView textView3 = new TextView(context) { // from class: org.telegram.ui.FilterChatlistActivity.InviteLinkCell.2
                ...
                protected void onMeasure(int i4, int i5) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec((View.MeasureSpec.getSize(i4) - AndroidUtilities.m1146dp(8.0f)) / 2, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(42.0f), TLObject.FLAG_30));
                }
            };
            ...
            spannableStringBuilder2.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2369R.drawable.msg_share_filled)), 0, 1, 0);
            spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(8.0f)), 1, 2, 0);
            spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2369R.string.LinkActionShare));
            spannableStringBuilder2.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(5.0f)), spannableStringBuilder2.length() - 1, spannableStringBuilder2.length(), 0);
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(127.0f), TLObject.FLAG_30));
        }
        ...
        public void options() {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2369R.string.EditName), C2369R.drawable.msg_edit);
            ...
            actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(C2369R.string.GetQRCode), C2369R.drawable.msg_qrcode);
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString(C2369R.string.DeleteLink), C2369R.drawable.msg_delete);
            ...
            if (overlayContainerView != null) {
                ...
                this.actionBarPopupWindow.setAnimationStyle(C2369R.style.PopupContextAnimation);
                ...
                this.actionBarPopupWindow.showAtLocation(overlayContainerView, 0, (int) (((overlayContainerView.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m1146dp(16.0f)) + overlayContainerView.getX() + paddingLeft), (int) (paddingTop + this.linkBox.getMeasuredHeight() + overlayContainerView.getY()));
            }
        }
        ...
        public void copy() {
            ...
            BulletinFactory.m1267of(this.parentFragment).createCopyBulletin(LocaleController.getString(C2369R.string.LinkCopied)).show();
        }
        ...
        protected void share() {
            ...
            try {
                ...
                this.parentFragment.startActivityForResult(Intent.createChooser(intent, LocaleController.getString(C2369R.string.InviteToGroupByLink)), 500);
            } catch (Exception e) {
                FileLog.m1160e(e);
            }
        }
