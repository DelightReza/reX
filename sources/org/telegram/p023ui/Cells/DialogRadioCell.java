...
public class DialogRadioCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int measuredWidth = ((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight()) - AndroidUtilities.m1146dp((this.valueTextView.getVisibility() == 0 ? 12 : 0) + 84);
        ...
        if (this.valueTextView.getVisibility() == 0) {
            ...
            measuredWidth -= this.valueTextView.getMeasuredWidth() + AndroidUtilities.m1146dp(12.0f);
        }
