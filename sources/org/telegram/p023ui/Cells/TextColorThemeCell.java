...
public class TextColorThemeCell extends FrameLayout {
    ...
    public TextColorThemeCell(Context context) {
        ...
        this.textView.setPadding(0, 0, 0, AndroidUtilities.m1146dp(3.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (i != 0) {
            ...
            canvas.drawCircle(!LocaleController.isRTL ? AndroidUtilities.m1146dp(28.0f) : getMeasuredWidth() - AndroidUtilities.m1146dp(28.0f), getMeasuredHeight() / 2, AndroidUtilities.m1146dp(10.0f), colorPaint);
        }
    }
}
