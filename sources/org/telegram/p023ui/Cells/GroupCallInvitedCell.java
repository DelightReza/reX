...
public abstract class GroupCallInvitedCell extends FrameLayout {
    ...
    public GroupCallInvitedCell(Context context) {
        ...
        this.statusTextView.setText(LocaleController.getString(C2369R.string.Invited));
        ...
        this.muteButton.setImageResource(C2369R.drawable.msg_invited);
        this.muteButton.setImportantForAccessibility(2);
        this.muteButton.setPadding(0, 0, AndroidUtilities.m1146dp(4.0f), 0);
    ...
    public void setData(int i, Long l, boolean z, boolean z2, boolean z3) {
        ...
        this.statusTextView.setText(LocaleController.getString(z3 ? C2369R.string.ShadyLeaving : z2 ? C2369R.string.ShadyJoining : z ? C2369R.string.ConferenceCalling : C2369R.string.Invited));
        float f = 0.5f;
