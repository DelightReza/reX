...
public class StickerSetCell extends FrameLayout {
    ...
    public StickerSetCell(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i != 0) {
            ...
            if (i == 1) {
                ...
                this.optionsButton.setImageResource(C2369R.drawable.msg_actions);
                ...
                this.reorderButton.setImageResource(C2369R.drawable.list_reorder);
                ...
                this.optionsButton.setImageResource(C2369R.drawable.floating_check);
        ...
        this.premiumButtonView.setButton(LocaleController.getString(C2369R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda7
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
        ...
        try {
            ...
            ((ViewGroup.MarginLayoutParams) this.premiumButtonView.getTextView().getLayoutParams()).leftMargin = AndroidUtilities.m1146dp(3.0f);
        ...
        this.sideButtons.setPadding(AndroidUtilities.m1146dp(10.0f), 0, AndroidUtilities.m1146dp(10.0f), 0);
        ...
        if (i == 3) {
            ...
            imageView6.setImageResource(C2369R.drawable.msg_close);
            this.deleteView.setPadding(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f));
    ...
    public void setStickersSet(TLRPC.TL_messages_stickerSet tL_messages_stickerSet, boolean z, boolean z2) {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (document != null && document.f1579id == tL_messages_stickerSet.set.thumb_document_id) {
                    break;
                } else {
                    i++;
                }
    ...
    public /* synthetic */ void lambda$setStickersSet$4(TLRPC.Document document) {
        if (this.stickersSet.documents.isEmpty()) {
            ...
            if (tL_messages_stickerSet.set.thumb_document_id == document.f1579id) {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1146dp(71.0f), getHeight() - 1, (getWidth() - getPaddingRight()) - (LocaleController.isRTL ? AndroidUtilities.m1146dp(71.0f) : 0), getHeight() - 1, Theme.dividerPaint);
        }
    }

    public void updateRightMargin() {
        this.sideButtons.measure(View.MeasureSpec.makeMeasureSpec(999999, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(58.0f), TLObject.FLAG_30));
        int iM1146dp = AndroidUtilities.m1146dp(26.0f) + this.sideButtons.getMeasuredWidth();
        if (LocaleController.isRTL) {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).leftMargin = iM1146dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).leftMargin = iM1146dp;
        } else {
            ((ViewGroup.MarginLayoutParams) this.textView.getLayoutParams()).rightMargin = iM1146dp;
            ((ViewGroup.MarginLayoutParams) this.valueTextView.getLayoutParams()).rightMargin = iM1146dp;
        }
    }
    ...
    public void updateButtonState(final int i, boolean z) {
        ...
        if (i == 1) {
            this.premiumButtonView.setButton(LocaleController.getString(C2369R.string.Unlock), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
            ...
            this.premiumButtonView.setButton(LocaleController.getString(C2369R.string.Restore), new View.OnClickListener() { // from class: org.telegram.ui.Cells.StickerSetCell$$ExternalSyntheticLambda1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
