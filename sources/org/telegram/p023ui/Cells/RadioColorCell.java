...
public class RadioColorCell extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        if (this.text2View.getVisibility() == 0) {
            this.text2View.measure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i) - AndroidUtilities.m1146dp(72.0f), TLObject.FLAG_30), i2);
        }
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(this.heightDp) + (this.text2View.getVisibility() == 0 ? AndroidUtilities.m1146dp(4.0f) + this.text2View.getMeasuredHeight() : 0), TLObject.FLAG_30));
    }
