...
public class StickerSetGroupInfoCell extends LinearLayout {
    ...
    public StickerSetGroupInfoCell(Context context) {
        ...
        textView.setText(LocaleController.getString(C2369R.string.GroupStickersInfo));
        addView(textView, LayoutHelper.createLinear(-1, -2, 51, 17, 4, 17, 0));
        TextView textView2 = new TextView(context);
        this.addButton = textView2;
        textView2.setPadding(AndroidUtilities.m1146dp(17.0f), 0, AndroidUtilities.m1146dp(17.0f), 0);
        ...
        this.addButton.setText(LocaleController.getString(C2369R.string.ChooseStickerSet).toUpperCase());
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.isLast || (view = (View) getParent()) == null || getMeasuredHeight() >= (measuredHeight = ((view.getMeasuredHeight() - view.getPaddingBottom()) - view.getPaddingTop()) - AndroidUtilities.m1146dp(24.0f))) {
            return;
        }
