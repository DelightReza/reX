...
public class SlideIntChooseView extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(75.0f), TLObject.FLAG_30));
        if (Build.VERSION.SDK_INT >= 29) {
            setSystemGestureExclusionRects(Arrays.asList(new Rect(0, 0, AndroidUtilities.m1146dp(80.0f), getMeasuredHeight()), new Rect(getMeasuredWidth() - AndroidUtilities.m1146dp(80.0f), 0, getMeasuredWidth(), getMeasuredHeight())));
        }
    }
