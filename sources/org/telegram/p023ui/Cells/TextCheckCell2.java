...
public class TextCheckCell2 extends FrameLayout {
        ...
        if (this.collapseViewContainer == null) {
            ...
            View view = new View(getContext()) { // from class: org.telegram.ui.Cells.TextCheckCell2.1
                ...
                protected void onDraw(Canvas canvas) {
                    super.onDraw(canvas);
                    canvas.drawLine(0.0f, AndroidUtilities.m1146dp(14.0f), 0.0f, getMeasuredHeight() - AndroidUtilities.m1146dp(14.0f), Theme.dividerPaint);
                }
            };
    ...
    protected void onMeasure(int i, int i2) {
        if (this.isMultiline) {
            ...
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(this.valueTextView.getVisibility() == 0 ? 64.0f : 50.0f) + (this.needDivider ? 1 : 0), TLObject.FLAG_30));
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (linearLayout != null) {
            if (LocaleController.isRTL) {
                linearLayout.setTranslationX((this.textView.getLeft() - this.collapseViewContainer.getMeasuredWidth()) - AndroidUtilities.m1146dp(8.0f));
            } else {
                linearLayout.setTranslationX(this.textView.getRight() + AndroidUtilities.m1146dp(8.0f));
            }
        }
    }
