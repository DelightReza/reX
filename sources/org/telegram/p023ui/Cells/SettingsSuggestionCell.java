...
public abstract class SettingsSuggestionCell extends LinearLayout {
    ...
    public void setType(int i) {
        ...
        if (i != 0) {
            if (i == 1) {
                this.textView.setText(LocaleController.getString(C2369R.string.YourPasswordHeader));
                this.detailTextView.setText(LocaleController.getString(C2369R.string.YourPasswordRemember));
                this.yesButton.setText(LocaleController.getString(C2369R.string.YourPasswordRememberYes));
                this.noButton.setVisibility(0);
                this.noButton.setText(LocaleController.getString(C2369R.string.YourPasswordRememberNo));
                return;
            }
            if (i == 2) {
                this.textView.setText(LocaleController.getString(C2369R.string.GraceSuggestionTitle));
                this.detailTextView.setText(LocaleController.getString(C2369R.string.GraceSuggestionMessage));
                this.yesButton.setText(LocaleController.getString(C2369R.string.GraceSuggestionButton));
        ...
        this.textView.setText(LocaleController.formatString("CheckPhoneNumber", C2369R.string.CheckPhoneNumber, PhoneFormat.getInstance().format("+" + user.phone)));
        String string = LocaleController.getString(C2369R.string.CheckPhoneNumberInfo);
        ...
        if (iIndexOf >= 0 && iLastIndexOf >= 0 && iIndexOf != iLastIndexOf) {
            ...
            try {
                spannableStringBuilder.setSpan(new URLSpanNoUnderline(LocaleController.getString(C2369R.string.CheckPhoneNumberLearnMoreUrl)), iIndexOf, iLastIndexOf - 2, 33);
            } catch (Exception e) {
                FileLog.m1160e(e);
            }
        }
        this.detailTextView.setText(spannableStringBuilder);
        this.yesButton.setText(LocaleController.getString(C2369R.string.CheckPhoneNumberYes));
        this.noButton.setVisibility(0);
        this.noButton.setText(LocaleController.getString(C2369R.string.CheckPhoneNumberNo));
    }
