...
public class ChatLoadingCell extends FrameLayout {
    ...
    public ChatLoadingCell(Context context, View view, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Cells.ChatLoadingCell.1
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(18.0f), ChatLoadingCell.this.getThemedPaint("paintChatActionBackground"));
                if (ChatLoadingCell.this.hasGradientService()) {
                    canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(18.0f), ChatLoadingCell.this.getThemedPaint("paintChatActionBackgroundDarken"));
                }
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(44.0f), TLObject.FLAG_30));
    }
