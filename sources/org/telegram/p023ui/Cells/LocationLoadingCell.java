...
public class LocationLoadingCell extends FrameLayout {
    ...
    public LocationLoadingCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        imageView.setImageResource(C2369R.drawable.location_empty);
        ...
        this.textView.setText(LocaleController.getString(C2369R.string.NoPlacesFound));
        addView(this.textView, LayoutHelper.createFrame(-2, -2.0f, 17, 0.0f, 34.0f, 0.0f, 0.0f));
    }

    @Override // android.widget.FrameLayout, android.view.View
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec((int) (AndroidUtilities.m1146dp(56.0f) * 2.5f), TLObject.FLAG_30));
    }
