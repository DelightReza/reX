...
public abstract class BrightnessControlCell extends FrameLayout {
    ...
    public BrightnessControlCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i == 0) {
            this.leftImageView.setImageResource(C2369R.drawable.msg_brightness_low);
            this.rightImageView.setImageResource(C2369R.drawable.msg_brightness_high);
            this.size = 48;
        } else {
            this.leftImageView.setImageResource(C2369R.drawable.msg_brightness_high);
            this.rightImageView.setImageResource(C2369R.drawable.msg_brightness_low);
            this.size = 43;
        }
    }
