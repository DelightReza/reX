...
public class AdminedChannelCell extends FrameLayout {
    ...
    public AdminedChannelCell(Context context, View.OnClickListener onClickListener, boolean z, int i) {
        ...
        if (onClickListener != null) {
            ...
            this.deleteButton.setImageResource(C2369R.drawable.msg_panel_clear);
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp((this.isLast ? 12 : 0) + 60), TLObject.FLAG_30));
    }
