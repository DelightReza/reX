...
public class MaxFileSizeCell extends FrameLayout {
    ...
    public MaxFileSizeCell(Context context) {
        ...
        SeekBarView seekBarView = new SeekBarView(context) { // from class: org.telegram.ui.Cells.MaxFileSizeCell.1
            @Override // org.telegram.p023ui.Components.SeekBarView, android.view.View
            ...
            public void onSeekBarDrag(boolean z, float f) {
                ...
                if (f <= 0.25f) {
                    ...
                    if (f < 0.25f) {
                        ...
                        f -= 0.25f;
                        if (f > 0.25f) {
                            i = (int) (104857600 + ((FileLoader.DEFAULT_MAX_FILE_SIZE - 104857600) * ((f - 0.25f) / 0.25f)));
                            long j = i;
                            MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C2369R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
                ...
                i = (int) (f2 + ((f / 0.25f) * f3));
                long j2 = i;
                MaxFileSizeCell.this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C2369R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j2)));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(80.0f), TLObject.FLAG_30));
        setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1146dp(80.0f));
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1146dp(42.0f);
        this.sizeTextView.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(30.0f), TLObject.FLAG_30));
        this.textView.measure(View.MeasureSpec.makeMeasureSpec(Math.max(AndroidUtilities.m1146dp(10.0f), (measuredWidth - this.sizeTextView.getMeasuredWidth()) - AndroidUtilities.m1146dp(8.0f)), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(30.0f), TLObject.FLAG_30));
        this.seekBarView.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth() - AndroidUtilities.m1146dp(20.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(30.0f), TLObject.FLAG_30));
    }
    ...
    public void setSize(long j) {
        ...
        float fMax2;
        this.currentSize = j;
        this.sizeTextView.setText(LocaleController.formatString("AutodownloadSizeLimitUpTo", C2369R.string.AutodownloadSizeLimitUpTo, AndroidUtilities.formatFileSize(j)));
        long j2 = j - 512000;
        if (j2 < 536576) {
