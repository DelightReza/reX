...
public class MentionCell extends LinearLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.needsDivider) {
            canvas.drawLine(AndroidUtilities.m1146dp(52.0f), getHeight() - 1, getWidth() - AndroidUtilities.m1146dp(8.0f), getHeight() - 1, Theme.dividerPaint);
        }
    }
    ...
    public void setEmojiSuggestion(MediaDataController.KeywordResult keywordResult) {
        ...
        this.nameTextView.setPadding(AndroidUtilities.m1146dp(22.0f), 0, 0, 0);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Drawable drawable = this.emojiDrawable;
        if (drawable != null) {
            int iM1146dp = AndroidUtilities.m1146dp(drawable instanceof AnimatedEmojiDrawable ? 24.0f : 20.0f);
            int iM1146dp2 = AndroidUtilities.m1146dp(this.emojiDrawable instanceof AnimatedEmojiDrawable ? -2.0f : 0.0f);
            this.emojiDrawable.setBounds(this.nameTextView.getLeft() + iM1146dp2, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) - iM1146dp) / 2, this.nameTextView.getLeft() + iM1146dp2 + iM1146dp, ((this.nameTextView.getTop() + this.nameTextView.getBottom()) + iM1146dp) / 2);
