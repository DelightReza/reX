...
public class TextRadioCell extends FrameLayout {
    ...
    public void updateRTL() {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1146dp(z3 ? this.padding : 64.0f);
        layoutParams.rightMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 64.0f : this.padding);
        ...
        layoutParams2.leftMargin = AndroidUtilities.m1146dp(z4 ? this.padding : 64.0f);
        layoutParams2.rightMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 64.0f : this.padding);
    ...
    public void setAnimationProgress(float f) {
        ...
        AndroidUtilities.m1146dp(40.0f);
        getMeasuredHeight();
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.animatedColorBackground != 0) {
            canvas.drawCircle(this.lastTouchX, getMeasuredHeight() / 2, (Math.max(this.lastTouchX, getMeasuredWidth() - this.lastTouchX) + AndroidUtilities.m1146dp(40.0f)) * this.animationProgress, this.animationPaint);
        }
        if (this.needDivider) {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setContentDescription(LocaleController.getString(this.radioButton.isChecked() ? C2369R.string.NotificationsOn : C2369R.string.NotificationsOff));
