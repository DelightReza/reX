...
public class PhotoAttachPhotoCell extends FrameLayout {
    ...
    public PhotoAttachPhotoCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        FrameLayout frameLayout2 = new FrameLayout(context) { // from class: org.telegram.ui.Cells.PhotoAttachPhotoCell.3
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), Theme.chat_timeBackgroundPaint);
            }
        };
        this.videoInfoContainer = frameLayout2;
        frameLayout2.setWillNotDraw(false);
        this.videoInfoContainer.setPadding(AndroidUtilities.m1146dp(5.0f), 0, AndroidUtilities.m1146dp(5.0f), 0);
        ...
        imageView.setImageResource(C2369R.drawable.play_mini_video);
        ...
        if (this.highQuality != z) {
            ...
            if (photoEntry != null) {
                if (photoEntry.isVideo) {
                    ...
                    ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1146dp(13.0f);
                ...
                if (photoEntry.highQuality) {
                    ...
                    ((FrameLayout.LayoutParams) this.videoTextView.getLayoutParams()).leftMargin = AndroidUtilities.m1146dp(0.0f);
                    this.videoTextView.setText(LocaleController.getString(C2369R.string.ShortHighQuality));
                    return;
                }
                this.videoPlayImageView.setVisibility(8);
    ...
    public void setStarsPrice(long j, boolean z) {
        ...
        if (j > 0) {
            ...
            if (this.star == null) {
                ...
                ColoredImageSpan coloredImageSpan = new ColoredImageSpan(C2369R.drawable.star_small_inner);
            ...
            if (z) {
                if (this.lock == null) {
                    ...
                    ColoredImageSpan coloredImageSpan2 = new ColoredImageSpan(C2369R.drawable.msg_mini_lock2);
    ...
    public void setItemSize(int i) {
        ...
        layoutParams3.topMargin = iM1146dp;
        layoutParams3.rightMargin = iM1146dp;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.isVertical) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(80.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp((this.isLast ? 0 : 6) + 80), TLObject.FLAG_30));
        } else {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp((this.isLast ? 0 : 6) + 80), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(80.0f), TLObject.FLAG_30));
        }
    }
    ...
    public void setPhotoEntry(MediaController.SearchImage searchImage, boolean z, boolean z2) {
        ...
        this.isLast = z2;
        Drawable drawable = this.zoomOnSelect ? Theme.chat_attachEmptyDrawable : getResources().getDrawable(C2369R.drawable.nophotos);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        /*
            ...
            android.graphics.Rect r1 = org.telegram.p023ui.Cells.PhotoAttachPhotoCell.rect
            r0.getHitRect(r1)
            int r0 = r6.getAction()
            r1 = 1
            r2 = 0
            if (r0 != 0) goto L27
            android.graphics.Rect r0 = org.telegram.p023ui.Cells.PhotoAttachPhotoCell.rect
            float r3 = r6.getX()
            int r3 = (int) r3
            float r4 = r6.getY()
            int r4 = (int) r4
        ...
        L7c:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Cells.PhotoAttachPhotoCell.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (photoEntry != null && photoEntry.isVideo) {
            sb.append(LocaleController.getString(C2369R.string.AttachVideo) + ", " + LocaleController.formatDuration(this.photoEntry.duration));
        } else {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(C2369R.id.acc_action_open_photo, LocaleController.getString(C2369R.string.Open)));
    }

    @Override // android.view.View
    public boolean performAccessibilityAction(int i, Bundle bundle) {
        if (i == C2369R.id.acc_action_open_photo) {
