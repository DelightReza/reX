    ...
    public TooManyCommunitiesHintCell(Context context) {
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.Cells.TooManyCommunitiesHintCell.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.save();
                canvas.translate((getMeasuredWidth() - textPaint.measureText(str)) - AndroidUtilities.m1146dp(8.0f), AndroidUtilities.dpf2(7.0f));
                this.rect.set(0.0f, 0.0f, textPaint.measureText(str), textPaint.getTextSize());
                this.rect.inset(-AndroidUtilities.m1146dp(6.0f), -AndroidUtilities.m1146dp(3.0f));
                float textSize = (textPaint.getTextSize() / 2.0f) + AndroidUtilities.m1146dp(3.0f);
        ...
        this.headerTextView.setText(LocaleController.getString(C2369R.string.TooManyCommunities));
        this.imageView.setImageResource(C2369R.drawable.groups_limit1);
    }
