...
public class ArchivedStickerSetCell extends FrameLayout implements Checkable {
    ...
    public ArchivedStickerSetCell(Context context, boolean z) {
        ...
        if (z) {
            ...
            progressButton2.setMinWidth(iM1146dp);
            progressButton2.setMinimumWidth(iM1146dp);
            ...
            progressButton2.setText(LocaleController.getString(C2369R.string.StickersRemove));
        ...
        if (stickerSetCovered instanceof TLRPC.TL_stickerSetFullCovered) {
            ...
            while (true) {
                if (i < arrayList.size()) {
                    ...
                    if (document3 != null && document3.f1579id == j) {
                        document2 = document3;
                        break;
                    }
                    i++;
