...
public class TopicExceptionCell extends FrameLayout {
    ...
    public void setTopic(long j, TLRPC.TL_forumTopic tL_forumTopic) {
        ...
        this.subtitle.setText(MessagesController.getInstance(UserConfig.selectedAccount).getMutedString(j, tL_forumTopic.f1631id));
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (this.drawDivider) {
            canvas.drawLine(AndroidUtilities.m1146dp(72.0f), getMeasuredHeight() - 1, getMeasuredWidth(), getMeasuredHeight() - 1, Theme.dividerPaint);
        }
    }
}
