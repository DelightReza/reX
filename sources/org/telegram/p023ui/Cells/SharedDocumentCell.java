...
public class SharedDocumentCell extends FrameLayout implements DownloadController.FileDownloadProgressListener {
    ...
    public SharedDocumentCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.statusDrawable = new RLottieDrawable(C2369R.raw.download_arrow, "download_arrow", AndroidUtilities.m1146dp(14.0f), AndroidUtilities.m1146dp(14.0f), true, null);
    ...
    public void setTextAndValueAndTypeAndThumb(String str, String str2, String str3, String str4, int i, boolean z) {
        ...
        if (str4 != null || i != 0) {
            if (str4 != null) {
                ...
                CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon = CanvasUtils.createCircleDrawableWithIcon(getContext(), i, AndroidUtilities.m1146dp(42.0f));
                if (i == C2369R.drawable.files_storage) {
                    i2 = Theme.key_chat_attachLocationBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2369R.drawable.files_gallery) {
                    i2 = Theme.key_chat_attachContactBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2369R.drawable.files_music) {
                    i2 = Theme.key_chat_attachAudioBackground;
                    i3 = Theme.key_chat_attachIcon;
                } else if (i == C2369R.drawable.files_internal) {
    ...
    public void setDocument(MessageObject messageObject, boolean z) {
        ...
        if (document == null) {
            ...
            if (TextUtils.isEmpty(documentFileName) && (str = document.mime_type) != null) {
                documentFileName = str.startsWith(MediaStreamTrack.VIDEO_TRACK_KIND) ? MessageObject.isGifDocument(document) ? LocaleController.getString(C2369R.string.AttachGif) : LocaleController.getString(C2369R.string.AttachVideo) : document.mime_type.startsWith("image") ? MessageObject.isGifDocument(document) ? LocaleController.getString(C2369R.string.AttachGif) : LocaleController.getString(C2369R.string.AttachPhoto) : document.mime_type.startsWith(MediaStreamTrack.AUDIO_TRACK_KIND) ? LocaleController.getString(C2369R.string.AttachAudio) : LocaleController.getString(C2369R.string.AttachDocument);
            }
            if (str4 == null) {
    ...
    private void updateDateView() {
        ...
        if (this.viewType == 2) {
            ...
            this.dateTextView.setText(String.format("%s, %s", fileSize, LocaleController.formatString("formatDateAtTime", C2369R.string.formatDateAtTime, LocaleController.getInstance().getFormatterYear().format(new Date(j)), LocaleController.getInstance().getFormatterDay().format(new Date(j)))));
        }
    }
    ...
    public void updateFileExistIcon(boolean z) {
        ...
        if (messageObject != null && messageObject.messageOwner.media != null) {
            ...
            if (messageObject.attachPathExists || messageObject.mediaExists || !this.drawDownloadIcon) {
                ...
                if (layoutParams != null) {
                    layoutParams.leftMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 8.0f : 72.0f);
                    layoutParams.rightMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 72.0f : 8.0f);
            ...
            if (layoutParams2 != null) {
                layoutParams2.leftMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 8.0f : 86.0f);
                layoutParams2.rightMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 86.0f : 8.0f);
                this.dateTextView.requestLayout();
            }
            if (this.loading) {
        ...
        if (layoutParams3 != null) {
            layoutParams3.leftMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 8.0f : 72.0f);
            layoutParams3.rightMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? 72.0f : 8.0f);
            this.dateTextView.requestLayout();
        }
        DownloadController.getInstance(this.currentAccount).removeLoadingFileObserver(this);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(56.0f), TLObject.FLAG_30));
        int iM1146dp = AndroidUtilities.m1146dp(34.0f) + this.nameTextView.getMeasuredHeight() + (this.needDivider ? 1 : 0);
        if (this.caption != null && this.captionTextView != null && this.message.hasHighlightedWords()) {
            ...
            iM1146dp += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m1146dp(3.0f);
        }
        setMeasuredDimension(getMeasuredWidth(), iM1146dp);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.viewType != 1) {
            if (this.nameTextView.getLineCount() > 1 || ((textView = this.captionTextView) != null && textView.getVisibility() == 0)) {
                int measuredHeight = this.nameTextView.getMeasuredHeight() - AndroidUtilities.m1146dp(22.0f);
                ...
                if (textView2 != null && textView2.getVisibility() == 0) {
                    ...
                    measuredHeight += this.captionTextView.getMeasuredHeight() + AndroidUtilities.m1146dp(3.0f);
                }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Cells.SharedDocumentCell.dispatchDraw(android.graphics.Canvas):void");
    }
