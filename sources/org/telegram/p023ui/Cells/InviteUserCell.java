...
public class InviteUserCell extends FrameLayout {
    ...
    public InviteUserCell(Context context, boolean z) {
        ...
        backupImageView.setRoundRadius(ExteraConfig.getAvatarCorners(50.0f));
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(72.0f), TLObject.FLAG_30));
    }
