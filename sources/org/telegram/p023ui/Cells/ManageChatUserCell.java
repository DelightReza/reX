...
public class ManageChatUserCell extends FrameLayout {
    ...
    public ManageChatUserCell(Context context, int i, int i2, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        BackupImageView backupImageView = new BackupImageView(context) { // from class: org.telegram.ui.Cells.ManageChatUserCell.1
            ...
            protected void onDraw(Canvas canvas) {
                if (ManageChatUserCell.this.storyItem != null) {
                    ...
                    ManageChatUserCell.this.storyAvatarParams.originalAvatarRect.set(fM1146dp, fM1146dp, getMeasuredWidth() - r0, getMeasuredHeight() - r0);
        ...
        if (z) {
            ...
            this.optionsButton.setImageResource(C2369R.drawable.ic_ab_other);
            ...
            this.optionsButton.setContentDescription(LocaleController.getString(C2369R.string.AccDescrUserOptions));
        }
    }
    ...
    */
    public void update(int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Cells.ManageChatUserCell.update(int):void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.needDivider) {
            ...
            canvas.drawLine(LocaleController.isRTL ? 0.0f : AndroidUtilities.m1146dp(68.0f), getMeasuredHeight() - 1, getMeasuredWidth() - (LocaleController.isRTL ? AndroidUtilities.m1146dp(68.0f) : 0), getMeasuredHeight() - 1, this.dividerColor >= 0 ? Theme.dividerExtraPaint : Theme.dividerPaint);
        }
    }
}
