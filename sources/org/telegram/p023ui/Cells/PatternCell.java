...
public class PatternCell extends BackupImageView implements DownloadController.FileDownloadProgressListener {
    ...
    public PatternCell(Context context, int i, PatternCellDelegate patternCellDelegate) {
        ...
        setRoundRadius(AndroidUtilities.m1146dp(6.0f));
        this.maxWallpaperSize = i;
        this.delegate = patternCellDelegate;
        RadialProgress2 radialProgress2 = new RadialProgress2(this);
        this.radialProgress = radialProgress2;
        radialProgress2.setProgressRect(AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(70.0f), AndroidUtilities.m1146dp(70.0f));
        ...
        setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Cells.PatternCell.1
            ...
            public void getOutline(View view, Outline outline) {
                outline.setRoundRect(AndroidUtilities.m1146dp(1.0f), AndroidUtilities.m1146dp(1.0f), view.getMeasuredWidth() - AndroidUtilities.m1146dp(1.0f), view.getMeasuredHeight() - AndroidUtilities.m1146dp(1.0f), AndroidUtilities.m1146dp(6.0f));
            }
        });
    ...
    public void setPattern(TLRPC.TL_wallPaper tL_wallPaper) {
        ...
        if (tL_wallPaper != null) {
            setImage(ImageLocation.getForDocument(FileLoader.getClosestPhotoSizeWithSize(tL_wallPaper.document.thumbs, AndroidUtilities.m1146dp(100.0f)), tL_wallPaper.document), "100_100", (ImageLocation) null, (String) null, "png", 0L, 1, tL_wallPaper);
        } else {
    ...
    public void updateSelected(boolean z) {
        ...
        if ((tL_wallPaper == null && selectedPattern == null) || (selectedPattern != null && tL_wallPaper != null && tL_wallPaper.f1742id == selectedPattern.f1742id)) {
    ...
    protected void onDraw(Canvas canvas) {
            ...
            if (this.gradientShader == null || backgroundColor != this.currentBackgroundColor || backgroundGradientColor1 != this.currentGradientColor1 || backgroundGradientColor2 != this.currentGradientColor2 || backgroundGradientColor3 != this.currentGradientColor3 || backgroundGradientAngle != this.currentGradientAngle) {
                ...
                if (backgroundGradientColor2 != 0) {
                    ...
                    if (motionBackgroundDrawable != null) {
                        ...
                        motionBackgroundDrawable2.setRoundRadius(AndroidUtilities.m1146dp(6.0f));
        ...
        if (motionBackgroundDrawable3 != null) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f), this.backgroundPaint);
        }
        super.onDraw(canvas);
    ...
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m1146dp(100.0f), AndroidUtilities.m1146dp(100.0f));
    }
    ...
    public void onProgressDownload(String str, long j, long j2) {
        ...
        TLRPC.TL_wallPaper selectedPattern = this.delegate.getSelectedPattern();
        TLRPC.TL_wallPaper tL_wallPaper = this.currentPattern;
        if ((!(tL_wallPaper == null && selectedPattern == null) && (selectedPattern == null || tL_wallPaper == null || tL_wallPaper.f1742id != selectedPattern.f1742id)) || this.radialProgress.getIcon() == 10) {
            return;
        }
