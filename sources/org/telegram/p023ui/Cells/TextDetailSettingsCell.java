...
public class TextDetailSettingsCell extends FrameLayout {
    ...
    public void setMultilineDetail(boolean z) {
        ...
        if (z) {
            ...
            this.valueTextView.setPadding(0, 0, 0, AndroidUtilities.m1146dp(12.0f));
            return;
        }
        this.valueTextView.setLines(1);
        this.valueTextView.setMaxLines(1);
    ...
    public void setTextAndValueAndIcon(String str, CharSequence charSequence, int i, boolean z) {
        ...
        this.textView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1146dp(50.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1146dp(50.0f) : 0, 0);
        this.valueTextView.setPadding(LocaleController.isRTL ? 0 : AndroidUtilities.m1146dp(50.0f), 0, LocaleController.isRTL ? AndroidUtilities.m1146dp(50.0f) : 0, this.multiline ? AndroidUtilities.m1146dp(12.0f) : 0);
        this.needDivider = z;
        setWillNotDraw(!z);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (LocaleController.isRTL) {
            ...
            fM1146dp = AndroidUtilities.m1146dp(this.imageView.getVisibility() == 0 ? 71.0f : 20.0f);
        }
        float measuredHeight = getMeasuredHeight() - 1;
        int measuredWidth = getMeasuredWidth();
        if (LocaleController.isRTL) {
            iM1146dp = AndroidUtilities.m1146dp(this.imageView.getVisibility() == 0 ? 71.0f : 20.0f);
        } else {
            iM1146dp = 0;
        }
