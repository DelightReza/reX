...
public class QuickRepliesSettingsActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.VoipQuickReplies));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.QuickRepliesSettingsActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    QuickRepliesSettingsActivity.this.lambda$onBackPressed$371();
                }
            }
        });
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.VoipQuickRepliesExplain));
                return;
            }
            if (itemViewType == 1) {
                return;
                ...
                switch (itemViewType) {
                    ...
                    case 12:
                        ...
                        if (i == QuickRepliesSettingsActivity.this.reply1Row) {
                            string = LocaleController.getString(C2369R.string.QuickReplyDefault1);
                            str = "quick_reply_msg1";
                        } else if (i == QuickRepliesSettingsActivity.this.reply2Row) {
                            string = LocaleController.getString(C2369R.string.QuickReplyDefault2);
                            str = "quick_reply_msg2";
                        } else if (i == QuickRepliesSettingsActivity.this.reply3Row) {
                            string = LocaleController.getString(C2369R.string.QuickReplyDefault3);
                            str = "quick_reply_msg3";
                        } else if (i == QuickRepliesSettingsActivity.this.reply4Row) {
                            string = LocaleController.getString(C2369R.string.QuickReplyDefault4);
            ...
            ((TextCheckCell) viewHolder.itemView).setTextAndCheck(LocaleController.getString(C2369R.string.AllowCustomQuickReply), QuickRepliesSettingsActivity.this.getParentActivity().getSharedPreferences("mainconfig", 0).getBoolean("quick_reply_allow_custom", true), false);
        }
