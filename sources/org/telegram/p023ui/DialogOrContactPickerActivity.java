...
import org.telegram.p023ui.ContactsActivity;
...
public class DialogOrContactPickerActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.BlockUserMultiTitle));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.DialogOrContactPickerActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    DialogOrContactPickerActivity.this.lambda$onBackPressed$371();
                }
            }
        });
        this.hasOwnBackground = true;
        ActionBarMenuItem actionBarMenuItemSearchListener = this.actionBar.createMenu().addItem(0, C2369R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() { // from class: org.telegram.ui.DialogOrContactPickerActivity.2
        ...
        FrameLayout frameLayout = new FrameLayout(context) { // from class: org.telegram.ui.DialogOrContactPickerActivity.4
            ...
            protected void onMeasure(int i, int i2) {
                ...
                C49834 c49834 = this;
                c49834.measureChildWithMargins(((BaseFragment) DialogOrContactPickerActivity.this).actionBar, i, 0, i2, 0);
                int measuredHeight = ((BaseFragment) DialogOrContactPickerActivity.this).actionBar.getMeasuredHeight();
                c49834.globalIgnoreLayout = true;
                int i3 = 0;
            ...
            */
            public boolean checkTabsAnimationInProgress() {
                /*
                    r7 = this;
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    boolean r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12813$$Nest$fgettabsAnimationInProgress(r0)
                    r1 = 0
                    if (r0 == 0) goto Lbf
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    boolean r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12805$$Nest$fgetbackAnimation(r0)
                    r2 = -1
                    r3 = 0
                    ...
                    if (r0 == 0) goto L59
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    org.telegram.ui.DialogOrContactPickerActivity$ViewPage[] r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12814$$Nest$fgetviewPages(r0)
                    r0 = r0[r1]
                    ...
                    org.telegram.ui.DialogOrContactPickerActivity$ViewPage[] r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12814$$Nest$fgetviewPages(r0)
                    r0 = r0[r5]
                    org.telegram.ui.DialogOrContactPickerActivity r3 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    org.telegram.ui.DialogOrContactPickerActivity$ViewPage[] r3 = org.telegram.p023ui.DialogOrContactPickerActivity.m12814$$Nest$fgetviewPages(r3)
                    r3 = r3[r1]
                    int r3 = r3.getMeasuredWidth()
                    org.telegram.ui.DialogOrContactPickerActivity r4 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    boolean r4 = org.telegram.p023ui.DialogOrContactPickerActivity.m12804$$Nest$fgetanimatingForward(r4)
                    if (r4 == 0) goto L52
                    r2 = 1
                L52:
                    int r3 = r3 * r2
                ...
                L59:
                    ...
                    r0 = r0[r1]
                    org.telegram.ui.DialogOrContactPickerActivity r4 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    org.telegram.ui.DialogOrContactPickerActivity$ViewPage[] r4 = org.telegram.p023ui.DialogOrContactPickerActivity.m12814$$Nest$fgetviewPages(r4)
                    r4 = r4[r1]
                    int r4 = r4.getMeasuredWidth()
                    org.telegram.ui.DialogOrContactPickerActivity r6 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    boolean r6 = org.telegram.p023ui.DialogOrContactPickerActivity.m12804$$Nest$fgetanimatingForward(r6)
                    if (r6 == 0) goto L8a
                    goto L8b
                L8a:
                    r2 = 1
                ...
                L9c:
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    android.animation.AnimatorSet r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12812$$Nest$fgettabsAnimation(r0)
                    if (r0 == 0) goto Lb3
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    android.animation.AnimatorSet r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12812$$Nest$fgettabsAnimation(r0)
                    r0.cancel()
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    r2 = 0
                    org.telegram.p023ui.DialogOrContactPickerActivity.m12818$$Nest$fputtabsAnimation(r0, r2)
                Lb3:
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    org.telegram.p023ui.DialogOrContactPickerActivity.m12819$$Nest$fputtabsAnimationInProgress(r0, r1)
                Lb8:
                    org.telegram.ui.DialogOrContactPickerActivity r0 = org.telegram.p023ui.DialogOrContactPickerActivity.this
                    boolean r0 = org.telegram.p023ui.DialogOrContactPickerActivity.m12813$$Nest$fgettabsAnimationInProgress(r0)
                    return r0
                Lbf:
                    return r1
                */
                throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.DialogOrContactPickerActivity.C49834.checkTabsAnimationInProgress():boolean");
            }
                    ...
                    if (this.startedTracking) {
                        ...
                        DialogOrContactPickerActivity.this.tabsAnimation.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.DialogOrContactPickerActivity.4.1
                            ...
                            public void onAnimationEnd(Animator animator) {
                                ...
                                C49834.this.maybeStartTracking = false;
                                C49834.this.startedTracking = false;
    ...
    private void showBlockAlert(final TLRPC.User user) {
        ...
        builder.setMessage(AndroidUtilities.replaceTags(LocaleController.formatString("AreYouSureBlockContact2", C2369R.string.AreYouSureBlockContact2, ContactsController.formatName(user.first_name, user.last_name))));
        builder.setPositiveButton(LocaleController.getString(C2369R.string.BlockContact), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DialogOrContactPickerActivity$$ExternalSyntheticLambda3
    ...
    public /* synthetic */ void lambda$showBlockAlert$3(TLRPC.User user, AlertDialog alertDialog, int i) {
        if (MessagesController.isSupportUser(user)) {
            AlertsCreator.showSimpleToast(this, LocaleController.getString(C2369R.string.ErrorOccurred));
        } else {
            MessagesController.getInstance(this.currentAccount).blockPeer(user.f1734id);
            AlertsCreator.showSimpleToast(this, LocaleController.getString(C2369R.string.UserBlocked));
        }
    ...
    private void updateTabs() {
        ...
        scrollSlidingTextTabStrip.addTextTab(0, LocaleController.getString(C2369R.string.BlockUserChatsTitle));
        this.scrollSlidingTextTabStrip.addTextTab(1, LocaleController.getString(C2369R.string.BlockUserContactsTitle));
