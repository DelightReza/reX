...
public class LogoutActivity extends BaseFragment {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.LogOutTitle));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.LogoutActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    LogoutActivity.this.lambda$onBackPressed$371();
                }
            }
        });
    ...
    public static AlertDialog makeLogOutDialog(Context context, final int i) {
        ...
        builder.setMessage(LocaleController.getString(C2369R.string.AreYouSureLogout));
        builder.setTitle(LocaleController.getString(C2369R.string.LogOut));
        builder.setPositiveButton(LocaleController.getString(C2369R.string.LogOut), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.LogoutActivity$$ExternalSyntheticLambda1
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType == 0) {
                ...
                if (i == LogoutActivity.this.alternativeHeaderRow) {
                    headerCell.setText(LocaleController.getString(C2369R.string.AlternativeOptions));
                    return;
                }
                return;
            }
            if (itemViewType != 1) {
                if (itemViewType == 3) {
                    ...
                    if (i == LogoutActivity.this.logoutRow) {
                        ...
                        textSettingsCell.setText(LocaleController.getString(C2369R.string.LogOutTitle), false);
                        return;
                    }
                    return;
                }
                ...
                if (i == LogoutActivity.this.logoutSectionRow) {
                    textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.LogOutInfo));
                    return;
                }
                return;
            }
            ...
            if (i == LogoutActivity.this.addAccountRow) {
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString(C2369R.string.AddAnotherAccount), LocaleController.getString(C2369R.string.AddAnotherAccountInfo), C2369R.drawable.msg_contact_add, true);
                return;
            }
            if (i == LogoutActivity.this.passcodeRow) {
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString(C2369R.string.SetPasscode), LocaleController.getString(C2369R.string.SetPasscodeInfo), C2369R.drawable.msg_permissions, true);
                return;
            }
            if (i == LogoutActivity.this.cacheRow) {
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString(C2369R.string.ClearCache), LocaleController.getString(C2369R.string.ClearCacheInfo), C2369R.drawable.msg_clearcache, true);
            } else if (i == LogoutActivity.this.phoneRow) {
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString(C2369R.string.ChangePhoneNumber), LocaleController.getString(C2369R.string.ChangePhoneNumberInfo), C2369R.drawable.msg_newphone, true);
            } else if (i == LogoutActivity.this.supportRow) {
                textDetailSettingsCell.setTextAndValueAndIcon(LocaleController.getString(C2369R.string.ContactSupport), LocaleController.getString(C2369R.string.ContactSupportInfo), C2369R.drawable.msg_help, false);
            }
        }
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                headerCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
            }
