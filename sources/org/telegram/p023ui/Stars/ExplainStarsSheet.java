...
public class ExplainStarsSheet extends BottomSheetWithRecyclerListView {
    ...
    public ExplainStarsSheet(Context context) {
        ...
        textView.setText(LocaleController.getString(C2369R.string.ExplainStarsTitle));
        ...
        textView2.setText(LocaleController.getString(C2369R.string.ExplainStarsTitle2));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2369R.string.ExplainStarsButton), false);
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2369R.string.ExplainStarsTitle);
    }
    ...
    protected RecyclerListView.SelectionAdapter createAdapter(RecyclerListView recyclerListView) {
        UniversalAdapter universalAdapter = new UniversalAdapter(recyclerListView, getContext(), this.currentAccount, 0, true, new Utilities.Callback2() { // from class: org.telegram.ui.Stars.ExplainStarsSheet$$ExternalSyntheticLambda1
            ...
            @Override // org.telegram.p023ui.Components.UniversalAdapter, org.telegram.ui.Components.RecyclerListView.SelectionAdapter
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(FeatureCell.Factory.m1319of(C2369R.drawable.msg_gift_premium, LocaleController.getString(C2369R.string.ExplainStarsFeature1Title), LocaleController.getString(C2369R.string.ExplainStarsFeature1Text)));
        arrayList.add(FeatureCell.Factory.m1319of(C2369R.drawable.msg_bot, LocaleController.getString(C2369R.string.ExplainStarsFeature2Title), AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.ExplainStarsFeature2Text), new Runnable() { // from class: org.telegram.ui.Stars.ExplainStarsSheet$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$fillItems$1();
            }
        }), true)));
        arrayList.add(FeatureCell.Factory.m1319of(C2369R.drawable.menu_unlock, LocaleController.getString(C2369R.string.ExplainStarsFeature3Title), LocaleController.getString(C2369R.string.ExplainStarsFeature3Text)));
        arrayList.add(FeatureCell.Factory.m1319of(C2369R.drawable.menu_feature_paid, LocaleController.getString(C2369R.string.ExplainStarsFeature4Title), LocaleController.getString(C2369R.string.ExplainStarsFeature4Text)));
    ...
    public static class FeatureCell extends LinearLayout {
        ...
        public FeatureCell(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
            super(context);
            setOrientation(0);
            setPadding(AndroidUtilities.m1146dp(i == 1 ? 11.0f : 32.0f), 0, AndroidUtilities.m1146dp(i == 1 ? 11.0f : 32.0f), AndroidUtilities.m1146dp(i == 1 ? 8.0f : 12.0f));
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* renamed from: of */
            public static UItem m1319of(int i, CharSequence charSequence, CharSequence charSequence2) {
