...
public class BalanceCloud extends LinearLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public BalanceCloud(final Context context, int i, AmountUtils$Currency amountUtils$Currency, final Theme.ResourcesProvider resourcesProvider) {
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(24.0f), Theme.getColor(Theme.key_undo_background, resourcesProvider)));
        ...
        linksTextView.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.Gift2MessageStarsInfoLink), new Runnable() { // from class: org.telegram.ui.Stars.BalanceCloud$$ExternalSyntheticLambda0
    ...
    private void updateBalance(boolean z) {
        ...
        if (amountUtils$Currency == AmountUtils$Currency.STARS) {
            this.textView1.setText(StarsIntroActivity.replaceStarsWithPlain(LocaleController.formatString(C2369R.string.Gift2MessageStarsInfo, LocaleController.formatNumber(balanceAmount.asDecimal(), ',')), 0.6f));
            ...
            this.textView2.setText(AndroidUtilities.replaceArrows(AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.Gift2MessageStarsInfoLink), new Runnable() { // from class: org.telegram.ui.Stars.BalanceCloud$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
        ...
        if (amountUtils$Currency == AmountUtils$Currency.TON) {
            this.textView1.setText(StarsIntroActivity.replaceStarsWithPlain(true, (CharSequence) AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.Gift2MessageStarsInfoTON, balanceAmount.asDecimalString())), 0.6f, this.coloredImageSpansTon));
