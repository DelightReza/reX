...
public class ChooseSpeedLayout {
    ...
    public ChooseSpeedLayout(Context context, final PopupSwipeBackLayout popupSwipeBackLayout, final Callback callback) {
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_arrow_back, LocaleController.getString(C2369R.string.Back), false, null);
        ...
        speedSlider.setMinimumWidth(AndroidUtilities.m1146dp(196.0f));
        ...
        layoutParams2.height = AndroidUtilities.m1146dp(8.0f);
        frameLayout2.setLayoutParams(layoutParams2);
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_speed_0_2, LocaleController.getString(C2369R.string.SpeedVerySlow), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem3 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_speed_slow, LocaleController.getString(C2369R.string.SpeedSlow), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem4 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_speed_normal, LocaleController.getString(C2369R.string.SpeedNormal), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem5 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_speed_fast, LocaleController.getString(C2369R.string.SpeedFast), false, null);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem6 = ActionBarMenuItem.addItem(this.speedSwipeBackLayout, C2369R.drawable.msg_speed_superfast, LocaleController.getString(C2369R.string.SpeedVeryFast), false, null);
