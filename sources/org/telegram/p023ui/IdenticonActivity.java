...
import org.telegram.p023ui.Components.IdenticonDrawable;
...
public class IdenticonActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.EncryptionKey));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.IdenticonActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    IdenticonActivity.this.lambda$onBackPressed$371();
                }
            }
        });
        ...
        this.fragmentView.setOnTouchListener(new View.OnTouchListener() { // from class: org.telegram.ui.IdenticonActivity$$ExternalSyntheticLambda0
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return IdenticonActivity.m13927$r8$lambda$_9TeDfLKkBhGucrGhUvCKvDx8M(view, motionEvent);
            }
        });
        ...
        frameLayout2.setPadding(AndroidUtilities.m1146dp(20.0f), AndroidUtilities.m1146dp(20.0f), AndroidUtilities.m1146dp(20.0f), AndroidUtilities.m1146dp(20.0f));
        ...
        FrameLayout frameLayout3 = new FrameLayout(context) { // from class: org.telegram.ui.IdenticonActivity.2
            ...
            protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
                ...
                if (IdenticonActivity.this.codeTextView != null) {
                    ...
                    int measuredHeight = (((IdenticonActivity.this.codeTextView.getMeasuredHeight() - IdenticonActivity.this.emojiTextView.getMeasuredHeight()) / 2) + IdenticonActivity.this.linearLayout1.getTop()) - AndroidUtilities.m1146dp(16.0f);
        ...
        this.linearLayout1.setPadding(AndroidUtilities.m1146dp(10.0f), 0, AndroidUtilities.m1146dp(10.0f), 0);
        ...
        if (encryptedChat != null) {
            ...
            int i7 = C2369R.string.EncryptionKeyDescription;
            ...
            if (iIndexOf != -1) {
                spannableStringBuilder.setSpan(new URLSpanReplacement(LocaleController.getString(C2369R.string.EncryptionKeyLink)), iIndexOf, iIndexOf + 12, 33);
            }
    ...
    /* renamed from: $r8$lambda$_9TeDfLKkBhGucrGhUv-CKvDx8M, reason: not valid java name */
    public static /* synthetic */ boolean m13927$r8$lambda$_9TeDfLKkBhGucrGhUvCKvDx8M(View view, MotionEvent motionEvent) {
        return true;
    }
