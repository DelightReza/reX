...
public class DatabaseMigrationHint extends FrameLayout {
    ...
    public DatabaseMigrationHint(Context context, int i) {
        ...
        rLottieImageView.setAnimation(C2369R.raw.db_migration_placeholder, 150, 150);
        ...
        this.title.setText(LocaleController.getString(C2369R.string.OptimizingTelegram));
        ...
        textView3.setLineSpacing(AndroidUtilities.m1146dp(2.0f), 1.0f);
        this.description1.setTextSize(1, 14.0f);
        this.description1.setText(LocaleController.getString(C2369R.string.OptimizingTelegramDescription1));
        ...
        this.description2.setText(LocaleController.getString(C2369R.string.OptimizingTelegramDescription2));
