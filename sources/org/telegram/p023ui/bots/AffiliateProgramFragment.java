...
public class AffiliateProgramFragment extends GradientHeaderActivity implements NotificationCenter.NotificationCenterDelegate {
    ...
    public View createView(final Context context) {
        ...
        View view = new View(context) { // from class: org.telegram.ui.bots.AffiliateProgramFragment.1
            ...
            protected void onMeasure(int i, int i2) {
                ...
                if (affiliateProgramFragment.isLandscapeMode) {
                    measuredHeight = (affiliateProgramFragment.statusBarHeight + ((BaseFragment) affiliateProgramFragment).actionBar.getMeasuredHeight()) - AndroidUtilities.m1146dp(16.0f);
                } else {
                    ...
                    int measuredHeight2 = iM1146dp + affiliateProgramFragment2.statusBarHeight;
                    if (affiliateProgramFragment2.backgroundView.getMeasuredHeight() + AndroidUtilities.m1146dp(24.0f) > measuredHeight2) {
                        measuredHeight2 = AffiliateProgramFragment.this.backgroundView.getMeasuredHeight() + AndroidUtilities.m1146dp(24.0f);
                    }
        ...
        configureHeader(LocaleController.getString(C2369R.string.BotAffiliateProgramTitle), LocaleController.getString(C2369R.string.BotAffiliateProgramText), this.aboveTitleView, null);
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2369R.string.AffiliateProgramStart), false);
        ...
        this.listView.setPadding(0, 0, 0, AndroidUtilities.m1146dp(84.0f));
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view) {
        if (this.button.isEnabled()) {
            ...
            tableView.addRow(LocaleController.getString(C2369R.string.AffiliateProgramCommission), percents(this.program.commission_permille));
            String string = LocaleController.getString(C2369R.string.AffiliateProgramDuration);
            int i = this.program.duration_months;
            tableView.addRow(string, i <= 0 ? LocaleController.getString(C2369R.string.Infinity) : (i < 12 || i % 12 != 0) ? LocaleController.formatPluralString("Months", i, new Object[0]) : LocaleController.formatPluralString("Years", i / 12, new Object[0]));
            frameLayout.addView(tableView, LayoutHelper.createFrame(-1, -2.0f, Opcodes.DNEG, 24.0f, 0.0f, 24.0f, 0.0f));
            new AlertDialog.Builder(context, this.resourceProvider).setTitle(LocaleController.getString(C2369R.string.AffiliateProgramAlert)).setMessage(LocaleController.getString(this.new_program ? C2369R.string.AffiliateProgramStartAlertText : C2369R.string.AffiliateProgramUpdateAlertText)).setView(frameLayout).setPositiveButton(LocaleController.getString(this.new_program ? C2369R.string.AffiliateProgramStartAlertButton : C2369R.string.AffiliateProgramUpdateAlertButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda9
    ...
    public /* synthetic */ void lambda$createView$5(View view, int i) {
        ...
        int i2 = universalAdapter.getItem(i).f2017id;
        if (i2 == 4) {
            end();
        } else if (i2 == 2) {
    ...
    private void closeToProfile(boolean z) {
        ...
        if (backgroundFragment != null) {
            if (z) {
                BulletinFactory.m1267of(backgroundFragment).createSimpleBulletin(C2369R.raw.linkbroken, LocaleController.getString(C2369R.string.AffiliateProgramEndedTitle), AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AffiliateProgramEndedText))).show();
            } else {
                BulletinFactory.m1267of(backgroundFragment).createSimpleBulletin(C2369R.raw.contact_check, LocaleController.getString(C2369R.string.AffiliateProgramStartedTitle), LocaleController.getString(C2369R.string.AffiliateProgramStartedText)).show();
            }
        }
    }

    private void update(boolean z) {
        this.button.setText(LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2369R.string.AffiliateProgramStart : C2369R.string.AffiliateProgramUpdate), z);
        AndroidUtilities.cancelRunOnUIThread(this.updateTimerRunnable);
        this.updateTimerRunnable.run();
        this.buttonSubtext.setText(AndroidUtilities.replaceSingleTag(LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2369R.string.AffiliateProgramStartInfo : C2369R.string.AffiliateProgramUpdateInfo), new Runnable() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$update$6() {
        Browser.openUrl(getContext(), LocaleController.getString((this.new_program || this.program.end_date != 0) ? C2369R.string.AffiliateProgramUpdateInfoLink : C2369R.string.AffiliateProgramStartInfoLink));
    }
    ...
    private class BulletinTextView extends TextView {
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawCircle(AndroidUtilities.m1146dp(3.5f), AndroidUtilities.m1146dp(11.5f), AndroidUtilities.m1146dp(2.5f), getPaint());
        }
    }
    ...
    private void end() {
        ...
        linearLayout.setOrientation(1);
        linearLayout.setPadding(AndroidUtilities.m1146dp(24.0f), 0, AndroidUtilities.m1146dp(24.0f), 0);
        TextView textView = new TextView(getContext());
        textView.setTextSize(1, 16.0f);
        int i = Theme.key_windowBackgroundWhiteBlackText;
        textView.setTextColor(Theme.getColor(i, this.resourceProvider));
        textView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AffiliateProgramStopText)));
        ...
        bulletinTextView.setPadding(AndroidUtilities.m1146dp(15.0f), 0, 0, 0);
        bulletinTextView.setTextSize(1, 16.0f);
        bulletinTextView.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AffiliateProgramStopText1)));
        ...
        bulletinTextView2.setPadding(AndroidUtilities.m1146dp(15.0f), 0, 0, 0);
        bulletinTextView2.setTextSize(1, 16.0f);
        bulletinTextView2.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView2.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AffiliateProgramStopText2)));
        ...
        bulletinTextView3.setPadding(AndroidUtilities.m1146dp(15.0f), 0, 0, 0);
        bulletinTextView3.setTextSize(1, 16.0f);
        bulletinTextView3.setTextColor(Theme.getColor(i, this.resourceProvider));
        bulletinTextView3.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AffiliateProgramStopText3)));
        linearLayout.addView(bulletinTextView3, LayoutHelper.createLinear(-1, -2, 0.0f, 0.0f, 0.0f, 10.0f));
        new AlertDialog.Builder(getContext(), this.resourceProvider).setTitle(LocaleController.getString(C2369R.string.AffiliateProgramAlert)).setView(linearLayout).setPositiveButton(LocaleController.getString(C2369R.string.AffiliateProgramStopButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.bots.AffiliateProgramFragment$$ExternalSyntheticLambda12
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i2) {
    ...
    public /* synthetic */ void lambda$end$8(AlertDialog alertDialog, TLObject tLObject, TLRPC.TL_error tL_error) {
        ...
        if (userFull != null) {
            ...
            starrefprogram2.end_date = getConnectionsManager().getCurrentTime() + (getConnectionsManager().isTestBackend() ? DataTypes.UNIT : 86400);
            userFull.starref_program = starrefprogram;
            getMessagesStorage().updateUserInfo(userFull, false);
            NotificationCenter.getInstance(this.currentAccount).lambda$postNotificationNameOnUIThread$1(NotificationCenter.userInfoDidLoad, Long.valueOf(this.bot_id), userFull);
        }
    ...
    public void fillItems(ArrayList arrayList, UniversalAdapter universalAdapter) {
        ...
        arrayList.add(FeatureCell.Factory.m1350as(C2369R.drawable.menu_feature_premium, LocaleController.getString(C2369R.string.BotAffiliateProgramFeature1Title), LocaleController.getString(C2369R.string.BotAffiliateProgramFeature1)));
        arrayList.add(FeatureCell.Factory.m1350as(C2369R.drawable.msg_channel, LocaleController.getString(C2369R.string.BotAffiliateProgramFeature2Title), LocaleController.getString(C2369R.string.BotAffiliateProgramFeature2)));
        arrayList.add(FeatureCell.Factory.m1350as(C2369R.drawable.menu_feature_links2, LocaleController.getString(C2369R.string.BotAffiliateProgramFeature3Title), LocaleController.getString(C2369R.string.BotAffiliateProgramFeature3)));
        arrayList.add(UItem.asShadow(1, null));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2369R.string.AffiliateProgramCommission)));
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2369R.string.AffiliateProgramCommissionInfo)));
        arrayList.add(UItem.asHeader(LocaleController.getString(C2369R.string.AffiliateProgramDuration)));
        if (this.durationTexts == null) {
            ...
            for (int i = 0; i < this.durationValues.size(); i++) {
                ...
                if (iIntValue == 0) {
                    this.durationTexts[i] = LocaleController.getString(C2369R.string.Infinity);
        ...
        arrayList.add(UItem.asShadow(LocaleController.getString(C2369R.string.AffiliateProgramDurationInfo)));
        arrayList.add(ColorfulTextCell.Factory.m1349as(2, getThemedColor(Theme.key_color_green), C2369R.drawable.filled_earn_stars, LocaleController.getString(C2369R.string.AffiliateProgramExistingProgramsTitle), LocaleController.getString(C2369R.string.AffiliateProgramExistingProgramsText)));
        arrayList.add(UItem.asShadow(3, null));
        if (!this.new_program && this.program.end_date == 0) {
            arrayList.add(UItem.asButton(4, LocaleController.getString(C2369R.string.AffiliateProgramStop)).red());
    ...
    public static class FeatureCell extends FrameLayout {
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* renamed from: as */
            public static UItem m1350as(int i, CharSequence charSequence, CharSequence charSequence2) {
    ...
    public static class ColorfulTextCell extends FrameLayout {
        ...
        public ColorfulTextCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            textView3.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(4.0f), Theme.getColor(Theme.key_color_green, resourcesProvider)));
            textView3.setTextSize(1, 13.0f);
            textView3.setTypeface(AndroidUtilities.bold());
            textView3.setPadding(AndroidUtilities.m1146dp(5.0f), 0, AndroidUtilities.m1146dp(4.0f), 0);
        ...
        public void set(int i, int i2, CharSequence charSequence, CharSequence charSequence2) {
            ...
            this.imageView.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(9.0f), i));
            this.titleView.setText(charSequence);
            if (TextUtils.isEmpty(charSequence2)) {
                this.imageViewLayoutParams.topMargin = AndroidUtilities.m1146dp(10.0f);
                this.imageViewLayoutParams.bottomMargin = AndroidUtilities.m1146dp(10.0f);
            ...
            this.imageViewLayoutParams.topMargin = AndroidUtilities.m1146dp(14.33f);
            this.imageViewLayoutParams.bottomMargin = AndroidUtilities.m1146dp(10.0f);
            this.titleView.setTypeface(AndroidUtilities.bold());
            this.titleView.setTextSize(1, 15.0f);
            this.textLayoutLayoutParams.topMargin = AndroidUtilities.m1146dp(10.0f);
            this.textLayoutLayoutParams.bottomMargin = AndroidUtilities.m1146dp(8.66f);
        ...
        public static class Factory extends UItem.UItemFactory {
            ...
            /* renamed from: as */
            public static UItem m1349as(int i, int i2, int i3, CharSequence charSequence, CharSequence charSequence2) {
                UItem uItemOfFactory = UItem.ofFactory(Factory.class);
