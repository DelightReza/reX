...
public class WebViewRequestProps {
    ...
    /* renamed from: of */
    public static WebViewRequestProps m1358of(int i, long j, long j2, String str, String str2, int i2, int i3, long j3, boolean z, TLRPC.BotApp botApp, boolean z2, String str3, TLRPC.User user, int i4, boolean z3, boolean z4) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.currentAccount == webViewRequestProps.currentAccount && this.peerId == webViewRequestProps.peerId && this.botId == webViewRequestProps.botId && TextUtils.equals(this.buttonUrl, webViewRequestProps.buttonUrl) && this.type == webViewRequestProps.type && this.replyToMsgId == webViewRequestProps.replyToMsgId && this.silent == webViewRequestProps.silent) {
            ...
            long j = botApp == null ? 0L : botApp.f1568id;
            TLRPC.BotApp botApp2 = webViewRequestProps.app;
            if (j == (botApp2 == null ? 0L : botApp2.f1568id) && this.allowWrite == webViewRequestProps.allowWrite && TextUtils.equals(this.startParam, webViewRequestProps.startParam)) {
                TLRPC.User user = this.botUser;
                long j2 = user == null ? 0L : user.f1734id;
                TLRPC.User user2 = webViewRequestProps.botUser;
                if (j2 == (user2 != null ? user2.f1734id : 0L) && this.flags == webViewRequestProps.flags) {
                    return true;
                }
            }
        }
