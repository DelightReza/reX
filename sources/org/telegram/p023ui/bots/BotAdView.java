...
public class BotAdView extends FrameLayout {
    ...
    public BotAdView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        linearLayout.setPadding(AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(5.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(5.0f));
        ...
        textView2.setPadding(AndroidUtilities.m1146dp(6.33f), 0, AndroidUtilities.m1146dp(6.33f), 0);
        textView2.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(9.0f), Theme.multAlpha(Theme.getColor(i, resourcesProvider), 0.1f)));
        textView2.setText(LocaleController.getString(C2369R.string.BotAdWhat));
    ...
    public void set(final ChatActivity chatActivity, final MessageObject messageObject, final Runnable runnable, final Runnable runnable2) {
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2369R.string.SponsoredMessageAd));
        int i = Theme.key_featuredStickers_addButton;
        ...
        if (this.titleView.getPaint().measureText(spannableStringBuilder.toString()) > (((AndroidUtilities.displaySize.x - AndroidUtilities.m1146dp(44.660004f)) - this.removeView.getPaint().measureText(this.removeView.getText().toString())) - AndroidUtilities.m1146dp(32.0f)) - AndroidUtilities.m1146dp(z ? 58.0f : 0.0f)) {
            spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2369R.string.SponsoredMessageAd));
            spannableStringBuilder.setSpan(new ForegroundColorSpan(Theme.getColor(i, this.resourcesProvider)), 0, spannableStringBuilder.length(), 33);
        ...
        this.removeView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.bots.BotAdView$$ExternalSyntheticLambda1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                BotAdView.m19438$r8$lambda$puxQK1wOL9Nff1GJAcexXGGAU(runnable, view);
            }
        });
    ...
    /* renamed from: $r8$lambda$puxQK1w-OL9Nff1GJAcexXGGA-U, reason: not valid java name */
    public static /* synthetic */ void m19438$r8$lambda$puxQK1wOL9Nff1GJAcexXGGAU(Runnable runnable, View view) {
        if (runnable != null) {
            runnable.run();
        }
    }
