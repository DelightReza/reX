...
import org.telegram.p023ui.Cells.TopicExceptionCell;
...
public class TopicsNotifySettingsFragments extends BaseFragment {
    ...
    /* renamed from: $r8$lambda$c3dNfmvd9-QA3F1Dmf28JyLaDVg, reason: not valid java name */
    public static /* synthetic */ void m19159$r8$lambda$c3dNfmvd9QA3F1Dmf28JyLaDVg(TLObject tLObject, TLRPC.TL_error tL_error) {
    }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.TopicsNotifySettingsFragments.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    TopicsNotifySettingsFragments.this.lambda$onBackPressed$371();
                }
            }
        });
        ...
        this.recyclerListView.setOnItemClickListener(new C67842());
    ...
    class C67842 implements RecyclerListView.OnItemClickListener {
        C67842() {
        }
        ...
        public void onItemClick(View view, int i) {
            ...
            if (((Item) TopicsNotifySettingsFragments.this.items.get(i)).viewType == 2) {
                ...
                bundle2.putLong("topic_id", tL_forumTopic.f1631id);
            ...
            if (((Item) TopicsNotifySettingsFragments.this.items.get(i)).viewType == 4) {
                ...
                builder.setTitle(LocaleController.getString(C2369R.string.NotificationsDeleteAllExceptionTitle));
                builder.setMessage(LocaleController.getString(C2369R.string.NotificationsDeleteAllExceptionAlert));
                builder.setPositiveButton(LocaleController.getString(C2369R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.TopicsNotifySettingsFragments$2$$ExternalSyntheticLambda1
        ...
        public /* synthetic */ void lambda$onItemClick$0(TLRPC.TL_forumTopic tL_forumTopic, NotificationsSettingsActivity.NotificationException notificationException) {
            TopicsNotifySettingsFragments.this.exceptionsTopics.add(Integer.valueOf(tL_forumTopic.f1631id));
        ...
        class AnonymousClass1 implements ProfileNotificationsActivity.ProfileNotificationsActivityDelegate {
            ...
            public void didRemoveException(long j) {
                TopicsNotifySettingsFragments.this.removeException(this.val$topic.f1631id);
            ...
            public /* synthetic */ void lambda$didRemoveException$0(TLRPC.TL_forumTopic tL_forumTopic) {
                TopicsNotifySettingsFragments.this.exceptionsTopics.remove(Integer.valueOf(tL_forumTopic.f1631id));
                TopicsNotifySettingsFragments.this.updateRows();
            }
        }
    ...
    public void removeException(int i) {
        ...
        getConnectionsManager().sendRequest(updatenotifysettings, new RequestDelegate() { // from class: org.telegram.ui.TopicsNotifySettingsFragments$$ExternalSyntheticLambda0
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                TopicsNotifySettingsFragments.m19159$r8$lambda$c3dNfmvd9QA3F1Dmf28JyLaDVg(tLObject, tL_error);
            }
        });
    }
    ...
    public void updateRows() {
        ...
        if (topics != null) {
            int i3 = 0;
            while (i < topics.size()) {
                if (this.exceptionsTopics.contains(Integer.valueOf(topics.get(i).f1631id))) {
    ...
    private class Item extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            return tL_forumTopic2 == null || (tL_forumTopic = item.topic) == null || tL_forumTopic2.f1631id == tL_forumTopic.f1631id;
        }
    }
}
