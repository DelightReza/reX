...
public class ProfileNotificationsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    */
    public boolean onFragmentCreate() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.ProfileNotificationsActivity.onFragmentCreate():boolean");
    }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ProfileNotificationsActivity.1
            ...
            public void onItemClick(int i) {
                ...
                ProfileNotificationsActivity.this.lambda$onBackPressed$371();
            }
        });
        ...
        if (this.addingException) {
            this.avatarContainer.setSubtitle(LocaleController.getString(C2369R.string.NotificationsNewException));
            this.actionBar.createMenu().addItem(1, LocaleController.getString(C2369R.string.Done).toUpperCase());
        } else {
            this.avatarContainer.setSubtitle(LocaleController.getString(C2369R.string.CustomNotifications));
        }
    ...
    public /* synthetic */ void lambda$createView$6(Context context, final String str, View view, int i) {
        if (view.isEnabled()) {
            ...
            if (i == this.customResetRow) {
                AlertDialog alertDialogCreate = new AlertDialog.Builder(context, this.resourcesProvider).setTitle(LocaleController.getString(C2369R.string.ResetCustomNotificationsAlertTitle)).setMessage(LocaleController.getString(C2369R.string.ResetCustomNotificationsAlert)).setPositiveButton(LocaleController.getString(C2369R.string.Reset), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.ProfileNotificationsActivity$$ExternalSyntheticLambda2
        ...
        if (uri == null || (ringtone = RingtoneManager.getRingtone(ApplicationLoader.applicationContext, uri)) == null) {
            ...
            if (i == 13) {
                if (uri.equals(Settings.System.DEFAULT_RINGTONE_URI)) {
                    title = LocaleController.getString(C2369R.string.DefaultRingtone);
                } else {
                    title = ringtone.getTitle(getParentActivity());
                }
            } else if (uri.equals(Settings.System.DEFAULT_NOTIFICATION_URI)) {
                title = LocaleController.getString(C2369R.string.SoundDefault);
            } else {
                title = ringtone.getTitle(getParentActivity());
            }
            ringtone.stop();
    ...
    private class ListAdapter extends ListAdapterMD3 {
            ...
            switch (viewHolder.getItemViewType()) {
                case 0:
                    ...
                    if (i == ProfileNotificationsActivity.this.generalRow) {
                        headerCell.setText(LocaleController.getString(C2369R.string.General));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.popupRow) {
                        headerCell.setText(LocaleController.getString(C2369R.string.ProfilePopupNotification));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.ledRow) {
                        headerCell.setText(LocaleController.getString(C2369R.string.NotificationsLed));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.callsRow) {
                        headerCell.setText(LocaleController.getString(C2369R.string.VoipNotificationSettings));
                        break;
                    }
                    break;
                case 1:
                    ...
                    if (i == ProfileNotificationsActivity.this.customResetRow) {
                        textSettingsCell.setText(LocaleController.getString(C2369R.string.ResetCustomNotifications), false);
                        ...
                        if (i == ProfileNotificationsActivity.this.soundRow) {
                            String string = notificationsSettings.getString("sound_" + sharedPrefKey, LocaleController.getString(C2369R.string.SoundDefault));
                            ...
                            if (j != 0) {
                                ...
                                if (document == null) {
                                    string = LocaleController.getString(C2369R.string.CustomSound);
                                } else {
                                    string = NotificationsSoundActivity.trimTitle(document, document.file_name_fixed);
                                }
                            } else if (string.equals("NoSound")) {
                                string = LocaleController.getString(C2369R.string.NoSound);
                            } else if (string.equals("Default")) {
                                string = LocaleController.getString(C2369R.string.SoundDefault);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Sound), string, true);
                            break;
                        } else if (i == ProfileNotificationsActivity.this.ringtoneRow) {
                            String string2 = notificationsSettings.getString("ringtone_" + sharedPrefKey, LocaleController.getString(C2369R.string.DefaultRingtone));
                            if (string2.equals("NoSound")) {
                                string2 = LocaleController.getString(C2369R.string.NoSound);
                            }
                            textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.VoipSettingsRingtone), string2, false);
                            break;
                            ...
                            if (i3 != 0 && i3 != 4) {
                                if (i3 != 1) {
                                    if (i3 != 2) {
                                        if (i3 == 3) {
                                            textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.Long), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                                            break;
                                        }
                                    } else {
                                        textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.VibrationDisabled), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                                        break;
                                    }
                                } else {
                                    textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.Short), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                                    break;
                                }
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.VibrationDefault), (ProfileNotificationsActivity.this.smartRow == -1 && ProfileNotificationsActivity.this.priorityRow == -1) ? false : true);
                                break;
                            }
                            ...
                            if (i4 != 0) {
                                if (i4 != 1 && i4 != 2) {
                                    if (i4 != 3) {
                                        if (i4 != 4) {
                                            if (i4 == 5) {
                                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.NotificationsImportance), LocaleController.getString(C2369R.string.NotificationsPriorityMedium), false);
                                                break;
                                            }
                                        } else {
                                            textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.NotificationsImportance), LocaleController.getString(C2369R.string.NotificationsPriorityLow), false);
                                            break;
                                        }
                                    } else {
                                        textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.NotificationsImportance), LocaleController.getString(C2369R.string.NotificationsPrioritySettings), false);
                                        break;
                                    }
                                } else {
                                    textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.NotificationsImportance), LocaleController.getString(C2369R.string.NotificationsPriorityUrgent), false);
                                    break;
                                }
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.NotificationsImportance), LocaleController.getString(C2369R.string.NotificationsPriorityHigh), false);
                                break;
                            }
                            ...
                            if (i5 == 0) {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.SmartNotifications), LocaleController.getString(C2369R.string.SmartNotificationsDisabled), ProfileNotificationsActivity.this.priorityRow != -1);
                                break;
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.SmartNotifications), LocaleController.formatString("SmartNotificationsInfo", C2369R.string.SmartNotificationsInfo, Integer.valueOf(i5), LocaleController.formatPluralString("Minutes", i6 / 60, new Object[0])), ProfileNotificationsActivity.this.priorityRow != -1);
                                break;
                            }
                            ...
                            if (i7 != 0 && i7 != 4) {
                                if (i7 != 1) {
                                    if (i7 != 2) {
                                        if (i7 == 3) {
                                            textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.Long), true);
                                            break;
                                        }
                                    } else {
                                        textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.VibrationDisabled), true);
                                        break;
                                    }
                                } else {
                                    textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.Short), true);
                                    break;
                                }
                            } else {
                                textSettingsCell.setTextAndValue(LocaleController.getString(C2369R.string.Vibrate), LocaleController.getString(C2369R.string.VibrationDefault), true);
                                break;
                            }
                        }
                    }
                ...
                case 2:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.ProfilePopupNotificationInfo));
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.ledInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.NotificationsLedInfo));
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.priorityInfoRow) {
                        if (ProfileNotificationsActivity.this.priorityRow == -1) {
                            textInfoPrivacyCell.setText("");
                        } else {
                            textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.PriorityInfo));
                        }
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        break;
                    } else if (i == ProfileNotificationsActivity.this.ringtoneInfoRow) {
                        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.VoipRingtoneInfo));
                        textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.context, C2369R.drawable.greydivider, Theme.key_windowBackgroundGrayShadow));
                        break;
                    }
                    break;
                case 3:
                    ...
                    textColorCell.setTextAndColor(LocaleController.getString(C2369R.string.NotificationsLedColor), i2, false);
                    break;
                case 4:
                    ...
                    if (i == ProfileNotificationsActivity.this.popupEnabledRow) {
                        radioCell.setText(LocaleController.getString(C2369R.string.PopupEnabled), i9 == 1, true);
                        radioCell.setTag(1);
                        break;
                    } else if (i == ProfileNotificationsActivity.this.popupDisabledRow) {
                        radioCell.setText(LocaleController.getString(C2369R.string.PopupDisabled), i9 == 2, false);
                        radioCell.setTag(2);
                        break;
                    }
                    break;
                ...
                case 7:
                    ...
                    if (i == ProfileNotificationsActivity.this.enableRow) {
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2369R.string.Notifications), ProfileNotificationsActivity.this.notificationsEnabled, true);
                        break;
                        ...
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2369R.string.MessagePreview), notificationsSettings4.getBoolean(NotificationsSettingsFacade.PROPERTY_CONTENT_PREVIEW + sharedPrefKey3, true), true);
                        break;
                        ...
                        textCheckCell.setTextAndCheck(LocaleController.getString(C2369R.string.StoriesSoundEnabled), notificationsSettings4.getBoolean(str, z), true);
                        break;
                    }
                    break;
            }
        ...
        public Theme.ResourcesProvider getResourcesProvider() {
            return ProfileNotificationsActivity.this.resourcesProvider;
        }
    }
