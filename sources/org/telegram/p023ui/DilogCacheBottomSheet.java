...
public class DilogCacheBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public DilogCacheBottomSheet(CacheControlActivity cacheControlActivity, CacheControlActivity.DialogFileEntities dialogFileEntities, final CacheModel cacheModel, final Delegate delegate) {
        ...
        StorageDiagramView storageDiagramView = new StorageDiagramView(getContext(), dialogFileEntities.dialogId) { // from class: org.telegram.ui.DilogCacheBottomSheet.2
            @Override // org.telegram.p023ui.Components.StorageDiagramView
        ...
        for (int i3 = 8; i2 < i3; i3 = 8) {
            if (i2 == 0) {
                string = LocaleController.getString(C2369R.string.LocalPhotoCache);
                i = Theme.key_statisticChartLine_lightblue;
            } else if (i2 == 1) {
                string = LocaleController.getString(C2369R.string.LocalVideoCache);
                i = Theme.key_statisticChartLine_blue;
            } else if (i2 == 2) {
                string = LocaleController.getString(C2369R.string.LocalDocumentCache);
                i = Theme.key_statisticChartLine_green;
            } else if (i2 == 3) {
                string = LocaleController.getString(C2369R.string.LocalMusicCache);
                i = Theme.key_statisticChartLine_red;
            } else if (i2 == 4) {
                string = LocaleController.getString(C2369R.string.LocalAudioCache);
                i = Theme.key_statisticChartLine_lightgreen;
            } else if (i2 == 5) {
                string = LocaleController.getString(C2369R.string.LocalStickersCache);
                i = Theme.key_statisticChartLine_orange;
            } else if (i2 == 7) {
                string = LocaleController.getString(C2369R.string.LocalStoriesCache);
                i = Theme.key_statisticChartLine_indigo;
            } else {
                string = LocaleController.getString(C2369R.string.LocalMiscellaneousCache);
        ...
        cachedMediaLayout.setBottomPadding(AndroidUtilities.m1146dp(80.0f));
    ...
    public /* synthetic */ void lambda$createButton$3(View view) {
        ...
        builder.setMessage(LocaleController.getString(C2369R.string.ClearCacheForChat));
        builder.setNegativeButton(LocaleController.getString(C2369R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda2
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
                this.f$0.lambda$createButton$1(alertDialog, i);
            }
        });
        builder.setPositiveButton(LocaleController.getString(C2369R.string.Clear), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.DilogCacheBottomSheet$$ExternalSyntheticLambda3
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
