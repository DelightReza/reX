...
public class MessageSeenView extends FrameLayout {
    ...
    public MessageSeenView(Context context, final int i, MessageObject messageObject, final TLRPC.Chat chat) {
        ...
        this.titleView.setRightPadding(AndroidUtilities.m1146dp(62.0f));
        ...
        Drawable drawableMutate = ContextCompat.getDrawable(context, this.isVoice ? C2369R.drawable.msg_played : C2369R.drawable.msg_seen).mutate();
    ...
    public /* synthetic */ void lambda$new$4(TLRPC.TL_error tL_error, TLObject tLObject, long j, final int i, TLRPC.Chat chat) {
        if (tL_error == null && (tLObject instanceof Vector)) {
            ...
            if (ChatObject.isChannel(chat)) {
                ...
                tL_channels_getParticipants.channel = MessagesController.getInstance(i).getInputChannel(chat.f1571id);
    ...
    public /* synthetic */ void lambda$new$0(TLObject tLObject, int i, HashMap map, ArrayList arrayList) {
        if (tLObject != null) {
            ...
            for (int i2 = 0; i2 < tL_channels_channelParticipants.users.size(); i2++) {
                ...
                map.put(Long.valueOf(user.f1734id), user);
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.titleView.getLayoutParams().width = getMeasuredWidth() - AndroidUtilities.m1146dp(40.0f);
    ...
    private void updateView() {
        ...
        if (this.users.size() == 1) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m1146dp(24.0f));
        } else if (this.users.size() == 2) {
            this.avatarsImageView.setTranslationX(AndroidUtilities.m1146dp(12.0f));
        } else {
            this.avatarsImageView.setTranslationX(0.0f);
        }
        this.titleView.setRightPadding(AndroidUtilities.m1146dp((Math.min(2, this.users.size() - 1) * 12) + 38));
        ...
        if (this.peerIds.size() == 1 && this.users.get(0) != null) {
            ...
            this.titleView.setText(LocaleController.getString(C2369R.string.NobodyViewed));
        } else {
    ...
    public RecyclerListView createListView() {
        ...
        this.listView.setAdapter(new RecyclerListView.SelectionAdapter() { // from class: org.telegram.ui.MessageSeenView.3
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                ...
                userCell.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1146dp(50.0f)));
    ...
    private static class UserCell extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
        private static MessageSeenCheckDrawable seenDrawable = new MessageSeenCheckDrawable(C2369R.drawable.msg_mini_checks, Theme.key_windowBackgroundWhiteGrayText);
        ...
        public UserCell(Context context) {
            ...
            this.nameView.setDrawablePadding(AndroidUtilities.m1146dp(3.0f));
        ...
        public void setUser(TLObject tLObject, int i) {
            ...
            if (i <= 0) {
                ...
                this.nameView.setTranslationY(AndroidUtilities.m1146dp(9.0f));
            } else {
        ...
        public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            String string = LocaleController.formatString("AccDescrPersonHasSeen", C2369R.string.AccDescrPersonHasSeen, this.nameView.getText());
        ...
        public void didReceivedNotification(int i, int i2, Object... objArr) {
            if (i == NotificationCenter.userEmojiStatusUpdated) {
                ...
                if (user2 == null || user == null || user2.f1734id != user.f1734id) {
                    return;
                }
                this.object = user;
                updateStatus(true);
