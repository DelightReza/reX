...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.mTextSize = AndroidUtilities.m1146dp(i);
        init();
    }
    ...
    */
    public boolean dispatchKeyEvent(android.view.KeyEvent r6) {
        ...
        L60:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.NumberPicker.dispatchKeyEvent(android.view.KeyEvent):boolean");
    }
    ...
    */
    public void setWrapSelectorWheel(boolean r5) {
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.NumberPicker.setWrapSelectorWheel(boolean):void");
    }
    ...
    protected void changeValueByOne(boolean z) {
        ...
        if (z) {
            this.mFlingScroller.startScroll(0, 0, 0, -this.mSelectorElementHeight, DataTypes.UNIT);
        } else {
            this.mFlingScroller.startScroll(0, 0, 0, this.mSelectorElementHeight, DataTypes.UNIT);
        }
        invalidate();
