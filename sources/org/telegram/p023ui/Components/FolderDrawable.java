    ...
    public void draw(Canvas canvas) {
        ...
        if (path != null) {
            if (this.pathInvalidated) {
                path.rewind();
                this.path.moveTo(m1279x(0.4871f), m1280y(0.6025f));
                this.path.lineTo(m1279x(0.8974f), m1280y(0.6025f));
                this.path.lineTo(m1279x(1.0f), m1280y(0.7564f));
                this.path.lineTo(m1279x(0.8974f), m1280y(0.9102f));
                this.path.lineTo(m1279x(0.4871f), m1280y(0.9102f));
                this.path.close();
                this.pathInvalidated = false;
                this.strokePaint.setStrokeWidth(AndroidUtilities.m1146dp(3.0f));
            }
