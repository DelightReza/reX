...
public class HorizontalRoundTabsLayout extends HorizontalScrollView {
    ...
    public void setTabs(ArrayList arrayList, final MessagesStorage.IntCallback intCallback) {
        ...
        for (final int i = 0; i < arrayList.size(); i++) {
            ...
            roundTabView.setPadding(AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(5.0f), AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(5.0f));
            LinearLayout.LayoutParams layoutParamsCreateLinear = LayoutHelper.createLinear(-2, -2);
            if (i < arrayList.size() - 1) {
                layoutParamsCreateLinear.rightMargin = AndroidUtilities.m1146dp(4.0f);
            }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.clipPath2.addRoundRect(rectF, AndroidUtilities.m1146dp(13.0f), AndroidUtilities.m1146dp(13.0f), Path.Direction.CCW);
    ...
    private static class RoundTabView extends View {
        ...
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.round(this.text.getWidth()) + getPaddingLeft() + getPaddingRight(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(Math.max(Math.round(this.text.getHeight()) + getPaddingTop() + getPaddingBottom(), AndroidUtilities.m1146dp(26.0f)), TLObject.FLAG_30));
        }
