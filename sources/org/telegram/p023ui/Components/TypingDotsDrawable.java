...
public class TypingDotsDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int i;
        if (this.isChat) {
            iM1146dp = AndroidUtilities.m1146dp(8.5f);
            i = getBounds().top;
        } else {
            iM1146dp = AndroidUtilities.m1146dp(9.3f);
            i = getBounds().top;
        }
        int i2 = iM1146dp + i;
        Paint paint = this.currentPaint;
        ...
        float f = i2;
        canvas.drawCircle(AndroidUtilities.m1146dp(3.0f), f, this.scales[0] * AndroidUtilities.density, paint);
        canvas.drawCircle(AndroidUtilities.m1146dp(9.0f), f, this.scales[1] * AndroidUtilities.density, paint);
        canvas.drawCircle(AndroidUtilities.m1146dp(15.0f), f, this.scales[2] * AndroidUtilities.density, paint);
        checkUpdate();
    }
