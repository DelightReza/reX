...
public class BackupImageView extends View {
    ...
    public void drawBlurredText(Canvas canvas, float f) {
        ...
        float currentWidth = this.blurText.getCurrentWidth() + AndroidUtilities.m1146dp(18.0f);
        float fM1146dp = AndroidUtilities.m1146dp(28.0f);
        float f2 = (measuredWidth - currentWidth) / 2.0f;
        float f3 = measuredHeight / 2.0f;
        RectF rectF = AndroidUtilities.rectTmp;
        float f4 = fM1146dp / 2.0f;
        ...
        this.blurText.draw(canvas, f2 + AndroidUtilities.m1146dp(9.0f), f3, -1, f);
        canvas.restore();
    }
