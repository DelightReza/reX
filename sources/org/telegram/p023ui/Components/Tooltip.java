...
public class Tooltip extends TextView {
    ...
    public Tooltip(Context context, ViewGroup viewGroup, int i, int i2) {
        ...
        setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(3.0f), i));
        setTextColor(i2);
        setTextSize(1, 14.0f);
        setPadding(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(7.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(7.0f));
        setGravity(16);
    ...
    private void updateTooltipPosition() {
        ...
        if (width >= 0) {
            measuredWidth = getMeasuredWidth() + width > view.getMeasuredWidth() ? (view.getMeasuredWidth() - getMeasuredWidth()) - AndroidUtilities.m1146dp(16.0f) : width;
        }
