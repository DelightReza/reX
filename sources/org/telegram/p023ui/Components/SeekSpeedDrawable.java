...
public class SeekSpeedDrawable extends Drawable {
    ...
    public SeekSpeedDrawable(final Runnable runnable, boolean z, boolean z2) {
        ...
        Path path = new Path();
        this.hintArrow = path;
        this.hintText = new Text(LocaleController.getString(C2369R.string.SeekSpeedHint), 14.0f);
        Path path2 = new Path();
        ...
        paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1146dp(1.66f)));
        path2.moveTo(AndroidUtilities.m1146dp(8.66f), -AndroidUtilities.m1146dp(6.33f));
        path2.lineTo(0.0f, 0.0f);
        path2.lineTo(AndroidUtilities.m1146dp(8.66f), AndroidUtilities.m1146dp(6.33f));
        path2.close();
        path3.moveTo(0.0f, -AndroidUtilities.m1146dp(6.33f));
        path3.lineTo(AndroidUtilities.m1146dp(8.66f), 0.0f);
        path3.lineTo(0.0f, AndroidUtilities.m1146dp(6.33f));
        path3.close();
        ...
        path.lineTo(0.0f, -AndroidUtilities.m1146dp(6.33f));
    ...
    public void draw(Canvas canvas) {
        ...
        float currentWidth = this.speedText.getCurrentWidth() + AndroidUtilities.m1146dp(46.0f);
        ...
        this.f1993t += fMin * Math.min(f3, 4.0f) * 1.5f;
        this.invalidate.run();
        float f4 = currentWidth / 2.0f;
        this.speedRect.set(bounds.centerX() - f4, bounds.top + AndroidUtilities.m1146dp(9.0f), bounds.centerX() + f4, bounds.top + AndroidUtilities.m1146dp(37.0f));
        canvas.save();
        float f5 = f * 0.4f;
        float f6 = 0.6f + f5;
        if (bounds.width() < AndroidUtilities.displaySize.x * 0.7f) {
            f6 *= 0.75f;
            if (this.isPiP) {
                canvas.translate(-AndroidUtilities.m1146dp(45.0f), 0.0f);
            }
        }
        canvas.scale(f6, f6, this.speedRect.centerX(), this.speedRect.top);
        canvas.translate(0.0f, (-AndroidUtilities.m1146dp(15.0f)) * (1.0f - f));
        ...
        canvas.save();
        float f7 = -f2;
        canvas.translate(((this.speedRect.centerX() - f4) + AndroidUtilities.m1146dp(9.0f)) - (AndroidUtilities.m1146dp(30.0f) * (1.0f - Math.max(0.0f, f7))), this.speedRect.centerY());
        this.arrowPaint.setColor(Theme.multAlpha(-1, Math.max(0.0f, f7) * f * ((((((float) Math.sin(this.f1993t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f)));
        canvas.drawPath(this.leftArrow, this.arrowPaint);
        canvas.translate(AndroidUtilities.m1146dp(10.66f), 0.0f);
        this.arrowPaint.setColor(Theme.multAlpha(-1, Math.max(0.0f, f7) * f * ((((((float) Math.sin((this.f1993t + 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f)));
        canvas.drawPath(this.leftArrow, this.arrowPaint);
        canvas.restore();
        canvas.save();
        canvas.translate(((-AndroidUtilities.m1146dp(28.0f)) / 2.0f) * f2, 0.0f);
        this.speedText.setAlpha((int) (f * 255.0f));
        this.speedText.draw(canvas);
        canvas.restore();
        canvas.save();
        canvas.translate(((this.speedRect.centerX() + f4) - AndroidUtilities.m1146dp(30.0f)) + (AndroidUtilities.m1146dp(30.0f) * (1.0f - Math.max(0.0f, f2))), this.speedRect.centerY());
        this.arrowPaint.setColor(Theme.multAlpha(-1, Math.max(0.0f, f2) * f * ((((((float) Math.sin(this.f1993t * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f)));
        canvas.drawPath(this.rightArrow, this.arrowPaint);
        canvas.translate(AndroidUtilities.m1146dp(10.66f), 0.0f);
        this.arrowPaint.setColor(Theme.multAlpha(-1, Math.max(0.0f, f2) * f * ((((((float) Math.sin((this.f1993t - 0.17f) * 3.141592653589793d)) / 2.0f) + 1.0f) * 0.75f) + 0.2f)));
        canvas.drawPath(this.rightArrow, this.arrowPaint);
        canvas.restore();
        canvas.restore();
        ...
        if (f8 > 0.0f) {
            if (this.hintDrawable == null) {
                RLottieDrawable rLottieDrawable = new RLottieDrawable(C2369R.raw.seek_speed_hint, "" + C2369R.raw.seek_speed_hint, AndroidUtilities.m1146dp(24.0f), AndroidUtilities.m1146dp(24.0f), true, null);
            ...
            float currentWidth2 = this.hintText.getCurrentWidth() + AndroidUtilities.m1146dp(54.0f);
            ...
            float fHeight = rectF3.top + (rectF3.height() * f) + AndroidUtilities.m1146dp(11.0f);
            float fCenterX2 = bounds.centerX() + f9;
            RectF rectF4 = this.speedRect;
            rectF2.set(fCenterX, fHeight, fCenterX2, rectF4.top + (rectF4.height() * f) + AndroidUtilities.m1146dp(11.0f) + fM1146dp);
            canvas.save();
            ...
            canvas.restore();
            canvas.drawRoundRect(this.hintRect, AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), this.backgroundPaint);
            this.hintDrawable.setBounds(((int) this.hintRect.left) + AndroidUtilities.m1146dp(11.0f), ((int) this.hintRect.centerY()) - (AndroidUtilities.m1146dp(24.0f) / 2), ((int) this.hintRect.left) + AndroidUtilities.m1146dp(35.0f), ((int) this.hintRect.centerY()) + (AndroidUtilities.m1146dp(24.0f) / 2));
            ...
            this.hintText.draw(canvas, this.hintRect.left + AndroidUtilities.m1146dp(39.0f), this.hintRect.centerY(), -1, f8);
            canvas.restore();
        }
    }
