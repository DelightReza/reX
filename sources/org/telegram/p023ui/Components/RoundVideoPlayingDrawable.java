...
public class RoundVideoPlayingDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            canvas.drawRect(AndroidUtilities.m1146dp(2.0f) + i2, AndroidUtilities.m1146dp((this.progress1 * 7.0f) + 2.0f) + i3, AndroidUtilities.m1146dp(4.0f) + i2, AndroidUtilities.m1146dp(10.0f) + i3, this.paint);
            canvas.drawRect(AndroidUtilities.m1146dp(5.0f) + i2, AndroidUtilities.m1146dp((this.progress2 * 7.0f) + 2.0f) + i3, AndroidUtilities.m1146dp(7.0f) + i2, AndroidUtilities.m1146dp(10.0f) + i3, this.paint);
            canvas.drawRect(AndroidUtilities.m1146dp(8.0f) + i2, AndroidUtilities.m1146dp((this.progress3 * 7.0f) + 2.0f) + i3, AndroidUtilities.m1146dp(10.0f) + i2, AndroidUtilities.m1146dp(10.0f) + i3, this.paint);
        }
        if (this.started) {
            update();
        }
