...
public class PermanentLinkBottomSheet extends BottomSheet {
    ...
    public PermanentLinkBottomSheet(Context context, boolean z, final BaseFragment baseFragment, final TLRPC.ChatFull chatFull, long j, boolean z2) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2369R.raw.shared_link_enter, "" + C2369R.raw.shared_link_enter, AndroidUtilities.m1146dp(90.0f), AndroidUtilities.m1146dp(90.0f), false, null);
        ...
        textView.setText(LocaleController.getString(C2369R.string.InviteLink));
        ...
        textView2.setText(LocaleController.getString(z2 ? C2369R.string.LinkInfoChannel : C2369R.string.LinkInfo));
        ...
        textView3.setText(LocaleController.getString(C2369R.string.ManageInviteLinks));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), Opcodes.ISHL)));
    ...
    public /* synthetic */ void lambda$new$2(TLRPC.ChatFull chatFull, BaseFragment baseFragment, View view) {
        ManageLinksActivity manageLinksActivity = new ManageLinksActivity(chatFull.f1572id, 0L, 0);
    ...
    public void updateColors() {
        ...
        int i = Theme.key_featuredStickers_addButton;
        rLottieImageView.setBackground(Theme.createCircleDrawable(iM1146dp, Theme.getColor(i)));
        this.manage.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i), Opcodes.ISHL)));
