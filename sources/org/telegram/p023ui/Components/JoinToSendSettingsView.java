...
public class JoinToSendSettingsView extends LinearLayout {
    ...
    public JoinToSendSettingsView(Context context, TLRPC.Chat chat) {
        ...
        headerCell.setText(LocaleController.getString(C2369R.string.ChannelSettingsJoinTitle));
        ...
        String string = LocaleController.getString(C2369R.string.ChannelSettingsJoinToSend);
        ...
        this.joinRequestCell.setTextAndCheck(LocaleController.getString(C2369R.string.ChannelSettingsJoinRequest), this.isJoinRequest, false);
        ...
        textInfoPrivacyCell.setText(LocaleController.getString(C2369R.string.ChannelSettingsJoinToSendInfo));
        addView(this.joinToSendInfoCell);
        TextInfoPrivacyCell textInfoPrivacyCell2 = new TextInfoPrivacyCell(context);
        this.joinRequestInfoCell = textInfoPrivacyCell2;
        textInfoPrivacyCell2.setText(LocaleController.getString(C2369R.string.ChannelSettingsJoinRequestInfo));
    ...
    private void updateToggleValue(float f) {
        ...
        float f2 = 1.0f - f;
        this.joinRequestCell.setTranslationY((-AndroidUtilities.m1146dp(16.0f)) * f2);
        this.joinRequestCell.setScaleY(1.0f - (0.1f * f2));
        int iM1146dp = this.joinRequestCell.getMeasuredHeight() <= 0 ? AndroidUtilities.m1146dp(50.0f) : this.joinRequestCell.getMeasuredHeight();
        this.joinToSendInfoCell.setAlpha(f2);
        float f3 = (-iM1146dp) * f2;
        this.joinToSendInfoCell.setTranslationY(((-AndroidUtilities.m1146dp(4.0f)) * f) + f3);
        this.joinRequestInfoCell.setAlpha(f);
        this.joinRequestInfoCell.setTranslationY(f3 + (AndroidUtilities.m1146dp(4.0f) * f2));
        requestLayout();
    }
