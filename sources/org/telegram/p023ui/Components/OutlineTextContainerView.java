...
public class OutlineTextContainerView extends FrameLayout {
    ...
    private static final SimpleFloatPropertyCompat ERROR_PROGRESS_PROPERTY = new SimpleFloatPropertyCompat("errorProgress", new SimpleFloatPropertyCompat.Getter() { // from class: org.telegram.ui.Components.OutlineTextContainerView$$ExternalSyntheticLambda4
        ...
        @Override // org.telegram.ui.Components.SimpleFloatPropertyCompat.Setter
        public final void set(Object obj, float f) {
            OutlineTextContainerView.m9999$r8$lambda$_HDnhwxl2YegjHeIRPL_ae39j8((OutlineTextContainerView) obj, f);
        }
    }).setMultiplier(100.0f);
    ...
    /* renamed from: $r8$lambda$_HDnhwxl2Y-egjHeIRPL_ae39j8, reason: not valid java name */
    public static /* synthetic */ void m9999$r8$lambda$_HDnhwxl2YegjHeIRPL_ae39j8(OutlineTextContainerView outlineTextContainerView, float f) {
    ...
    public OutlineTextContainerView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.strokeWidthRegular = Math.max(2, AndroidUtilities.m1146dp(0.5f));
        this.strokeWidthSelected = AndroidUtilities.m1146dp(1.6667f);
        ...
        updateColor();
        setPadding(0, AndroidUtilities.m1146dp(6.0f), 0, 0);
    }
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        float paddingTop = getPaddingTop() + ((this.textPaint.getTextSize() / 2.0f) - AndroidUtilities.m1146dp(1.75f));
        ...
        canvas.save();
        this.rect.set(getPaddingLeft() + AndroidUtilities.m1146dp(10.0f), getPaddingTop(), (getWidth() - AndroidUtilities.m1146dp(18.0f)) - getPaddingRight(), getPaddingTop() + (strokeWidth * 2.0f));
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), this.outlinePaint);
        canvas.restore();
        float paddingLeft = getPaddingLeft() + AndroidUtilities.m1146dp(10.0f);
        float paddingTop2 = getPaddingTop() + strokeWidth;
        float f4 = paddingLeft + (fMeasureText / 2.0f);
        canvas.drawLine(((((paddingLeft + fMeasureText) + AndroidUtilities.m1146dp(10.0f)) - f4) * (z ? this.titleProgress : 1.0f)) + f4, paddingTop2, ((getWidth() - strokeWidth) - getPaddingRight()) - AndroidUtilities.m1146dp(6.0f), paddingTop2, this.outlinePaint);
        float fM1146dp = f4 + AndroidUtilities.m1146dp(4.0f);
        canvas.drawLine(paddingLeft, paddingTop2, fM1146dp + ((paddingLeft - fM1146dp) * (z ? this.titleProgress : 1.0f)), paddingTop2, this.outlinePaint);
        canvas.save();
        canvas.scale(f3, f3, getPaddingLeft() + AndroidUtilities.m1146dp(18.0f), f);
        canvas.drawText(this.mText, getPaddingLeft() + AndroidUtilities.m1146dp(14.0f) + f2, f, this.textPaint);
        canvas.restore();
    }
}
