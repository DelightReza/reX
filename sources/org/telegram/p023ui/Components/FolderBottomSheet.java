...
import org.telegram.p023ui.FiltersSetupActivity;
...
public class FolderBottomSheet extends BottomSheetWithRecyclerListView {
    ...
    public static void showForDeletion(final BaseFragment baseFragment, final int i, final Utilities.Callback callback) {
        ...
        final Runnable runnable = new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda11
        ...
        if (dialogFilter != null && dialogFilter.isMyChatlist()) {
            AlertDialog alertDialogCreate = new AlertDialog.Builder(baseFragment.getContext()).setTitle(LocaleController.getString(C2369R.string.FilterDelete)).setMessage(LocaleController.getString(C2369R.string.FilterDeleteAlertLinks)).setNegativeButton(LocaleController.getString(C2369R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda12
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i3) {
                    FolderBottomSheet.m9471$r8$lambda$lp5dkVKpHmrmggBQ9OGJZjkB5o(callback, alertDialog, i3);
                }
            }).setPositiveButton(LocaleController.getString(C2369R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda13
                @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                public final void onClick(AlertDialog alertDialog, int i3) {
                    runnable.run();
                }
        ...
        baseFragment.getConnectionsManager().sendRequest(tL_chatlists_getLeaveChatlistSuggestions, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda20
            ...
            public final void run(TLObject tLObject, TLRPC.TL_error tL_error) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda21
                    @Override // java.lang.Runnable
                    public final void run() {
                        FolderBottomSheet.m9469$r8$lambda$cCDM0O0ir7WgxsrczN4I5ZeImM(baseFragment, tLObject, i, callback);
                    }
                });
            }
        });
    ...
    /* renamed from: $r8$lambda$cCDM0O0ir7WgxsrczN4I5-ZeImM, reason: not valid java name */
    public static /* synthetic */ void m9469$r8$lambda$cCDM0O0ir7WgxsrczN4I5ZeImM(BaseFragment baseFragment, TLObject tLObject, int i, Utilities.Callback callback) {
    ...
    /* renamed from: $r8$lambda$lp5dkVKpHmrmggBQ9OG-JZjkB5o, reason: not valid java name */
    public static /* synthetic */ void m9471$r8$lambda$lp5dkVKpHmrmggBQ9OGJZjkB5o(Utilities.Callback callback, AlertDialog alertDialog, int i) {
        if (callback != null) {
    ...
    public FolderBottomSheet(BaseFragment baseFragment, int i, TL_chatlists.TL_chatlists_chatlistUpdates tL_chatlists_chatlistUpdates) {
        ...
        if (arrayList2 != null) {
            while (true) {
                ...
                if (arrayList2.get(i2).f1454id == i) {
        ...
        if (chatlist_chatlistinvite instanceof TL_chatlists.TL_chatlists_chatlistInvite) {
            ...
            if (arrayList2 != null) {
                while (true) {
                    ...
                    if (dialogFilter.f1454id == this.filterId) {
                        this.title = dialogFilter.name;
                        this.titleEntities = dialogFilter.entities;
                        this.titleNoanimate = dialogFilter.title_noanimate;
                        break;
    ...
    private void init() {
        ...
        this.recyclerListView.setPadding(AndroidUtilities.m1146dp(6.0f), 0, AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(this.button != null ? 68.0f : 0.0f));
                ...
                if (parentLayout != null) {
                    ...
                    if (this.updates != null) {
                        ...
                        callback = new Utilities.Callback() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda7
                            @Override // org.telegram.messenger.Utilities.Callback
                            public final void run(Object obj) {
                                FolderBottomSheet.m9463$r8$lambda$LnLGAcIF3RNRFVPwgtxewCpCVw(parentLayout, callback2, (Integer) obj);
                            }
                        };
                    }
                    int i3 = 0;
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$6(BaseFragment baseFragment, ArrayList arrayList) {
        this.reqId = -1;
        BulletinFactory.m1267of(baseFragment).createSimpleBulletin(C2369R.raw.ic_delete, LocaleController.formatString(C2369R.string.FolderLinkDeletedTitle, this.title), LocaleController.formatPluralString("FolderLinkDeletedSubtitle", arrayList.size(), new Object[0])).setDuration(5000).show();
        this.success = true;
        lambda$new$0();
        getBaseFragment().getMessagesController().invalidateChatlistFolderUpdate(this.filterId);
    }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$10(TLObject tLObject, final Pair pair) {
        this.reqId = getBaseFragment().getConnectionsManager().sendRequest(tLObject, new RequestDelegate() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda9
            @Override // org.telegram.tgnet.RequestDelegate
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$11(ArrayList arrayList, BaseFragment baseFragment) {
        ...
        if (this.updates != null || (this.invite instanceof TL_chatlists.TL_chatlists_chatlistInviteAlready)) {
            ...
            int i = C2369R.raw.folder_in;
            SpannableStringBuilder spannableStringBuilderReplaceTags = AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.FolderLinkUpdatedTitle, this.escapedTitle));
            if (arrayList.size() <= 0) {
            ...
            bulletinFactoryM1267of.createSimpleBulletin(i, spannableStringBuilderReplaceTags, pluralString).setDuration(5000).show();
            return;
        }
        BulletinFactory.m1267of(baseFragment).createSimpleBulletin(C2369R.raw.contact_check, AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.FolderLinkAddedTitle, this.escapedTitle)), LocaleController.formatPluralString("FolderLinkAddedSubtitle", arrayList.size(), new Object[0])).setDuration(5000).show();
    }

    /* renamed from: $r8$lambda$LnLGAcIF3RNRFVPwgtxe-wCpCVw, reason: not valid java name */
    public static /* synthetic */ void m9463$r8$lambda$LnLGAcIF3RNRFVPwgtxewCpCVw(INavigationLayout iNavigationLayout, final Utilities.Callback callback, final Integer num) {
        ...
        if (baseFragment instanceof DialogsActivity) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda16
                @Override // java.lang.Runnable
                public final void run() {
                    FolderBottomSheet.$r8$lambda$9JxFwf3jckGVRUOp9bth4TFA8Io(dialogsActivity, num, callback, baseFragment);
                }
            }, 80L);
            return;
        }
    ...
    public /* synthetic */ void lambda$onJoinButtonClicked$17(TLRPC.TL_error tL_error, TLObject tLObject, final Utilities.Callback callback) {
        ...
        this.reqId = -1;
        int i2 = 0;
        if (FilterCreateActivity.processErrors(tL_error, getBaseFragment(), BulletinFactory.m1267of(getBaseFragment())) && tLObject != null) {
            if (tLObject instanceof TLRPC.Updates) {
                ...
                if (arrayList.isEmpty()) {
                    ...
                    if (update instanceof TLRPC.TL_updateDialogFilter) {
                        i = ((TLRPC.TL_updateDialogFilter) update).f1723id;
                    }
                } else {
                    while (true) {
                        ...
                        if (arrayList.get(i2) instanceof TLRPC.TL_updateDialogFilter) {
                            i = ((TLRPC.TL_updateDialogFilter) arrayList.get(i2)).f1723id;
                            break;
                        }
                        i2++;
                    }
            ...
            if (this.alreadyJoined.contains(Long.valueOf(peerDialogId))) {
                ...
                if (peerDialogId >= 0) {
                    ...
                    if (ChatObject.isChannelAndNotMegaGroup(chat)) {
                        string = LocaleController.getString(C2369R.string.FolderLinkAlreadySubscribed);
                    } else {
                        string = LocaleController.getString(C2369R.string.FolderLinkAlreadyJoined);
                    }
                    arrayList.add(chat);
                    str = string;
                }
                if (this.lastClickedDialogId != peerDialogId || System.currentTimeMillis() - this.lastClicked > 1500) {
                    ...
                    BulletinFactory.m1266of(this.bulletinContainer, null).createChatsBulletin(arrayList, str, null).setDuration(1500).show();
                    return;
                }
                return;
            }
    ...
    public void updateCount(boolean z) {
        ...
        if (button != null) {
            if (this.deleting) {
                button.setText(LocaleController.getString(size > 0 ? C2369R.string.FolderLinkButtonRemoveChats : C2369R.string.FolderLinkButtonRemove), z);
            } else {
                ArrayList arrayList = this.peers;
                if (arrayList == null || arrayList.isEmpty()) {
                    this.button.setText(LocaleController.getString(C2369R.string.f1459OK), z);
                } else {
                    if (this.invite instanceof TL_chatlists.TL_chatlists_chatlistInvite) {
                        this.button.setText(LocaleController.formatSpannable(C2369R.string.FolderLinkButtonAdd, MessageObject.replaceAnimatedEmoji(Emoji.replaceEmoji(this.title, this.button.getTextPaint().getFontMetricsInt(), false), this.titleEntities, this.button.getTextPaint().getFontMetricsInt())), z);
                        this.button.setEmojiCacheType(this.titleNoanimate ? 26 : 0);
                    } else {
                        this.button.setText(size > 0 ? LocaleController.formatPluralString("FolderLinkButtonJoinPlural", size, new Object[0]) : LocaleController.getString(C2369R.string.FolderLinkButtonNone), z);
                    }
                }
            }
    ...
    static class Button extends FrameLayout {
        ...
        public Button(Context context, String str) {
            ...
            ShapeDrawable shapeDrawableCreateRoundRectDrawable = Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), Theme.getColor(i));
            ...
            this.text.setTextSize(AndroidUtilities.m1146dp(14.0f));
            ...
            this.countText.setTextSize(AndroidUtilities.m1146dp(12.0f));
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (f < 1.0f) {
                ...
                float fM1146dp = ((AndroidUtilities.m1146dp(15.66f) + this.countText.getCurrentWidth()) * f2) + currentWidth;
                Rect rect = AndroidUtilities.rectTmp2;
                rect.set((int) (((getMeasuredWidth() - fM1146dp) - getWidth()) / 2.0f), (int) (((getMeasuredHeight() - this.text.getHeight()) / 2.0f) - AndroidUtilities.m1146dp(1.0f)), (int) ((((getMeasuredWidth() - fM1146dp) + getWidth()) / 2.0f) + currentWidth), (int) (((getMeasuredHeight() + this.text.getHeight()) / 2.0f) - AndroidUtilities.m1146dp(1.0f)));
                ...
                rect.set((int) (((getMeasuredWidth() - fM1146dp) / 2.0f) + currentWidth + AndroidUtilities.m1146dp(5.0f)), (int) ((getMeasuredHeight() - AndroidUtilities.m1146dp(18.0f)) / 2.0f), (int) (((getMeasuredWidth() - fM1146dp) / 2.0f) + currentWidth + AndroidUtilities.m1146dp(13.0f) + Math.max(AndroidUtilities.m1146dp(9.0f), this.countText.getCurrentWidth())), (int) ((getMeasuredHeight() + AndroidUtilities.m1146dp(18.0f)) / 2.0f));
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(10.0f), AndroidUtilities.m1146dp(10.0f), this.paint);
                rect.offset(-AndroidUtilities.m1146dp(0.3f), -AndroidUtilities.m1146dp(0.4f));
    ...
    protected CharSequence getTitle() {
        if (this.deleting) {
            return LocaleController.getString(C2369R.string.FolderLinkTitleRemove);
        }
        if (this.invite instanceof TL_chatlists.TL_chatlists_chatlistInvite) {
            return LocaleController.getString(C2369R.string.FolderLinkTitleAdd);
        }
        ArrayList arrayList = this.peers;
        if (arrayList == null || arrayList.isEmpty()) {
            return LocaleController.getString(C2369R.string.FolderLinkTitleAlready);
        }
        return LocaleController.getString(C2369R.string.FolderLinkTitleAddChats);
    }

    /* renamed from: org.telegram.ui.Components.FolderBottomSheet$1 */
    class C38721 extends RecyclerListView.SelectionAdapter {
        C38721() {
        }
        ...
        */
        public void onBindViewHolder(androidx.recyclerview.widget.RecyclerView.ViewHolder r11, int r12) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.FolderBottomSheet.C38721.onBindViewHolder(androidx.recyclerview.widget.RecyclerView$ViewHolder, int):void");
        }
    ...
    public static class HeaderCell extends FrameLayout {
        ...
        public HeaderCell(Context context) {
            ...
            this.actionTextView.setTextSize(AndroidUtilities.m1146dp(15.0f));
        ...
        public void setAction(CharSequence charSequence, final Runnable runnable) {
            ...
            this.actionTextView.setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.FolderBottomSheet$HeaderCell$$ExternalSyntheticLambda0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    FolderBottomSheet.HeaderCell.m9503$r8$lambda$kFktNU1EJbYmEg4fSZvDobQYVY(runnable, view);
                }
            });
        }

        /* renamed from: $r8$lambda$kFktNU1EJbYmEg4fSZ-vDobQYVY, reason: not valid java name */
        public static /* synthetic */ void m9503$r8$lambda$kFktNU1EJbYmEg4fSZvDobQYVY(Runnable runnable, View view) {
            if (runnable != null) {
                runnable.run();
            }
        }
    ...
    private class TitleCell extends FrameLayout {
        ...
        public TitleCell(Context context, boolean z, CharSequence charSequence, ArrayList arrayList, boolean z2) {
            super(context);
            this.already = z;
            FoldersPreview foldersPreview = new FoldersPreview(context, null, LocaleController.getString(C2369R.string.FolderLinkPreviewLeft), charSequence == null ? "" : new SpannableStringBuilder(charSequence), arrayList, z2, LocaleController.getString(C2369R.string.FolderLinkPreviewRight), null);
            ...
            this.titleTextView.setLineSpacing(AndroidUtilities.m1146dp(-1.0f), 1.0f);
        ...
        public void setSelectedCount(int i, boolean z) {
            if (FolderBottomSheet.this.deleting) {
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatSpannable(C2369R.string.FolderLinkSubtitleRemove, this.title)));
                return;
            }
            if (this.already) {
                ...
                if (FolderBottomSheet.this.peers == null || FolderBottomSheet.this.peers.isEmpty()) {
                    this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatSpannable(C2369R.string.FolderLinkSubtitleAlready, this.title)));
                    return;
                } else {
            ...
            if (FolderBottomSheet.this.peers == null || FolderBottomSheet.this.peers.isEmpty()) {
                ...
                this.subtitleTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatSpannable(C2369R.string.FolderLinkSubtitle, this.title)));
            }
        }

        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(172.0f), TLObject.FLAG_30));
        }
        ...
        private class FoldersPreview extends View {
            ...
            public FoldersPreview(Context context, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, ArrayList arrayList, boolean z, CharSequence charSequence4, CharSequence charSequence5) {
                ...
                this.paint.setTextSize(AndroidUtilities.m1146dp(15.33f));
                ...
                this.selectedTextPaint.setTextSize(AndroidUtilities.m1146dp(17.0f));
                ...
                this.countText.setCallback(this);
                this.countText.setTextSize(AndroidUtilities.m1146dp(11.66f));
                ...
                float fM1146dp2 = AndroidUtilities.m1146dp(1.0f);
                fArr2[7] = fM1146dp2;
                fArr2[6] = fM1146dp2;
                fArr2[5] = fM1146dp2;
                fArr2[4] = fM1146dp2;
                Shader.TileMode tileMode = Shader.TileMode.CLAMP;
                LinearGradient linearGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1146dp(80.0f), 0.0f, new int[]{-1, 16777215}, new float[]{0.0f, 1.0f}, tileMode);
                this.leftGradient = linearGradient;
                this.leftPaint.setShader(linearGradient);
                Paint paint = this.leftPaint;
                PorterDuff.Mode mode = PorterDuff.Mode.DST_OUT;
                paint.setXfermode(new PorterDuffXfermode(mode));
                LinearGradient linearGradient2 = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1146dp(80.0f), 0.0f, new int[]{16777215, -1}, new float[]{0.0f, 1.0f}, tileMode);
            ...
            private CharSequence normalizeTitle(CharSequence charSequence) {
                return (charSequence == null || "ALL_CHATS".equals(charSequence.toString())) ? LocaleController.getString(C2369R.string.FilterAllChats) : charSequence;
            }
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (this.middleFolder != null) {
                    canvas.save();
                    currentWidth = this.middleFolder.getCurrentWidth() + (isCountEmpty() ? 0.0f : AndroidUtilities.m1146dp(15.32f) + this.countText.getCurrentWidth());
                ...
                if (!isCountEmpty()) {
                    Rect rect = AndroidUtilities.rectTmp2;
                    rect.set((int) (this.middleFolder.getCurrentWidth() + f + AndroidUtilities.m1146dp(4.66f)), (int) (measuredHeight - AndroidUtilities.m1146dp(9.0f)), (int) (this.middleFolder.getCurrentWidth() + f + AndroidUtilities.m1146dp(15.32f) + this.countText.getCurrentWidth()), (int) (AndroidUtilities.m1146dp(9.0f) + measuredHeight));
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(rect);
                    canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(9.0f), AndroidUtilities.m1146dp(9.0f), this.selectedPaint);
                    rect.offset(-AndroidUtilities.m1146dp(0.33f), -AndroidUtilities.m1146dp(0.66f));
                    this.countText.setBounds(rect);
                    this.countText.draw(canvas);
                }
                float fM1146dp = AndroidUtilities.m1146dp(30.0f);
                float currentWidth3 = (f - fM1146dp) - this.leftFolder.getCurrentWidth();
                if (this.leftFolder2 == null || this.leftFolder.getCurrentWidth() >= AndroidUtilities.m1146dp(64.0f)) {
                    currentWidth2 = currentWidth3;
                } else {
                    currentWidth2 = currentWidth3 - (this.leftFolder2.getCurrentWidth() + fM1146dp);
                    canvas.save();
                    canvas.translate(currentWidth2, (measuredHeight - (this.leftFolder2.getHeight() / 2.0f)) + AndroidUtilities.m1146dp(1.0f));
                    this.leftFolder2.draw(canvas);
                    canvas.restore();
                }
                if (this.leftFolder != null) {
                    canvas.save();
                    canvas.translate(currentWidth3, (measuredHeight - (this.leftFolder.getHeight() / 2.0f)) + AndroidUtilities.m1146dp(1.0f));
                ...
                if (this.rightFolder != null) {
                    canvas.save();
                    canvas.translate(currentWidth4 + fM1146dp, (measuredHeight - (this.rightFolder.getHeight() / 2.0f)) + AndroidUtilities.m1146dp(1.0f));
                    this.rightFolder.draw(canvas);
                    canvas.restore();
                    currentWidth4 += this.rightFolder.getCurrentWidth() + fM1146dp;
                }
                if (this.rightFolder2 != null && this.rightFolder.getCurrentWidth() < AndroidUtilities.m1146dp(64.0f)) {
                    canvas.save();
                    canvas.translate(currentWidth4 + fM1146dp, (measuredHeight - (this.rightFolder2.getHeight() / 2.0f)) + AndroidUtilities.m1146dp(1.0f));
                    this.rightFolder2.draw(canvas);
                    canvas.restore();
                    currentWidth4 += fM1146dp + this.rightFolder2.getCurrentWidth();
                }
                float height = measuredHeight + (this.middleFolder.getHeight() / 2.0f) + AndroidUtilities.m1146dp(12.0f);
                canvas.drawRect(0.0f, height, getMeasuredWidth(), height + 1.0f, this.paint);
                this.path.rewind();
                RectF rectF2 = AndroidUtilities.rectTmp;
                float f2 = currentWidth / 2.0f;
                float f3 = f2 + measuredWidth;
                rectF2.set((measuredWidth - f2) - AndroidUtilities.m1146dp(4.0f), height - AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f) + f3, height);
                this.path.addRoundRect(rectF2, this.radii, Path.Direction.CW);
                canvas.drawPath(this.path, this.selectedPaint);
                canvas.save();
                float fMax = Math.max(AndroidUtilities.m1146dp(8.0f), currentWidth2);
                this.leftMatrix.reset();
                this.leftMatrix.postTranslate(Math.min(f, fMax + AndroidUtilities.m1146dp(8.0f)), 0.0f);
                this.leftGradient.setLocalMatrix(this.leftMatrix);
                float fMin = Math.min(getMeasuredWidth() - AndroidUtilities.m1146dp(8.0f), currentWidth4);
                this.rightMatrix.reset();
                this.rightMatrix.postTranslate(Math.max(f3, fMin - AndroidUtilities.m1146dp(88.0f)), 0.0f);
    ...
    public void updateHeaderCell(boolean z) {
        ...
        if (arrayList != null && arrayList.size() - this.alreadyJoined.size() > 1) {
            ...
            this.headerCell.setAction(LocaleController.getString(z2 ? C2369R.string.DeselectAll : C2369R.string.SelectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private void deselectAll(final HeaderCell headerCell, final boolean z) {
        ...
        updateCount(true);
        headerCell.setAction(LocaleController.getString(z ? C2369R.string.SelectAll : C2369R.string.DeselectAll), new Runnable() { // from class: org.telegram.ui.Components.FolderBottomSheet$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
