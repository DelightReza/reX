...
public class PhotoCropView extends FrameLayout {
    ...
    public PhotoCropView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cropView.setBottomPadding(AndroidUtilities.m1146dp(64.0f));
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        ...
        if (this.thumbImageVisible && view == (cropView = this.cropView)) {
            ...
            int videoThumbX = (this.delegate.getVideoThumbX() - (iM1146dp / 2)) + AndroidUtilities.m1146dp(2.0f);
            int measuredHeight = getMeasuredHeight() - AndroidUtilities.m1146dp(156.0f);
            ...
            float fWidth = actualRect.width() + ((iM1146dp - actualRect.width()) * this.thumbAnimationProgress);
            ...
            canvas.drawCircle(videoThumbX + r1, measuredHeight + iM1146dp + AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(3.0f), this.circlePaint);
        }
        return zDrawChild;
    }
    ...
    public float getRectX() {
        return this.cropView.getCropLeft() - AndroidUtilities.m1146dp(14.0f);
    }

    public float getRectY() {
        return (this.cropView.getCropTop() - AndroidUtilities.m1146dp(14.0f)) - (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0);
    }
