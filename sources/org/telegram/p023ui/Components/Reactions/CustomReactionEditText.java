...
public abstract class CustomReactionEditText extends EditTextCaption {
    ...
    public CustomReactionEditText(Context context, Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        setTextSize(1, 22.0f);
        setGravity(80);
        setPadding(AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(12.0f));
    ...
    protected void extendActionMode(ActionMode actionMode, Menu menu) {
        menu.clear();
        int i = C2369R.id.menu_delete;
        menu.add(i, i, 0, LocaleController.getString(C2369R.string.Delete));
    }
