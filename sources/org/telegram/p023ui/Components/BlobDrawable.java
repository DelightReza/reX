...
public class BlobDrawable {
    ...
    public BlobDrawable(int i, int i2) {
        ...
        this.f1840m = new Matrix();
        this.f1839N = i;
        this.f1838L = (float) (Math.tan(3.141592653589793d / (r0 * 2.0f)) * 1.3333333333333333d);
        ...
        for (int i3 = 0; i3 < this.f1839N; i3++) {
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        while (true) {
            ...
            if (f3 < f4) {
                ...
                float fMin = this.f1838L * (Math.min(f9, f11) + ((Math.max(f9, f11) - Math.min(f9, f11)) / 2.0f)) * this.cubicBezierK;
                this.f1840m.reset();
                this.f1840m.setRotate(f13, f, f2);
                ...
                fArr7[3] = f16;
                this.f1840m.reset();
                this.f1840m.setRotate(f14, f, f2);
                this.f1840m.mapPoints(this.pointEnd);
                if (i == 0) {
                    Path path = this.path;
