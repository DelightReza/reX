...
public class CounterView extends View {
    ...
    public static class CounterDrawable {
        ...
        private void drawInternal(Canvas canvas) {
            ...
            float fM1146dp = (this.lastH - AndroidUtilities.m1146dp(f)) / 2.0f;
            updateX(this.countWidth);
            RectF rectF = this.rectF;
            float f2 = this.f1857x;
            rectF.set(f2, fM1146dp, this.countWidth + f2 + AndroidUtilities.m1146dp(this.radius - 0.5f), AndroidUtilities.m1146dp(f) + fM1146dp);
            ...
            if (this.countLayout != null) {
                canvas.save();
                canvas.translate(this.countLeft, fM1146dp + AndroidUtilities.m1146dp(4.0f));
        ...
        public void setText(CharSequence charSequence, boolean z, int i, boolean z2) {
            ...
            if (!z3) {
                ...
                this.countWidth = Math.max(AndroidUtilities.m1146dp(12.0f), (int) Math.ceil(this.textPaint.measureText(charSequence.toString())));
            ...
            if (z3) {
                ...
                if (this.countLayout != null) {
                    ...
                    if (charSequence2.length() == charSequence.length() && !z2) {
                        ...
                        int iMax = Math.max(AndroidUtilities.m1146dp(12.0f), (int) Math.ceil(this.textPaint.measureText(charSequence2.toString())));
        ...
        public void draw(Canvas canvas) {
            ...
            if (f2 != 1.0f) {
                ...
                float fM1146dp = (this.lastH - AndroidUtilities.m1146dp(this.radius * 2.0f)) / 2.0f;
                ...
                RectF rectF = this.rectF;
                float f9 = this.f1857x;
                rectF.set(f9, fM1146dp, f7 + f9 + AndroidUtilities.m1146dp(this.radius - 0.5f), AndroidUtilities.m1146dp(this.radius * 2.0f) + fM1146dp);
                canvas.save();
                ...
                if (this.countAnimationInLayout != null) {
                    ...
                    float fM1146dp2 = AndroidUtilities.m1146dp(4.0f) + fM1146dp;
                    int iM1146dp = AndroidUtilities.m1146dp(13.0f);
                    if (!z2) {
                        iM1146dp = -iM1146dp;
                    }
                    canvas.translate(f15, fM1146dp2 + (iM1146dp * (1.0f - f6)));
                    ...
                    float fM1146dp3 = AndroidUtilities.m1146dp(4.0f) + fM1146dp;
                    int iM1146dp2 = AndroidUtilities.m1146dp(13.0f);
                    if (!z2) {
                        iM1146dp2 = -iM1146dp2;
                    }
                    canvas.translate(f16, fM1146dp3 + (iM1146dp2 * (1.0f - f6)));
                    this.textPaint.setAlpha((int) (f6 * 255.0f));
                    this.countLayout.draw(canvas);
                    canvas.restore();
                }
                if (this.countOldLayout != null) {
                    canvas.save();
                    canvas.translate(this.countLeft, AndroidUtilities.m1146dp(4.0f) + fM1146dp + ((z2 ? -AndroidUtilities.m1146dp(13.0f) : AndroidUtilities.m1146dp(13.0f)) * f6));
        ...
        public void updateBackgroundRect() {
            ...
            if (f != 1.0f) {
                ...
                if (i == 0 || i == 1) {
                    ...
                    RectF rectF = this.rectF;
                    float f2 = this.f1857x;
                    rectF.set(f2, fM1146dp, this.countWidth + f2 + AndroidUtilities.m1146dp(11.0f), AndroidUtilities.m1146dp(23.0f) + fM1146dp);
                    return;
                }
                float f3 = f * 2.0f;
                if (f3 > 1.0f) {
                ...
                float fM1146dp2 = (this.lastH - AndroidUtilities.m1146dp(this.radius * 2.0f)) / 2.0f;
                int i2 = this.countWidth;
                int i3 = this.countWidthOld;
                float f4 = i2 == i3 ? i2 : (i2 * f3) + (i3 * (1.0f - f3));
                updateX(f4);
                RectF rectF2 = this.rectF;
                float f5 = this.f1857x;
                rectF2.set(f5, fM1146dp2, f4 + f5 + AndroidUtilities.m1146dp(11.0f), AndroidUtilities.m1146dp(23.0f) + fM1146dp2);
                return;
            }
            updateX(this.countWidth);
            float fM1146dp3 = (this.lastH - AndroidUtilities.m1146dp(this.radius * 2.0f)) / 2.0f;
            RectF rectF3 = this.rectF;
            float f6 = this.f1857x;
            rectF3.set(f6, fM1146dp3, this.countWidth + f6 + AndroidUtilities.m1146dp(11.0f), AndroidUtilities.m1146dp(23.0f) + fM1146dp3);
        }

        private void updateX(float f) {
            float fM1146dp = this.drawBackground ? AndroidUtilities.m1146dp(5.5f) : 0.0f;
            int i = this.gravity;
            if (i == 5) {
                float f2 = this.width - fM1146dp;
                this.countLeft = f2;
                ...
                this.countLeft = fM1146dp;
            } else {
                this.countLeft = (int) ((this.width - f) / 2.0f);
            }
            this.f1857x = this.countLeft - fM1146dp;
        }
        ...
        public int getWidth() {
            ...
            return this.countWidth + AndroidUtilities.m1146dp(this.radius - 0.5f);
        }
    }
