...
public class VoipCoverEmoji {
    ...
    public VoipCoverEmoji(TLRPC.User user, final View view, int i) {
        ...
        this.fromRandomX = this.toRandomX + AndroidUtilities.m1146dp(12.0f);
        this.fromRandomY = this.toRandomY + AndroidUtilities.m1146dp(12.0f);
        this.toRandomX = Utilities.random.nextInt(AndroidUtilities.m1146dp(16.0f)) + AndroidUtilities.m1146dp(12.0f);
        this.toRandomY = Utilities.random.nextInt(AndroidUtilities.m1146dp(16.0f)) + AndroidUtilities.m1146dp(12.0f);
        ...
        this.positionAnimator.addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.VoipCoverEmoji.1
            ...
            public void onAnimationEnd(Animator animator, boolean z) {
                ...
                VoipCoverEmoji.this.toRandomX = Utilities.random.nextInt(AndroidUtilities.m1146dp(16.0f)) + AndroidUtilities.m1146dp(12.0f);
                VoipCoverEmoji.this.toRandomY = Utilities.random.nextInt(AndroidUtilities.m1146dp(16.0f)) + AndroidUtilities.m1146dp(12.0f);
    ...
    private void show() {
        ...
        this.isShown = true;
        final int i = 12;
        this.diffX = this.posX > getCenterX() ? AndroidUtilities.m1146dp(12) : -AndroidUtilities.m1146dp(12);
        ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(0.0f, 1.0f);
    ...
    public /* synthetic */ void lambda$show$2(int i, int i2, ValueAnimator valueAnimator) {
        ...
        ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(AndroidUtilities.m1146dp(i), 0);
    ...
    public void onDraw(Canvas canvas) {
        ...
        canvas.save();
        float f = this.scale;
        canvas.scale(f, f, this.width / 2.0f, AndroidUtilities.m1146dp(300.0f));
