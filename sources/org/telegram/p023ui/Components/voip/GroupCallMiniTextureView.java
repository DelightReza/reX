...
public class GroupCallMiniTextureView extends FrameLayout implements GroupCallStatusIcon.Callback {
    ...
    public GroupCallMiniTextureView(final GroupCallRenderersContainer groupCallRenderersContainer, ArrayList arrayList, final ChatObject.Call call, final GroupCallActivity groupCallActivity) {
        ...
        CrossOutDrawable crossOutDrawable = new CrossOutDrawable(groupCallRenderersContainer.getContext(), C2369R.drawable.calls_video, -1);
        this.pausedVideoDrawable = crossOutDrawable;
        crossOutDrawable.setCrossOut(true, false);
        this.pausedVideoDrawable.setOffsets(-AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f));
        this.pausedVideoDrawable.setStrokeWidth(AndroidUtilities.dpf2(3.4f));
        this.castingScreenDrawable = groupCallRenderersContainer.getContext().getResources().getDrawable(C2369R.drawable.screencast_big).mutate();
        ...
        final String string = LocaleController.getString(C2369R.string.VoipVideoOnPause);
        String string2 = LocaleController.getString(C2369R.string.VoipVideoScreenSharingTwoLines);
        int iM1146dp = AndroidUtilities.m1146dp(400.0f);
        Layout.Alignment alignment = Layout.Alignment.ALIGN_CENTER;
        final StaticLayout staticLayout = new StaticLayout(string2, textPaint, iM1146dp, alignment, 1.0f, 0.0f, false);
        TLRPC.Chat chat = MessagesController.getInstance(this.currentAccount).getChat(Long.valueOf(call.chatId));
        final StaticLayout staticLayout2 = new StaticLayout(LocaleController.formatString("VoipVideoNotAvailable", C2369R.string.VoipVideoNotAvailable, LocaleController.formatPluralString("Participants", MessagesController.getInstance(this.currentAccount).groupCallVideoMaxParticipants, new Object[0])), textPaint, AndroidUtilities.m1146dp(400.0f), alignment, 1.0f, 0.0f, false);
        final String string3 = LocaleController.getString(C2369R.string.VoipVideoScreenSharing);
        ...
        VoIPTextureView voIPTextureView = new VoIPTextureView(groupCallRenderersContainer.getContext(), false, false, true, true) { // from class: org.telegram.ui.Components.voip.GroupCallMiniTextureView.1
            ...
            @Override // org.telegram.p023ui.Components.voip.VoIPTextureView
            ...
            @Override // org.telegram.p023ui.Components.voip.VoIPTextureView, android.view.ViewGroup, android.view.View
            protected void dispatchDraw(Canvas canvas) {
                ...
                if (!this.renderer.isFirstFrameRendered() || (!(this.renderer.getAlpha() == 1.0f || this.blurRenderer.getAlpha() == 1.0f) || GroupCallMiniTextureView.this.videoIsPaused)) {
                    ...
                    if (videoParticipant == call.videoNotAvailableParticipant) {
                        if (groupCallMiniTextureView4.showingInFullscreen || !groupCallRenderersContainer.inFullscreenMode) {
                            float fM1146dp2 = AndroidUtilities.m1146dp(48.0f);
                            textPaint.setAlpha(255);
                            canvas.save();
                            canvas.translate((((getMeasuredWidth() - fM1146dp2) / 2.0f) - (AndroidUtilities.m1146dp(400.0f) / 2.0f)) + (fM1146dp2 / 2.0f), ((getMeasuredHeight() / 2) - fM1146dp2) + fM1146dp2 + AndroidUtilities.m1146dp(10.0f));
                        ...
                        int iM1146dp2 = AndroidUtilities.m1146dp(33.0f);
                        ...
                        if (groupCallMiniTextureView5.animateToFullscreen || groupCallMiniTextureView5.showingInFullscreen) {
                            f4 = iM1146dp2;
                            fM1146dp = AndroidUtilities.m1146dp(10.0f) + (AndroidUtilities.m1146dp(39.0f) * groupCallRenderersContainer.progressToFullscreenMode);
                        } else {
                            f4 = iM1146dp2;
                            fM1146dp = AndroidUtilities.m1146dp(10.0f) * Math.max(1.0f - groupCallRenderersContainer.progressToFullscreenMode, (GroupCallMiniTextureView.this.showingAsScrimView || GroupCallMiniTextureView.this.animateToScrimView) ? groupCallRenderersContainer.progressToScrimView : 0.0f);
                        }
                        int i = (int) (f4 + fM1146dp);
                        ...
                        float measuredHeight = ((getMeasuredHeight() - i) / 2) - AndroidUtilities.m1146dp(28.0f);
                        f = 48.0f;
                        float fM1146dp3 = AndroidUtilities.m1146dp(17.0f);
                        f3 = 255.0f;
                        float fM1146dp4 = AndroidUtilities.m1146dp(74.0f);
                        f2 = 2.0f;
                        GroupCallMiniTextureView groupCallMiniTextureView7 = GroupCallMiniTextureView.this;
                        int iM1146dp3 = (int) ((measuredHeight - ((fM1146dp3 + (fM1146dp4 * ((groupCallMiniTextureView7.showingInFullscreen || groupCallMiniTextureView7.animateToFullscreen) ? groupCallRenderersContainer.progressToFullscreenMode : 0.0f))) * f8)) + (AndroidUtilities.m1146dp(17.0f) * f5));
                        GroupCallMiniTextureView.this.castingScreenDrawable.setBounds(measuredWidth, iM1146dp3, measuredWidth + i, iM1146dp3 + i);
                        ...
                        if (f10 > 0.0f || f9 > 0.0f) {
                            ...
                            canvas.drawText(string3, (measuredWidth - (fMeasureText2 / 2.0f)) + (i / 2.0f), AndroidUtilities.m1146dp(32.0f) + r10, textPaint2);
                        } else {
                            GroupCallMiniTextureView.this.stopSharingTextView.setAlpha(0.0f);
                        }
                        GroupCallMiniTextureView.this.stopSharingTextView.setTranslationY(((AndroidUtilities.m1146dp(72.0f) + r10) + GroupCallMiniTextureView.this.swipeToBackDy) - this.currentClipVertical);
                        ...
                        if (groupCallRenderersContainer.progressToFullscreenMode < 1.0f && f9 < 1.0f) {
                            ...
                            canvas.save();
                            canvas.translate((measuredWidth - (AndroidUtilities.m1146dp(400.0f) / 2.0f)) + (i / 2.0f), r10 + AndroidUtilities.m1146dp(10.0f));
                ...
                float measuredHeight2 = (getMeasuredHeight() - this.currentClipVertical) - AndroidUtilities.m1146dp(80.0f);
                if (GroupCallMiniTextureView.this.participant != call.videoNotAvailableParticipant) {
                    ...
                    if ((groupCallMiniTextureView11.showingInFullscreen || groupCallMiniTextureView11.animateToFullscreen) && !GroupCallActivity.isLandscapeMode && !GroupCallActivity.isTabletMode) {
                        float fM1146dp5 = AndroidUtilities.m1146dp(90.0f);
                        GroupCallRenderersContainer groupCallRenderersContainer2 = groupCallRenderersContainer;
                        measuredHeight2 -= (fM1146dp5 * groupCallRenderersContainer2.progressToFullscreenMode) * (1.0f - groupCallRenderersContainer2.progressToHideUi);
                    }
                ...
                if (GroupCallMiniTextureView.this.videoIsPaused || GroupCallMiniTextureView.this.videoIsPausedProgress != 0.0f) {
                    ...
                    if (f14 > 0.0f) {
                        ...
                        float measuredWidth2 = (getMeasuredWidth() - fM1146dp6) / f2;
                        float measuredHeight3 = (getMeasuredHeight() - fM1146dp6) / f2;
                        if (GroupCallMiniTextureView.this.participant == call.videoNotAvailableParticipant) {
                            measuredHeight3 -= fM1146dp6 / 2.5f;
                        }
                        RectF rectF = AndroidUtilities.rectTmp;
                        float f15 = measuredHeight3 + fM1146dp6;
                        rectF.set((int) measuredWidth2, (int) measuredHeight3, (int) (measuredWidth2 + fM1146dp6), (int) f15);
                        if (f14 != 1.0f) {
                        ...
                        canvas.drawText(string, (measuredWidth2 - (fMeasureText / f2)) + (fM1146dp6 / f2), f15 + AndroidUtilities.m1146dp(16.0f), textPaint);
                    }
                }
            }

            @Override // org.telegram.p023ui.Components.voip.VoIPTextureView, android.view.ViewGroup
            ...
            @Override // org.telegram.p023ui.Components.voip.VoIPTextureView, android.widget.FrameLayout, android.view.ViewGroup, android.view.View
            ...
            @Override // org.telegram.p023ui.Components.voip.VoIPTextureView, android.view.View, android.view.ViewParent
        ...
        this.speakingPaint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
        ...
        imageView.setPadding(AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f));
        imageView.setImageDrawable(ContextCompat.getDrawable(groupCallRenderersContainer.getContext(), C2369R.drawable.voicechat_screencast));
        imageView.setColorFilter(new PorterDuffColorFilter(-1, PorterDuff.Mode.MULTIPLY));
        Drawable drawableCreateSimpleSelectorRoundRectDrawable = Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(19.0f), 0, ColorUtils.setAlphaComponent(-1, 100));
        ...
        textView.setText(LocaleController.getString(C2369R.string.VoipVideoScreenStopSharing));
        this.stopSharingTextView.setTextSize(1, 15.0f);
        this.stopSharingTextView.setTypeface(AndroidUtilities.bold());
        this.stopSharingTextView.setPadding(AndroidUtilities.m1146dp(21.0f), 0, AndroidUtilities.m1146dp(21.0f), 0);
        ...
        this.noRtmpStreamTextView.setPadding(AndroidUtilities.m1146dp(21.0f), 0, AndroidUtilities.m1146dp(21.0f), 0);
        ...
        if (ChatObject.canManageCalls(chat)) {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.NoRtmpStreamFromAppOwner)));
        } else {
            this.noRtmpStreamTextView.setText(AndroidUtilities.replaceTags(LocaleController.formatString("NoRtmpStreamFromAppViewer", C2369R.string.NoRtmpStreamFromAppViewer, chat.title)));
        }
    ...
    */
    protected void dispatchDraw(android.graphics.Canvas r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.GroupCallMiniTextureView.dispatchDraw(android.graphics.Canvas):void");
    }
    ...
    protected boolean drawChild(Canvas canvas, View view, long j) {
        if (this.swipeToBack && (view == this.textureView || view == this.noVideoStubLayout)) {
            float fMax = (Math.max(0.0f, 1.0f - (Math.abs(this.swipeToBackDy) / AndroidUtilities.m1146dp(300.0f))) * 0.1f) + 0.9f;
            canvas.save();
    ...
    */
    protected void onMeasure(int r14, int r15) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.GroupCallMiniTextureView.onMeasure(int, int):void");
    }
    ...
    */
    public void updateAttachState(boolean r24) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.GroupCallMiniTextureView.updateAttachState(boolean):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x00c5 A[PHI: r11
      0x00c5: PHI (r11v15 org.telegram.ui.Components.voip.GroupCallGridCell) = (r11v12 org.telegram.ui.Components.voip.GroupCallGridCell), (r11v16 org.telegram.ui.Components.voip.GroupCallGridCell) binds: [B:52:0x00ca, B:48:0x00c3] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public void updatePosition(android.view.ViewGroup r9, android.view.ViewGroup r10, org.telegram.p023ui.Components.RecyclerListView r11, org.telegram.p023ui.Components.voip.GroupCallRenderersContainer r12) {
        /*
            Method dump skipped, instructions count: 442
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.GroupCallMiniTextureView.updatePosition(android.view.ViewGroup, android.view.ViewGroup, org.telegram.ui.Components.RecyclerListView, org.telegram.ui.Components.voip.GroupCallRenderersContainer):void");
    }
    ...
    */
    private void updateIconColor(boolean r9) {
        ...
        L47:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.GroupCallMiniTextureView.updateIconColor(boolean):void");
    }
    ...
    public void updateSize(int i) {
        int measuredWidth = this.parentContainer.getMeasuredWidth() - AndroidUtilities.m1146dp(6.0f);
    ...
    private class NoVideoStubLayout extends View {
        ...
        public NoVideoStubLayout(Context context) {
            ...
            this.tinyWaveDrawable.minRadius = AndroidUtilities.m1146dp(76.0f);
            this.tinyWaveDrawable.maxRadius = AndroidUtilities.m1146dp(92.0f);
            this.tinyWaveDrawable.generateBlob();
            this.bigWaveDrawable.minRadius = AndroidUtilities.m1146dp(80.0f);
            this.bigWaveDrawable.maxRadius = AndroidUtilities.m1146dp(95.0f);
            ...
            this.backgroundPaint.setColor(ColorUtils.setAlphaComponent(-16777216, Opcodes.LAND));
        }

        @Override // android.view.View
        protected void onMeasure(int i, int i2) {
            super.onMeasure(i, i2);
            float fM1146dp = AndroidUtilities.m1146dp(157.0f);
            this.f2024cx = getMeasuredWidth() >> 1;
            this.f2025cy = (getMeasuredHeight() >> 1) + (GroupCallActivity.isLandscapeMode ? 0.0f : (-getMeasuredHeight()) * 0.12f);
            float f = fM1146dp / 2.0f;
            this.avatarImageReceiver.setRoundRadius((int) f);
            this.avatarImageReceiver.setImageCoords(this.f2024cx - f, this.f2025cy - f, fM1146dp, fM1146dp);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.save();
            canvas.scale(f10, f10, this.f2024cx, this.f2025cy);
            GroupCallActivity.WeavingState weavingState3 = this.currentState;
            if (weavingState3 != null) {
                weavingState3.update((int) (this.f2025cy - AndroidUtilities.m1146dp(100.0f)), (int) (this.f2024cx - AndroidUtilities.m1146dp(100.0f)), AndroidUtilities.m1146dp(200.0f), 16L, this.amplitude);
            }
            ...
            for (int i = 0; i < 2; i++) {
                ...
                this.bigWaveDrawable.draw(this.f2024cx, this.f2025cy, canvas, this.paint);
                this.tinyWaveDrawable.draw(this.f2024cx, this.f2025cy, canvas, this.paint);
            }
            canvas.restore();
            float f11 = (this.amplitude * 0.2f) + 1.0f;
            canvas.save();
            canvas.scale(f11, f11, this.f2024cx, this.f2025cy);
