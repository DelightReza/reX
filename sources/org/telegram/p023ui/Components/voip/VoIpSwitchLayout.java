...
public class VoIpSwitchLayout extends FrameLayout {
    ...
    private void setText(Type type, boolean z) {
        final String string;
        int i = C49144.$SwitchMap$org$telegram$ui$Components$voip$VoIpSwitchLayout$Type[type.ordinal()];
        if (i != 1) {
            if (i == 2) {
                string = LocaleController.getString(C2369R.string.VoipFlip);
            } else if (i != 3) {
                if (i == 4) {
                    string = LocaleController.getString(C2369R.string.VoipAudioRoutingBluetooth);
                } else if (i == 5) {
                    string = LocaleController.getString(C2369R.string.VoipSpeaker);
                } else {
                    string = "";
                }
            } else if (z) {
                string = LocaleController.getString(C2369R.string.VoipStartVideo);
            } else {
                string = LocaleController.getString(C2369R.string.VoipStopVideo);
            }
        } else if (z) {
            string = LocaleController.getString(C2369R.string.VoipUnmute);
        } else {
            string = LocaleController.getString(C2369R.string.VoipMute);
        }
        ...
        if (this.currentTextView.getVisibility() == 8 && this.newTextView.getVisibility() == 8) {
            ...
            this.currentTextView.animate().alpha(0.0f).translationY(-AndroidUtilities.m1146dp(4.0f)).setDuration(140L).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.voip.VoIpSwitchLayout.1
            ...
            this.newTextView.setTranslationY(AndroidUtilities.m1146dp(5.0f));
    ...
    */
    public void setType(org.telegram.ui.Components.voip.VoIpSwitchLayout.Type r13, boolean r14, boolean r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.VoIpSwitchLayout.setType(org.telegram.ui.Components.voip.VoIpSwitchLayout$Type, boolean, boolean):void");
    }
    ...
    public void lambda$setType$0(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2369R.raw.speaker_to_bt, "" + C2369R.raw.speaker_to_bt, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2369R.raw.speaker_to_bt, "" + C2369R.raw.speaker_to_bt, i, i, true, null);
    ...
    public void lambda$setType$2(int i) {
        this.voIpButtonView.unSelectedIcon = new RLottieDrawable(C2369R.raw.bt_to_speaker, "" + C2369R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon = new RLottieDrawable(C2369R.raw.bt_to_speaker, "" + C2369R.raw.bt_to_speaker, i, i, true, null);
        this.voIpButtonView.selectedIcon.setColorFilter(new PorterDuffColorFilter(-16777216, PorterDuff.Mode.MULTIPLY));
    }
    ...
    public static class VoIpButtonView extends View {
        ...
        public VoIpButtonView(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
            ...
            this.maxRadius = iM1146dp;
            this.unselectedRadius = iM1146dp;
            this.selectedRadius = 0;
        ...
        private boolean isClick(float f, float f2, float f3, float f4) {
            return Math.abs(f - f2) <= ((float) AndroidUtilities.m1146dp(48.0f)) && Math.abs(f3 - f4) <= ((float) AndroidUtilities.m1146dp(48.0f));
        }
    }
}
