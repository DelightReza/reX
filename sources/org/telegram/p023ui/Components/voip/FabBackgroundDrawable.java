...
public class FabBackgroundDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float f = iMin / 2;
        canvas.drawCircle(f, f, r0 - AndroidUtilities.m1146dp(4.0f), this.bgPaint);
    }
    ...
    protected void onBoundsChange(Rect rect) {
        ...
        float f = iMin / 2;
        new Canvas(this.shadowBitmap).drawCircle(f, f, r5 - AndroidUtilities.m1146dp(4.0f), new Paint(1));
    }
    ...
    public boolean getPadding(Rect rect) {
        ...
        rect.set(iM1146dp, iM1146dp, iM1146dp, iM1146dp);
        return true;
    }
}
