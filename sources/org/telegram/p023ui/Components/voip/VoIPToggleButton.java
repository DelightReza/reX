...
public class VoIPToggleButton extends FrameLayout {
    ...
    public VoIPToggleButton(Context context, float f) {
        ...
        this.xRefPaint.setStrokeWidth(AndroidUtilities.m1146dp(3.0f));
        this.crossPaint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
    ...
    */
    protected void onDraw(android.graphics.Canvas r17) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.voip.VoIPToggleButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setData(int i, int i2, int i3, float f, boolean z, String str, boolean z2, boolean z3) {
        ...
        if (this.rippleDrawable == null || z) {
            if (Color.alpha(i3) == 255 && AndroidUtilities.computePerceivedBrightness(i3) > 0.5d) {
                Drawable drawableCreateSimpleSelectorCircleDrawable = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1146dp(this.diameter), 0, ColorUtils.setAlphaComponent(-16777216, (int) (f * 25.5f)));
                ...
                Drawable drawableCreateSimpleSelectorCircleDrawable2 = Theme.createSimpleSelectorCircleDrawable(AndroidUtilities.m1146dp(this.diameter), 0, ColorUtils.setAlphaComponent(-1, (int) (f * 76.5f)));
