...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(Context context, VoIPBackgroundProvider voIPBackgroundProvider) {
        ...
        TextView textView = new TextView(context, voIPBackgroundProvider) { // from class: org.telegram.ui.Components.voip.VoIPStatusTextView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(this.bgRect, AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(16.0f), this.val$backgroundProvider.getDarkPaint());
                super.onDraw(canvas);
            }
        };
        ...
        this.badConnectionTextView.setPadding(AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(2.0f), AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(2.0f));
        this.badConnectionTextView.setText(LocaleController.getString(C2369R.string.VoipWeakNetwork));
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(LocaleController.getString(C2369R.string.VoipReconnecting));
    ...
    public void replaceViews(final View view, final View view2, Runnable runnable) {
        ...
        view2.setTranslationY(AndroidUtilities.m1146dp(15.0f));
        view2.setAlpha(0.0f);
        ...
        this.animator.addListener(new C49012(view, view2, runnable));
    ...
    public static /* synthetic */ void $r8$lambda$7qpEzghzXJzSCxBxECkhuY5Xs_4(View view, View view2, ValueAnimator valueAnimator) {
        ...
        view.setTranslationY(AndroidUtilities.m1146dp(8.0f) * f);
        view.setAlpha(fFloatValue);
        view2.setTranslationY((-AndroidUtilities.m1146dp(6.0f)) * fFloatValue);
        view2.setAlpha(f);
    }

    /* renamed from: org.telegram.ui.Components.voip.VoIPStatusTextView$2 */
    class C49012 extends AnimatorListenerAdapter {
        final /* synthetic */ View val$in;
        final /* synthetic */ Runnable val$onEnd;
        final /* synthetic */ View val$out;

        C49012(View view, View view2, Runnable runnable) {
            this.val$out = view;
            this.val$in = view2;
