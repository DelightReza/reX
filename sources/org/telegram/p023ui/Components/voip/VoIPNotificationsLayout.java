...
public class VoIPNotificationsLayout extends LinearLayout {
    ...
    public CharSequence ellipsize(CharSequence charSequence) {
        ...
        return TextUtils.ellipsize(charSequence, this.textPaint, AndroidUtilities.m1146dp(300.0f), TextUtils.TruncateAt.END);
    }
    ...
    public int getChildsHight() {
        ...
        return (childCount > 0 ? AndroidUtilities.m1146dp(16.0f) : 0) + (childCount * AndroidUtilities.m1146dp(32.0f));
    }
    ...
    private static class NotificationView extends FrameLayout {
        ...
        public void setText(CharSequence charSequence) {
            int iM1146dp = AndroidUtilities.displaySize.x - AndroidUtilities.m1146dp(120.0f);
            StaticLayout staticLayoutCreateStaticLayout = StaticLayoutEx.createStaticLayout(charSequence, this.textView.getPaint(), iM1146dp, Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false, TextUtils.TruncateAt.END, iM1146dp, 10);
            if (staticLayoutCreateStaticLayout != null) {
                iM1146dp = 0;
                for (int i = 0; i < staticLayoutCreateStaticLayout.getLineCount(); i++) {
                    iM1146dp = (int) Math.max(iM1146dp, Math.ceil(staticLayoutCreateStaticLayout.getLineWidth(i)));
                }
            }
            this.textView.setMaxWidth(iM1146dp);
        ...
        protected void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRoundRect(this.bgRect, AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(16.0f), this.backgroundProvider.getDarkPaint(this.ignoreShader));
            ...
            if (this.backgroundProvider.isReveal()) {
                ...
                canvas.drawRoundRect(this.bgRect, AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(16.0f), this.backgroundProvider.getRevealDarkPaint());
