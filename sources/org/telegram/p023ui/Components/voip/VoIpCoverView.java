...
public class VoIpCoverView extends View {
    ...
    public VoIpCoverView(Context context, TLRPC.User user, VoIPBackgroundProvider voIPBackgroundProvider) {
        ...
        if (zIsEnabled) {
            this.voipCoverEmojiLeft = new VoipCoverEmoji[]{new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(32.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(28.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(35.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(28.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(26.0f))};
            this.voipCoverEmojiRight = new VoipCoverEmoji[]{new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(32.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(28.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(35.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(28.0f)), new VoipCoverEmoji(user, this, AndroidUtilities.m1146dp(26.0f))};
    ...
    public void onConnected() {
        if (this.allowAnimations && !this.isConnected) {
            ...
            this.connectedDiffX = iM1146dp;
            ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(0, iM1146dp);
    ...
    public /* synthetic */ void lambda$onEmojiExpanded$1(ValueAnimator valueAnimator) {
        ...
        this.diffX1 = AndroidUtilities.lerp(this.connectedDiffX, AndroidUtilities.m1146dp(56.0f), fFloatValue);
        this.diffX2 = AndroidUtilities.lerp(this.connectedDiffX, AndroidUtilities.m1146dp(36.0f), fFloatValue);
        this.diffX3 = AndroidUtilities.lerp(this.connectedDiffX, AndroidUtilities.m1146dp(60.0f), fFloatValue);
        this.diffX4 = AndroidUtilities.lerp(this.connectedDiffX, AndroidUtilities.m1146dp(36.0f), fFloatValue);
        this.diffX5 = AndroidUtilities.lerp(this.connectedDiffX, AndroidUtilities.m1146dp(64.0f), fFloatValue);
        this.diffY1 = AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(50.0f), fFloatValue);
        this.diffY2 = AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(20.0f), fFloatValue);
        this.diffY3 = AndroidUtilities.lerp(0, 0, fFloatValue);
        this.diffY4 = AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(-20.0f), fFloatValue);
        this.diffY5 = AndroidUtilities.lerp(0, AndroidUtilities.m1146dp(-40.0f), fFloatValue);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        if (this.allowAnimations && !this.isPaused) {
            ...
            this.voipCoverEmojiLeft[0].setPosition((measuredWidth - AndroidUtilities.m1146dp(120.0f)) - this.diffX1, AndroidUtilities.m1146dp(120.0f) - this.diffY1);
            this.voipCoverEmojiLeft[1].setPosition((measuredWidth - AndroidUtilities.m1146dp(180.0f)) - this.diffX2, AndroidUtilities.m1146dp(150.0f) - this.diffY2);
            this.voipCoverEmojiLeft[2].setPosition((measuredWidth - AndroidUtilities.m1146dp(150.0f)) - this.diffX3, AndroidUtilities.m1146dp(185.0f) - this.diffY3);
            this.voipCoverEmojiLeft[3].setPosition((measuredWidth - AndroidUtilities.m1146dp(176.0f)) - this.diffX4, AndroidUtilities.m1146dp(240.0f) - this.diffY4);
            this.voipCoverEmojiLeft[4].setPosition((measuredWidth - AndroidUtilities.m1146dp(130.0f)) - this.diffX5, AndroidUtilities.m1146dp(265.0f) - this.diffY5);
            for (VoipCoverEmoji voipCoverEmoji : this.voipCoverEmojiLeft) {
                voipCoverEmoji.onDraw(canvas);
            }
            this.voipCoverEmojiRight[0].setPosition(AndroidUtilities.m1146dp(50.0f) + measuredWidth + this.diffX1, AndroidUtilities.m1146dp(120.0f) - this.diffY1);
            this.voipCoverEmojiRight[1].setPosition(AndroidUtilities.m1146dp(110.0f) + measuredWidth + this.diffX2, AndroidUtilities.m1146dp(150.0f) - this.diffY2);
            this.voipCoverEmojiRight[2].setPosition(AndroidUtilities.m1146dp(80.0f) + measuredWidth + this.diffX3, AndroidUtilities.m1146dp(185.0f) - this.diffY3);
            this.voipCoverEmojiRight[3].setPosition(AndroidUtilities.m1146dp(106.0f) + measuredWidth + this.diffX4, AndroidUtilities.m1146dp(240.0f) - this.diffY4);
            this.voipCoverEmojiRight[4].setPosition(measuredWidth + AndroidUtilities.m1146dp(60.0f) + this.diffX5, AndroidUtilities.m1146dp(265.0f) - this.diffY5);
            for (VoipCoverEmoji voipCoverEmoji2 : this.voipCoverEmojiRight) {
