...
public class BackgroundGradientDrawable extends GradientDrawable {
    ...
    public static class Sizes {
        ...
        /* renamed from: of */
        public static Sizes m1265of(int i, int i2, int... iArr) {
        ...
        public static Sizes ofDeviceScreen(float f, Orientation orientation) {
            ...
            if (i == i2) {
                return m1265of(i, i2, new int[0]);
            }
            if (orientation == Orientation.BOTH) {
                return m1265of(i, i2, i2, i);
            }
            return (orientation == Orientation.PORTRAIT) == (i < i2) ? m1265of(i, i2, new int[0]) : m1265of(i2, i, new int[0]);
        }
    }
    ...
    public Disposable drawExactBoundsSize(Canvas canvas, final View view, float f) {
        ...
        Disposable disposable2 = (Disposable) this.disposables.put(view, new Disposable() { // from class: org.telegram.ui.Components.BackgroundGradientDrawable$$ExternalSyntheticLambda2
    ...
    static /* synthetic */ class C33842 {
        ...
        static final /* synthetic */ int[] f1837x8f1352bc;
        ...
        static {
            ...
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.TR_BL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.RIGHT_LEFT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.BR_TL.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.BOTTOM_TOP.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.BL_TR.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f1837x8f1352bc[GradientDrawable.Orientation.LEFT_RIGHT.ordinal()] = 7;
    ...
    public static Rect getGradientPoints(GradientDrawable.Orientation orientation, int i, int i2) {
        Rect rect = new Rect();
        switch (C33842.f1837x8f1352bc[orientation.ordinal()]) {
            case 1:
                int i3 = i / 2;
                rect.left = i3;
                rect.top = 0;
