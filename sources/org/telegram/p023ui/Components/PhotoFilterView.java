...
import org.telegram.p023ui.Cells.PhotoEditRadioCell;
import org.telegram.p023ui.Cells.PhotoEditToolCell;
import org.telegram.p023ui.Components.BlurringShader;
import org.telegram.p023ui.Components.FilterShaders;
import org.telegram.p023ui.Components.PhotoEditorSeekBar;
...
public class PhotoFilterView extends FrameLayout implements FilterShaders.FilterShadersDelegate, StoryRecorder.Touchable {
    ...
    */
    public PhotoFilterView(android.content.Context r24, org.telegram.p023ui.Components.VideoEditTextureView r25, android.graphics.Bitmap r26, android.graphics.Bitmap r27, int r28, org.telegram.messenger.MediaController.SavedFilterState r29, org.telegram.p023ui.Components.PaintingOverlay r30, int r31, boolean r32, boolean r33, org.telegram.ui.Components.BlurringShader.BlurManager r34, org.telegram.ui.ActionBar.Theme.ResourcesProvider r35) {
        /*
            Method dump skipped, instructions count: 1591
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.PhotoFilterView.<init>(android.content.Context, org.telegram.ui.Components.VideoEditTextureView, android.graphics.Bitmap, android.graphics.Bitmap, int, org.telegram.messenger.MediaController$SavedFilterState, org.telegram.ui.Components.PaintingOverlay, int, boolean, boolean, org.telegram.ui.Components.BlurringShader$BlurManager, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    class TextureViewSurfaceTextureListenerC41662 implements TextureView.SurfaceTextureListener {
        ...
        TextureViewSurfaceTextureListenerC41662(boolean z, BlurringShader.BlurManager blurManager) {
    ...
    private void updateSelectedBlurType() {
        int i = this.blurType;
        if (i == 0) {
            Drawable drawableMutate = this.blurOffButton.getContext().getResources().getDrawable(C2369R.drawable.msg_blur_off).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, C2369R.drawable.msg_blur_radial, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            this.blurLinearButton.setCompoundDrawablesWithIntrinsicBounds(0, C2369R.drawable.msg_blur_linear, 0, 0);
            this.blurLinearButton.setTextColor(-1);
        } else if (i == 1) {
            this.blurOffButton.setCompoundDrawablesWithIntrinsicBounds(0, C2369R.drawable.msg_blur_off, 0, 0);
            this.blurOffButton.setTextColor(-1);
            Drawable drawableMutate2 = this.blurOffButton.getContext().getResources().getDrawable(C2369R.drawable.msg_blur_radial).mutate();
            ...
            this.blurRadialButton.setCompoundDrawablesWithIntrinsicBounds(0, C2369R.drawable.msg_blur_radial, 0, 0);
            this.blurRadialButton.setTextColor(-1);
            Drawable drawableMutate3 = this.blurOffButton.getContext().getResources().getDrawable(C2369R.drawable.msg_blur_linear).mutate();
    ...
    private static class RecyclerListViewWithShadows extends RecyclerListView {
        ...
        public RecyclerListViewWithShadows(Context context) {
            ...
            paint.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1146dp(8.0f), new int[]{-16777216, 0}, new float[]{0.0f, 1.0f}, tileMode));
            paint2.setShader(new LinearGradient(0.0f, 0.0f, 0.0f, AndroidUtilities.m1146dp(8.0f), new int[]{0, -16777216}, new float[]{0.0f, 1.0f}, tileMode));
        }
        ...
        public void dispatchDraw(Canvas canvas) {
            ...
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1146dp(8.0f), this.topPaint);
            this.bottomPaint.setAlpha((int) (this.bottomAlpha.set(this.bottom ? 1.0f : 0.0f) * 255.0f));
            canvas.save();
            canvas.translate(0.0f, getHeight() - AndroidUtilities.m1146dp(8.0f));
            canvas.drawRect(0.0f, 0.0f, getWidth(), AndroidUtilities.m1146dp(8.0f), this.bottomPaint);
            canvas.restore();
        }
    ...
    private void fixLayout(int i, int i2) {
        ...
        float fCeil2;
        if (this.ownLayout) {
            int iM1146dp = i - AndroidUtilities.m1146dp(28.0f);
            int iM1146dp2 = i2 - (AndroidUtilities.m1146dp(214.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            ...
            int iCeil = (int) Math.ceil(((f - fCeil2) / 2.0f) + AndroidUtilities.m1146dp(14.0f));
            int iCeil2 = (int) Math.ceil(((f2 - fCeil) / 2.0f) + AndroidUtilities.m1146dp(14.0f) + (!this.inBubbleMode ? AndroidUtilities.statusBarHeight : 0));
            int i4 = (int) fCeil2;
            int i5 = (int) fCeil;
            if (this.ownsTextureView) {
            ...
            ((FrameLayout.LayoutParams) this.blurControl.getLayoutParams()).height = AndroidUtilities.m1146dp(38.0f) + iM1146dp2;
            ((FrameLayout.LayoutParams) this.curvesControl.getLayoutParams()).height = iM1146dp2 + AndroidUtilities.m1146dp(28.0f);
            if (AndroidUtilities.isTablet()) {
                int iM1146dp3 = AndroidUtilities.m1146dp(86.0f) * 10;
                FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) this.recyclerListView.getLayoutParams();
                if (iM1146dp3 < iM1146dp) {
                    layoutParams2.width = iM1146dp3;
                    layoutParams2.leftMargin = (iM1146dp - iM1146dp3) / 2;
                } else {
    ...
    public void setEnhanceValue(float f) {
        ...
        while (true) {
            ...
            if ((childAt instanceof PhotoEditToolCell) && this.recyclerListView.getChildAdapterPosition(childAt) == this.enhanceTool) {
                ((PhotoEditToolCell) childAt).setIconAndTextAndValue(LocaleController.getString(C2369R.string.Enhance), this.enhanceValue, 0, 100);
                break;
            }
            i++;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                ...
                if (i == PhotoFilterView.this.tintShadowsTool) {
                    photoEditRadioCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.TintShadows), 0, PhotoFilterView.this.tintShadowsColor);
                    return;
                } else {
                    if (i == PhotoFilterView.this.tintHighlightsTool) {
                        photoEditRadioCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.TintHighlights), 0, PhotoFilterView.this.tintHighlightsColor);
                        return;
                    }
                    return;
                }
            ...
            if (i == PhotoFilterView.this.enhanceTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Enhance), PhotoFilterView.this.enhanceValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.highlightsTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Highlights), PhotoFilterView.this.highlightsValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.contrastTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Contrast), PhotoFilterView.this.contrastValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.exposureTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Exposure), PhotoFilterView.this.exposureValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.warmthTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Warmth), PhotoFilterView.this.warmthValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.saturationTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Saturation), PhotoFilterView.this.saturationValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.vignetteTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Vignette), PhotoFilterView.this.vignetteValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.shadowsTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Shadows), PhotoFilterView.this.shadowsValue, -100, 100);
                return;
            }
            if (i == PhotoFilterView.this.grainTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Grain), PhotoFilterView.this.grainValue, 0, 100);
                return;
            }
            if (i == PhotoFilterView.this.sharpenTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Sharpen), PhotoFilterView.this.sharpenValue, 0, 100);
            } else if (i == PhotoFilterView.this.fadeTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.Fade), PhotoFilterView.this.fadeValue, 0, 100);
            } else if (i == PhotoFilterView.this.softenSkinTool) {
                photoEditToolCell.setIconAndTextAndValue(LocaleController.getString(C2369R.string.SoftenSkin), PhotoFilterView.this.softenSkinValue, 0, 100);
            }
        }
    ...
    public static class EnhanceView extends View {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.topTextPaint.setShadowLayer(AndroidUtilities.m1146dp(8.0f), 0.0f, 0.0f, 805306368);
            this.topTextPaint.setTextSize(AndroidUtilities.m1146dp(34.0f));
            this.bottomTextPaint.setColor(-1);
            this.bottomTextPaint.setShadowLayer(AndroidUtilities.m1146dp(12.0f), 0.0f, 0.0f, 805306368);
            this.bottomTextPaint.setTextSize(AndroidUtilities.m1146dp(58.0f));
            if (this.topText == null) {
                StaticLayout staticLayout = new StaticLayout(LocaleController.getString(C2369R.string.Enhance), this.topTextPaint, getMeasuredWidth(), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.restore();
            canvas.save();
            canvas.translate(((getWidth() - this.bottomTextWidth) / 2.0f) - this.bottomTextLeft, (getHeight() * 0.22f) + AndroidUtilities.m1146dp(60.0f));
