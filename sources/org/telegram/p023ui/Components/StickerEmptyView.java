...
public class StickerEmptyView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void createButtonLayout(CharSequence charSequence, final Runnable runnable) {
        ((LinearLayout.LayoutParams) this.subtitle.getLayoutParams()).topMargin = AndroidUtilities.m1146dp(12.0f);
        TextView textView = new TextView(getContext());
        textView.setText(charSequence);
        int i = Theme.key_featuredStickers_buttonText;
        textView.setTextColor(Theme.getColor(i, this.resourcesProvider));
        textView.setPadding(AndroidUtilities.m1146dp(45.0f), AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(45.0f), AndroidUtilities.m1146dp(12.0f));
        ...
        frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider), ColorUtils.setAlphaComponent(Theme.getColor(i, this.resourcesProvider), 30)));
    ...
    public void setKeyboardHeight(int i, boolean z) {
        if (this.keyboardSize != i) {
            ...
            this.keyboardSize = i;
            float fM1146dp = (-(i >> 1)) + (i > 0 ? AndroidUtilities.m1146dp(20.0f) : 0);
            if (z) {
                ViewPropertyAnimator viewPropertyAnimatorTranslationY = this.linearLayout.animate().translationY(fM1146dp);
                CubicBezierInterpolator cubicBezierInterpolator = CubicBezierInterpolator.DEFAULT;
                viewPropertyAnimatorTranslationY.setInterpolator(cubicBezierInterpolator).setDuration(250L);
                RadialProgressView radialProgressView = this.progressBar;
                if (radialProgressView != null) {
                    radialProgressView.animate().translationY(fM1146dp).setInterpolator(cubicBezierInterpolator).setDuration(250L);
                    return;
                }
                return;
            }
            this.linearLayout.setTranslationY(fM1146dp);
            RadialProgressView radialProgressView2 = this.progressBar;
            if (radialProgressView2 != null) {
                radialProgressView2.setTranslationY(fM1146dp);
            }
        }
    }
