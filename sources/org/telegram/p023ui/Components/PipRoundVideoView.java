...
public class PipRoundVideoView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void show(Activity activity, Runnable runnable) {
        ...
        PipFrameLayout pipFrameLayout = new PipFrameLayout(activity) { // from class: org.telegram.ui.Components.PipRoundVideoView.1
            ...
            protected void onDraw(Canvas canvas) {
                ...
                if (drawable != null) {
                    ...
                    Theme.chat_roundVideoShadow.setBounds(AndroidUtilities.m1146dp(1.0f), AndroidUtilities.m1146dp(2.0f), AndroidUtilities.m1146dp(125.0f), AndroidUtilities.m1146dp(125.0f));
                    ...
                    canvas.drawCircle(AndroidUtilities.m1146dp(63.0f), AndroidUtilities.m1146dp(63.0f), AndroidUtilities.m1146dp(59.5f), Theme.chat_docBackPaint);
                }
            }
        };
        this.windowView = pipFrameLayout;
        pipFrameLayout.setWillNotDraw(false);
        this.videoWidth = AndroidUtilities.m1146dp(126.0f);
        this.videoHeight = AndroidUtilities.m1146dp(126.0f);
        ...
        aspectRatioFrameLayout.setOutlineProvider(new ViewOutlineProvider() { // from class: org.telegram.ui.Components.PipRoundVideoView.3
            ...
            public void getOutline(View view, Outline outline) {
                outline.setOval(0, 0, AndroidUtilities.m1146dp(120.0f), AndroidUtilities.m1146dp(120.0f));
            }
        });
    ...
    */
    public void animateToBoundsMaybe() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.PipRoundVideoView.animateToBoundsMaybe():void");
    }
