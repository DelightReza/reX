...
public class PickerBottomLayoutViewer extends FrameLayout {
    ...
    public PickerBottomLayoutViewer(Context context, boolean z) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m1146dp(20.0f), 0, AndroidUtilities.m1146dp(20.0f), 0);
        ...
        this.doneButton.setPadding(AndroidUtilities.m1146dp(20.0f), 0, AndroidUtilities.m1146dp(20.0f), 0);
        this.doneButton.setText(LocaleController.getString(C2369R.string.Send).toUpperCase());
        ...
        this.doneButtonBadgeTextView.setBackgroundResource(this.isDarkTheme ? C2369R.drawable.photobadge : C2369R.drawable.bluecounter);
