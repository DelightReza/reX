...
public class SearchDownloadsContainer extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public void update(boolean z) {
        ...
        if (TextUtils.isEmpty(this.searchQuery) || isEmptyDownloads()) {
            ...
            if (this.rowCount == 0) {
                ...
                this.emptyView.title.setText(LocaleController.getString(C2369R.string.SearchEmptyViewDownloads));
        ...
        if (z) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: org.telegram.ui.Components.SearchDownloadsContainer.4
                ...
                public boolean areItemsTheSame(int i8, int i9) {
                    ...
                    return (messageObject2 == null || messageObject == null || messageObject2.getDocument() == null || messageObject.getDocument() == null || messageObject2.getDocument().f1579id != messageObject.getDocument().f1579id) ? false : true;
                }
    ...
    public void showPremiumFloodWaitBulletin(final boolean z) {
        ...
        BulletinFactory.m1267of(this.parentFragment).createSimpleBulletin(C2369R.raw.speed_limit, LocaleController.getString(z ? C2369R.string.UploadSpeedLimited : C2369R.string.DownloadSpeedLimited), AndroidUtilities.replaceCharSequence("%d", AndroidUtilities.premiumText(LocaleController.getString(z ? C2369R.string.UploadSpeedLimitedMessage : C2369R.string.DownloadSpeedLimitedMessage), new Runnable() { // from class: org.telegram.ui.Components.SearchDownloadsContainer$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
