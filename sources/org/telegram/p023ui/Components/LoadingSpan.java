...
public class LoadingSpan extends ReplacementSpan {
    ...
    public LoadingSpan(View view, int i) {
        this(view, i, AndroidUtilities.m1146dp(2.0f));
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        int i6 = (int) f;
        this.drawable.setBounds(i6, (int) (i3 + ((((i5 - AndroidUtilities.m1146dp(2.0f)) - i3) / 2.0f) * (1.0f - this.scaleY)) + this.yOffset), this.size + i6, (int) (((i5 - AndroidUtilities.m1146dp(2.0f)) - ((((i5 - AndroidUtilities.m1146dp(2.0f)) - i3) / 2.0f) * (1.0f - this.scaleY))) + this.yOffset));
        if (paint != null) {
