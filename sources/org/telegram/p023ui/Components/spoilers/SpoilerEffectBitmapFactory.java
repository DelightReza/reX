...
public class SpoilerEffectBitmapFactory {
    ...
    private SpoilerEffectBitmapFactory() {
        int iM1146dp = AndroidUtilities.m1146dp(SharedConfig.getDevicePerformanceClass() == 2 ? 150.0f : 100.0f);
        Point point = AndroidUtilities.displaySize;
        int iMin = (int) Math.min(Math.min(point.x, point.y) * 0.5f, iM1146dp);
        this.size = iMin;
        if (iMin < AndroidUtilities.m1146dp(80.0f)) {
            this.size = AndroidUtilities.m1146dp(80.0f);
        }
    }
    ...
    Paint getPaint() {
        if (this.shaderBitmap == null) {
            ...
            int i2 = this.size;
            int i3 = (int) (i2 / 10.0f);
            int iM1146dp = (int) ((i2 / AndroidUtilities.m1146dp(200.0f)) * 60.0f);
            for (int i4 = 0; i4 < 10; i4++) {
                for (int i5 = 0; i5 < 10; i5++) {
                    ...
                    int i6 = i3 * i4;
                    int i7 = i3 * i5;
                    spoilerEffect.setBounds(i6, i7 - AndroidUtilities.m1146dp(5.0f), i6 + i3 + AndroidUtilities.m1146dp(3.0f), i7 + i3 + AndroidUtilities.m1146dp(5.0f));
                    spoilerEffect.drawPoints = true;
                    spoilerEffect.setMaxParticlesCount(Math.min(SpoilerEffect.MAX_PARTICLES_PER_ENTITY * 5, iM1146dp));
