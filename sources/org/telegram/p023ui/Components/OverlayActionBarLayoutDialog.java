...
public class OverlayActionBarLayoutDialog extends Dialog implements INavigationLayout.INavigationLayoutDelegate {
    ...
    public void onMeasureOverride(int[] iArr) {
        ...
        iArr[0] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1146dp(530.0f), View.MeasureSpec.getSize(iArr[0])), TLObject.FLAG_30);
        iArr[1] = View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1146dp(528.0f), View.MeasureSpec.getSize(iArr[1])), TLObject.FLAG_30);
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.frameLayout.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: org.telegram.ui.Components.OverlayActionBarLayoutDialog$$ExternalSyntheticLambda1
            ...
            public final WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                return OverlayActionBarLayoutDialog.m10002$r8$lambda$AKWEMZGytT31G2x4IT_NdAkiqA(view, windowInsets);
            }
        });
        if (i >= 26) {
    ...
    /* renamed from: $r8$lambda$AKW-EMZGytT31G2x4IT_NdAkiqA, reason: not valid java name */
    public static /* synthetic */ WindowInsets m10002$r8$lambda$AKWEMZGytT31G2x4IT_NdAkiqA(View view, WindowInsets windowInsets) {
