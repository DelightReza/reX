...
public class RadialProgressView extends View {
    ...
    public RadialProgressView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.size = AndroidUtilities.m1146dp(40.0f);
    ...
    */
    private void updateAnimation(long r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.RadialProgressView.updateAnimation(long):void");
    }
    ...
    public void setStrokeWidth(float f) {
        this.progressPaint.setStrokeWidth(AndroidUtilities.m1146dp(f));
    }
