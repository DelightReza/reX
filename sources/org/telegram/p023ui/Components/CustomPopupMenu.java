...
public abstract class CustomPopupMenu {
    ...
    public CustomPopupMenu(Context context, Theme.ResourcesProvider resourcesProvider, boolean z) {
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, C2369R.drawable.popup_fixed_alert2, resourcesProvider, z ? 1 : 0);
        ...
        this.popupWindow.setAnimationStyle(C2369R.style.PopupContextAnimation2);
