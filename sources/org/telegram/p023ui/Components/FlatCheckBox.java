...
public class FlatCheckBox extends View {
    ...
    public FlatCheckBox(Context context) {
        ...
        this.HEIGHT = AndroidUtilities.m1146dp(37.0f);
        this.INNER_PADDING = AndroidUtilities.m1146dp(22.0f);
        this.TRANSLETE_TEXT = AndroidUtilities.m1146dp(8.0f);
        this.f1878P = AndroidUtilities.m1146dp(2.5f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension((str == null ? 0 : (int) this.textPaint.measureText(str)) + (this.INNER_PADDING << 1) + (this.f1878P * 2), this.HEIGHT + AndroidUtilities.m1146dp(4.0f));
        if (getMeasuredWidth() != this.lastW) {
            this.rectF.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
            this.rectF.inset(this.f1878P + (this.outLinePaint.getStrokeWidth() / 2.0f), this.f1878P + (this.outLinePaint.getStrokeWidth() / 2.0f));
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.translate(AndroidUtilities.m1146dp(12.0f), measuredHeight - AndroidUtilities.m1146dp(9.0f));
        if (this.progress > 0.5f) {
            this.checkPaint.setColor(this.colorTextActive);
            float f4 = 1.0f - f3;
            canvas.drawLine(AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) - (AndroidUtilities.m1146dp(4.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m1146dp(4.0f) * f4)), this.checkPaint);
            canvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m1146dp(8.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m1146dp(8.0f) * f4)), this.checkPaint);
        }
        canvas.restore();
    }
