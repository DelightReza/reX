...
public class GLIconRenderer implements GLSurfaceView.Renderer {
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (icon3D != null) {
            ...
            icon3D.draw(this.mMVPMatrix, this.mRotationMatrix, this.mWidth, this.mHeight, this.gradientStartX, this.gradientScaleX, this.gradientStartY, this.gradientScaleY, this.white, this.golden, this.f1931dt);
        }
    }
