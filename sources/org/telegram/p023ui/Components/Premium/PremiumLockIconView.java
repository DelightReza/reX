...
public class PremiumLockIconView extends ImageView {
    ...
    public PremiumLockIconView(Context context, int i, Theme.ResourcesProvider resourcesProvider) {
        ...
        setImageResource(i == TYPE_REACTIONS ? C2369R.drawable.msg_premium_lock2 : C2369R.drawable.msg_mini_premiumlock);
        if (i == TYPE_REACTIONS) {
        ...
        if (i == TYPE_REACTIONS_LOCK) {
            ...
            setImageResource(C2369R.drawable.msg_archive_hide);
        } else if (i == TYPE_GIFT_PIN) {
            setScaleType(ImageView.ScaleType.CENTER);
            setImageResource(C2369R.drawable.msg_limit_pin);
        }
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.type == TYPE_REACTIONS) {
            ...
            rectF.set((getMeasuredWidth() / 2.0f) + AndroidUtilities.m1146dp(2.5f), (getMeasuredHeight() / 2.0f) + AndroidUtilities.dpf2(5.7f), getMeasuredWidth() - AndroidUtilities.dpf2(0.2f), getMeasuredHeight());
            this.path.addRoundRect(rectF, AndroidUtilities.m1146dp(2.0f), AndroidUtilities.m1146dp(2.0f), direction);
            this.path.close();
            this.starParticles.rect.set(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight());
            this.starParticles.rect.inset(AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f));
            return;
        }
        updateGradient();
    }
        ...
        if (paint != null) {
            ...
            if (i == TYPE_REACTIONS_LOCK) {
                ...
                if (this.currentColor != 0) {
                    ...
                    PremiumGradient.getInstance().updateMainGradientMatrix(0, 0, getMeasuredWidth(), getMeasuredHeight(), -AndroidUtilities.m1146dp(24.0f), 0.0f);
    ...
    public void setLocked(boolean z) {
        if (this.type != TYPE_REACTIONS) {
            setImageResource(z ? C2369R.drawable.msg_mini_premiumlock : C2369R.drawable.msg_mini_stickerstar);
        }
    }
}
