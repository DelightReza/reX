...
public class BoostCounterSpan extends ReplacementSpan {
    ...
    public BoostCounterSpan(View view, TextPaint textPaint, int i) {
        ...
        Drawable drawableMutate = ContextCompat.getDrawable(view.getContext(), C2369R.drawable.mini_boost_profile_badge).mutate();
        this.boostProfileBadge = drawableMutate;
        Drawable drawableMutate2 = ContextCompat.getDrawable(view.getContext(), C2369R.drawable.mini_boost_profile_badge2).mutate();
    ...
    public int getWidth() {
        return (int) (AndroidUtilities.m1146dp(16.0f) + this.countText.getWidth());
    }
    ...
    public void draw(Canvas canvas, CharSequence charSequence, int i, int i2, float f, int i3, int i4, int i5, Paint paint) {
        ...
        canvas.save();
        canvas.translate(f, -AndroidUtilities.m1146dp(0.2f));
        if (this.currentCount == 1) {
            canvas.translate(AndroidUtilities.m1146dp(1.5f), 0.0f);
            this.boostProfileBadge.draw(canvas);
        } else {
            this.boostProfileBadge2.draw(canvas);
        }
        canvas.translate(AndroidUtilities.m1146dp(16.0f), 0.0f);
