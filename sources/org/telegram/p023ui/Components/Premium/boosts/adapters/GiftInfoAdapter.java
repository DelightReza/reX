...
import org.telegram.p023ui.Components.Premium.boosts.cells.TableCell;
...
public abstract class GiftInfoAdapter extends RecyclerListView.SelectionAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 1) {
            ...
            linkCell.setPadding(0, 0, 0, AndroidUtilities.m1146dp(14.0f));
        } else if (i != 5) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (tL_payments_checkedGiftCode3.boost != null) {
            ...
            if (str2 == null || str2.isEmpty()) {
                textInfoCell.setText(LocaleController.getString(C2369R.string.BoostingLinkNotActivated));
                return;
            } else {
        ...
        if (this.isUnused) {
            if (tL_payments_checkedGiftCode3.to_id == -1) {
                string = LocaleController.getString(C2369R.string.BoostingSendLinkToAnyone);
            } else {
                string = LocaleController.getString(C2369R.string.BoostingSendLinkToFriends);
            }
        ...
        textInfoCell.setText(LocaleController.formatString("BoostingUsedLinkDate", C2369R.string.BoostingUsedLinkDate, LocaleController.formatString("formatDateAtTime", C2369R.string.formatDateAtTime, LocaleController.getInstance().getFormatterYear().format(date), LocaleController.getInstance().getFormatterDay().format(date))));
    }
    ...
    public /* synthetic */ boolean lambda$share$4(String str, DialogsActivity dialogsActivity, ArrayList arrayList, CharSequence charSequence, boolean z, boolean z2, int i, TopicsFragment topicsFragment) {
        ...
        while (i2 < arrayList.size()) {
            ...
            this.baseFragment.getSendMessagesHelper().sendMessage(SendMessagesHelper.SendMessageParams.m1191of(str, j2, null, null, null, true, null, null, null, true, 0, 0, null, false));
            i2++;
            j = j2;
        }
