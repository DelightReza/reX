...
public class LinkCell extends FrameLayout {
    ...
    public LinkCell(Context context, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        spoilersTextView.setPadding(AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(13.0f), AndroidUtilities.m1146dp(50.0f), AndroidUtilities.m1146dp(13.0f));
        ...
        frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1146dp, color, ColorUtils.setAlphaComponent(Theme.getColor(i, resourcesProvider), 76)));
        ...
        imageView.setImageResource(C2369R.drawable.menu_copy_s);
        this.imageView.setColorFilter(Theme.getColor(Theme.key_dialogTextBlack, resourcesProvider));
        this.imageView.setPadding(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f));
        this.imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(20.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i, resourcesProvider), 76)));
    ...
    public void hideSlug(final Runnable runnable) {
        ...
        this.linkView.setPadding(AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(14.0f), AndroidUtilities.m1146dp(14.0f), AndroidUtilities.m1146dp(18.0f));
