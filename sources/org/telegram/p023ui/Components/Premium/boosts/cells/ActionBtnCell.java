...
public class ActionBtnCell extends FrameLayout {
    ...
    public void setStartGiveAwayStyle(int i, boolean z) {
        ...
        this.button.setText(LocaleController.getString(C2369R.string.BoostingStartGiveaway), z);
    ...
    public void setGiftPremiumStyle(int i, boolean z, boolean z2) {
        ...
        this.button.setCount(i, z);
        this.button.setText(LocaleController.getString(C2369R.string.GiftPremium), z);
        this.backgroundView.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider));
    }
    ...
    public void setActivateForFreeStyle() {
        this.drawDivider = true;
        this.button.setEnabled(true);
        this.button.setText(LocaleController.getString(C2369R.string.GiftPremiumActivateForFree), false);
        this.backgroundView.setBackgroundColor(Theme.getColor(Theme.key_dialogBackground, this.resourcesProvider));
    }
    ...
    public void setOkStyle(boolean z) {
        ...
        this.button.setEnabled(true);
        this.button.setText(z ? LocaleController.formatString("BoostingUseLink", C2369R.string.BoostingUseLink, new Object[0]) : LocaleController.formatString("OK", C2369R.string.f1459OK, new Object[0]), false);
    }
    ...
    public void setCloseStyle() {
        ...
        this.button.setShowZero(false);
        this.button.setEnabled(true);
        this.button.setText(LocaleController.formatString("Close", C2369R.string.Close, new Object[0]), false);
    }
