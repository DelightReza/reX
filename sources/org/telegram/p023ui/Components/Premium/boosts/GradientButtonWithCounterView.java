...
public class GradientButtonWithCounterView extends ButtonWithCounterView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), PremiumGradient.getInstance().getMainGradientPaint());
        this.flickerDrawable.setParentWidth(getMeasuredWidth());
        this.flickerDrawable.draw(canvas, this.rect, AndroidUtilities.m1146dp(8.0f), null);
        super.onDraw(canvas);
        invalidate();
    }
}
