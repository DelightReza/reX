...
public class UserSelectorBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public /* synthetic */ void lambda$checkEditTextHint$2() {
        this.searchField.setHintText(LocaleController.getString(C2369R.string.Search), true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$checkEditTextHint$3() {
        this.searchField.setHintText(LocaleController.getString(C2369R.string.GiftPremiumUsersSearchHint), true);
    }
    ...
    public UserSelectorBottomSheet(Context context, final int i, long j, BirthdayController.BirthdayState birthdayState, final int i2, boolean z, final Theme.ResourcesProvider resourcesProvider) {
        ...
        if (j != 0 && !hashSet.contains(Long.valueOf(j))) {
            ...
            linkedHashMap.put(Long.valueOf(user.f1734id), user);
        }
        ...
        SelectorSearchCell selectorSearchCell = new SelectorSearchCell(getContext(), resourcesProvider, null) { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet.5
            ...
            protected void onLayout(boolean z2, int i4, int i5, int i6, int i7) {
                ...
                UserSelectorBottomSheet.this.listPaddingTop = getMeasuredHeight() + AndroidUtilities.m1146dp(64.0f);
        ...
        selectorSearchCell.setHintText(LocaleController.getString((!hashSet.isEmpty() || i2 == 1 || i2 == 2 || i2 == 3 || i2 == 4) ? C2369R.string.Search : C2369R.string.GiftPremiumUsersSearchHint), false);
        ...
        if (i2 == 4) {
            ...
            linearLayout.setPadding(AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(4.0f));
            ...
            textView.setText(LocaleController.getString(C2369R.string.ConferenceCallWithVideo));
        ...
        viewGroup5.addView(frameLayout, LayoutHelper.createFrameMarginPx(-1, 300.0f, 87, i8, 0, i8, AndroidUtilities.m1146dp(68.0f)));
        this.selectorAdapter.setData(arrayList, this.recyclerListView);
        RecyclerListView recyclerListView = this.recyclerListView;
        int i9 = this.backgroundPaddingLeft;
        recyclerListView.setPadding(i9, 0, i9, AndroidUtilities.m1146dp(i2 != 1 ? 60.0f : f));
    ...
    public /* synthetic */ void lambda$new$8(int i, Theme.ResourcesProvider resourcesProvider, int i2, View view, int i3, float f, float f2) {
        ...
        if (view instanceof SelectorUserCell) {
            ...
            long j = user != null ? user.f1734id : -chat.f1571id;
            if (i == 3) {
            ...
            if (i == 0 || i == 2) {
                if (UserObject.areGiftsDisabled(j)) {
                    BulletinFactory.m1266of(this.container, resourcesProvider).createSimpleBulletin(C2369R.raw.error, AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.UserDisallowedGifts, DialogObject.getShortName(j)))).show();
                    return;
                }
            ...
            if (z != z2) {
                ...
                this.buttonContainer.animate().alpha(z2 ? 1.0f : 0.0f).translationY(z2 ? 0.0f : AndroidUtilities.m1146dp(12.0f)).setInterpolator(CubicBezierInterpolator.EASE_OUT_QUINT).setDuration(320L).withEndAction(!z2 ? new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet$$ExternalSyntheticLambda24
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    public /* synthetic */ boolean lambda$new$11(int i, View view, int i2, float f, float f2) {
        ...
        SelectorUserCell selectorUserCell = (SelectorUserCell) view;
        TLRPC.User user = selectorUserCell.getUser();
        long j = user != null ? user.f1734id : -selectorUserCell.getChat().f1571id;
        boolean z = (i == 4 && this.selectedIds.isEmpty()) ? false : true;
        if (this.selectedIds.contains(Long.valueOf(j))) {
            this.selectedIds.remove(Long.valueOf(j));
        } else {
    ...
    protected void onPreDraw(Canvas canvas, int i, float f) {
        this.headerView.setTranslationY(Math.max(i, AndroidUtilities.statusBarHeight - AndroidUtilities.m1146dp(8.0f)) + AndroidUtilities.m1146dp(8.0f));
    ...
    private void next() {
        ...
        if (this.selectedIds.size() != 0) {
            if (!this.paymentOptions.isEmpty() || (i = this.type) == 0 || i == 2 || i == 4) {
                ...
                if (arrayList.size() == 1) {
                    long j = ((TLRPC.User) arrayList.get(0)).f1734id;
                    if (UserObject.areGiftsDisabled(j)) {
                        BulletinFactory.m1266of(this.container, this.resourcesProvider).createSimpleBulletin(C2369R.raw.error, AndroidUtilities.replaceTags(LocaleController.formatString(C2369R.string.UserDisallowedGifts, DialogObject.getShortName(j)))).show();
                        return;
                    }
    ...
    private void showMaximumUsersToast() {
        ...
        if (this.type == 4) {
            ...
            string = LocaleController.getString(C2369R.string.BoostingSelectUpToWarningUsers);
        }
        BulletinFactory.m1266of(this.container, this.resourcesProvider).createSimpleBulletin(C2369R.raw.chats_infotip, string).show(true);
        try {
    ...
    private void updateCheckboxes(boolean r10) {
        ...
        L5:
            ...
            boolean r6 = r5 instanceof org.telegram.p023ui.Components.Premium.boosts.cells.selector.SelectorUserCell
            if (r6 == 0) goto L57
        ...
        L2d:
            ...
            org.telegram.ui.Components.Premium.boosts.cells.selector.SelectorUserCell r5 = (org.telegram.p023ui.Components.Premium.boosts.cells.selector.SelectorUserCell) r5
        ...
        L6b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Premium.boosts.UserSelectorBottomSheet.updateCheckboxes(boolean):void");
    }
    ...
    public void updateActionButton(boolean z) {
        ...
        if (this.type == 4) {
            spannableStringBuilder.append((CharSequence) LocaleController.getString(C2369R.string.CallInviteMembersButton));
        } else if (this.selectedIds.size() == 0) {
            if (LocaleController.isRTL) {
                spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumChooseRecipientsBtn", C2369R.string.GiftPremiumChooseRecipientsBtn));
            ...
            spannableStringBuilder.append((CharSequence) LocaleController.getString("GiftPremiumProceedBtn", C2369R.string.GiftPremiumProceedBtn));
        }
    ...
    private int addSection(ArrayList arrayList, CharSequence charSequence, ArrayList arrayList2, boolean z) {
        ...
        while (i < size) {
            ...
            if (user != null && !user.bot && !UserObject.isService(user.f1734id)) {
                long j = user.f1734id;
                if (j != this.userId && !this.excludeUserIds.contains(Long.valueOf(j))) {
                    this.selectedIds.contains(Long.valueOf(user.f1734id));
                    iM1146dp += AndroidUtilities.m1146dp(56.0f);
                    arrayList3.add(decorate(SelectorAdapter.Item.asUser(user, this.selectedIds.contains(Long.valueOf(user.f1734id)))));
                }
            }
        }
        ...
        int iM1146dp2 = iM1146dp + AndroidUtilities.m1146dp(32.0f);
        ...
        if (isSearching()) {
            ...
            while (i < size) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    if (!user2.bot && !UserObject.isService(user2.f1734id)) {
                        long j = user2.f1734id;
                        iM1146dp2 += AndroidUtilities.m1146dp(56.0f);
                        if (!this.excludeUserIds.contains(Long.valueOf(user2.f1734id))) {
                    ...
                    if (this.type == 3 && ChatObject.isChannelAndNotMegaGroup(chat)) {
                        ...
                        iM1146dp2 += AndroidUtilities.m1146dp(56.0f);
                        if (!this.excludeUserIds.contains(Long.valueOf(-chat.f1571id))) {
            ...
            if (this.includeTonOption && this.type == 3) {
                if (this.tonIcon == null) {
                    CombinedDrawable combinedDrawable = new CombinedDrawable(Theme.createCircleDrawable(AndroidUtilities.m1146dp(46.0f), Theme.getColor(Theme.key_featuredStickers_addButton, this.resourcesProvider)), getContext().getResources().getDrawable(C2369R.drawable.ton).mutate());
                ...
                String string = LocaleController.getString(C2369R.string.Gift2ExportTONTitle);
                int i2 = this.tonDays;
            ...
            if ((i3 == 0 || i3 == 2) && userFull != null && userFull.birthday == null) {
                iM1146dp = AndroidUtilities.m1146dp(50.0f);
                this.items.add(SelectorAdapter.Item.asButton(1, C2369R.drawable.menu_birthday, LocaleController.getString(C2369R.string.GiftsBirthdaySetup)));
            } else {
                iM1146dp = 0;
            }
            if (this.onShareCallLinkListener != null && this.type == 4) {
                this.items.add(SelectorAdapter.Item.asButton(3, C2369R.drawable.msg2_link2, LocaleController.getString(C2369R.string.VoipConferenceShareLink)));
            }
            if (this.birthdays != null) {
                iM1146dp = iM1146dp + addSection(this.items, LocaleController.getString(C2369R.string.BirthdayToday), this.birthdays.today, true) + addSection(this.items, LocaleController.getString(C2369R.string.BirthdayYesterday), this.birthdays.yesterday, true) + addSection(this.items, LocaleController.getString(C2369R.string.BirthdayTomorrow), this.birthdays.tomorrow, true);
            }
            int i4 = this.type;
            if ((i4 == 0 || i4 == 2) && (currentUser = UserConfig.getInstance(this.currentAccount).getCurrentUser()) != null) {
                this.items.add(SelectorAdapter.Item.asTopSection(LocaleController.getString(C2369R.string.Gift2MyselfSection)));
                SelectorAdapter.Item itemAsUser = SelectorAdapter.Item.asUser(currentUser, this.selectedIds.contains(Long.valueOf(currentUser.f1734id)));
                itemAsUser.subtext = LocaleController.getString(C2369R.string.Gift2Myself);
            ...
            if (!this.hints.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (user3 != null) {
                        long j3 = user3.f1734id;
                        if (j3 != this.userId && !user3.self && !user3.bot && !UserObject.isService(j3) && !UserObject.isDeleted(user3) && ((birthdayState2 = this.birthdays) == null || !birthdayState2.contains(user3.f1734id))) {
                            if (!this.excludeUserIds.contains(Long.valueOf(user3.f1734id))) {
                                if (this.selectedIds.contains(Long.valueOf(user3.f1734id))) {
                                    arrayList3.add(Long.valueOf(user3.f1734id));
                                }
                                iM1146dp += AndroidUtilities.m1146dp(56.0f);
                                arrayList4.add(decorate(SelectorAdapter.Item.asUser(user3, this.selectedIds.contains(Long.valueOf(user3.f1734id)))));
                            }
                        }
                    }
                }
                if (!arrayList4.isEmpty()) {
                    ...
                    itemAsTopSection = SelectorAdapter.Item.asTopSection(LocaleController.getString(C2369R.string.GiftPremiumFrequentContacts));
            ...
            for (String str : this.contactsLetters) {
                ...
                for (TLRPC.TL_contact tL_contact : (List) this.contactsMap.get(str)) {
                    ...
                    if (j4 != clientUserId && j4 != this.userId && ((birthdayState = this.birthdays) == null || !birthdayState.contains(j4))) {
                        if (!this.excludeUserIds.contains(Long.valueOf(tL_contact.user_id)) && (user = MessagesController.getInstance(this.currentAccount).getUser(Long.valueOf(tL_contact.user_id))) != null && !user.bot && !UserObject.isService(user.f1734id)) {
                            iM1146dp += AndroidUtilities.m1146dp(56.0f);
                            if (this.selectedIds.contains(Long.valueOf(user.f1734id))) {
                                arrayList3.add(Long.valueOf(user.f1734id));
                            }
                            arrayList5.add(decorate(SelectorAdapter.Item.asUser(user, this.selectedIds.contains(Long.valueOf(user.f1734id)))));
                        }
                    }
                }
            ...
            if (itemAsTopSection != null && arrayList3.size() > 0 && !this.selectedIds.isEmpty()) {
                itemAsTopSection.withRightText(LocaleController.getString(C2369R.string.DeselectAll), new View.OnClickListener() { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet$$ExternalSyntheticLambda11
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
    ...
    public /* synthetic */ void lambda$openOptions$22(final TLRPC.User user, View view) {
        ItemOptions.makeOptions(this.container, this.resourcesProvider, (View) view.getParent()).add(C2369R.drawable.msg_discuss, LocaleController.getString(C2369R.string.SendMessage), new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet$$ExternalSyntheticLambda22
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$openOptions$20(user);
            }
        }).add(C2369R.drawable.msg_openprofile, LocaleController.getString(C2369R.string.OpenProfile), new Runnable() { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet$$ExternalSyntheticLambda23
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$openOptions$20(TLRPC.User user) {
        ...
        bundle2.putLong("user_id", user.f1734id);
    ...
    protected CharSequence getTitle() {
        ...
        if (i != 0) {
            if (i == 1) {
                return LocaleController.getString(C2369R.string.GiftStarsTitle);
            }
            if (i != 2) {
                if (i == 4) {
                    return LocaleController.getString(C2369R.string.VoipConferenceAddPeople);
                }
                return LocaleController.getString(C2369R.string.GiftTelegramPremiumTitle);
            }
        }
        return LocaleController.getString(C2369R.string.GiftTelegramPremiumOrStarsTitle);
    }
    ...
    private void openBirthdaySetup() {
        AlertsCreator.createBirthdayPickerDialog(getContext(), LocaleController.getString(C2369R.string.EditProfileBirthdayTitle), LocaleController.getString(C2369R.string.EditProfileBirthdayButton), null, new Utilities.Callback() { // from class: org.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet$$ExternalSyntheticLambda26
            @Override // org.telegram.messenger.Utilities.Callback
            public final void run(Object obj) {
    ...
    public /* synthetic */ void lambda$openBirthdaySetup$26(TLObject tLObject, TLRPC.UserFull userFull, TL_account.TL_birthday tL_birthday, TLRPC.TL_error tL_error) {
        ...
        if (tLObject instanceof TLRPC.TL_boolTrue) {
            BulletinFactory.m1266of(this.bulletinContainer, this.resourcesProvider).createSimpleBulletin(C2369R.raw.contact_check, LocaleController.getString(C2369R.string.PrivacyBirthdaySetDone)).setDuration(5000).show();
            return;
        }
        if (userFull != null) {
            if (tL_birthday == null) {
        ...
        if (tL_error != null && (str = tL_error.text) != null && str.startsWith("FLOOD_WAIT_")) {
            if (getContext() != null) {
                new AlertDialog.Builder(getContext(), this.resourcesProvider).setTitle(LocaleController.getString(C2369R.string.PrivacyBirthdayTooOftenTitle)).setMessage(LocaleController.getString(C2369R.string.PrivacyBirthdayTooOftenMessage)).setPositiveButton(LocaleController.getString(C2369R.string.f1459OK), null).show();
                return;
            }
            return;
        }
        BulletinFactory.m1266of(this.bulletinContainer, this.resourcesProvider).createSimpleBulletin(C2369R.raw.error, LocaleController.getString(C2369R.string.UnknownError)).show();
    }
