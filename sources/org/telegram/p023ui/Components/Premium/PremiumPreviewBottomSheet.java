...
public class PremiumPreviewBottomSheet extends BottomSheetWithRecyclerListView implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumPreviewBottomSheet(final BaseFragment baseFragment, final int i, TLRPC.User user, GiftPremiumBottomSheet$GiftTier giftPremiumBottomSheet$GiftTier, TL_stars.StarGift starGift, Theme.ResourcesProvider resourcesProvider) {
        ...
        premiumGradientTools.f1945y1 = 1.0f;
        premiumGradientTools.f1944x2 = 0.0f;
        premiumGradientTools.f1946y2 = 0.0f;
        premiumGradientTools.f1941cx = 0.0f;
        premiumGradientTools.f1942cy = 0.0f;
        updateRows();
        this.recyclerListView.setPadding(AndroidUtilities.m1146dp(6.0f), 0, AndroidUtilities.m1146dp(6.0f), 0);
    ...
    */
    public void setTitle(boolean r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Premium.PremiumPreviewBottomSheet.setTitle(boolean):void");
    }
    ...
    protected CharSequence getTitle() {
        return LocaleController.getString(C2369R.string.TelegramPremium);
    }
    ...
    class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                shadowSectionCell = new View(context) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.7
                    ...
                    protected void onMeasure(int i5, int i6) {
                        super.onMeasure(i5, View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(68.0f), TLObject.FLAG_30));
                    }
                };
            } else if (i == 4) {
                ...
                shadowSectionCell = new PremiumFeatureCell(context, ((BottomSheet) PremiumPreviewBottomSheet.this).resourcesProvider) { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet.Adapter.6
                    ...
                    protected void dispatchDraw(Canvas canvas2) {
                        ...
                        canvas2.drawRoundRect(rectF, AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), PremiumPreviewBottomSheet.this.gradientTools.paint);
                ...
                String string = LocaleController.getString("GiftPremiumPrivacyPolicyAndTerms", C2369R.string.GiftPremiumPrivacyPolicyAndTerms);
                ...
                }), AndroidUtilities.replaceSingleTag(LocaleController.getString("GiftPremiumPrivacyPolicy", C2369R.string.GiftPremiumPrivacyPolicy), i5, 0, new Runnable() { // from class: org.telegram.ui.Components.Premium.PremiumPreviewBottomSheet$Adapter$$ExternalSyntheticLambda1
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$0() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2369R.string.TermsOfServiceUrl));
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$onCreateViewHolder$1() {
            Browser.openUrl(PremiumPreviewBottomSheet.this.fragment.getParentActivity(), LocaleController.getString(C2369R.string.PrivacyPolicyUrl));
        }
    ...
    protected boolean onCustomOpenAnimation() {
        ...
        this.enterAnimator.addListener(new C42534(rightDrawable));
    ...
    class C42534 extends AnimatorListenerAdapter {
        final /* synthetic */ Drawable val$startEnterFromDrawable;

        C42534(Drawable drawable) {
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        ...
        if (i == NotificationCenter.groupStickersDidLoad && (inputStickerSet = this.statusStickerSet) != null && inputStickerSet.f1596id == ((Long) objArr[0]).longValue()) {
            setTitle(true);
        }
    }
}
