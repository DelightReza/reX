...
import org.telegram.p023ui.Components.Premium.HelloParticles;
...
public class VideoScreenPreview extends FrameLayout implements PagerHeaderView, NotificationCenter.NotificationCenterDelegate {
    ...
    public VideoScreenPreview(Context context, SvgHelper.SvgDrawable svgDrawable, int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (i2 == 1) {
            ...
            drawable3.size1 = 4;
            drawable3.f1956k3 = 0.98f;
            drawable3.f1955k2 = 0.98f;
            drawable3.f1954k1 = 0.98f;
        ...
        AspectRatioFrameLayout aspectRatioFrameLayout = new AspectRatioFrameLayout(context) { // from class: org.telegram.ui.Components.Premium.VideoScreenPreview.1
            ...
            protected void onMeasure(int i4, int i5) {
                ...
                float fM1146dp = VideoScreenPreview.this.roundRadius - AndroidUtilities.m1146dp(3.0f);
                this.clipPath.addRoundRect(AndroidUtilities.rectTmp, fM1146dp, fM1146dp, Path.Direction.CW);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setVideo$0(File file) throws SecurityException, IOException, IllegalArgumentException {
        this.file = file;
        checkVideo();
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.size != measuredWidth) {
            ...
            if (matrixParticlesDrawable != null) {
                ...
                this.matrixParticlesDrawable.excludeRect.inset(AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(16.0f));
            }
            ...
            if (drawable != null) {
                ...
                if (i5 == 6 || i5 == 9 || i5 == 3 || i5 == 7 || i5 == 24 || i5 == 11 || i5 == 4) {
                    ...
                    this.starDrawable.rect.inset(AndroidUtilities.m1146dp(30.0f), AndroidUtilities.m1146dp(30.0f));
                } else {
                    RectF rectF = AndroidUtilities.rectTmp;
                ...
                this.starDrawable.excludeRect.inset(AndroidUtilities.m1146dp(10.0f), AndroidUtilities.m1146dp(10.0f));
            }
            ...
            if (speedLineParticles$Drawable != null) {
                ...
                this.speedLinesDrawable.rect.inset(AndroidUtilities.m1146dp(100.0f), AndroidUtilities.m1146dp(100.0f));
            ...
            if (drawable2 != null) {
                ...
                this.helloParticlesDrawable.rect.inset(AndroidUtilities.m1146dp(0.0f), getMeasuredHeight() * 0.1f);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        RectF rectF = AndroidUtilities.rectTmp;
        rectF.inset(-AndroidUtilities.m1146dp(3.0f), -AndroidUtilities.m1146dp(3.0f));
        rectF.inset(-AndroidUtilities.m1146dp(3.0f), -AndroidUtilities.m1146dp(3.0f));
        canvas.drawRoundRect(rectF, this.roundRadius + AndroidUtilities.m1146dp(3.0f), this.roundRadius + AndroidUtilities.m1146dp(3.0f), this.phoneFrame2);
        rectF.inset(AndroidUtilities.m1146dp(3.0f), AndroidUtilities.m1146dp(3.0f));
        ...
        float fM1146dp = this.roundRadius - AndroidUtilities.m1146dp(3.0f);
        this.roundRadius = fM1146dp;
        RoundedBitmapDrawable roundedBitmapDrawable = this.roundedBitmapDrawable;
        if (roundedBitmapDrawable != null) {
            roundedBitmapDrawable.setCornerRadius(fM1146dp);
        }
        ...
        canvas.drawCircle(this.imageReceiver.getCenterX(), this.imageReceiver.getImageY() + AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(6.0f), this.phoneFrame1);
    }
        ...
        if ((this.file != null || SharedConfig.streamMedia) && this.videoPlayerBase == null) {
            ...
            if (file != null && file.exists()) {
                ...
                try {
                    ...
                    sb.append("&id=");
                    sb.append(this.document.f1579id);
                    sb.append("&hash=");
