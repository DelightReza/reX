...
public class PremiumGradient {
    ...
    private PremiumGradient() {
        ...
        this.premiumStarDrawableMini = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2369R.drawable.msg_premium_liststar).mutate();
        this.premiumStarMenuDrawable = createGradientDrawable(ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2369R.drawable.msg_settings_premium));
        this.goldenStarMenuDrawable = createGradientDrawable(ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2369R.drawable.msg_settings_premium), premiumGradientTools2);
        this.premiumStarMenuDrawable2 = createGradientDrawable(ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2369R.drawable.msg_premium_normal));
        this.premiumStarColoredDrawable = ContextCompat.getDrawable(ApplicationLoader.applicationContext, C2369R.drawable.msg_premium_liststar).mutate();
    ...
    public static class PremiumGradientTools {
        ...
        /* renamed from: cx */
        public float f1941cx;

        /* renamed from: cy */
        public float f1942cy;
        ...
        /* renamed from: x1 */
        public float f1943x1;

        /* renamed from: x2 */
        public float f1944x2;

        /* renamed from: y1 */
        public float f1945y1;

        /* renamed from: y2 */
        public float f1946y2;
        ...
        public void gradientMatrix(int i, int i2, int i3, int i4, float f, float f2) {
            ...
            if (this.exactly) {
                this.matrix.reset();
                this.matrix.postScale((i3 - i) / 100.0f, i5 / 100.0f, this.f1941cx * 100.0f, this.f1942cy * 100.0f);
        ...
        public void chekColors() {
            ...
            iArr2[4] = color5;
            if (color3 == 0) {
                float f = this.f1943x1 * 100.0f;
                float f2 = this.f1945y1 * 100.0f;
                float f3 = this.f1944x2 * 100.0f;
                float f4 = this.f1946y2 * 100.0f;
                int[] iArr3 = this.colors;
                this.shader = new LinearGradient(f, f2, f3, f4, new int[]{iArr3[0], iArr3[1]}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
            } else if (color4 == 0) {
                float f5 = this.f1943x1 * 100.0f;
                float f6 = this.f1945y1 * 100.0f;
                float f7 = this.f1944x2 * 100.0f;
                float f8 = this.f1946y2 * 100.0f;
                ...
                float f9 = this.f1943x1 * 100.0f;
                float f10 = this.f1945y1 * 100.0f;
                float f11 = this.f1944x2 * 100.0f;
                float f12 = this.f1946y2 * 100.0f;
                ...
                float f13 = this.f1943x1 * 100.0f;
                float f14 = this.f1945y1 * 100.0f;
                float f15 = this.f1944x2 * 100.0f;
                float f16 = this.f1946y2 * 100.0f;
