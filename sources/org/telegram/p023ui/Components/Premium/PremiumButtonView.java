...
public class PremiumButtonView extends FrameLayout implements Loadable {
    ...
    public PremiumButtonView(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        this(context, AndroidUtilities.m1146dp(8.0f), z, resourcesProvider);
    }
    ...
    public PremiumButtonView(Context context, int i, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        AnimatedTextView animatedTextView = new AnimatedTextView(context, true, true, true) { // from class: org.telegram.ui.Components.Premium.PremiumButtonView.1
            ...
            protected void onDraw(Canvas canvas) {
                if (PremiumButtonView.this.loadingT > 0.0f) {
                    ...
                    int iM1146dp = (int) ((1.0f - PremiumButtonView.this.loadingT) * AndroidUtilities.m1146dp(24.0f));
                    PremiumButtonView.this.loadingDrawable.setBounds(0, iM1146dp, getWidth(), getHeight() + iM1146dp);
                ...
                if (PremiumButtonView.this.loadingT < 1.0f) {
                    if (PremiumButtonView.this.loadingT != 0.0f) {
                        canvas.save();
                        canvas.translate(0.0f, (int) (PremiumButtonView.this.loadingT * AndroidUtilities.m1146dp(-24.0f)));
        ...
        this.buttonTextView.setTextSize(AndroidUtilities.m1146dp(14.0f));
        ...
        this.buttonLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(i, 0, ColorUtils.setAlphaComponent(-1, Opcodes.ISHL)));
        ...
        if (z) {
            ...
            animatedTextView2.setPadding(AndroidUtilities.m1146dp(34.0f), 0, AndroidUtilities.m1146dp(34.0f), 0);
            ...
            this.overlayTextView.setTextSize(AndroidUtilities.m1146dp(14.0f));
            this.overlayTextView.setTypeface(AndroidUtilities.bold());
            this.overlayTextView.getDrawable().setAllowCancel(true);
            this.overlayTextView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), 0, ColorUtils.setAlphaComponent(-1, Opcodes.ISHL)));
    ...
    protected void dispatchDraw(Canvas canvas) {
        if (this.counterView != null) {
            this.counterOffset.set(((r0.counterDrawable.getWidth() * 0.85f) + AndroidUtilities.m1146dp(3.0f)) / 2.0f);
            this.counterOffset2.set((getMeasuredWidth() / 2.0f) + (this.overlayTextView.getDrawable().getWidth() / 2.0f) + AndroidUtilities.m1146dp(3.0f));
    ...
    public void updateOverlayProgress() {
        ...
        this.overlayTextView.setTranslationY(AndroidUtilities.m1146dp(12.0f) * (1.0f - this.overlayProgress));
        this.buttonLayout.setAlpha(1.0f - this.overlayProgress);
        this.buttonLayout.setTranslationY((-AndroidUtilities.m1146dp(12.0f)) * this.overlayProgress);
