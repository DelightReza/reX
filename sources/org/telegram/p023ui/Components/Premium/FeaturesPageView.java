...
public class FeaturesPageView extends BaseListPageView {
    ...
    */
    public FeaturesPageView(android.content.Context r17, int r18, org.telegram.ui.ActionBar.Theme.ResourcesProvider r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Premium.FeaturesPageView.<init>(android.content.Context, int, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }

    /* renamed from: $r8$lambda$dXX_8n-C6-cQoBeyITZRw1xIN6w, reason: not valid java name */
    public static /* synthetic */ int m10610$r8$lambda$dXX_8nC6cQoBeyITZRw1xIN6w(SparseIntArray sparseIntArray, Item item, Item item2) {
    ...
    @Override // org.telegram.p023ui.Components.Premium.BaseListPageView
    ...
    private class HeaderView extends FrameLayout {
        ...
        public HeaderView(Context context) {
            ...
            if (i == 0) {
                this.height = AndroidUtilities.m1146dp(150.0f);
                BackupImageView backupImageView = new BackupImageView(context);
                this.imageView = backupImageView;
                backupImageView.setRoundRadius((int) (AndroidUtilities.m1146dp(65.0f) / 2.0f));
                ...
                textView.setText(LocaleController.getString(C2369R.string.UpgradedStories));
            ...
            if (i == 1) {
                ...
                textView2.setText(LocaleController.getString(C2369R.string.TelegramBusiness));
                ...
                textView3.setText(LocaleController.getString(C2369R.string.TelegramBusinessSubtitle2));
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (FeaturesPageView.this.type == 0) {
                ...
                rectF.set(rect);
                rectF.inset(-AndroidUtilities.m1146dp(5.0f), -AndroidUtilities.m1146dp(5.0f));
