...
public class PremiumFeatureBottomSheet extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public PremiumFeatureBottomSheet(final BaseFragment baseFragment, Context context, int i, boolean z, int i2, final boolean z2, PremiumPreviewFragment.SubscriptionTier subscriptionTier, Theme.ResourcesProvider resourcesProvider) throws Resources.NotFoundException {
        ...
        this.svgIcon = SvgHelper.getDrawable(AndroidUtilities.readRes(C2369R.raw.star_loader));
        ...
        if (i2 == 40) {
            ...
            this.premiumFeatures.add(new PremiumPreviewFragment.PremiumFeatureData(40, C2369R.drawable.gift, LocaleController.getString(C2369R.string.FeaturePreviewGifts), LocaleController.getString(C2369R.string.FeaturePreviewGiftsDescription)));
        }
        int i3 = 0;
        while (true) {
        ...
        premiumGradientTools.f1945y1 = 1.1f;
        premiumGradientTools.f1944x2 = 1.5f;
        premiumGradientTools.f1946y2 = -0.2f;
        ...
        this.content = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.2
            ...
            protected void onMeasure(int i4, int i5) {
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(PremiumFeatureBottomSheet.this.contentHeight + AndroidUtilities.m1146dp(2.0f), TLObject.FLAG_30));
            }
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                rectF.set(0.0f, AndroidUtilities.m1146dp(2.0f), getMeasuredWidth(), getMeasuredHeight() + AndroidUtilities.m1146dp(18.0f));
                canvas.save();
                canvas.clipRect(0, 0, getMeasuredWidth(), getMeasuredHeight());
                premiumGradientTools.paint.setAlpha(PremiumFeatureBottomSheet.this.gradientAlpha);
                canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(12.0f) - 1, AndroidUtilities.m1146dp(12.0f) - 1, premiumGradientTools.paint);
                canvas.restore();
        ...
        imageView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(12.0f), ColorUtils.setAlphaComponent(-1, 40), ColorUtils.setAlphaComponent(-1, 100)));
        ...
        ViewPager viewPager = new ViewPager(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.3
                ...
                try {
                    ...
                    Scroller scroller = new Scroller(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.3.1
                        ...
                        public void startScroll(int i4, int i5, int i6, int i7, int i8) {
                            super.startScroll(i4, i5, i6, i7, (C42433.this.smoothScroll ? 3 : 1) * i8);
                        }
                    };
            ...
            protected void onMeasure(int i4, int i5) throws Resources.NotFoundException {
                ...
                if (getChildCount() > 0) {
                    ...
                    iM1146dp = getChildAt(0).getMeasuredHeight();
                }
                super.onMeasure(i4, View.MeasureSpec.makeMeasureSpec(iM1146dp + PremiumFeatureBottomSheet.this.topGlobalOffset, TLObject.FLAG_30));
            }
        ...
        this.viewPager.addOnPageChangeListener(new C42455(bottomPagesView));
        ...
        if (i2 == 40) {
            this.premiumButtonView.setOverlayText(StarGiftSheet.replaceUnderstood(LocaleController.getString(C2369R.string.Understood)), true, false);
        } else if (UserConfig.getInstance(i).isPremium()) {
            this.premiumButtonView.setOverlayText(LocaleController.getString(C2369R.string.f1459OK), false, false);
        }
        ...
        final Drawable drawableMutate = ContextCompat.getDrawable(getContext(), C2369R.drawable.header_shadow).mutate();
        FrameLayout frameLayout3 = new FrameLayout(getContext()) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.6
            ...
            protected void dispatchDraw(Canvas canvas) {
                ...
                PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                drawable.setBounds(0, ((premiumFeatureBottomSheet.topCurrentOffset + ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) - AndroidUtilities.m1146dp(2.0f)) + 1, getMeasuredWidth(), getMeasuredHeight());
            ...
            protected boolean drawChild(Canvas canvas, View view, long j) {
                if (view == scrollView) {
                    ...
                    this.path.rewind();
                    RectF rectF = AndroidUtilities.rectTmp;
                    rectF.set(0.0f, PremiumFeatureBottomSheet.this.topCurrentOffset + AndroidUtilities.m1146dp(18.0f), getMeasuredWidth(), getMeasuredHeight());
                    this.path.addRoundRect(rectF, AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(18.0f), Path.Direction.CW);
            ...
            public boolean dispatchTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() == 0) {
                    ...
                    PremiumFeatureBottomSheet premiumFeatureBottomSheet = PremiumFeatureBottomSheet.this;
                    if (y < (premiumFeatureBottomSheet.topCurrentOffset - ((BottomSheet) premiumFeatureBottomSheet).backgroundPaddingTop) + AndroidUtilities.m1146dp(2.0f)) {
    ...
    class C42455 implements ViewPager.OnPageChangeListener {
        ...
        C42455(BottomPagesView bottomPagesView) {
        ...
        public void onPageSelected(int i) {
            if (((PremiumPreviewFragment.PremiumFeatureData) PremiumFeatureBottomSheet.this.premiumFeatures.get(i)).type == 0) {
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString(C2369R.string.DoubledLimits));
                ...
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString(C2369R.string.UpgradedStories));
                PremiumFeatureBottomSheet.this.actionBar.requestLayout();
            } else if (((PremiumPreviewFragment.PremiumFeatureData) PremiumFeatureBottomSheet.this.premiumFeatures.get(i)).type == 40) {
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString(C2369R.string.FeaturePreviewGifts));
                PremiumFeatureBottomSheet.this.actionBar.requestLayout();
            } else if (((PremiumPreviewFragment.PremiumFeatureData) PremiumFeatureBottomSheet.this.premiumFeatures.get(i)).type == 28) {
                PremiumFeatureBottomSheet.this.actionBar.setTitle(LocaleController.getString(C2369R.string.TelegramBusiness));
                PremiumFeatureBottomSheet.this.actionBar.requestLayout();
            }
            checkPage();
        }
        ...
        */
        private void checkPage() {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Premium.PremiumFeatureBottomSheet.C42455.checkPage():void");
        }
    ...
    private void setButtonText() {
        if (this.forceAbout) {
            this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2369R.string.AboutTelegramPremium));
            return;
        }
        if (this.onlySelectedType) {
            int i = this.startType;
            if (i == 4) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2369R.string.UnlockPremiumReactions));
                this.premiumButtonView.setIcon(C2369R.raw.unlock_icon);
                return;
            } else if (i == 10) {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2369R.string.UnlockPremiumIcons));
                this.premiumButtonView.setIcon(C2369R.raw.unlock_icon);
                return;
            } else {
                this.premiumButtonView.buttonTextView.setText(LocaleController.getString(C2369R.string.AboutTelegramPremium));
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.actionBar.setExtraHeight(AndroidUtilities.m1146dp(2.0f));
        ...
        ((FrameLayout.LayoutParams) this.actionBar.getLayoutParams()).topMargin = (-this.backgroundPaddingTop) - AndroidUtilities.m1146dp(2.0f);
        ...
        if (((PremiumPreviewFragment.PremiumFeatureData) this.premiumFeatures.get(this.selectedPosition)).type == 14) {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.UpgradedStories));
            this.actionBar.requestLayout();
        } else if (((PremiumPreviewFragment.PremiumFeatureData) this.premiumFeatures.get(this.selectedPosition)).type == 28) {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.TelegramBusiness));
            this.actionBar.requestLayout();
        } else if (((PremiumPreviewFragment.PremiumFeatureData) this.premiumFeatures.get(this.selectedPosition)).type == 40) {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.FeaturePreviewGifts));
            this.actionBar.requestLayout();
        } else {
            this.actionBar.setTitle(LocaleController.getString(C2369R.string.DoubledLimits));
            this.actionBar.requestLayout();
        }
    }
    ...
    public void didReceivedNotification(int i, int i2, Object... objArr) {
        if (i == NotificationCenter.billingProductDetailsUpdated || i == NotificationCenter.premiumPromoUpdated) {
            ...
            if (UserConfig.getInstance(this.currentAccount).isPremium()) {
                this.premiumButtonView.setOverlayText(LocaleController.getString(C2369R.string.f1459OK), false, true);
            } else {
                this.premiumButtonView.clearOverlayText();
            }
        }
    ...
    private class ViewPage extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (((BottomSheet) PremiumFeatureBottomSheet.this).isPortrait) {
                marginLayoutParams.topMargin = AndroidUtilities.m1146dp(20.0f);
                marginLayoutParams.bottomMargin = 0;
            } else {
                marginLayoutParams.topMargin = AndroidUtilities.m1146dp(10.0f);
                marginLayoutParams.bottomMargin = AndroidUtilities.m1146dp(10.0f);
            }
            ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = 0;
            super.onMeasure(i, i2);
            if (this.topViewOnFullHeight) {
                this.topView.getLayoutParams().height = getMeasuredHeight() - AndroidUtilities.m1146dp(16.0f);
                ((ViewGroup.MarginLayoutParams) this.topView.getLayoutParams()).bottomMargin = AndroidUtilities.m1146dp(16.0f);
        ...
        void setFeatureDate(PremiumPreviewFragment.PremiumFeatureData premiumFeatureData) {
            ...
            if (i == 0 || i == 14 || i == 28) {
                ...
                if (PremiumFeatureBottomSheet.this.startType == 4) {
                    this.title.setText(LocaleController.getString(C2369R.string.AdditionalReactions));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.AdditionalReactionsDescription)));
                } else if (PremiumFeatureBottomSheet.this.startType == 3) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewNoAds));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewNoAdsDescription2)));
                } else if (PremiumFeatureBottomSheet.this.startType == 24) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewTags));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewTagsDescription)));
                } else if (PremiumFeatureBottomSheet.this.startType == 10) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewAppIcon));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewAppIconDescription2)));
                } else if (PremiumFeatureBottomSheet.this.startType == 2) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewDownloadSpeed));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewDownloadSpeedDescription2)));
                } else if (PremiumFeatureBottomSheet.this.startType == 9) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewAdvancedChatManagement));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewAdvancedChatManagementDescription2)));
                } else if (PremiumFeatureBottomSheet.this.startType == 8) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewVoiceToText));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewVoiceToTextDescription2)));
                } else if (PremiumFeatureBottomSheet.this.startType == 13) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewTranslations));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewTranslationsDescription)));
                } else if (PremiumFeatureBottomSheet.this.startType == 38) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewEffects));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewEffectsDescription)));
                } else if (PremiumFeatureBottomSheet.this.startType == 22) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewWallpaper));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewWallpaperDescription)));
                } else if (PremiumFeatureBottomSheet.this.startType == 23) {
                    this.title.setText(LocaleController.getString(C2369R.string.PremiumPreviewProfileColor));
                    this.description.setText(AndroidUtilities.replaceTags(LocaleController.getString(C2369R.string.PremiumPreviewProfileColorDescription)));
                } else {
            ...
            if (z && this.featuresLayout == null) {
                ...
                featureCell.set(C2369R.drawable.menu_feature_unique, LocaleController.getString(C2369R.string.GiftsFeature1Title), LocaleController.getString(C2369R.string.GiftsFeature1Text));
                ...
                featureCell2.set(C2369R.drawable.menu_feature_tradable, LocaleController.getString(C2369R.string.GiftsFeature2Title), LocaleController.getString(C2369R.string.GiftsFeature2Text));
                ...
                featureCell3.set(C2369R.drawable.menu_wear, LocaleController.getString(C2369R.string.GiftsFeature3Title), LocaleController.getString(C2369R.string.GiftsFeature3Text));
            ...
            ((ViewGroup.MarginLayoutParams) this.description.getLayoutParams()).topMargin = AndroidUtilities.m1146dp(z ? 6.0f : 10.0f);
        }
    }
    ...
    View getViewForPosition(Context context, int i) {
        ...
        if (i2 == 5) {
            return new PremiumStickersPreviewRecycler(context, this.currentAccount) { // from class: org.telegram.ui.Components.Premium.PremiumFeatureBottomSheet.11
                @Override // org.telegram.p023ui.Components.Premium.PremiumStickersPreviewRecycler, org.telegram.p023ui.Components.Premium.PagerHeaderView
    ...
    void checkTopOffset() {
        ...
        if (iMin != this.topCurrentOffset) {
            ...
            AndroidUtilities.updateViewVisibilityAnimated(this.actionBar, this.topCurrentOffset < AndroidUtilities.m1146dp(this.startType == 40 ? 5.0f : 30.0f), 1.0f, true);
        }
    }
