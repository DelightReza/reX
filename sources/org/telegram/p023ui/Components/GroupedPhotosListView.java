...
public class GroupedPhotosListView extends View implements GestureDetector.OnGestureListener {
    ...
    public GroupedPhotosListView(Context context, int i) {
        ...
        this.itemWidth = AndroidUtilities.m1146dp(42.0f);
        this.itemHeight = AndroidUtilities.m1146dp(56.0f);
        this.itemSpacing = AndroidUtilities.m1146dp(1.0f);
        this.itemY = i;
    ...
    */
    public void fillList() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.GroupedPhotosListView.fillList():void");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.hasPhotos || !this.imagesToDraw.isEmpty()) {
            ...
            if (imageLocation != null && (photoSize2 = imageLocation.photoSize) != null) {
                iMax = Math.max(this.itemWidth, (int) (photoSize2.f1605w * (this.itemHeight / photoSize2.f1604h)));
            } else {
            ...
            if (i5 >= 0 && i5 < this.currentPhotos.size()) {
                ...
                if (imageLocation2 != null && (photoSize = imageLocation2.photoSize) != null) {
                    iMax2 = Math.max(this.itemWidth, (int) (photoSize.f1605w * (this.itemHeight / photoSize.f1604h)));
                } else {
