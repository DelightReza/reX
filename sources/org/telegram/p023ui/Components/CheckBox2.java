...
public class CheckBox2 extends View {
    ...
    protected void onDraw(Canvas canvas) {
        if (this.iconDrawable != null) {
            ...
            this.paint.setStrokeWidth(AndroidUtilities.m1146dp(1.2f));
            this.paint.setColor(Theme.getColor(Theme.key_switch2Track));
            canvas.drawCircle(measuredWidth, measuredHeight, measuredWidth - AndroidUtilities.m1146dp(1.5f), this.paint);
            return;
        }
