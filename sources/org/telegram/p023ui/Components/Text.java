...
public class Text {
    ...
    public Text(CharSequence charSequence, float f, Typeface typeface) {
        ...
        this.paint = textPaint;
        textPaint.setTextSize(AndroidUtilities.m1146dp(f));
    ...
    public Text setShadow(float f) {
        this.paint.setShadowLayer(AndroidUtilities.m1146dp(1.0f), 0.0f, AndroidUtilities.m1146dp(0.66f), Theme.multAlpha(-16777216, f));
        return this;
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.ellipsizeGradient == null) {
            this.ellipsizeGradient = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1146dp(8.0f), 0.0f, new int[]{16777215, -1}, new float[]{0.0f, 1.0f}, Shader.TileMode.CLAMP);
        ...
        this.ellipsizeMatrix.postTranslate(this.ellipsizeWidth - AndroidUtilities.m1146dp(8.0f), 0.0f);
        this.ellipsizeGradient.setLocalMatrix(this.ellipsizeMatrix);
        canvas.drawRect(this.ellipsizeWidth - AndroidUtilities.m1146dp(8.0f), 0.0f, this.ellipsizeWidth, this.layout.getHeight(), this.ellipsizePaint);
        canvas.restore();
        canvas.restore();
    }
