    ...
    */
    public static /* synthetic */ int $r8$lambda$Jxjb1g4dHVPktfHUABWJR3wxpuE(org.telegram.messenger.MessagesController r4, int r5, org.telegram.tgnet.TLObject r6, org.telegram.tgnet.TLObject r7) {
        ...
        L6c:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.GroupVoipInviteAlert.$r8$lambda$Jxjb1g4dHVPktfHUABWJR3wxpuE(org.telegram.messenger.MessagesController, int, org.telegram.tgnet.TLObject, org.telegram.tgnet.TLObject):int");
    }
    ...
    class SearchAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void searchUsers(final String str) {
            ...
            this.searchAdapterHelper.queryServerSearch(null, true, false, true, false, false, GroupVoipInviteAlert.this.currentChat.f1571id, false, 2, -1);
        ...
        public /* synthetic */ void lambda$processSearch$2(final String str, final int i) {
            ...
            this.searchAdapterHelper.queryServerSearch(str, ChatObject.canAddUsers(GroupVoipInviteAlert.this.currentChat), false, true, false, false, ChatObject.isChannel(GroupVoipInviteAlert.this.currentChat) ? GroupVoipInviteAlert.this.currentChat.f1571id : 0L, false, 2, i);
        }
        ...
        */
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                manageChatUserCell.setCustomRightImage(C2369R.drawable.msg_invited);
                ...
                view2.setLayoutParams(new RecyclerView.LayoutParams(-1, AndroidUtilities.m1146dp(56.0f)));
                view = view2;
            } else {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            manageChatUserCell.setCustomImageVisible(GroupVoipInviteAlert.this.invitedUsers.contains(Long.valueOf(user.f1734id)));
    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                manageChatUserCell2.setCustomRightImage(C2369R.drawable.msg_invited);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ...
                    if (i == GroupVoipInviteAlert.this.addNewRow) {
                        manageChatTextCell.setText(LocaleController.getString(C2369R.string.VoipGroupCopyInviteLink), null, C2369R.drawable.msg_link, 7, (!GroupVoipInviteAlert.this.loadingUsers || GroupVoipInviteAlert.this.firstLoaded) && GroupVoipInviteAlert.this.membersHeaderRow == -1 && !GroupVoipInviteAlert.this.participants.isEmpty());
                        return;
                    }
                    return;
                }
                ...
                if (i == GroupVoipInviteAlert.this.membersHeaderRow) {
                    graySectionCell.setText(LocaleController.getString(C2369R.string.ChannelOtherMembers));
                    return;
                } else {
                    if (i == GroupVoipInviteAlert.this.contactsHeaderRow) {
                        if (GroupVoipInviteAlert.this.showContacts) {
                            graySectionCell.setText(LocaleController.getString(C2369R.string.YourContactsToInvite));
                            return;
                        } else {
                            graySectionCell.setText(LocaleController.getString(C2369R.string.GroupContacts));
                            return;
                        }
                    }
                    return;
            ...
            if (item instanceof TLRPC.TL_contact) {
                ...
                peerId = ((TLRPC.User) item).f1734id;
            } else if (item instanceof TLRPC.ChannelParticipant) {
