    ...
    */
    protected java.lang.String downloadUrlContent(android.os.AsyncTask r19, java.lang.String r20, java.util.HashMap r21, boolean r22) throws java.io.IOException {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.WebPlayerView.downloadUrlContent(android.os.AsyncTask, java.lang.String, java.util.HashMap, boolean):java.lang.String");
    }
    ...
    class YoutubeVideoTask extends AsyncTask {
        ...
        /*
            ...
            To view partially-correct add '--show-bad-code' argument
        */
        public java.lang.String[] doInBackground(java.lang.Void... r25) throws org.json.JSONException, java.lang.InterruptedException, java.io.UnsupportedEncodingException {
            /*
        ...
        public void onPostExecute(String[] strArr) {
            if (strArr[0] != null) {
                if (BuildVars.LOGS_ENABLED) {
                    FileLog.m1157d("start play youtube video " + strArr[1] + " " + strArr[0]);
                }
    ...
    private class VimeoVideoTask extends AsyncTask {
        ...
        public String doInBackground(Void... voidArr) throws JSONException {
            ...
            try {
                JSONObject jSONObject = new JSONObject(strDownloadUrlContent).getJSONObject(PluginsConstants.REQUEST).getJSONObject("files");
    ...
    class ControlsView extends FrameLayout {
        ...
        public void setDuration(int i) {
            ...
            this.duration = i;
            StaticLayout staticLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.duration), this.textPaint, AndroidUtilities.m1146dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
        ...
        public void setProgress(int i) {
            ...
            this.progress = i;
            this.progressLayout = new StaticLayout(AndroidUtilities.formatShortDuration(this.progress), this.textPaint, AndroidUtilities.m1146dp(1000.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
            invalidate();
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (WebPlayerView.this.inFullscreen) {
                iM1146dp = AndroidUtilities.m1146dp(36.0f) + this.durationWidth;
                measuredWidth = (getMeasuredWidth() - AndroidUtilities.m1146dp(76.0f)) - this.durationWidth;
                measuredHeight = getMeasuredHeight() - AndroidUtilities.m1146dp(28.0f);
            } else {
                measuredWidth = getMeasuredWidth();
                measuredHeight = getMeasuredHeight() - AndroidUtilities.m1146dp(12.0f);
                iM1146dp = 0;
            }
            int i = this.duration;
            int i2 = (i != 0 ? (int) ((measuredWidth - iM1146dp) * (this.progress / i)) : 0) + iM1146dp;
            if (motionEvent.getAction() == 0) {
                if (this.isVisible && !WebPlayerView.this.isInline && !WebPlayerView.this.isStream) {
                    if (this.duration != 0) {
                        int x = (int) motionEvent.getX();
                        int y = (int) motionEvent.getY();
                        if (x >= i2 - AndroidUtilities.m1146dp(10.0f) && x <= AndroidUtilities.m1146dp(10.0f) + i2 && y >= measuredHeight - AndroidUtilities.m1146dp(10.0f) && y <= measuredHeight + AndroidUtilities.m1146dp(10.0f)) {
                ...
                if (this.progressPressed) {
                    ...
                    if (WebPlayerView.this.initied) {
                        this.progress = (int) (this.duration * ((this.currentProgressX - iM1146dp) / (measuredWidth - iM1146dp)));
                ...
                if (i3 < iM1146dp) {
                    this.currentProgressX = iM1146dp;
                } else if (i3 > measuredWidth) {
                    this.currentProgressX = measuredWidth;
                }
                setProgress((int) (this.duration * MediaDataController.MAX_STYLE_RUNS_COUNT * ((this.currentProgressX - iM1146dp) / (measuredWidth - iM1146dp))));
                invalidate();
            }
    ...
    public WebPlayerView(final Context context, boolean z, boolean z2, WebPlayerViewDelegate webPlayerViewDelegate) {
        ...
        if (z2) {
            ...
            this.shareButton.setImageResource(C2369R.drawable.ic_share_video);
    ...
    public /* synthetic */ void lambda$new$3(View view) {
        ...
        if (viewGroup != this) {
            ...
            this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() - AndroidUtilities.m1146dp(10.0f), TLObject.FLAG_30));
        }
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawRect(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1146dp(10.0f), this.backgroundPaint);
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int i6 = i4 - i2;
        int iM1146dp = ((i6 - AndroidUtilities.m1146dp(10.0f)) - this.aspectRatioFrameLayout.getMeasuredHeight()) / 2;
        AspectRatioFrameLayout aspectRatioFrameLayout = this.aspectRatioFrameLayout;
        aspectRatioFrameLayout.layout(measuredWidth, iM1146dp, aspectRatioFrameLayout.getMeasuredWidth() + measuredWidth, this.aspectRatioFrameLayout.getMeasuredHeight() + iM1146dp);
        if (this.controlsView.getParent() == this) {
        ...
        this.controlsView.imageReceiver.setImageCoords(0.0f, 0.0f, getMeasuredWidth(), getMeasuredHeight() - AndroidUtilities.m1146dp(10.0f));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.aspectRatioFrameLayout.measure(View.MeasureSpec.makeMeasureSpec(size, TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(size2 - AndroidUtilities.m1146dp(10.0f), TLObject.FLAG_30));
        if (this.controlsView.getParent() == this) {
        ...
        this.progressView.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(44.0f), TLObject.FLAG_30), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(44.0f), TLObject.FLAG_30));
    ...
    public void updatePlayButton() {
        ...
        if (!this.videoPlayer.isPlaying()) {
            if (this.isCompleted) {
                this.playButton.setImageResource(this.isInline ? C2369R.drawable.ic_againinline : C2369R.drawable.ic_again);
                return;
            } else {
                this.playButton.setImageResource(this.isInline ? C2369R.drawable.ic_playinline : C2369R.drawable.ic_play);
                return;
            }
        }
        this.playButton.setImageResource(this.isInline ? C2369R.drawable.ic_pauseinline : C2369R.drawable.ic_pause);
    ...
    public void updateFullscreenButton() {
        ...
        if (!this.inFullscreen) {
            this.fullscreenButton.setImageResource(C2369R.drawable.ic_gofullscreen);
            this.fullscreenButton.setLayoutParams(LayoutHelper.createFrame(56, 56.0f, 85, 0.0f, 0.0f, 0.0f, 5.0f));
        } else {
            this.fullscreenButton.setImageResource(C2369R.drawable.ic_outfullscreen);
    ...
    public void updateInlineButton() {
        ...
        imageView.setImageResource(this.isInline ? C2369R.drawable.ic_goinline : C2369R.drawable.ic_outinline);
    ...
    */
    public boolean loadVideo(java.lang.String r27, org.telegram.tgnet.TLRPC.Photo r28, java.lang.Object r29, java.lang.String r30, boolean r31) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.WebPlayerView.loadVideo(java.lang.String, org.telegram.tgnet.TLRPC$Photo, java.lang.Object, java.lang.String, boolean):boolean");
    }
