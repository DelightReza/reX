...
public class ContextProgressView extends View {
    ...
    public ContextProgressView(Context context, int i) {
        ...
        this.innerPaint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.cicleRect.set((getMeasuredWidth() / 2) - AndroidUtilities.m1146dp(9.0f), (getMeasuredHeight() / 2) - AndroidUtilities.m1146dp(9.0f), r0 + AndroidUtilities.m1146dp(18.0f), r2 + AndroidUtilities.m1146dp(18.0f));
        canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, AndroidUtilities.m1146dp(9.0f), this.innerPaint);
