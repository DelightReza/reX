...
public class DownloadsInfoBottomSheet extends BottomSheet {
    ...
    public DownloadsInfoBottomSheet(Context context, final BaseFragment baseFragment, boolean z) {
        ...
        textView.setText(LocaleController.getString(C2369R.string.DownloadedFiles));
        ...
        textView2.setText(LocaleController.formatString("DownloadedFilesMessage", C2369R.string.DownloadedFilesMessage, new Object[0]));
        ...
        textView3.setText(LocaleController.getString(C2369R.string.ManageDeviceStorage));
        ...
        textView3.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1146dp2, Theme.getColor(i3), ColorUtils.setAlphaComponent(Theme.getColor(i), Opcodes.ISHL)));
        ...
        textView4.setText(LocaleController.getString(C2369R.string.ClearDownloadsList));
        textView4.setTextColor(Theme.getColor(i3));
        textView4.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i3), Opcodes.ISHL)));
