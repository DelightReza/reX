...
public class CheckBoxSquare extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.rectF.set(fM1146dp, fM1146dp, AndroidUtilities.m1146dp(18.0f) - fM1146dp, AndroidUtilities.m1146dp(18.0f) - fM1146dp);
        this.drawBitmap.eraseColor(0);
        this.drawCanvas.drawRoundRect(this.rectF, AndroidUtilities.m1146dp(2.0f), AndroidUtilities.m1146dp(2.0f), Theme.checkboxSquare_backgroundPaint);
        if (f2 != 1.0f) {
            float fMin = Math.min(AndroidUtilities.m1146dp(7.0f), (AndroidUtilities.m1146dp(7.0f) * f2) + fM1146dp);
            this.rectF.set(AndroidUtilities.m1146dp(2.0f) + fMin, AndroidUtilities.m1146dp(2.0f) + fMin, AndroidUtilities.m1146dp(16.0f) - fMin, AndroidUtilities.m1146dp(16.0f) - fMin);
        ...
        if (this.progress > 0.5f) {
            ...
            float f4 = 1.0f - f;
            this.drawCanvas.drawLine(AndroidUtilities.m1146dp(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.m1146dp(7.0f) - (AndroidUtilities.m1146dp(3.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m1146dp(3.0f) * f4)), Theme.checkboxSquare_checkPaint);
            this.drawCanvas.drawLine((int) AndroidUtilities.dpf2(7.0f), (int) AndroidUtilities.dpf2(13.0f), (int) (AndroidUtilities.dpf2(7.0f) + (AndroidUtilities.m1146dp(7.0f) * f4)), (int) (AndroidUtilities.dpf2(13.0f) - (AndroidUtilities.m1146dp(7.0f) * f4)), Theme.checkboxSquare_checkPaint);
        }
