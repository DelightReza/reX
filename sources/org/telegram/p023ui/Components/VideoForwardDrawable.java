...
public class VideoForwardDrawable extends Drawable {
    ...
    public VideoForwardDrawable(boolean z) {
        ...
        while (true) {
            ...
            if (i == 0) {
                int i2 = i * 2;
                this.path1.moveTo(AndroidUtilities.m1146dp(r0[i2]), AndroidUtilities.m1146dp(r0[i2 + 1]));
            } else {
                int i3 = i * 2;
                this.path1.lineTo(AndroidUtilities.m1146dp(r0[i3]), AndroidUtilities.m1146dp(r0[i3 + 1]));
            }
            i++;
        }
    }
    ...
    */
    public void draw(android.graphics.Canvas r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.VideoForwardDrawable.draw(android.graphics.Canvas):void");
    }
