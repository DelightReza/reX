...
import org.telegram.p023ui.Stories.recorder.GallerySheet;
...
public class PhotoViewerCoverEditor extends FrameLayout {
    ...
    public PhotoViewerCoverEditor(final Context context, final Theme.ResourcesProvider resourcesProvider, PhotoViewer photoViewer, BlurringShader.BlurManager blurManager) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.EditorSetCoverTitle));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2369R.string.EditorSetCoverSave), false);
        addView(this.button, LayoutHelper.createFrame(-1, 48.0f, 87, 10.0f, 10.0f, 10.0f, 10.0f));
        EditCoverButton editCoverButton = new EditCoverButton(context, photoViewer, LocaleController.getString(C2369R.string.EditorSetCoverGallery), true);
        ...
        this.timelineView.setDelegate(new C41682());
    }
    ...
    public /* synthetic */ void lambda$new$1(Context context, Theme.ResourcesProvider resourcesProvider, View view) {
        if (this.gallerySheet == null) {
            GallerySheet gallerySheet = new GallerySheet(context, resourcesProvider, LocaleController.getString(C2369R.string.VideoChooseCover), true, this.aspectRatio);
    ...
    /* renamed from: org.telegram.ui.Components.PhotoViewerCoverEditor$2 */
    class C41682 implements TimelineView.TimelineDelegate {
