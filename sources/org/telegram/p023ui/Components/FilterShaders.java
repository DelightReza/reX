...
public class FilterShaders {
    ...
    private static class ToneCurve {
            ...
            while (i < length - 1) {
                ...
                while (true) {
                    ...
                    if (i3 < ((int) f)) {
                        ...
                        int i4 = length;
                        double d3 = f3;
                        float f4 = (float) ((pointF.y * d2) + (pointF2.y * d) + (((d3 * d3) / 6.0d) * (((((d2 * d2) * d2) - d2) * dArr[i]) + ((((d * d) * d) - d) * dArr[i2]))));
                        if (f4 > 255.0f) {
                            f4 = 255.0f;
                        } else if (f4 < 0.0f) {
                            f4 = 0.0f;
        ...
        private double[] secondDerivative(ArrayList arrayList) {
            ...
            for (int i4 = 1; i4 < size; i4++) {
                ...
                double d6 = d5 / dArr7[1];
                dArr6[1] = dArr6[1] - (dArr7[2] * d6);
                dArr6[0] = d4;
    ...
    private boolean setupExternalShaders() {
        ...
        while (true) {
            ...
            if (i < (z2 ? 2 : 1)) {
                ...
                GLES20.glAttachShader(this.rgbToHsvShaderProgram[i], iLoadShader5);
                GLES20.glAttachShader(this.rgbToHsvShaderProgram[i], iLoadShader6);
                ...
                GLES20.glGetProgramiv(this.rgbToHsvShaderProgram[i], 35714, iArr, 0);
                if (iArr[0] == 0) {
                    GLES20.glDeleteProgram(this.rgbToHsvShaderProgram[i]);
    ...
    public boolean drawBlurPass() {
        ...
        if (blurType == 1) {
            ...
            GLES20.glUniform2f(this.radialBlurExcludePointHandle, blurExcludePoint.f1929x, blurExcludePoint.f1930y);
            ...
            GLES20.glUniform2f(this.linearBlurExcludePointHandle, blurExcludePoint2.f1929x, blurExcludePoint2.f1930y);
