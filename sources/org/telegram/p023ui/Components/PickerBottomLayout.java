...
public class PickerBottomLayout extends FrameLayout {
    ...
    public PickerBottomLayout(Context context, boolean z, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.cancelButton.setPadding(AndroidUtilities.m1146dp(33.0f), 0, AndroidUtilities.m1146dp(33.0f), 0);
        this.cancelButton.setText(LocaleController.getString(C2369R.string.Cancel).toUpperCase());
        ...
        this.doneButton.setPadding(AndroidUtilities.m1146dp(33.0f), 0, AndroidUtilities.m1146dp(33.0f), 0);
        ...
        this.doneButtonBadgeTextView.setBackgroundDrawable(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(11.0f), Theme.getColor(Theme.key_picker_badge, resourcesProvider)));
        this.doneButtonBadgeTextView.setMinWidth(AndroidUtilities.m1146dp(23.0f));
        this.doneButtonBadgeTextView.setPadding(AndroidUtilities.m1146dp(8.0f), 0, AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(1.0f));
        ...
        this.doneButtonTextView.setCompoundDrawablePadding(AndroidUtilities.m1146dp(8.0f));
        this.doneButtonTextView.setText(LocaleController.getString(C2369R.string.Send).toUpperCase());
