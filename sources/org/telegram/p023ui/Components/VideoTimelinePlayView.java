...
public abstract class VideoTimelinePlayView extends View {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int measuredWidth = getMeasuredWidth() - AndroidUtilities.m1146dp(44.0f);
        float f = measuredWidth;
        int iM1146dp = ((int) (this.progressLeft * f)) + AndroidUtilities.m1146dp(22.0f);
        int iM1146dp2 = ((int) (this.playProgress * f)) + AndroidUtilities.m1146dp(22.0f);
        int iM1146dp3 = ((int) (this.progressRight * f)) + AndroidUtilities.m1146dp(22.0f);
        if (motionEvent.getAction() == 0) {
            ...
            int iM1146dp5 = AndroidUtilities.m1146dp(8.0f);
            if (iM1146dp3 != iM1146dp && iM1146dp2 - iM1146dp5 <= x && x <= iM1146dp5 + iM1146dp2 && y >= 0.0f && y <= getMeasuredHeight()) {
            ...
            if (iM1146dp - iM1146dp4 <= x && x <= Math.min(iM1146dp + iM1146dp4, iM1146dp3) && y >= 0.0f && y <= getMeasuredHeight()) {
            ...
            if (iM1146dp3 - iM1146dp4 <= x && x <= iM1146dp4 + iM1146dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressDx = (int) (x - iM1146dp3);
                invalidate();
                return true;
            }
            if (iM1146dp <= x && x <= iM1146dp3 && y >= 0.0f && y <= getMeasuredHeight()) {
                ...
                this.pressedPlay = true;
                float fM1146dp = (x - AndroidUtilities.m1146dp(16.0f)) / f;
                this.playProgress = fM1146dp;
                VideoTimelineViewDelegate videoTimelineViewDelegate5 = this.delegate;
                if (videoTimelineViewDelegate5 != null) {
                    videoTimelineViewDelegate5.onPlayProgressChanged(fM1146dp);
                }
                this.pressDx = 0.0f;
                invalidate();
                return true;
            ...
            if (this.pressedPlay) {
                float fM1146dp2 = (((int) (x - this.pressDx)) - AndroidUtilities.m1146dp(16.0f)) / f;
                this.playProgress = fM1146dp2;
            ...
            if (this.pressedLeft) {
                ...
                if (i < AndroidUtilities.m1146dp(16.0f)) {
                    iM1146dp3 = AndroidUtilities.m1146dp(16.0f);
                } else if (i <= iM1146dp3) {
                    iM1146dp3 = i;
                }
                float fM1146dp3 = (iM1146dp3 - AndroidUtilities.m1146dp(16.0f)) / f;
                this.progressLeft = fM1146dp3;
                float f4 = this.progressRight;
                float f5 = f4 - fM1146dp3;
                float f6 = this.maxProgressDiff;
                if (f5 > f6) {
                    this.progressRight = fM1146dp3 + f6;
                } else {
                    float f7 = this.minProgressDiff;
                    if (f7 != 0.0f && f4 - fM1146dp3 < f7) {
                        float f8 = f4 - f7;
            ...
            if (this.pressedRight) {
                ...
                float fM1146dp4 = (iM1146dp - AndroidUtilities.m1146dp(16.0f)) / f;
                this.progressRight = fM1146dp4;
                float f12 = this.progressLeft;
                float f13 = fM1146dp4 - f12;
                float f14 = this.maxProgressDiff;
                if (f13 > f14) {
                    this.progressLeft = fM1146dp4 - f14;
                } else {
                    float f15 = this.minProgressDiff;
                    if (f15 != 0.0f && fM1146dp4 - f12 < f15) {
                        float f16 = f12 + f15;
    ...
    public void reloadFrames(int i) {
        ...
        if (i == 0) {
            this.frameHeight = AndroidUtilities.m1146dp(38.0f);
            this.framesToLoad = Math.max(1, (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m1146dp(32.0f)) / (this.frameHeight * Utilities.clamp((this.videoWidth == 0 || (i2 = this.videoHeight) == 0) ? 1.0f : r1 / i2, 1.3333334f, 0.5625f))));
            this.frameWidth = (int) Math.ceil((getMeasuredWidth() - AndroidUtilities.m1146dp(32.0f)) / this.framesToLoad);
    ...
    */
    protected void onDraw(android.graphics.Canvas r21) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.VideoTimelinePlayView.onDraw(android.graphics.Canvas):void");
    }
    ...
    private void drawProgress(Canvas canvas, float f, float f2) {
        ...
        float fM1146dp2 = AndroidUtilities.m1146dp(46.0f) + fM1146dp;
        float f3 = ((fM1146dp2 - fM1146dp) / 2.0f) * (1.0f - f2);
        float f4 = fM1146dp + f3;
        float f5 = fM1146dp2 - f3;
        this.shadowPaint.setAlpha((int) (38.0f * f2));
        this.whitePaint.setAlpha((int) (f2 * 255.0f));
        float fM1146dp3 = fDpf2 + AndroidUtilities.m1146dp(10.0f) + (((getMeasuredWidth() - (fDpf2 * 2.0f)) - AndroidUtilities.m1146dp(20.0f)) * f);
        this.rect3.set(fM1146dp3 - AndroidUtilities.dpf2(1.5f), f4, AndroidUtilities.dpf2(1.5f) + fM1146dp3, f5);
        this.rect3.inset(-AndroidUtilities.dpf2(0.66f), -AndroidUtilities.dpf2(0.66f));
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f), this.shadowPaint);
        this.rect3.set(fM1146dp3 - AndroidUtilities.dpf2(1.5f), f4, fM1146dp3 + AndroidUtilities.dpf2(1.5f), f5);
        canvas.drawRoundRect(this.rect3, AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(6.0f), this.whitePaint);
    }
