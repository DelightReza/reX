...
public class LinkActionView extends LinearLayout {
    ...
    public LinkActionView(final Context context, final BaseFragment baseFragment, final BottomSheet bottomSheet, long j, boolean z, boolean z2) {
        ...
        textView.setPadding(AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(13.0f), AndroidUtilities.m1146dp(40.0f), AndroidUtilities.m1146dp(13.0f));
        ...
        this.optionsView.setContentDescription(LocaleController.getString(C2369R.string.AccDescrMoreOptions));
        ...
        spannableStringBuilder.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(6.0f)), 1, 2, 0);
        spannableStringBuilder.append((CharSequence) LocaleController.getString(C2369R.string.LinkActionCopy));
        textView2.setText(spannableStringBuilder);
        textView2.setContentDescription(LocaleController.getString(C2369R.string.LinkActionCopy));
        ...
        spannableStringBuilder2.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(6.0f)), 1, 2, 0);
        spannableStringBuilder2.append((CharSequence) LocaleController.getString(C2369R.string.LinkActionShare));
        textView3.setText(spannableStringBuilder2);
        textView3.setContentDescription(LocaleController.getString(C2369R.string.LinkActionShare));
        textView3.setPadding(AndroidUtilities.m1146dp(8.0f), 0, AndroidUtilities.m1146dp(8.0f), 0);
        ...
        spannableStringBuilder3.append((CharSequence) "..").setSpan(new ColoredImageSpan(ContextCompat.getDrawable(context, C2369R.drawable.msg_delete_filled)), 0, 1, 0);
        spannableStringBuilder3.setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(8.0f)), 1, 2, 0);
        spannableStringBuilder3.append((CharSequence) LocaleController.getString(C2369R.string.DeleteLink));
        spannableStringBuilder3.append((CharSequence) ".").setSpan(new DialogCell.FixedWidthSpan(AndroidUtilities.m1146dp(5.0f)), spannableStringBuilder3.length() - 1, spannableStringBuilder3.length(), 0);
        textView4.setText(spannableStringBuilder3);
        textView4.setPadding(AndroidUtilities.m1146dp(8.0f), 0, AndroidUtilities.m1146dp(8.0f), 0);
        ...
        avatarsContainer.avatarsImageView.setAvatarsTextSize(AndroidUtilities.m1146dp(18.0f));
            ...
            baseFragment.showDialog(new ShareAlert(context, null, str, false, str, false, baseFragment.getResourceProvider()) { // from class: org.telegram.ui.Components.LinkActionView.1
                ...
                protected void onSend(LongSparseArray longSparseArray, int i, TLRPC.TL_forumTopic tL_forumTopic, boolean z) {
                    ...
                    if (z) {
                        ...
                        LinkActionView.this.showBulletin(C2369R.raw.forward, AndroidUtilities.replaceTags(string));
                    }
                }
            });
        } catch (Exception e) {
    ...
    public /* synthetic */ void lambda$new$4(BaseFragment baseFragment, View view) {
        ...
        builder.setTitle(LocaleController.getString(C2369R.string.DeleteLink));
        builder.setMessage(LocaleController.getString(C2369R.string.DeleteLinkHelp));
        builder.setPositiveButton(LocaleController.getString(C2369R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda10
    ...
    public /* synthetic */ void lambda$new$9(Context context, BottomSheet bottomSheet, BaseFragment baseFragment, View view) {
        ...
        if (!this.permanent && this.canEdit) {
            ...
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2369R.string.Edit), C2369R.drawable.msg_edit);
        ...
        if (!this.hideRevokeOption) {
            ...
            actionBarMenuSubItem3.setTextAndIcon(LocaleController.getString(C2369R.string.RevokeLink), C2369R.drawable.msg_delete);
        ...
        if (container != null) {
            ...
            this.actionBarPopupWindow.showAtLocation(container, 0, (int) (((container.getMeasuredWidth() - actionBarPopupWindowLayout.getMeasuredWidth()) - AndroidUtilities.m1146dp(16.0f)) + container.getX() + paddingLeft), (int) (paddingTop + this.frameLayout.getMeasuredHeight() + container.getY()));
        }
    }
    ...
    public void showBulletin(int i, CharSequence charSequence) {
        Bulletin bulletinCreateSimpleBulletin = BulletinFactory.m1267of(this.fragment).createSimpleBulletin(i, charSequence);
    ...
    private void showQrCode() {
        ...
        Context context = getContext();
        String string = LocaleController.getString(C2369R.string.InviteByQRCode);
        String str2 = this.link;
        String string2 = this.qrText;
        if (string2 == null) {
            string2 = LocaleController.getString(this.isChannel ? z ? C2369R.string.QRCodeLinkHelpChannelDirect : C2369R.string.QRCodeLinkHelpChannel : C2369R.string.QRCodeLinkHelpGroup);
        }
    ...
    public void updateColors() {
        ...
        textView2.setBackground(Theme.createSimpleSelectorRoundRectDrawable(iM1146dp, color, Theme.getColor(i3)));
        this.shareView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), Theme.getColor(i2), Theme.getColor(i3)));
        this.removeView.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), Theme.getColor(Theme.key_chat_attachAudioBackground), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_windowBackgroundWhite), Opcodes.ISHL)));
        this.frameLayout.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(8.0f), Theme.getColor(Theme.key_graySection), ColorUtils.setAlphaComponent(Theme.getColor(Theme.key_listSelector), 76)));
        ...
        this.avatarsContainer.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(6.0f), 0, ColorUtils.setAlphaComponent(Theme.getColor(i4), 76)));
    ...
    public void setLink(String str) {
        this.link = str;
        if (str == null) {
            this.linkView.setText(LocaleController.getString(C2369R.string.Loading));
    ...
    public void hideRevokeOption(boolean z) {
        if (this.hideRevokeOption != z) {
            ...
            imageView.setImageDrawable(ContextCompat.getDrawable(imageView.getContext(), C2369R.drawable.ic_ab_other));
        }
    }
        ...
        public AvatarsContainer(Context context) {
            ...
            this.avatarsImageView = new AvatarsImageView(context, false) { // from class: org.telegram.ui.Components.LinkActionView.AvatarsContainer.1
                ...
                protected void onMeasure(int i, int i2) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(Math.min(3, LinkActionView.this.usersCount) == 0 ? 0 : ((r2 - 1) * 20) + 32), TLObject.FLAG_30), i2);
                }
            };
            LinearLayout linearLayout = new LinearLayout(context);
            linearLayout.setOrientation(0);
            ...
            setPadding(0, AndroidUtilities.m1146dp(8.0f), 0, AndroidUtilities.m1146dp(8.0f));
    ...
    private void revokeLink() {
        ...
        builder.setPositiveButton(LocaleController.getString(C2369R.string.RevokeButton), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.LinkActionView$$ExternalSyntheticLambda11
            @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
            public final void onClick(AlertDialog alertDialog, int i) {
    ...
    public void setUsers(int i, ArrayList arrayList, boolean z) {
        ...
        if (i == 0) {
            this.avatarsContainer.setVisibility(8);
            setPadding(AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(18.0f));
        } else {
            this.avatarsContainer.setVisibility(0);
            setPadding(AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(18.0f), AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(10.0f));
