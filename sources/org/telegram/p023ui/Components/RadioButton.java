    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.icon == null) {
            if (this.progress <= 0.5f) {
                canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, f4 - AndroidUtilities.m1146dp(1.0f), checkedPaint);
                canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (f4 - AndroidUtilities.m1146dp(1.0f)) * (1.0f - f), eraser);
            } else {
                canvas.drawCircle(getMeasuredWidth() / 2, getMeasuredHeight() / 2, (this.size / 4) + (((f4 - AndroidUtilities.m1146dp(1.0f)) - (this.size / 4)) * f), checkedPaint);
            }
        }
        canvas.restore();
        if (this.icon != null) {
