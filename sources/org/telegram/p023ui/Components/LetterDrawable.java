...
public class LetterDrawable extends Drawable {
    ...
    public LetterDrawable(Theme.ResourcesProvider resourcesProvider, int i) {
        ...
        if (i == 0) {
            ...
            namePaint.setTextSize(AndroidUtilities.m1146dp(28.0f));
        ...
        if (i == 1) {
            ...
            namePaintTopic.setTextSize(AndroidUtilities.m1146dp(13.0f));
    ...
    public void setTitle(String str) {
        ...
        if (this.stringBuilder.length() > 0) {
            try {
                StaticLayout staticLayout = new StaticLayout(this.stringBuilder.toString().toUpperCase(), this.textPaint, AndroidUtilities.m1146dp(100.0f), Layout.Alignment.ALIGN_NORMAL, 1.0f, 0.0f, false);
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.style == 0) {
            ...
            canvas.drawRoundRect(this.rect, AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), paint);
        }
        canvas.save();
        float f = this.scale;
        if (f != 1.0f) {
