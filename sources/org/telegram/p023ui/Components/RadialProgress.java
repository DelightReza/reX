...
public class RadialProgress {
    ...
    private int diff = AndroidUtilities.m1146dp(4.0f);
    ...
    public RadialProgress(View view) {
        ...
        this.miniProgressPaint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.drawMiniProgress && this.currentDrawable != null) {
            ...
            if (Math.abs(this.progressRect.width() - AndroidUtilities.m1146dp(44.0f)) < AndroidUtilities.density) {
                float f5 = 16;
                fCenterX = this.progressRect.centerX() + AndroidUtilities.m1146dp(f5);
                fCenterY = this.progressRect.centerY() + AndroidUtilities.m1146dp(f5);
                i = 20;
                i2 = 0;
            } else {
            ...
            if (canvas2 != null) {
                ...
                f3 = -90.0f;
                f4 = 1.0f;
                canvas2.drawCircle(AndroidUtilities.m1146dp(f6), AndroidUtilities.m1146dp(f6), AndroidUtilities.m1146dp(i3 + 1) * f2, Theme.checkboxSquare_eraserPaint);
            } else {
                f3 = -90.0f;
                f4 = 1.0f;
            ...
            if (drawable4 != null) {
                ...
                float f7 = i3;
                this.previousMiniDrawable.setBounds((int) (fCenterX - (AndroidUtilities.m1146dp(f7) * f2)), (int) (fCenterY - (AndroidUtilities.m1146dp(f7) * f2)), (int) ((AndroidUtilities.m1146dp(f7) * f2) + fCenterX), (int) ((AndroidUtilities.m1146dp(f7) * f2) + fCenterY));
            ...
            if (!this.hideCurrentDrawable && (drawable2 = this.currentMiniDrawable) != null) {
                ...
                float f8 = i3;
                this.currentMiniDrawable.setBounds((int) (fCenterX - AndroidUtilities.m1146dp(f8)), (int) (fCenterY - AndroidUtilities.m1146dp(f8)), (int) (AndroidUtilities.m1146dp(f8) + fCenterX), (int) (AndroidUtilities.m1146dp(f8) + fCenterY));
            ...
            if (this.currentMiniWithRound || this.previousMiniWithRound) {
                ...
                float f9 = i3 - 2;
                this.cicleRect.set(fCenterX - (AndroidUtilities.m1146dp(f9) * f2), fCenterY - (AndroidUtilities.m1146dp(f9) * f2), fCenterX + (AndroidUtilities.m1146dp(f9) * f2), fCenterY + (AndroidUtilities.m1146dp(f9) * f2));
