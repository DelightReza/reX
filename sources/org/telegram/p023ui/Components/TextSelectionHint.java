...
public abstract class TextSelectionHint extends View {
    ...
    public TextSelectionHint(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        this.padding = AndroidUtilities.m1146dp(24.0f);
        ...
        setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(6.0f), getThemedColor(Theme.key_undo_background)));
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (getMeasuredWidth() != this.lastW || this.textLayout == null) {
            Animator animator = this.f2009a;
            if (animator != null) {
                animator.removeAllListeners();
                this.f2009a.cancel();
            }
            String string = LocaleController.getString(C2369R.string.TextSelectionHint);
        ...
        int height = this.textLayout.getHeight() + (AndroidUtilities.m1146dp(8.0f) * 2);
        if (height < AndroidUtilities.m1146dp(56.0f)) {
            height = AndroidUtilities.m1146dp(56.0f);
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.currentStart == this.animateToStart) {
            ...
            i = iM1146dp;
            i2 = lineBottom2;
            roundedRect(this.path, -AndroidUtilities.m1146dp(4.0f), this.textLayout.getLineTop(lineForOffset2), 0.0f, this.textLayout.getLineBottom(lineForOffset2), AndroidUtilities.m1146dp(4.0f), AndroidUtilities.m1146dp(4.0f), true, false);
            canvas.drawPath(this.path, this.selectionPaint);
        } else {
            f = f5;
            direction = direction2;
        ...
        canvas.save();
        canvas.translate(((int) ((this.textLayout.getPrimaryHorizontal(this.animateToStart) - (AndroidUtilities.m1146dp(f3) * (f2 - this.startOffsetValue))) + ((this.textLayout.getPrimaryHorizontal(this.start) - this.textLayout.getPrimaryHorizontal(this.animateToStart)) * this.startOffsetValue))) - i, i2);
    ...
    public void hideInternal() {
        ...
        this.f2009a = valueAnimatorOfFloat;
