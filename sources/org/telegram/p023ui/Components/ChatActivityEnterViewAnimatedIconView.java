...
import org.telegram.p023ui.Cells.ShareDialogCell$RepostStoryDrawable$$ExternalSyntheticLambda0;
...
public class ChatActivityEnterViewAnimatedIconView extends RLottieImageView {
    ...
    public ChatActivityEnterViewAnimatedIconView(Context context) {
        ...
        this.stateMap = new HashMap() { // from class: org.telegram.ui.Components.ChatActivityEnterViewAnimatedIconView.1
            ...
            public RLottieDrawable get(Object obj) {
                ...
                return new RLottieDrawable(i, String.valueOf(i), AndroidUtilities.m1146dp(32.0f), AndroidUtilities.m1146dp(32.0f));
            }
        };
    }
    ...
    public void setState(State state, boolean z) {
        ...
        int i = C35142.f1847x9047a843[state.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C35142 {
        ...
        static {
            ...
            try {
                f1847x9047a843[State.VIDEO.ordinal()] = 2;
    ...
    private static final class TransitState {
        ...
        static {
            ...
            VOICE_TO_VIDEO = new TransitState("VOICE_TO_VIDEO", 0, state, state2, C2369R.raw.voice_to_video);
            State state3 = State.STICKER;
            State state4 = State.KEYBOARD;
            STICKER_TO_KEYBOARD = new TransitState("STICKER_TO_KEYBOARD", 1, state3, state4, C2369R.raw.sticker_to_keyboard);
            State state5 = State.SMILE;
            SMILE_TO_KEYBOARD = new TransitState("SMILE_TO_KEYBOARD", 2, state5, state4, C2369R.raw.smile_to_keyboard);
            VIDEO_TO_VOICE = new TransitState("VIDEO_TO_VOICE", 3, state2, state, C2369R.raw.video_to_voice);
            KEYBOARD_TO_STICKER = new TransitState("KEYBOARD_TO_STICKER", 4, state4, state3, C2369R.raw.keyboard_to_sticker);
            State state6 = State.GIF;
            KEYBOARD_TO_GIF = new TransitState("KEYBOARD_TO_GIF", 5, state4, state6, C2369R.raw.keyboard_to_gif);
            KEYBOARD_TO_SMILE = new TransitState("KEYBOARD_TO_SMILE", 6, state4, state5, C2369R.raw.keyboard_to_smile);
            GIF_TO_KEYBOARD = new TransitState("GIF_TO_KEYBOARD", 7, state6, state4, C2369R.raw.gif_to_keyboard);
            GIF_TO_SMILE = new TransitState("GIF_TO_SMILE", 8, state6, state5, C2369R.raw.gif_to_smile);
            SMILE_TO_GIF = new TransitState("SMILE_TO_GIF", 9, state5, state6, C2369R.raw.smile_to_gif);
            SMILE_TO_STICKER = new TransitState("SMILE_TO_STICKER", 10, state5, state3, C2369R.raw.smile_to_sticker);
            STICKER_TO_SMILE = new TransitState("STICKER_TO_SMILE", 11, state3, state5, C2369R.raw.sticker_to_smile);
            $VALUES = $values();
        }
