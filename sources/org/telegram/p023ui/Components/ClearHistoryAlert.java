...
public class ClearHistoryAlert extends BottomSheet {
    ...
    public static class BottomSheetCell extends FrameLayout {
        ...
        public BottomSheetCell(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            view.setBackground(Theme.createSimpleSelectorRoundRectDrawable(AndroidUtilities.m1146dp(4.0f), getThemedColor(Theme.key_featuredStickers_addButton), getThemedColor(Theme.key_featuredStickers_addButtonPressed)));
    ...
    */
    public ClearHistoryAlert(android.content.Context r26, org.telegram.tgnet.TLRPC.User r27, org.telegram.tgnet.TLRPC.Chat r28, boolean r29, org.telegram.ui.ActionBar.Theme.ResourcesProvider r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.ClearHistoryAlert.<init>(android.content.Context, org.telegram.tgnet.TLRPC$User, org.telegram.tgnet.TLRPC$Chat, boolean, org.telegram.ui.ActionBar.Theme$ResourcesProvider):void");
    }
    ...
    public void updateLayout() {
        ...
        int iMax = Math.max(this.location[1] - AndroidUtilities.m1146dp(this.autoDeleteOnly ? 6.0f : 19.0f), 0);
