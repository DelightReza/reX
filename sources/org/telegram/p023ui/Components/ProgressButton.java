...
public class ProgressButton extends Button {
    ...
    public ProgressButton(Context context) {
        ...
        setMinWidth(iM1146dp);
        setMinimumWidth(iM1146dp);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawProgress || this.progressAlpha != 0.0f) {
            this.progressRect.set(getMeasuredWidth() - AndroidUtilities.m1146dp(11.0f), AndroidUtilities.m1146dp(3.0f), r0 + AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(11.0f));
