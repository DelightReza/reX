    ...
    public ChatAttachAlertColorsLayout(ChatAttachAlert chatAttachAlert, Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        RecyclerListView recyclerListView = new RecyclerListView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.1
            ...
            public boolean onTouchEvent(MotionEvent motionEvent) {
                if (motionEvent.getAction() != 0 || motionEvent.getY() >= ChatAttachAlertColorsLayout.this.parentAlert.scrollOffsetY[0] - AndroidUtilities.m1146dp(80.0f)) {
        ...
        this.gridView.setOnScrollListener(new RecyclerView.OnScrollListener() { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.2
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int i) {
                ...
                if (i == 0) {
                    ...
                    int iM1146dp2 = iM1146dp + (actionBarMenuItem != null ? AndroidUtilities.m1146dp(actionBarMenuItem.getAlpha() * 26.0f) : 0);
                    int backgroundPaddingTop = ChatAttachAlertColorsLayout.this.parentAlert.getBackgroundPaddingTop();
                    if (((ChatAttachAlertColorsLayout.this.parentAlert.scrollOffsetY[0] - backgroundPaddingTop) - iM1146dp2) + backgroundPaddingTop >= ActionBar.getCurrentActionBarHeight() || (holder = (RecyclerListView.Holder) ChatAttachAlertColorsLayout.this.gridView.findViewHolderForAdapterPosition(0)) == null || holder.itemView.getTop() <= AndroidUtilities.m1146dp(7.0f)) {
                        return;
                    }
                    ChatAttachAlertColorsLayout.this.gridView.smoothScrollBy(0, holder.itemView.getTop() - AndroidUtilities.m1146dp(7.0f));
                }
            }
        });
            ...
            public void smoothScrollToPosition(RecyclerView recyclerView, RecyclerView.State state, int i) {
                LinearSmoothScroller linearSmoothScroller = new LinearSmoothScroller(recyclerView.getContext()) { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.3.1
                    ...
                    public int calculateDyToMakeVisible(View view, int i2) {
                        return super.calculateDyToMakeVisible(view, i2) - (ChatAttachAlertColorsLayout.this.gridView.getPaddingTop() - AndroidUtilities.m1146dp(7.0f));
                    }
        ...
        gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() { // from class: org.telegram.ui.Components.ChatAttachAlertColorsLayout.4
            ...
            public int getSpanSize(int i) {
                return ChatAttachAlertColorsLayout.this.itemSize + (i % ChatAttachAlertColorsLayout.this.itemsPerRow != ChatAttachAlertColorsLayout.this.itemsPerRow + (-1) ? AndroidUtilities.m1146dp(5.0f) : 0);
            }
        });
    ...
    */
    public void onPreMeasure(int r7, int r8) {
        ...
        L18:
            ...
            int r1 = org.telegram.p023ui.ActionBar.ActionBar.getCurrentActionBarHeight()
            r0.topMargin = r1
        ...
        L40:
            ...
            int r3 = org.telegram.messenger.AndroidUtilities.m1146dp(r2)
        ...
        La0:
            ...
            int r8 = org.telegram.messenger.AndroidUtilities.m1146dp(r8)
            int r7 = r7 - r8
            if (r7 >= 0) goto Laa
            goto Lab
        Laa:
        ...
        Lab:
            ...
            int r1 = org.telegram.messenger.AndroidUtilities.m1146dp(r8)
            int r8 = org.telegram.messenger.AndroidUtilities.m1146dp(r8)
        ...
        Lc8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.ChatAttachAlertColorsLayout.onPreMeasure(int, int):void");
    }
    ...
    public void onShow(ChatAttachAlert.AttachAlertLayout attachAlertLayout) {
        ...
        this.parentAlert.actionBar.setTitle(LocaleController.getString(C2369R.string.SelectColor));
