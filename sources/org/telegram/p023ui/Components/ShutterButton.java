...
public class ShutterButton extends View {
    ...
    public ShutterButton(Context context) {
        ...
        this.shadowDrawable = getResources().getDrawable(C2369R.drawable.camera_btn);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.shadowDrawable.setBounds(measuredWidth - AndroidUtilities.m1146dp(36.0f), measuredHeight - AndroidUtilities.m1146dp(36.0f), AndroidUtilities.m1146dp(36.0f) + measuredWidth, AndroidUtilities.m1146dp(36.0f) + measuredHeight);
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m1146dp(26.0f), this.whitePaint);
        if (this.state != State.RECORDING) {
            if (this.redProgress != 0.0f) {
                canvas.drawCircle(f, f2, AndroidUtilities.m1146dp(26.5f) * scaleX, this.redPaint);
                return;
            }
            return;
        }
        ...
        canvas.drawCircle(f, f2, AndroidUtilities.m1146dp(26.5f) * scaleX * this.redProgress, this.redPaint);
    }

    @Override // android.view.View
    protected void onMeasure(int i, int i2) {
        setMeasuredDimension(AndroidUtilities.m1146dp(84.0f), AndroidUtilities.m1146dp(84.0f));
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK.getId(), LocaleController.getString(C2369R.string.AccActionTakePicture)));
        accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK.getId(), LocaleController.getString(C2369R.string.AccActionRecordVideo)));
    }
}
