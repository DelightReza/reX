...
public class ChecksHintView extends FrameLayout {
    ...
    public ChecksHintView(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        frameLayout.setBackground(Theme.createRoundRectDrawable(AndroidUtilities.m1146dp(6.0f), getThemedColor(Theme.key_chat_gifSaveHintBackground)));
        int i = 0;
        frameLayout.setPadding(AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f), 0, AndroidUtilities.m1146dp(8.0f));
        ...
        while (i < 2) {
            ...
            this.textView[i].setMaxWidth(AndroidUtilities.m1146dp(250.0f));
            ...
            if (i == 0) {
                this.imageView[i].setAnimation(C2369R.raw.ticks_single, 24, 24);
                this.textView[i].setText(LocaleController.getString(C2369R.string.HintSent));
            } else {
                this.imageView[i].setAnimation(C2369R.raw.ticks_double, 24, 24);
                this.textView[i].setText(LocaleController.getString(C2369R.string.HintRead));
            }
        ...
        imageView.setImageResource(C2369R.drawable.tooltip_arrow);
    ...
    public boolean showForMessageCell(ChatMessageCell chatMessageCell, boolean z) {
        ...
        final int i3 = 0;
        if (i2 <= getMeasuredHeight() + AndroidUtilities.m1146dp(10.0f)) {
            return false;
        }
        int checksY = i2 + chatMessageCell.getChecksY() + AndroidUtilities.m1146dp(6.0f);
        int checksX = chatMessageCell.getChecksX() + AndroidUtilities.m1146dp(5.0f);
        ...
        if (left > view.getMeasuredWidth() / 2) {
            int measuredWidth2 = (measuredWidth - getMeasuredWidth()) - AndroidUtilities.m1146dp(20.0f);
            setTranslationX(measuredWidth2);
            iM1146dp += measuredWidth2;
        } else {
            setTranslationX(0.0f);
        }
        float left2 = ((chatMessageCell.getLeft() + checksX) - iM1146dp) - (this.arrowImageView.getMeasuredWidth() / 2);
        this.arrowImageView.setTranslationX(left2);
        if (left > view.getMeasuredWidth() / 2) {
            if (left2 < AndroidUtilities.m1146dp(10.0f)) {
                float fM1146dp = left2 - AndroidUtilities.m1146dp(10.0f);
                setTranslationX(getTranslationX() + fM1146dp);
                this.arrowImageView.setTranslationX(left2 - fM1146dp);
            }
        ...
        if (z) {
            ...
            this.animatorSet.addListener(new C36981());
    ...
    class C36981 extends AnimatorListenerAdapter {
        C36981() {
        }
