...
import org.telegram.p023ui.Components.Paint.ShapeDetector;
...
public class MediaActivity extends BaseFragment implements SharedMediaLayout.SharedMediaPreloaderDelegate, FloatingDebugProvider, NotificationCenter.NotificationCenterDelegate {
    ...
    public boolean onFragmentCreate() {
        this.type = getArguments().getInt(PluginsConstants.Settings.TYPE, 0);
    ...
    */
    public android.view.View createView(android.content.Context r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.MediaActivity.createView(android.content.Context):android.view.View");
    }

    /* renamed from: org.telegram.ui.Components.MediaActivity$1 */
    class C40061 extends ActionBar.ActionBarMenuOnItemClick {
        C40061() {
        }
        ...
        public void onItemClick(int i) {
            if (i == -1) {
                ...
                MediaActivity.this.lambda$onBackPressed$371();
                return;
            }
            if (i != 2) {
                if (i == 10) {
            ...
            if (MediaActivity.this.actionModeMessageObjects != null) {
                ...
                builder.setTitle(LocaleController.getString(arrayList.size() > 1 ? C2369R.string.DeleteStoriesTitle : C2369R.string.DeleteStoryTitle));
                builder.setMessage(LocaleController.formatPluralString("DeleteStoriesSubtitle", arrayList.size(), new Object[0]));
                builder.setPositiveButton(LocaleController.getString(C2369R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.MediaActivity$1$$ExternalSyntheticLambda0
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i3) {
                        this.f$0.lambda$onItemClick$0(arrayList, alertDialog, i3);
                    }
                });
                builder.setNegativeButton(LocaleController.getString(C2369R.string.Cancel), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.Components.MediaActivity$1$$ExternalSyntheticLambda1
                    @Override // org.telegram.ui.ActionBar.AlertDialog.OnButtonClickListener
                    public final void onClick(AlertDialog alertDialog, int i3) {
                        alertDialog.dismiss();
                    }
    ...
    public /* synthetic */ void lambda$createView$10(View view) {
        ...
        (z ? BulletinFactory.m1267of(this).createSimpleBulletin(C2369R.raw.contact_check, LocaleController.formatPluralString("StorySavedTitle", i, new Object[0]), LocaleController.getString("StorySavedSubtitle"), LocaleController.getString("Undo"), runnable2).show() : BulletinFactory.m1267of(this).createSimpleBulletin(C2369R.raw.chats_archived, LocaleController.formatPluralString("StoryArchived", i, new Object[0]), LocaleController.getString("Undo"), 5000, runnable2).show()).setOnHideListener(new Runnable() { // from class: org.telegram.ui.Components.MediaActivity$$ExternalSyntheticLambda12
            @Override // java.lang.Runnable
            public final void run() {
                ...
                if (closestTab == 8 || closestTab == 9) {
                    ...
                    if (buttonWithCounterView != null) {
                        ...
                        if (closestTab == 8) {
                            ...
                            buttonWithCounterView.setText(LocaleController.getString(C2369R.string.SaveToProfile), z4);
                        }
    ...
    private void showSubtitle(final int i, final boolean z, boolean z2) {
        ...
        if (zArr[i] != z || this.firstSubtitleCheck[i]) {
            ...
            if (z3) {
                ...
                this.subtitleAnimator[i].addListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Components.MediaActivity.7
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        MediaActivity.this.nameTextView[i].setTranslationY(z ? 0.0f : AndroidUtilities.m1146dp(8.0f));
            ...
            this.nameTextView[i].setTranslationY(z ? 0.0f : AndroidUtilities.m1146dp(8.0f));
    ...
    public /* synthetic */ void lambda$showSubtitle$12(int i, ValueAnimator valueAnimator) {
        ...
        this.nameTextView[i].setTranslationY(AndroidUtilities.lerp(AndroidUtilities.m1146dp(8.0f), 0, this.subtitleT[i]));
    ...
    private class StoriesTabsView extends BottomPagerTabs {
        ...
        public BottomPagerTabs.Tab[] createTabs() {
            return new BottomPagerTabs.Tab[]{new BottomPagerTabs.Tab(0, C2369R.raw.msg_stories_saved, 20, 40, LocaleController.getString(C2369R.string.ProfileMyStoriesTab)), new BottomPagerTabs.Tab(1, C2369R.raw.msg_stories_archive, 0, 0, LocaleController.getString(C2369R.string.ProfileStoriesArchiveTab))};
        }
    }
