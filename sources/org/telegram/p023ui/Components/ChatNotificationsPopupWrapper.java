...
public class ChatNotificationsPopupWrapper {
            ...
            public final void didSelectDate(boolean z, int i2, int i3) {
                AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda11
                    ...
                    public final void run() {
                        ChatNotificationsPopupWrapper.m8751$r8$lambda$jhiS2GRG2Zdjm9uB5JrzKUjxx0(i2, i, callback);
                    }
                }, 16L);
            }
        });
    ...
    /* renamed from: $r8$lambda$jhiS2GRG2Zdjm9uB5Jr-zKUjxx0, reason: not valid java name */
    public static /* synthetic */ void m8751$r8$lambda$jhiS2GRG2Zdjm9uB5JrzKUjxx0(int i, int i2, Callback callback) {
        if (i != 0) {
    ...
    public ChatNotificationsPopupWrapper(final Context context, final int i, final PopupSwipeBackLayout popupSwipeBackLayout, boolean z, boolean z2, final Callback callback, final Theme.ResourcesProvider resourcesProvider) {
        ...
        this.isProfile = z2;
        ActionBarPopupWindow.ActionBarPopupWindowLayout actionBarPopupWindowLayout = new ActionBarPopupWindow.ActionBarPopupWindowLayout(context, z ? C2369R.drawable.popup_fixed_alert : 0, resourcesProvider) { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper.1
            Path path = new Path();
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem2 = ActionBarMenuItem.addItem(this.windowLayout, C2369R.drawable.msg_tone_on, LocaleController.getString(C2369R.string.SoundOn), false, resourcesProvider);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem3 = ActionBarMenuItem.addItem(this.windowLayout, C2369R.drawable.msg_mute_1h, LocaleController.getString(C2369R.string.MuteFor1h), false, resourcesProvider);
        ...
        ActionBarMenuSubItem actionBarMenuSubItemAddItem4 = ActionBarMenuItem.addItem(this.windowLayout, C2369R.drawable.msg_mute_1h, LocaleController.getString(C2369R.string.MuteFor1h), false, resourcesProvider);
        ...
        ActionBarMenuItem.addItem(this.windowLayout, C2369R.drawable.msg_mute_period, LocaleController.getString(C2369R.string.MuteForPopup), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda5
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f$0.lambda$new$6(context, resourcesProvider, i, callback, view);
            }
        });
        ActionBarMenuItem.addItem(this.windowLayout, C2369R.drawable.msg_customize, LocaleController.getString(C2369R.string.NotificationsCustomize), false, resourcesProvider).setOnClickListener(new View.OnClickListener() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda6
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
    ...
    public void lambda$update$11(final long j, final long j2, final HashSet hashSet) {
        ...
        if (zIsDialogMuted) {
            this.muteUnmuteButton.setTextAndIcon(LocaleController.getString(C2369R.string.UnmuteNotifications), C2369R.drawable.msg_unmute);
            color = Theme.getColor(Theme.key_windowBackgroundWhiteGreenText2);
            this.soundToggle.setVisibility(8);
        } else {
            this.muteUnmuteButton.setTextAndIcon(LocaleController.getString(C2369R.string.MuteNotifications), C2369R.drawable.msg_mute);
            ...
            if (MessagesController.getInstance(this.currentAccount).isDialogNotificationsSoundEnabled(j, j2)) {
                this.soundToggle.setTextAndIcon(LocaleController.getString(C2369R.string.SoundOff), C2369R.drawable.msg_tone_off);
            } else {
                this.soundToggle.setTextAndIcon(LocaleController.getString(C2369R.string.SoundOn), C2369R.drawable.msg_tone_on);
            }
            color = color2;
        }
        if (this.type == 1) {
    ...
    private String formatMuteForTime(int i) {
        ...
        if (i2 != 0) {
            sb.append(i2);
            sb.append(LocaleController.getString(C2369R.string.SecretChatTimerDays));
        }
        if (i4 != 0) {
            if (sb.length() > 0) {
                sb.append(" ");
            ...
            sb.append(i4);
            sb.append(LocaleController.getString(C2369R.string.SecretChatTimerHours));
        }
        if (i5 != 0) {
            if (sb.length() > 0) {
                sb.append(" ");
            ...
            sb.append(i5);
            sb.append(LocaleController.getString(C2369R.string.SecretChatTimerMinutes));
        }
        return LocaleController.formatString("MuteForButton", C2369R.string.MuteForButton, sb.toString());
    }
    ...
    public void showAsOptions(BaseFragment baseFragment, View view, float f, float f2, boolean z) {
        ...
        this.windowLayout.measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(1000.0f), TLObject.FLAG_31), View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(1000.0f), TLObject.FLAG_31));
    ...
    public static ItemOptions addAsItemOptions(final BaseFragment baseFragment, final ItemOptions itemOptions, final long j, final long j2) {
        ...
        itemOptionsMakeSwipeback.add(C2369R.drawable.msg_arrow_back, LocaleController.getString(C2369R.string.Back), new RunnableC1500x164780ca(itemOptions));
        itemOptionsMakeSwipeback.add(C2369R.drawable.msg_tone_on, LocaleController.getString(C2369R.string.SoundOn), new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda13
            @Override // java.lang.Runnable
            public final void run() {
        ...
        itemOptionsMakeSwipeback.add(C2369R.drawable.msg_mute_period, LocaleController.getString(C2369R.string.MuteForPopup), new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda14
            @Override // java.lang.Runnable
            public final void run() {
                AlertsCreator.createMuteForPickerDialog(itemOptions.getContext(), resourceProvider, new AlertsCreator.ScheduleDatePickerDelegate() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda18
                    ...
                    public final void didSelectDate(boolean z, int i, int i2) {
                        AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda19
                            @Override // java.lang.Runnable
                            public final void run() {
                                ChatNotificationsPopupWrapper.m8747$r8$lambda$2E5Qdzb2TlshZLi5DNrMyDRQJs(i, i, callback);
                            }
                        }, 16L);
                    }
                });
        ...
        itemOptionsMakeSwipeback.add(C2369R.drawable.msg_customize, LocaleController.getString(C2369R.string.NotificationsCustomize), new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda15
            @Override // java.lang.Runnable
            public final void run() {
        ...
        new Runnable() { // from class: org.telegram.ui.Components.ChatNotificationsPopupWrapper$$ExternalSyntheticLambda17
            @Override // java.lang.Runnable
            public final void run() {
                ChatNotificationsPopupWrapper.m8752$r8$lambda$jslqYv3H4CQpj7lsolTF0FqDk4(currentAccount, j, j2, last2, last);
            }
        }.run();
    ...
    /* renamed from: $r8$lambda$2E5Qdzb2TlshZLi5DNrM-yDRQJs, reason: not valid java name */
    public static /* synthetic */ void m8747$r8$lambda$2E5Qdzb2TlshZLi5DNrMyDRQJs(int i, int i2, Utilities.Callback callback) {
        if (i != 0) {
            SharedPreferences notificationsSettings = MessagesController.getNotificationsSettings(i2);
            notificationsSettings.edit().putInt("last_selected_mute_until_time", i).putInt("last_selected_mute_until_time2", notificationsSettings.getInt("last_selected_mute_until_time", 0)).apply();
        }
    ...
    public static /* synthetic */ void $r8$lambda$99jwGva_EFC_FHEqFr4J7466z3Y(ItemOptions itemOptions, int i, long j, long j2, BaseFragment baseFragment, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (BulletinFactory.canShowBulletin(baseFragment)) {
            BulletinFactory.createMuteBulletin(baseFragment, !zIsDialogMuted ? 3 : 4, !zIsDialogMuted ? ConnectionsManager.DEFAULT_DATACENTER_ID : 0, resourcesProvider).show();
        }
    }

    /* renamed from: $r8$lambda$jslqYv3H4CQpj7lso-lTF0FqDk4, reason: not valid java name */
    public static /* synthetic */ void m8752$r8$lambda$jslqYv3H4CQpj7lsolTF0FqDk4(int i, long j, long j2, ActionBarMenuSubItem actionBarMenuSubItem, ActionBarMenuSubItem actionBarMenuSubItem2) {
        int color;
        if (MessagesController.getInstance(i).isDialogMuted(j, j2)) {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2369R.string.UnmuteNotifications), C2369R.drawable.msg_unmute);
            color = Theme.getColor(Theme.key_windowBackgroundWhiteGreenText2);
            actionBarMenuSubItem2.setVisibility(8);
        } else {
            actionBarMenuSubItem.setTextAndIcon(LocaleController.getString(C2369R.string.MuteNotifications), C2369R.drawable.msg_mute);
            int color2 = Theme.getColor(Theme.key_text_RedBold);
            actionBarMenuSubItem2.setVisibility(0);
            if (MessagesController.getInstance(i).isDialogNotificationsSoundEnabled(j, j2)) {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(C2369R.string.SoundOff), C2369R.drawable.msg_tone_off);
            } else {
                actionBarMenuSubItem2.setTextAndIcon(LocaleController.getString(C2369R.string.SoundOn), C2369R.drawable.msg_tone_on);
            }
            color = color2;
        }
