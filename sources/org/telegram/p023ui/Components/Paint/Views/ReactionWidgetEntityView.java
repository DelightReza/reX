...
public class ReactionWidgetEntityView extends EntityView {
    ...
    @Override // org.telegram.p023ui.Components.Paint.Views.EntityView, android.view.ViewGroup, android.view.View
    ...
    public int getPadding() {
        return (int) ((this.baseSize.height - AndroidUtilities.m1146dp(84.0f)) / 2.0f);
    }
    ...
    public org.telegram.p023ui.Components.Rect getSelectionBounds() {
        ...
        return new org.telegram.p023ui.Components.Rect((getPositionX() - f) * scaleX, (getPositionY() - f) * scaleX, f2, f2);
    }
