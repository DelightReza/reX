...
public class EditTextOutline extends EditTextBoldCursor {
    ...
    public EditTextOutline(Context context) {
        ...
        setFrameRoundRadius(AndroidUtilities.m1146dp(16.0f));
    ...
    public void setFrameColor(int i) {
        ...
        if (i2 == 0 && i != 0) {
            setPadding(AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(7.0f), AndroidUtilities.m1146dp(19.0f), AndroidUtilities.m1146dp(7.0f));
            setCursorColor(-1);
        } else if (i2 != 0 && i == 0) {
            setPadding(AndroidUtilities.m1146dp(7.0f), AndroidUtilities.m1146dp(7.0f), AndroidUtilities.m1146dp(7.0f), AndroidUtilities.m1146dp(7.0f));
            setCursorColor(-1);
        }
        this.mFrameColor = i;
        if (i != 0) {
        ...
        if (this.mFrameColor != 0) {
            ...
            if (this.isFrameDirty) {
                ...
                for (int i2 = 0; i2 < layout.getLineCount(); i2++) {
                    ...
                    if (this.lines[i2].width() > AndroidUtilities.m1146dp(1.0f)) {
            ...
            while (true) {
                ...
                if (rectF9.width() >= AndroidUtilities.m1146dp(1.0f) && rectF10.width() >= AndroidUtilities.m1146dp(1.0f)) {
                    ...
                    if (z) {
                        for (int i6 = i5; i6 >= 1; i6--) {
                            ...
                            if (rectF11.width() >= AndroidUtilities.m1146dp(1.0f) && rectF12.width() >= AndroidUtilities.m1146dp(1.0f)) {
