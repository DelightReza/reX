...
public abstract class EntityView extends FrameLayout {
    ...
    public boolean onTouchMove(float f, float f2, boolean z, float f3, float f4) {
        ...
        if (entityViewDelegate5 != null) {
            entityViewDelegate5.onEntityDraggedTop(this.position.f1930y - ((((float) getHeight()) / 2.0f) * scaleX) < ((float) AndroidUtilities.m1146dp(66.0f)));
            this.delegate.onEntityDraggedBottom(this.position.f1930y + ((((float) getHeight()) / 2.0f) * scaleX) > ((float) (((View) getParent()).getHeight() - AndroidUtilities.m1146dp(114.0f))));
        }
        EntityViewDelegate entityViewDelegate6 = this.delegate;
        updateTrash((entityViewDelegate6 == null || entityViewDelegate6.isEntityDeletable()) && !z && MathUtils.distance(f5, f6, ((float) ((View) getParent()).getWidth()) / 2.0f, (float) (((View) getParent()).getHeight() - AndroidUtilities.m1146dp(76.0f))) < ((float) AndroidUtilities.m1146dp(32.0f)));
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        this.delegate.getTransformedTouch(motionEvent.getRawX(), motionEvent.getRawY(), this.f1905xy);
        ...
        if (z) {
            ...
            float[] fArr5 = this.f1905xy;
            fArr4[0] = fArr5[0];
            fArr4[1] = fArr5[1];
        }
        if (this.lastIsMultitouch != z) {
            float[] fArr6 = this.f1905xy;
        ...
        if (actionMasked == 0) {
            ...
            float[] fArr10 = entityView.f1905xy;
    ...
    */
    public void pan(float r10, float r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Paint.Views.EntityView.pan(float, float):void");
    }
    ...
    protected float getPositionX() {
        float measuredWidth;
        float f = this.position.f1929x;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyX;
            if (i == 1) {
                measuredWidth = AndroidUtilities.m1146dp(8.0f) + (((width() / 2.0f) - getStickyPaddingLeft()) * getScaleX());
            } else if (i == 2) {
                measuredWidth = view.getMeasuredWidth() / 2.0f;
            } else {
                measuredWidth = i == 3 ? (view.getMeasuredWidth() - AndroidUtilities.m1146dp(8.0f)) - (((width() / 2.0f) + getStickyPaddingRight()) * getScaleX()) : f;
            }
            ValueAnimator valueAnimator = this.stickyXAnimator;
            if (valueAnimator != null) {
    ...
    protected float getPositionY() {
        ...
        float f = this.position.f1930y;
        if (getParent() != null) {
            View view = (View) getParent();
            int i = this.stickyY;
            if (i == 1) {
                measuredHeight = AndroidUtilities.m1146dp(64.0f) + (((height() / 2.0f) - getStickyPaddingTop()) * getScaleY());
            } else if (i == 2) {
                measuredHeight = view.getMeasuredHeight() / 2.0f;
            } else {
                measuredHeight = i == 3 ? (view.getMeasuredHeight() - AndroidUtilities.m1146dp(64.0f)) - (((height() / 2.0f) + getStickyPaddingBottom()) * getScaleY()) : f;
            }
            ValueAnimator valueAnimator = this.stickyYAnimator;
            if (valueAnimator != null) {
    ...
    public class SelectionView extends FrameLayout {
        ...
        public SelectionView(Context context) {
            ...
            this.paint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1146dp(10.0f), AndroidUtilities.m1146dp(10.0f)}, 0.5f));
        ...
        public void updatePosition() {
            ...
            layoutParams.leftMargin = (int) selectionBounds.f1970x;
            layoutParams.topMargin = (int) selectionBounds.f1971y;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (getParent() instanceof View) {
            ...
            if (trashCenter()) {
                ...
                float height = (view.getHeight() - AndroidUtilities.m1146dp(76.0f)) - getY();
