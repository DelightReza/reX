...
public class PaintWeightChooserView extends View {
    ...
    public PaintWeightChooserView(Context context) {
        ...
        this.colorPaint.setShadowLayer(AndroidUtilities.m1146dp(4.0f), 0.0f, AndroidUtilities.m1146dp(2.0f), 1342177280);
        this.backgroundPaint.setColor(1090519039);
        this.backgroundPaint.setShadowLayer(AndroidUtilities.m1146dp(3.0f), 0.0f, AndroidUtilities.m1146dp(1.0f), 637534208);
    }
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.touchRect.set(0.0f, (getHeight() - height) / 2.0f, AndroidUtilities.m1146dp(32.0f), (getHeight() + height) / 2.0f);
    }
    ...
    */
    protected void onDraw(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Paint.Views.PaintWeightChooserView.onDraw(android.graphics.Canvas):void");
    }

    private void drawCircleWithShadow(Canvas canvas, float f, float f2, float f3, boolean z) {
        if (z) {
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((f - f3) - AndroidUtilities.m1146dp(6.0f), (f2 - f3) - AndroidUtilities.m1146dp(6.0f), f + f3 + AndroidUtilities.m1146dp(6.0f), f2 + f3 + AndroidUtilities.m1146dp(6.0f));
