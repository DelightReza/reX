...
public class PaintToolsView extends LinearLayout {
    ...
    public PaintToolsView(Context context, boolean z) {
        ...
        while (i < Brush.BRUSHES_LIST.size() + 2) {
            ...
            if (i == 0) {
                ...
                this.buttons[i2].setImageResource(C2369R.drawable.msg_add);
    ...
    public void setSelectedIndex(int i) {
        ...
        if (this.isShapeSelected) {
            ...
            AndroidUtilities.updateImageViewImageAnimated(this.buttons[this.brushesCount + 1], C2369R.drawable.msg_add);
        }
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float fMin = (Math.min((rLottieImageView.getWidth() - rLottieImageView.getPaddingLeft()) - rLottieImageView.getPaddingRight(), (rLottieImageView.getHeight() - rLottieImageView.getPaddingTop()) - rLottieImageView.getPaddingBottom()) / 2.0f) + AndroidUtilities.m1146dp(3.0f) + (AndroidUtilities.m1146dp(3.0f) * f2);
    ...
    private RLottieImageView createView(boolean z, boolean z2) {
        ...
        rLottieImageView.setPadding(AndroidUtilities.m1146dp(z ? 0.0f : 8.0f), AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(z2 ? 0.0f : 8.0f), AndroidUtilities.m1146dp(8.0f));
