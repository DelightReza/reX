...
public abstract class PipettePickerView extends View {
    ...
    public PipettePickerView(Context context, Bitmap bitmap) {
        ...
        this.outlinePaint.setStrokeWidth(AndroidUtilities.m1146dp(4.0f));
        ...
        this.colorPaint.setStrokeWidth(AndroidUtilities.m1146dp(12.0f));
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(this.dstRect, AndroidUtilities.m1146dp(1.0f), AndroidUtilities.m1146dp(1.0f), this.outlinePaint);
        canvas.restore();
    }
}
