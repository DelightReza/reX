...
public class ShapeInput {
    ...
    public ShapeInput(RenderView renderView, Runnable runnable) {
        ...
        this.centerPointStrokePaint.setStrokeWidth(AndroidUtilities.m1146dp(1.0f));
        ...
        this.controlPointStrokePaint.setStrokeWidth(AndroidUtilities.m1146dp(1.0f));
        this.linePaint.setStyle(style);
        this.linePaint.setColor(-1);
        this.linePaint.setStrokeWidth(AndroidUtilities.m1146dp(0.8f));
        this.linePaint.setPathEffect(new DashPathEffect(new float[]{AndroidUtilities.m1146dp(8.0f), AndroidUtilities.m1146dp(8.0f)}, 0.0f));
    ...
    */
    private boolean isInsideShape(float r21, float r22) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.Paint.ShapeInput.isInsideShape(float, float):boolean");
    }
    ...
    public void process(MotionEvent motionEvent, float f) {
        ...
        if (actionMasked != 0) {
            ...
            if (point2 == null) {
                ...
                if (point3 != null) {
                    ...
                    float f5 = f4 - point4.f1901x;
                    float f6 = (fArr3[1] + this.touchOffsetY) - point4.f1902y;
                    for (int i = 0; i < this.movingPoints.size(); i++) {
                        Point point5 = (Point) this.movingPoints.get(i);
                        point5.update(point5.f1901x + f5, point5.f1902y + f6);
                    }
                }
            } else {
                if (point2.rotate) {
        ...
        for (int i2 = 0; i2 < this.allPoints.size(); i2++) {
            ...
            if (point7.draw) {
                ...
                float f7 = point7.f1901x;
                float f8 = point7.f1902y;
                float[] fArr6 = this.tempPoint;
                double dDistance = MathUtils.distance(f7, f8, fArr6[0], fArr6[1]);
                if (dDistance < AndroidUtilities.m1146dp(40.0f) && (point == null || dDistance < d)) {
                    point = point7;
                    d = dDistance;
                }
            }
        ...
        if (point != null) {
            ...
            float f9 = point8.f1901x;
            float[] fArr9 = this.tempPoint;
            this.touchOffsetX = f9 - fArr9[0];
            this.touchOffsetY = point8.f1902y - fArr9[1];
            return;
        }
        ...
        if (point9 != null) {
            ...
            float f10 = point10.f1901x;
            float[] fArr10 = this.tempPoint;
            this.touchOffsetX = f10 - fArr10[0];
            this.touchOffsetY = point10.f1902y - fArr10[1];
        }
    }
    ...
    public void start(int i) {
        ...
        shape.radiusX = fMin;
        this.shape.thickness = this.renderView.getCurrentWeight();
        this.shape.rounding = AndroidUtilities.m1146dp(32.0f);
        ...
        if (this.shape.getType() == 3) {
            ...
            Point point4 = new Point() { // from class: org.telegram.ui.Components.Paint.ShapeInput.7
                private void limit() {
                    if (this.f1902y > ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY && this.f1902y < ShapeInput.this.shape.centerY + ShapeInput.this.shape.radiusY) {
                        if (this.f1901x <= ShapeInput.this.shape.centerX && this.f1901x > ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX) {
                            this.f1901x = ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX;
                        } else if (this.f1901x > ShapeInput.this.shape.centerY && this.f1901x < ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX) {
                            this.f1901x = ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX;
                        }
                    }
                    if (this.f1901x <= ShapeInput.this.shape.centerX - ShapeInput.this.shape.radiusX || this.f1901x >= ShapeInput.this.shape.centerX + ShapeInput.this.shape.radiusX) {
                        return;
                    }
                    if (this.f1902y <= ShapeInput.this.shape.centerY && this.f1902y > ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY) {
                        this.f1902y = ShapeInput.this.shape.centerY - ShapeInput.this.shape.radiusY;
                    } else {
                        if (this.f1902y <= ShapeInput.this.shape.centerY || this.f1902y >= ShapeInput.this.shape.centerY + ShapeInput.this.shape.radiusY) {
                            return;
                        }
                ...
                protected void update(float f7, float f8) {
                    set(f7, f8);
                    limit();
                    ShapeInput.this.shape.middleX = this.f1901x;
                    ShapeInput.this.shape.middleY = this.f1902y;
                }
        ...
        this.center = new Point(z) { // from class: org.telegram.ui.Components.Paint.ShapeInput.8
            @Override // org.telegram.ui.Components.Paint.ShapeInput.Point
            void set() {
                this.f1901x = ShapeInput.this.shape.centerX;
                this.f1902y = ShapeInput.this.shape.centerY;
            }
    ...
    private void drawPoint(Canvas canvas, Size size, Point point) {
        canvas.drawCircle((point.f1901x / size.width) * canvas.getWidth(), (point.f1902y / size.height) * canvas.getHeight(), AndroidUtilities.m1146dp(5.0f), point.green ? this.centerPointPaint : this.controlPointPaint);
        canvas.drawCircle((point.f1901x / size.width) * canvas.getWidth(), (point.f1902y / size.height) * canvas.getHeight(), AndroidUtilities.m1146dp(5.0f), point.green ? this.centerPointStrokePaint : this.controlPointStrokePaint);
    }

    private class CornerPoint extends Point {

        /* renamed from: rx */
        public float f1899rx;

        /* renamed from: ry */
        public float f1900ry;
        public Shape shape;
        ...
        public CornerPoint(Shape shape, boolean z, boolean z2) {
            ...
            this.rotate = false;
            this.shape = shape;
            this.f1899rx = z ? -1.0f : 1.0f;
            this.f1900ry = z2 ? -1.0f : 1.0f;
            set();
        }
        ...
        void set() {
            Shape shape = this.shape;
            if (shape != null) {
                ShapeInput.this.rotate(shape.centerX + (this.f1899rx * shape.radiusX), shape.centerY + (this.f1900ry * shape.radiusY), true);
        ...
        protected void update(float f, float f2) {
            super.update(f, f2);
            Shape shape = this.shape;
            float f3 = shape.centerX + ((-this.f1899rx) * shape.radiusX);
            float f4 = shape.centerY + ((-this.f1900ry) * shape.radiusY);
