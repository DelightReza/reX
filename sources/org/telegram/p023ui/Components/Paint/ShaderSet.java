...
public abstract class ShaderSet {
    ...
    private static Map createMap() {
        ...
        map4.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "alpha", "preview"});
        ...
        map5.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map6.put("uniforms", new String[]{"mvpMatrix", "otexture", "texture", PluginsConstants.Settings.MASK, "color", "preview"});
        ...
        map7.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map8.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "blured", "color"});
        ...
        map9.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "blured", "color"});
        ...
        map10.put("uniforms", new String[]{"mvpMatrix", "texture", "blured", "eraser", PluginsConstants.Settings.MASK, "flipy"});
        ...
        map12.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map13.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map14.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map15.put("uniforms", new String[]{"mvpMatrix", "texture", "otexture", "preview", PluginsConstants.Settings.MASK, "color"});
        ...
        map16.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "color"});
        ...
        map18.put("uniforms", new String[]{"mvpMatrix", "texture", PluginsConstants.Settings.MASK, "clear", "color", PluginsConstants.Settings.TYPE, "color", "resolution", "center", "radius", "thickness", "rounding", "fill", "rotation", "middle", "arrowTriangleLength", "composite"});
