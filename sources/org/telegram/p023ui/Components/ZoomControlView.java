...
public class ZoomControlView extends View {
    ...
    public ZoomControlView(Context context) {
        ...
        this.minusDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_minus);
        this.plusDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_plus);
        this.progressDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_slide);
        this.filledProgressDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_slide_a);
        this.knobDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_round);
        this.pressedKnobDrawable = context.getResources().getDrawable(C2369R.drawable.zoom_round_b);
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.ZoomControlView.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (z) {
            this.minusCx = AndroidUtilities.m1146dp(41.0f);
            this.minusCy = measuredHeight;
            this.plusCx = getMeasuredWidth() - AndroidUtilities.m1146dp(41.0f);
            this.plusCy = measuredHeight;
            this.progressStartX = this.minusCx + AndroidUtilities.m1146dp(18.0f);
            this.progressStartY = measuredHeight;
            this.progressEndX = this.plusCx - AndroidUtilities.m1146dp(18.0f);
            this.progressEndY = measuredHeight;
        } else {
            this.minusCx = measuredWidth;
            this.minusCy = AndroidUtilities.m1146dp(41.0f);
            this.plusCx = measuredWidth;
            this.plusCy = getMeasuredHeight() - AndroidUtilities.m1146dp(41.0f);
            this.progressStartX = measuredWidth;
            this.progressStartY = this.minusCy + AndroidUtilities.m1146dp(18.0f);
            this.progressEndX = measuredWidth;
            this.progressEndY = this.plusCy - AndroidUtilities.m1146dp(18.0f);
        }
        this.minusDrawable.setBounds(this.minusCx - AndroidUtilities.m1146dp(7.0f), this.minusCy - AndroidUtilities.m1146dp(7.0f), this.minusCx + AndroidUtilities.m1146dp(7.0f), this.minusCy + AndroidUtilities.m1146dp(7.0f));
        this.minusDrawable.draw(canvas);
        this.plusDrawable.setBounds(this.plusCx - AndroidUtilities.m1146dp(7.0f), this.plusCy - AndroidUtilities.m1146dp(7.0f), this.plusCx + AndroidUtilities.m1146dp(7.0f), this.plusCy + AndroidUtilities.m1146dp(7.0f));
        ...
        if (z) {
            this.progressDrawable.setBounds(i2, i4 - AndroidUtilities.m1146dp(3.0f), this.progressEndX, this.progressStartY + AndroidUtilities.m1146dp(3.0f));
            this.filledProgressDrawable.setBounds(this.progressStartX, this.progressStartY - AndroidUtilities.m1146dp(3.0f), i5, this.progressStartY + AndroidUtilities.m1146dp(3.0f));
        } else {
            this.progressDrawable.setBounds(i4, 0, i3, AndroidUtilities.m1146dp(6.0f));
            this.filledProgressDrawable.setBounds(this.progressStartY, 0, i6, AndroidUtilities.m1146dp(6.0f));
            canvas.save();
            canvas.rotate(90.0f);
            canvas.translate(0.0f, (-this.progressStartX) - AndroidUtilities.m1146dp(3.0f));
        }
