...
public class SubstringLayoutAnimator {
    ...
    public void create(StaticLayout staticLayout, CharSequence charSequence, CharSequence charSequence2, TextPaint textPaint) {
        ...
        if (iIndexOf >= 0) {
            ...
            this.animateInLayout = new StaticLayout(spannableStringBuilder, textPaint, iM1146dp, alignment, 1.0f, 0.0f, false);
            StaticLayout staticLayout2 = new StaticLayout(spannableStringBuilder2, textPaint, AndroidUtilities.m1146dp(400.0f), alignment, 1.0f, 0.0f, false);
            ...
            this.animateInLayout = new StaticLayout(charSequence2, textPaint, iM1146dp2, alignment2, 1.0f, 0.0f, false);
            this.animateOutLayout = new StaticLayout(charSequence, textPaint, AndroidUtilities.m1146dp(400.0f), alignment2, 1.0f, 0.0f, false);
