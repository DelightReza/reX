...
public class RecyclerItemsEnterAnimator {
    ...
    public void showItemsAnimated(int i) {
        ...
        ViewTreeObserverOnPreDrawListenerC43992 viewTreeObserverOnPreDrawListenerC43992 = new ViewTreeObserverOnPreDrawListenerC43992(progressView, i);
        this.preDrawListeners.add(viewTreeObserverOnPreDrawListenerC43992);
        this.listView.getViewTreeObserver().addOnPreDrawListener(viewTreeObserverOnPreDrawListenerC43992);
    }

    /* renamed from: org.telegram.ui.Components.RecyclerItemsEnterAnimator$2 */
    class ViewTreeObserverOnPreDrawListenerC43992 implements ViewTreeObserver.OnPreDrawListener {
        final /* synthetic */ int val$finalFrom;
        final /* synthetic */ View val$finalProgressView;

        ViewTreeObserverOnPreDrawListenerC43992(View view, int i) {
