...
public class LoadingDrawable extends Drawable {
    ...
    public void setRadiiDp(float f) {
        if (this.usePath != null) {
            this.paint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1146dp(f)));
            this.strokePaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1146dp(f)));
        } else {
            setRadiiDp(f, f, f, f);
        }
    }
    ...
    public void setRadiiDp(float f, float f2, float f3, float f4) {
        setRadii(AndroidUtilities.m1146dp(f), AndroidUtilities.m1146dp(f2), AndroidUtilities.m1146dp(f3), AndroidUtilities.m1146dp(f4));
    }
    ...
    */
    public void draw(android.graphics.Canvas r30) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.LoadingDrawable.draw(android.graphics.Canvas):void");
    }
