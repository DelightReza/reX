...
public class ReactedUsersListView extends FrameLayout {
    ...
    public ReactedUsersListView(final Context context, final Theme.ResourcesProvider resourcesProvider, final int i, MessageObject messageObject, TLRPC.ReactionCount reactionCount, boolean z, final boolean z2) {
        ...
        if (z) {
            this.listView.setPadding(0, 0, 0, AndroidUtilities.m1146dp(8.0f));
        ...
        RecyclerView.Adapter adapter = new RecyclerView.Adapter() { // from class: org.telegram.ui.Components.ReactedUsersListView.2
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
                ViewGroup reactedUserHolderView;
                if (i2 == 0) {
        ...
        FlickerLoadingView flickerLoadingView = new FlickerLoadingView(context, resourcesProvider) { // from class: org.telegram.ui.Components.ReactedUsersListView.4
            ...
            public int getAdditionalHeight() {
                ...
                return messageContainsEmojiButton.getMeasuredHeight() + AndroidUtilities.m1146dp(8.0f);
            }
        };
        ...
        while (it2.hasNext()) {
            ...
            if (((ArrayList) this.peerReactionMap.get(userSeen2.dialogId)) == null) {
                ...
                if (tLObject instanceof TLRPC.User) {
                    ...
                    tL_peerUser.user_id = ((TLRPC.User) userSeen2.user).f1734id;
                } else if (tLObject instanceof TLRPC.Chat) {
                    TLRPC.TL_peerChat tL_peerChat = new TLRPC.TL_peerChat();
                    tL_messagePeerReaction.peer_id = tL_peerChat;
                    tL_peerChat.chat_id = ((TLRPC.Chat) userSeen2.user).f1571id;
                }
    ...
    public void updateCustomReactionsButton() {
        ...
        for (int i = 0; i < this.customReactionsEmoji.size(); i++) {
            ...
            if (inputStickerSet != null && !hashSet.contains(Long.valueOf(inputStickerSet.f1596id))) {
    ...
    public void updateHeight() {
        if (this.onHeightChangedListener != null) {
            ...
            int iM1146dp = AndroidUtilities.m1146dp(size * 50);
            MessageContainsEmojiButton messageContainsEmojiButton = this.messageContainsEmojiButton;
            if (messageContainsEmojiButton != null) {
                iM1146dp += messageContainsEmojiButton.getMeasuredHeight() + AndroidUtilities.m1146dp(8.0f);
            }
            if (this.listView.getMeasuredHeight() != 0) {
                iM1146dp = Math.min(this.listView.getMeasuredHeight(), iM1146dp);
            }
            this.onHeightChangedListener.onHeightChanged(this, iM1146dp);
        }
    }
    ...
    public static class ContainerLinerLayout extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
                    ...
                    if (getChildAt(i3) instanceof ReactedUsersListView) {
                        ...
                        if (recyclerListView.getAdapter().getItemCount() == recyclerListView.getChildCount()) {
                            ...
                            for (int i4 = 0; i4 < childCount; i4++) {
                                recyclerListView.getChildAt(i4).measure(View.MeasureSpec.makeMeasureSpec(AndroidUtilities.m1146dp(1000.0f), 0), i2);
                                if (recyclerListView.getChildAt(i4).getMeasuredWidth() > iM1146dp) {
                                    iM1146dp = recyclerListView.getChildAt(i4).getMeasuredWidth();
                                }
                            }
            ...
            if (size < AndroidUtilities.m1146dp(240.0f)) {
                size = AndroidUtilities.m1146dp(240.0f);
            }
            if (size > AndroidUtilities.m1146dp(280.0f)) {
                size = AndroidUtilities.m1146dp(280.0f);
            }
            if (size < 0) {
                size = 0;
            }
            if (iM1146dp == 0 || iM1146dp >= size) {
                iM1146dp = size;
            }
            if (recyclerListView != null) {
                for (int i5 = 0; i5 < recyclerListView.getChildCount(); i5++) {
                    recyclerListView.getChildAt(i5).measure(View.MeasureSpec.makeMeasureSpec(iM1146dp, TLObject.FLAG_30), i2);
                }
            }
            super.onMeasure(View.MeasureSpec.makeMeasureSpec(iM1146dp, TLObject.FLAG_30), i2);
        }
    }
