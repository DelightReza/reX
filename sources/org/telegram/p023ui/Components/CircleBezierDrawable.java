...
public class CircleBezierDrawable {
    ...
    /* renamed from: m */
    private Matrix f1854m = new Matrix();
    ...
    public void draw(float f, float f2, Canvas canvas, Paint paint) {
        ...
        float fMax = this.f1852L * Math.max(f6, f7) * this.cubicBezierK;
        this.path.reset();
        char c = 0;
        int i = 0;
        while (i < this.f1853N) {
            this.f1854m.reset();
            this.f1854m.setRotate((360.0f / this.f1853N) * i, f, f2);
            ...
            float f11 = f2 - f10;
            fArr2[1] = f11;
            fArr2[2] = f + fMax + (f9 * fArr[i] * this.f1852L);
            fArr2[3] = f11;
            this.f1854m.mapPoints(fArr2);
            int i2 = i + 1;
            int i3 = i2 >= this.f1853N ? 0 : i2;
            ...
            float f15 = f2 - f14;
            fArr4[1] = f15;
            fArr4[2] = (f - fMax) + (f13 * fArr3[i3] * this.f1852L);
            fArr4[3] = f15;
            this.f1854m.reset();
            this.f1854m.setRotate((360.0f / this.f1853N) * i3, f, f2);
            this.f1854m.mapPoints(this.pointEnd);
            if (i == 0) {
                Path path = this.path;
