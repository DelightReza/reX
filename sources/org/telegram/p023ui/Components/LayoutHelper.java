...
public abstract class LayoutHelper {
    ...
    public static FrameLayout.LayoutParams createFrame(int i, float f, int i2, float f2, float f3, float f4, float f5) {
        ...
        layoutParams.setMargins(AndroidUtilities.m1146dp(f2), AndroidUtilities.m1146dp(f3), AndroidUtilities.m1146dp(f4), AndroidUtilities.m1146dp(f5));
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrame(float f, float f2, int i, float f3, float f4, float f5, float f6) {
        ...
        layoutParams.setMargins(AndroidUtilities.m1146dp(f3), AndroidUtilities.m1146dp(f4), AndroidUtilities.m1146dp(f5), AndroidUtilities.m1146dp(f6));
        return layoutParams;
    }
    ...
    public static FrameLayout.LayoutParams createFrameRelatively(float f, float f2, int i, float f3, float f4, float f5, float f6) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1146dp(LocaleController.isRTL ? f5 : f3);
        layoutParams.topMargin = AndroidUtilities.m1146dp(f4);
        if (!LocaleController.isRTL) {
            f3 = f5;
        }
        layoutParams.rightMargin = AndroidUtilities.m1146dp(f3);
        layoutParams.bottomMargin = AndroidUtilities.m1146dp(f6);
        return layoutParams;
    }
    ...
    public static RelativeLayout.LayoutParams createRelative(float f, float f2, int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.leftMargin = AndroidUtilities.m1146dp(i);
        layoutParams.topMargin = AndroidUtilities.m1146dp(i2);
        layoutParams.rightMargin = AndroidUtilities.m1146dp(i3);
        layoutParams.bottomMargin = AndroidUtilities.m1146dp(i4);
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.setMargins(AndroidUtilities.m1146dp(i4), AndroidUtilities.m1146dp(i5), AndroidUtilities.m1146dp(i6), AndroidUtilities.m1146dp(i7));
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, float f, int i3, int i4, int i5, int i6) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getSize(i), getSize(i2), f);
        layoutParams.setMargins(AndroidUtilities.m1146dp(i3), AndroidUtilities.m1146dp(i4), AndroidUtilities.m1146dp(i5), AndroidUtilities.m1146dp(i6));
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams createLinear(int i, int i2, int i3, float f, float f2, float f3, float f4) {
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(getSize(i), getSize(i2));
        layoutParams.setMargins(AndroidUtilities.m1146dp(f), AndroidUtilities.m1146dp(f2), AndroidUtilities.m1146dp(f3), AndroidUtilities.m1146dp(f4));
        layoutParams.gravity = i3;
        return layoutParams;
    }
