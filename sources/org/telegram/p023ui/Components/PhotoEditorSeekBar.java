...
public class PhotoEditorSeekBar extends View {
    ...
    public PhotoEditorSeekBar(Context context) {
        ...
        this.thumbSize = AndroidUtilities.m1146dp(16.0f);
        this.thumbDX = 0;
        this.progress = 0.0f;
        this.pressed = false;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(i / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m1146dp(1.0f), getMeasuredWidth() - (this.thumbSize / 2), (getMeasuredHeight() / 2) + AndroidUtilities.m1146dp(1.0f), this.innerPaint);
        if (this.minValue == 0) {
            canvas.drawRect(this.thumbSize / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m1146dp(1.0f), i2, (getMeasuredHeight() / 2) + AndroidUtilities.m1146dp(1.0f), this.outerPaint);
        } else if (this.progress > 0.5f) {
            canvas.drawRect((getMeasuredWidth() / 2) - AndroidUtilities.m1146dp(1.0f), (getMeasuredHeight() - this.thumbSize) / 2, getMeasuredWidth() / 2, (getMeasuredHeight() + this.thumbSize) / 2, this.outerPaint);
            canvas.drawRect(getMeasuredWidth() / 2, (getMeasuredHeight() / 2) - AndroidUtilities.m1146dp(1.0f), i2, (getMeasuredHeight() / 2) + AndroidUtilities.m1146dp(1.0f), this.outerPaint);
        } else {
            canvas.drawRect(getMeasuredWidth() / 2, (getMeasuredHeight() - this.thumbSize) / 2, (getMeasuredWidth() / 2) + AndroidUtilities.m1146dp(1.0f), (getMeasuredHeight() + this.thumbSize) / 2, this.outerPaint);
            canvas.drawRect(i2, (getMeasuredHeight() / 2) - AndroidUtilities.m1146dp(1.0f), getMeasuredWidth() / 2, (getMeasuredHeight() / 2) + AndroidUtilities.m1146dp(1.0f), this.outerPaint);
        }
