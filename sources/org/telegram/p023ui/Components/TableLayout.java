...
public class TableLayout extends View {
        ...
        */
        public void measure(int r2, int r3, boolean r4) {
            ...
            L18:
                ...
                int r2 = r1.textHeight
                int r3 = r3 - r2
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p023ui.Components.TableLayout.this
                int r2 = org.telegram.p023ui.Components.TableLayout.m11811$$Nest$fgetitemPaddingTop(r2)
                int r3 = r3 - r2
                r1.textY = r3
                goto L31
            L29:
            ...
            L4a:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p023ui.Components.TableLayout.this
                org.telegram.ui.Components.TableLayout$TableLayoutDelegate r2 = org.telegram.p023ui.Components.TableLayout.m11807$$Nest$fgetdelegate(r2)
                org.telegram.tgnet.TLRPC$TL_pageTableCell r3 = r1.cell
                int r4 = r1.measuredWidth
                org.telegram.ui.Components.TableLayout r0 = org.telegram.p023ui.Components.TableLayout.this
                int r0 = org.telegram.p023ui.Components.TableLayout.m11810$$Nest$fgetitemPaddingLeft(r0)
                int r0 = r0 * 2
                int r4 = r4 - r0
                org.telegram.ui.ArticleViewer$DrawingText r2 = r2.createTextLayout(r3, r4)
                r1.setTextLayout(r2)
                int r2 = r1.textHeight
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p023ui.Components.TableLayout.this
                int r3 = org.telegram.p023ui.Components.TableLayout.m11811$$Nest$fgetitemPaddingTop(r3)
                int r3 = r3 * 2
                int r2 = r2 + r3
                r1.fixedHeight = r2
            L71:
                ...
                int r4 = r1.textWidth
                int r3 = r3 - r4
                org.telegram.ui.Components.TableLayout r4 = org.telegram.p023ui.Components.TableLayout.this
                int r4 = org.telegram.p023ui.Components.TableLayout.m11810$$Nest$fgetitemPaddingLeft(r4)
                int r3 = r3 - r4
                int r2 = r2 + r3
                r1.textX = r2
                return
            ...
            La2:
                org.telegram.ui.Components.TableLayout r3 = org.telegram.p023ui.Components.TableLayout.this
                int r3 = org.telegram.p023ui.Components.TableLayout.m11810$$Nest$fgetitemPaddingLeft(r3)
                int r2 = r2 + r3
                r1.textX = r2
                return
            Lac:
                org.telegram.ui.Components.TableLayout r2 = org.telegram.p023ui.Components.TableLayout.this
                int r2 = org.telegram.p023ui.Components.TableLayout.m11810$$Nest$fgetitemPaddingLeft(r2)
                r1.textX = r2
            Lb4:
                return
            */
        ...
        public int getTextX() {
            return this.f2005x + this.textX;
        }

        public int getTextY() {
            return this.f2006y + this.textY;
        }
        ...
        public void draw(Canvas canvas, View view) {
            ...
            boolean z = false;
            boolean z2 = true;
            boolean z3 = this.f2005x + this.measuredWidth == TableLayout.this.getMeasuredWidth();
            boolean z4 = this.f2006y + this.measuredHeight == TableLayout.this.getMeasuredHeight();
            ...
            if (this.cell.header || (TableLayout.this.isStriped && this.layoutParams.rowSpec.span.min % 2 == 0)) {
                if (this.f2005x == 0 && this.f2006y == 0) {
                ...
                if (z2) {
                    TableLayout.this.rect.set(this.f2005x, this.f2006y, r3 + this.measuredWidth, r5 + this.measuredHeight);
                    ...
                    canvas2.drawRect(this.f2005x, this.f2006y, r2 + this.measuredWidth, r4 + this.measuredHeight, TableLayout.this.delegate.getHeaderPaint());
                    canvas2 = canvas;
                } else {
                    canvas2 = canvas;
                    canvas2.drawRect(this.f2005x, this.f2006y, r1 + this.measuredWidth, r3 + this.measuredHeight, TableLayout.this.delegate.getStripPaint());
                }
            }
            ...
            if (TableLayout.this.drawLines) {
                ...
                if (i2 == 0) {
                    ...
                    paint = linePaint;
                    paint2 = linePaint2;
                    canvas.drawLine(i2 - strokeWidth2, this.f2006y, i2 - strokeWidth2, r3 + this.measuredHeight, paint2);
                }
                int i5 = this.f2006y;
                if (i5 == 0) {
                    int i6 = this.f2005x;
                    ...
                    canvas.drawLine(this.f2005x, i5 - strokeWidth2, r2 + this.measuredWidth, i5 - strokeWidth2, paint2);
                }
                float f11 = (z3 && (i = this.f2006y) == 0) ? i + iM1146dp : this.f2006y - strokeWidth;
                if (z3 && z4) {
                    f = (this.f2006y + this.measuredHeight) - iM1146dp;
                } else {
                    f = (this.f2006y + this.measuredHeight) - strokeWidth;
                }
                float f12 = f;
                int i8 = this.f2005x;
                ...
                int i10 = this.f2005x;
                float f13 = (i10 == 0 && z4) ? i10 + iM1146dp : i10 - strokeWidth;
                if (z3 && z4) {
                    f2 = (i10 + this.measuredWidth) - iM1146dp;
                } else {
    ...
    public TableLayout(Context context, TableLayoutDelegate tableLayoutDelegate, TextSelectionHelper.ArticleTextSelectionHelper articleTextSelectionHelper) {
        ...
        this.itemPaddingTop = AndroidUtilities.m1146dp(7.0f);
        this.itemPaddingLeft = AndroidUtilities.m1146dp(8.0f);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i6 < childCount2) {
            ...
            if (childAt.cell != null) {
                ...
                if (childAt.fixedHeight != 0 && childAt.fixedHeight != sizeInCell2 && childAt.layoutParams.rowSpec.span.max - childAt.layoutParams.rowSpec.span.min <= 1) {
                    ...
                    while (true) {
                        if (i3 < size) {
                            Point point = (Point) tableLayout.rowSpans.get(i3);
                            i3 = (point.f1929x > ((float) childAt.layoutParams.rowSpec.span.min) || point.f1930y <= ((float) childAt.layoutParams.rowSpec.span.min)) ? i3 + 1 : 0;
                        } else {
        ...
        while (i16 < size2) {
            ...
            if (!z) {
                ...
                for (int i22 = 0; i22 < size4; i22++) {
                    Child child4 = (Child) tableLayout.childrens.get(i22);
                    if (child != child4) {
        ...
        for (int i23 = 0; i23 < childCount3; i23++) {
            Child childAt2 = tableLayout.getChildAt(i23);
    ...
    final class Axis {
        ...
        private int calculateMaxIndex() {
            ...
            return iMax == -1 ? TLObject.FLAG_31 : iMax;
        }
        ...
        private PackedMap createGroupBounds() {
            Assoc assocM1296of = Assoc.m1296of(Spec.class, Bounds.class);
            int childCount = TableLayout.this.getChildCount();
            for (int i = 0; i < childCount; i++) {
                LayoutParams layoutParams = TableLayout.this.getChildAt(i).getLayoutParams();
                boolean z = this.horizontal;
                Spec spec = z ? layoutParams.columnSpec : layoutParams.rowSpec;
                assocM1296of.put(spec, spec.getAbsoluteAlignment(z).getBounds());
            }
            return assocM1296of.pack();
        }
        ...
        private PackedMap createLinks(boolean z) {
            Assoc assocM1296of = Assoc.m1296of(Interval.class, MutableInt.class);
            Spec[] specArr = (Spec[]) getGroupBounds().keys;
            int length = specArr.length;
            for (int i = 0; i < length; i++) {
                assocM1296of.put(z ? specArr[i].span : specArr[i].span.inverse(), new MutableInt());
            }
            return assocM1296of.pack();
        }
    ...
    static final class Assoc extends ArrayList {
        ...
        /* renamed from: of */
        public static Assoc m1296of(Class cls, Class cls2) {
