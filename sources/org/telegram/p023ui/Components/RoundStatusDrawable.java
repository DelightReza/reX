...
public class RoundStatusDrawable extends StatusDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(AndroidUtilities.m1146dp(6.0f), AndroidUtilities.m1146dp(this.isChat ? 8.0f : 9.0f), AndroidUtilities.m1146dp(4.0f), paint);
        if (this.started) {
            update();
        }
    }
    ...
    public int getIntrinsicHeight() {
        return AndroidUtilities.m1146dp(10.0f);
    }
}
