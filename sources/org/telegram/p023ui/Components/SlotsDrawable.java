...
public class SlotsDrawable extends RLottieDrawable {
            ...
            if (jArr[i4] != 0) {
                ...
                if (TextUtils.isEmpty(res)) {
                    ...
                    AndroidUtilities.runOnUIThread(new Runnable() { // from class: org.telegram.ui.Components.SlotsDrawable$$ExternalSyntheticLambda8
                        @Override // java.lang.Runnable
                        public final void run() {
                            SlotsDrawable.m11678$r8$lambda$CRSx3qZRDIU7oRxYGW02aqy5aI(document, i3, messageObject2, chatMessageCell2, tL_messages_stickerSet2);
                        }
                    });
                    z = true;
                } else {
    ...
    /* renamed from: $r8$lambda$CRSx3-qZRDIU7oRxYGW02aqy5aI, reason: not valid java name */
    public static /* synthetic */ void m11678$r8$lambda$CRSx3qZRDIU7oRxYGW02aqy5aI(TLRPC.Document document, int i, MessageObject messageObject, ChatMessageCell chatMessageCell, TLRPC.TL_messages_stickerSet tL_messages_stickerSet) {
    ...
    */
    public /* synthetic */ void lambda$setDiceNumber$10(org.telegram.tgnet.TLRPC.TL_messages_stickerSet r18, final int r19, final org.telegram.messenger.MessageObject r20, final org.telegram.p023ui.Cells.ChatMessageCell r21, final boolean r22) {
        /*
            Method dump skipped, instructions count: 292
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.SlotsDrawable.lambda$setDiceNumber$10(org.telegram.tgnet.TLRPC$TL_messages_stickerSet, int, org.telegram.messenger.MessageObject, org.telegram.ui.Cells.ChatMessageCell, boolean):void");
    }
