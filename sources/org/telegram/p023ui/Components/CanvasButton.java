...
public class CanvasButton {
    ...
    float roundRadius = AndroidUtilities.m1146dp(12.0f);
    ...
    public CanvasButton(View view) {
        ...
        this.maskPaint.setPathEffect(new CornerPathEffect(AndroidUtilities.m1146dp(12.0f)));
        ...
        if (!this.pathCreated) {
            ...
            while (true) {
                ...
                if (i8 < i7) {
                    ...
                    if (Math.abs(f - f2) < AndroidUtilities.m1146dp(4.0f)) {
