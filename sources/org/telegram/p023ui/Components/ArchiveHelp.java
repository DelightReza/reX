...
public class ArchiveHelp extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    public ArchiveHelp(Context context, int i, Theme.ResourcesProvider resourcesProvider, Runnable runnable, final Runnable runnable2) {
        ...
        imageView.setBackground(Theme.createCircleDrawable(AndroidUtilities.m1146dp(80.0f), Theme.getColor(Theme.key_avatar_backgroundSaved, resourcesProvider)));
        imageView.setImageResource(C2369R.drawable.large_archive);
        ...
        textView.setText(LocaleController.getString(C2369R.string.ArchiveHintHeader1));
        ...
        linearLayout.addView(makeHint(C2369R.drawable.msg_archive_archive, LocaleController.getString("ArchiveHintSection1"), LocaleController.getString("ArchiveHintSection1Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C2369R.drawable.msg_archive_hide, LocaleController.getString("ArchiveHintSection2"), LocaleController.getString("ArchiveHintSection2Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        linearLayout.addView(makeHint(C2369R.drawable.msg_archive_stories, LocaleController.getString("ArchiveHintSection3"), LocaleController.getString("ArchiveHintSection3Info"), resourcesProvider), LayoutHelper.createLinear(-1, -2, 7, 32, 0, 32, 16));
        if (runnable2 != null) {
    ...
    protected void onMeasure(int i, int i2) {
        super.onMeasure(View.MeasureSpec.makeMeasureSpec(Math.min(AndroidUtilities.m1146dp(400.0f), View.MeasureSpec.getSize(i)), TLObject.FLAG_30), i2);
    }
    ...
    private void updateText() {
        ...
        Drawable drawableMutate = getContext().getResources().getDrawable(C2369R.drawable.msg_arrowright).mutate();
