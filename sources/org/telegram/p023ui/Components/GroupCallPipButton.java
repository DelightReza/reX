...
public class GroupCallPipButton extends FrameLayout implements NotificationCenter.NotificationCenterDelegate, VoIPService.StateListener {
    ...
    public GroupCallPipButton(Context context, int i, boolean z) {
        ...
        this.blobDrawable.maxRadius = AndroidUtilities.m1146dp(37.0f);
        this.blobDrawable.minRadius = AndroidUtilities.m1146dp(32.0f);
        this.blobDrawable2.maxRadius = AndroidUtilities.m1146dp(37.0f);
        this.blobDrawable2.minRadius = AndroidUtilities.m1146dp(32.0f);
        this.blobDrawable.generateBlob();
        this.blobDrawable2.generateBlob();
        this.bigMicDrawable = new RLottieDrawable(C2369R.raw.voice_outlined, "" + C2369R.raw.voice_outlined, AndroidUtilities.m1146dp(22.0f), AndroidUtilities.m1146dp(30.0f), true, null);
        ...
        this.prepareToRemoveShader = new LinearGradient(0.0f, 0.0f, AndroidUtilities.m1146dp(350.0f), 0.0f, new int[]{-2801343, -561538, 0}, new float[]{0.0f, 0.4f, 1.0f}, Shader.TileMode.CLAMP);
        if (z) {
            setState(0);
        }
    }
    ...
    public static class WeavingState {
        ...
        public void update(long j, float f) {
            ...
            int iM1146dp = AndroidUtilities.m1146dp(130.0f);
    ...
    */
    protected void onDraw(android.graphics.Canvas r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.Components.GroupCallPipButton.onDraw(android.graphics.Canvas):void");
    }
    ...
    public void setState(int i) {
        ...
        if (weavingState == null || weavingState.currentState != i) {
            ...
            if (sharedInstance != null && ChatObject.isChannelOrGiga(sharedInstance.getChat())) {
                string = LocaleController.getString(C2369R.string.VoipChannelVoiceChat);
            } else {
                string = LocaleController.getString(C2369R.string.VoipGroupVoiceChat);
            }
            if (i == 0) {
                string = string + ", " + LocaleController.getString(C2369R.string.VoipTapToMute);
            } else if (i == 2) {
                string = string + ", " + LocaleController.getString(C2369R.string.Connecting);
            } else if (i == 3) {
                string = string + ", " + LocaleController.getString(C2369R.string.VoipMutedByAdmin);
            }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (GroupCallPip.getInstance() != null) {
            accessibilityNodeInfo.addAction(new AccessibilityNodeInfo.AccessibilityAction(16, LocaleController.getString(GroupCallPip.getInstance().showAlert ? C2369R.string.AccDescrCloseMenu : C2369R.string.AccDescrOpenMenu2)));
        }
    }
