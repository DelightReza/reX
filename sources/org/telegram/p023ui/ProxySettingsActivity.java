...
public class ProxySettingsActivity extends BaseFragment {
    ...
    public View createView(final Context context) throws NoSuchFieldException, SecurityException {
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.ProxyDetails));
        ...
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.ProxySettingsActivity.1
            ...
            public void onItemClick(int i) {
                boolean z;
                if (i == -1) {
                    ProxySettingsActivity.this.lambda$onBackPressed$371();
                    return;
                }
        ...
        while (i < 2) {
            ...
            if (i == 0) {
                this.typeCell[i].setText(LocaleController.getString(C2369R.string.UseProxySocks5), i == this.currentType, true);
            } else {
                this.typeCell[i].setText(LocaleController.getString(C2369R.string.UseProxyTelegram), i == this.currentType, false);
            }
        ...
        this.inputFieldsContainer.setElevation(AndroidUtilities.m1146dp(1.0f));
        ...
        for (int i3 = 5; i2 < i3; i3 = 5) {
            ...
            this.inputFields[i2].setCursorSize(AndroidUtilities.m1146dp(20.0f));
            ...
            if (i2 == 0) {
                this.inputFields[i2].setHintText(LocaleController.getString(C2369R.string.UseProxyAddress));
                this.inputFields[i2].setText(this.currentProxyInfo.address);
            } else if (i2 == 1) {
                this.inputFields[i2].setHintText(LocaleController.getString(C2369R.string.UseProxyPort));
                this.inputFields[i2].setText("" + this.currentProxyInfo.port);
            } else if (i2 == 2) {
                this.inputFields[i2].setHintText(LocaleController.getString(C2369R.string.UseProxyUsername));
                this.inputFields[i2].setText(this.currentProxyInfo.username);
            } else if (i2 == 3) {
                this.inputFields[i2].setHintText(LocaleController.getString(C2369R.string.UseProxyPassword));
                this.inputFields[i2].setText(this.currentProxyInfo.password);
            } else if (i2 == 4) {
                this.inputFields[i2].setHintText(LocaleController.getString(C2369R.string.UseProxySecret));
        ...
        for (int i5 = 0; i5 < 2; i5++) {
            ...
            this.bottomCells[i5].setBackground(Theme.getThemedDrawableByKey(context, C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
            if (i5 == 0) {
                this.bottomCells[i5].setText(LocaleController.getString(C2369R.string.UseProxyInfo));
            } else {
                this.bottomCells[i5].setText(LocaleController.getString(C2369R.string.UseProxyTelegramInfo) + "\n\n" + LocaleController.getString(C2369R.string.UseProxyTelegramInfo2));
        ...
        this.pasteCell.setText(LocaleController.getString(C2369R.string.PasteFromClipboard), false);
        ...
        int i7 = C2369R.drawable.greydivider_bottom;
        ...
        this.shareCell.setText(LocaleController.getString(C2369R.string.ShareFile), false);
        ...
        this.sectionCell[1].setBackgroundDrawable(Theme.getThemedDrawableByKey(context, C2369R.drawable.greydivider_bottom, i8));
    ...
    public /* synthetic */ void lambda$createView$4(Context context, View view) {
        ...
        try {
            ...
            QRCodeBottomSheet qRCodeBottomSheet = new QRCodeBottomSheet(context, LocaleController.getString(C2369R.string.ShareQrCode), str + sb.toString(), LocaleController.getString(C2369R.string.QRCodeLinkHelpProxy), true);
            qRCodeBottomSheet.setCenterImage(SvgHelper.getBitmap(AndroidUtilities.readRes(C2369R.raw.qr_dog), AndroidUtilities.m1146dp(60.0f), AndroidUtilities.m1146dp(60.0f), false));
    ...
    */
    public void updatePasteCell() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: org.telegram.p023ui.ProxySettingsActivity.updatePasteCell():void");
    }
