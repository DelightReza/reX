...
public class StoriesListPlaceProvider implements StoryViewer.PlaceProvider {
    ...
    /* renamed from: of */
    public static StoriesListPlaceProvider m1334of(RecyclerListView recyclerListView) {
        return m1335of(recyclerListView, false);
    }

    /* renamed from: of */
    public static StoriesListPlaceProvider m1335of(RecyclerListView recyclerListView, boolean z) {
        return new StoriesListPlaceProvider(recyclerListView, z);
    }

    /* renamed from: of */
    public static StoriesListPlaceProvider m1333of(ProfileChannelCell profileChannelCell) {
    ...
    public static /* synthetic */ void $r8$lambda$dVvQM61LLLmGehYO5ae62iOJhMA(Path path, Canvas canvas, RectF rectF, float f, boolean z) {
        ...
        path.addCircle((rectF.right + AndroidUtilities.m1146dp(7.0f)) - (AndroidUtilities.m1146dp(14.0f) * fPow), (rectF.bottom + AndroidUtilities.m1146dp(7.0f)) - (AndroidUtilities.m1146dp(14.0f) * fPow), AndroidUtilities.m1146dp(11.0f), Path.Direction.CW);
