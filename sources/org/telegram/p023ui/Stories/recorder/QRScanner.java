...
public class QRScanner {
    ...
    public static final class Detected {
        ...
        /* renamed from: cx */
        public final float f2112cx;

        /* renamed from: cy */
        public final float f2113cy;
    ...
    public static class QrRegionDrawer {
        ...
        public QrRegionDrawer(Runnable runnable) {
            ...
            paint.setColor(-8697);
            paint.setStrokeWidth(AndroidUtilities.m1146dp(6.0f));
            paint.setStrokeJoin(Paint.Join.ROUND);
            paint.setStrokeCap(Paint.Cap.ROUND);
            paint.setShadowLayer(1.0804527E9f, 0.0f, AndroidUtilities.m1146dp(3.0f), AndroidUtilities.m1146dp(6.0f));
        ...
        public void draw(Canvas canvas, RectF rectF) {
            ...
            float f2 = this.animatedQrCX.set(this.qrResult.f2112cx);
            float fWidth = rectF.left + (rectF.width() * f2);
            float f3 = this.animatedQrCY.set(this.qrResult.f2113cy);
            ...
            if (f > 0.0f) {
                ...
                while (i < iMin) {
                    ...
                    float f4 = f;
                    float f5 = f2;
                    float fWidth2 = rectF.left + ((this.animatedQPX[i2].set(pointF.x - detected2.f2112cx) + f5) * rectF.width());
                    float fHeight2 = rectF.top + ((this.animatedQPY[i2].set(pointF.y - this.qrResult.f2113cy) + f3) * rectF.height());
                    float fWidth3 = rectF.left + ((this.animatedQPX[i].set(pointF2.x - this.qrResult.f2112cx) + f5) * rectF.width());
                    float fHeight3 = rectF.top + ((this.animatedQPY[i].set(pointF2.y - this.qrResult.f2113cy) + f3) * rectF.height());
                    float fWidth4 = rectF.left + ((this.animatedQPX[i4].set(pointF3.x - this.qrResult.f2112cx) + f5) * rectF.width());
                    float fHeight4 = (rectF.top + ((this.animatedQPY[i4].set(pointF3.y - this.qrResult.f2113cy) + f3) * rectF.height())) - fHeight3;
        ...
        public void setQrDetected(Detected detected) {
            ...
            if (detected != null && !this.hasQrResult) {
                this.animatedQrCX.set(detected.f2112cx, true);
                this.animatedQrCY.set(detected.f2113cy, true);
                for (int i = 0; i < Math.min(4, detected.points.length); i++) {
                    this.animatedQPX[i].set(detected.points[i].x - detected.f2112cx, true);
                    this.animatedQPY[i].set(detected.points[i].y - detected.f2113cy, true);
                }
            }
