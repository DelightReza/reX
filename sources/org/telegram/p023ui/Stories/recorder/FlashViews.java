...
public class FlashViews {
    ...
    public void drawGradient(Canvas canvas, boolean z) {
        if (this.gradient != null) {
            ...
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(12.0f) - 2, AndroidUtilities.m1146dp(12.0f) - 2, this.paint);
        }
    }
