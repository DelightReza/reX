...
public class DraftsController {
    ...
    public static /* synthetic */ void $r8$lambda$RiC0JImjTCT65pJVD7o8arqUXPQ(MessagesStorage messagesStorage, StoryDraft storyDraft) {
        ...
        try {
            try {
                ...
                int i = 1;
                sQLitePreparedStatementExecuteFast.bindLong(1, storyDraft.f2092id);
    ...
    public void saveForEdit(StoryEntry storyEntry, long j, TL_stories.StoryItem storyItem) {
        ...
        while (i < size) {
            ...
            if (storyEntry2.isEdit && storyEntry2.editStoryId == storyItem.f1766id) {
    ...
    public StoryEntry getForEdit(long j, TL_stories.StoryItem storyItem) {
        ...
        while (i < size) {
            ...
            if (storyEntry.isEdit && storyItem.f1766id == storyEntry.editStoryId && j == storyEntry.editStoryPeerId && ((document = (messageMedia = storyItem.media).document) == null || document.f1579id == storyEntry.editDocumentId)) {
                TLRPC.Photo photo = messageMedia.photo;
                if (photo == null || photo.f1603id == storyEntry.editPhotoId) {
    ...
    public static class StoryDraft {
        ...
        public StoryDraft(StoryEntry storyEntry) {
            ...
            this.f2092id = storyEntry.draftId;
        ...
        public StoryEntry toEntry() {
            ...
            storyEntry.draftId = this.f2092id;
            storyEntry.isDraft = true;
