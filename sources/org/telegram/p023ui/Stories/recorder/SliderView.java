...
public class SliderView extends View {
    ...
    public SliderView(Context context, int i) {
        ...
        if (i == 0) {
            ...
            animatedTextDrawable3.setTextSize(AndroidUtilities.m1146dp(14.0f));
            ...
            if (i == 1) {
                animatedTextDrawable3.setText(LocaleController.getString(C2369R.string.FlashWarmth));
            } else if (i == 2) {
                animatedTextDrawable3.setText(LocaleController.getString(C2369R.string.FlashIntensity));
            } else if (i == 3) {
                animatedTextDrawable3.setText(LocaleController.getString(C2369R.string.WallpaperDimming));
            }
        }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        rectF.set(0.0f, 0.0f, this.f2126w, this.f2124h);
        ...
        canvas.saveLayerAlpha(0.0f, 0.0f, this.f2126w, this.f2124h, 255, 31);
        if (this.currentType == 0) {
            this.text.setBounds(AndroidUtilities.m1146dp(42.0f), -AndroidUtilities.m1146dp(1.0f), this.f2126w, this.f2124h - AndroidUtilities.m1146dp(1.0f));
            this.text.draw(canvas);
        } else {
            this.text2.setBounds(AndroidUtilities.m1146dp(12.33f), -AndroidUtilities.m1146dp(1.0f), (this.f2126w - ((int) this.text.getCurrentWidth())) - AndroidUtilities.m1146dp(6.0f), this.f2124h - AndroidUtilities.m1146dp(1.0f));
            this.text2.draw(canvas);
            this.text.setBounds(this.f2126w - AndroidUtilities.m1146dp(111.0f), -AndroidUtilities.m1146dp(1.0f), this.f2126w - AndroidUtilities.m1146dp(11.0f), this.f2124h - AndroidUtilities.m1146dp(1.0f));
            this.text.draw(canvas);
        }
        if (this.currentType == 0) {
        ...
        canvas.save();
        canvas.drawRect(0.0f, 0.0f, this.f2126w * f2, this.f2124h, this.whitePaint);
        canvas.restore();
        canvas.restore();
        canvas.restore();
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 0) {
            ...
            if (motionEvent.getAction() == 1 && System.currentTimeMillis() - this.pressTime < ViewConfiguration.getTapTimeout()) {
                ...
                this.value = x / this.f2126w;
                this.valueIsAnimated = true;
            } else {
                this.value = Utilities.clamp(this.value + ((x - this.lastTouchX) / this.f2126w), 1.0f, 0.0f);
                this.valueIsAnimated = false;
                z = true;
            }
    ...
    protected void onMeasure(int i, int i2) {
        if (this.currentType == 3) {
            this.f2125r = AndroidUtilities.dpf2(8.0f);
        } else {
            this.f2125r = AndroidUtilities.dpf2(6.33f);
        }
        ...
        if (i3 > 0) {
            this.f2126w = i3;
            this.f2124h = AndroidUtilities.m1146dp(48.0f);
        } else if (this.currentType == 0) {
            this.f2126w = (int) Math.min(this.textPaint.measureText(LocaleController.getString(C2369R.string.StoryAudioRemove)) + AndroidUtilities.m1146dp(88.0f), View.MeasureSpec.getSize(i));
            this.f2124h = AndroidUtilities.m1146dp(48.0f);
        } else {
            this.f2126w = AndroidUtilities.m1146dp(190.0f);
            this.f2124h = AndroidUtilities.m1146dp(44.0f);
        }
        setMeasuredDimension(this.f2126w, this.f2124h);
        if (this.currentType == 0) {
            float fM1146dp = AndroidUtilities.m1146dp(25.0f);
            float f = this.f2124h / 2.0f;
            this.speaker1Paint.setPathEffect(new CornerPathEffect(AndroidUtilities.dpf2(1.33f)));
            this.speaker1Path.rewind();
            this.speaker1Path.moveTo(fM1146dp - AndroidUtilities.dpf2(8.66f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1146dp - AndroidUtilities.dpf2(3.0f), f - AndroidUtilities.dpf2(2.9f));
            this.speaker1Path.lineTo(fM1146dp - AndroidUtilities.dpf2(3.0f), AndroidUtilities.dpf2(2.9f) + f);
            this.speaker1Path.lineTo(fM1146dp - AndroidUtilities.dpf2(8.66f), AndroidUtilities.dpf2(2.9f) + f);
            ...
            this.speaker2Path.moveTo(fM1146dp - AndroidUtilities.dpf2(7.5f), f);
            this.speaker2Path.lineTo(fM1146dp, f - AndroidUtilities.dpf2(7.33f));
            this.speaker2Path.lineTo(fM1146dp, AndroidUtilities.dpf2(7.33f) + f);
            this.speaker2Path.close();
            this.speakerWave1Path.rewind();
            RectF rectF = AndroidUtilities.rectTmp;
            rectF.set((fM1146dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1146dp(4.33f), f - AndroidUtilities.m1146dp(4.33f), (fM1146dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1146dp(4.33f), AndroidUtilities.m1146dp(4.33f) + f);
            ...
            this.speakerWave2Paint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
            this.speakerWave2Path.rewind();
            rectF.set((fM1146dp - AndroidUtilities.dpf2(0.33f)) - AndroidUtilities.m1146dp(8.0f), f - AndroidUtilities.m1146dp(8.0f), (fM1146dp - AndroidUtilities.dpf2(0.33f)) + AndroidUtilities.m1146dp(8.0f), f + AndroidUtilities.m1146dp(8.0f));
