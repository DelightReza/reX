...
public abstract class RoundVideoRecorder extends FrameLayout {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int measuredWidth = ((i3 - i) - this.cameraView.getMeasuredWidth()) - AndroidUtilities.m1146dp(16.0f);
        int iM1146dp = AndroidUtilities.m1146dp(72.0f);
        CameraView cameraView = this.cameraView;
        cameraView.layout(measuredWidth, iM1146dp, cameraView.getMeasuredWidth() + measuredWidth, this.cameraView.getMeasuredHeight() + iM1146dp);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        this.shadowPaint.setShadowLayer(AndroidUtilities.m1146dp(2.0f), 0.0f, AndroidUtilities.m1146dp(0.66f), Theme.multAlpha(536870912, this.alpha));
        ...
        if (this.recordingStarted > 0) {
            ...
            this.progressPaint.setShadowLayer(AndroidUtilities.m1146dp(1.0f), 0.0f, AndroidUtilities.m1146dp(0.33f), Theme.multAlpha(536870912, this.alpha));
            rectF.inset(-AndroidUtilities.m1146dp(7.665f), -AndroidUtilities.m1146dp(7.665f));
    ...
    public String sinceRecordingText() {
        ...
        int i2 = (int) ((jSinceRecording - (i * MediaDataController.MAX_STYLE_RUNS_COUNT)) / 100);
        int i3 = i / 60;
        int i4 = i % 60;
        StringBuilder sb = new StringBuilder();
        sb.append(i3);
        sb.append(":");
        sb.append(i4 < 10 ? MVEL.VERSION_SUB : "");
        sb.append(i4);
        sb.append(".");
        sb.append(i2);
        return sb.toString();
