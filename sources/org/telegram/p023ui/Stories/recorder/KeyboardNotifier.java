...
public class KeyboardNotifier {
    ...
    public boolean keyboardVisible() {
        return this.keyboardHeight > AndroidUtilities.navigationBarHeight + AndroidUtilities.m1146dp(20.0f) || this.awaitingKeyboard;
    }
    ...
    public void fire() {
        if (this.awaitingKeyboard) {
            if (this.keyboardHeight < AndroidUtilities.navigationBarHeight + AndroidUtilities.m1146dp(20.0f)) {
                return;
            } else {
