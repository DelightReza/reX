...
public class StoryReactionWidgetBackground extends Drawable {
    ...
    public StoryReactionWidgetBackground(View view) {
        ...
        paint.setShadowLayer(AndroidUtilities.m1146dp(4.0f), 0.0f, 0.0f, 1593835520);
    ...
    public void updateShadowLayer(float f) {
        this.shadowPaint.setShadowLayer(AndroidUtilities.m1146dp(2.0f) / f, 0.0f, AndroidUtilities.dpf2(0.7f) / f, ColorUtils.setAlphaComponent(-16777216, 45));
    }
