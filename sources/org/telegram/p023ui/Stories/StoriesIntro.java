...
public class StoriesIntro extends FrameLayout {
    ...
    public StoriesIntro(Context context, final View view) {
        ...
        linearLayout.setPadding(0, AndroidUtilities.m1146dp(48.0f), 0, AndroidUtilities.m1146dp(48.0f));
        linearLayout.setGravity(1);
        TextView textView = new TextView(context);
        textView.setTextColor(-1);
        textView.setTypeface(AndroidUtilities.bold());
        textView.setText(LocaleController.getString(C2369R.string.StoriesIntroHeader));
        textView.setTextSize(1, 20.0f);
        linearLayout.addView(textView, LayoutHelper.createLinear(-2, -2));
        final TextView textView2 = new TextView(context);
        textView2.setTextColor(-1761607681);
        textView2.setText(LocaleController.getString(C2369R.string.StoriesIntroSubHeader));
        textView2.setTextSize(1, 14.0f);
        textView2.setGravity(1);
        linearLayout.addView(textView2, LayoutHelper.createLinear(-2, -2, 68.0f, 8.0f, 68.0f, 36.0f));
        ArrayList arrayList = new ArrayList(4);
        this.items = arrayList;
        arrayList.add(new StoriesIntroItemView(context, C2369R.raw.stories_intro_go_forward, LocaleController.getString(C2369R.string.StoriesIntroGoForwardHeader), LocaleController.getString(C2369R.string.StoriesIntroGoForwardSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2369R.raw.stories_intro_pause, LocaleController.getString(C2369R.string.StoriesIntroPauseAndSeekHeader), LocaleController.getString(C2369R.string.StoriesIntroPauseAndSeekSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2369R.raw.stories_intro_go_back, LocaleController.getString(C2369R.string.StoriesIntroGoBackHeader), LocaleController.getString(C2369R.string.StoriesIntroGoBackSubHeader)));
        arrayList.add(new StoriesIntroItemView(context, C2369R.raw.stories_intro_go_to_next, LocaleController.getString(C2369R.string.StoriesIntroGoToNextAuthorHeader), LocaleController.getString(C2369R.string.StoriesIntroGoToNextAuthorSubHeader)));
        int measuredWidth = view.getMeasuredWidth() - AndroidUtilities.m1146dp(100.0f);
        ...
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(AndroidUtilities.m1146dp(8.0f) + measuredWidth > view.getMeasuredWidth() ? view.getMeasuredWidth() - AndroidUtilities.m1146dp(8.0f) : measuredWidth, AndroidUtilities.m1146dp(64.0f));
        layoutParams.setMargins(0, AndroidUtilities.m1146dp(5.0f), 0, AndroidUtilities.m1146dp(5.0f));
        ...
        textView3.setText(LocaleController.getString(C2369R.string.StoriesIntroDismiss));
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: org.telegram.ui.Stories.StoriesIntro.1
            ...
            public void onGlobalLayout() {
                ...
                if (iArr[1] + AndroidUtilities.m1146dp(24.0f) > view.getMeasuredHeight()) {
    ...
    static class StoriesIntroItemView extends View {
        ...
        public StoriesIntroItemView(Context context, int i, String str, String str2) {
            ...
            this.header = str;
            this.subHeader = str2;
            RLottieDrawable rLottieDrawable = new RLottieDrawable(i, "" + i, AndroidUtilities.m1146dp(36.0f), AndroidUtilities.m1146dp(36.0f), true, null);
        ...
        public int getRequiredWidth() {
            ...
            return AndroidUtilities.m1146dp(88.0f) + AndroidUtilities.m1146dp(8.0f) + Math.max(iWidth, this.textBounds.width());
        }
        ...
        protected void onMeasure(int i, int i2) {
            ...
            this.lottieDrawable.setBounds(i4, i5, i4 + iM1146dp2, iM1146dp2 + i5);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            int iM1146dp = AndroidUtilities.m1146dp(40.0f);
            int measuredHeight = getMeasuredHeight() / 2;
            int iM1146dp2 = (int) (AndroidUtilities.m1146dp(36.0f) + (AndroidUtilities.m1146dp(8.0f) * this.progress));
            int i = iM1146dp2 / 2;
            int i2 = iM1146dp - i;
            int i3 = measuredHeight - i;
            this.lottieDrawable.setBounds(i2, i3, i2 + iM1146dp2, iM1146dp2 + i3);
