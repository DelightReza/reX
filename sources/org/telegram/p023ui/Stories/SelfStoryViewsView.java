...
public class SelfStoryViewsView extends FrameLayout {
    ...
    public SelfStoryViewsView(Context context, final StoryViewer storyViewer) {
        ...
        this.selfStoriesPreviewView = new SelfStoriesPreviewView(getContext()) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.1
            @Override // org.telegram.p023ui.Stories.SelfStoriesPreviewView
            void onDragging() {
        ...
        ViewPagerInner viewPagerInner = new ViewPagerInner(context) { // from class: org.telegram.ui.Stories.SelfStoryViewsView.2
            ...
            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                if (!checkTopOffset(motionEvent) && Math.abs(SelfStoryViewsView.this.getCurrentTopOffset() - SelfStoryViewsView.this.bottomPadding) <= AndroidUtilities.m1146dp(1.0f)) {
        ...
        C63924 c63924 = new C63924(storyViewer, context);
        this.pagerAdapter = c63924;
        viewPagerInner2.setAdapter(c63924);
    ...
    class C63924 extends PagerAdapter {
        ...
        C63924(StoryViewer storyViewer, Context context) {
        ...
        public Object instantiateItem(ViewGroup viewGroup, int i) {
            SelfStoryViewsPage selfStoryViewsPage = new SelfStoryViewsPage(this.val$storyViewer, this.val$context, SelfStoryViewsView.this.sharedFilterState, new Consumer() { // from class: org.telegram.ui.Stories.SelfStoryViewsView$4$$ExternalSyntheticLambda0
                ...
                @Override // org.telegram.p023ui.Stories.SelfStoryViewsPage
            ...
            selfStoryViewsPage.setPadding(0, AndroidUtilities.m1146dp(16.0f), 0, 0);
    ...
    public void setKeyboardHeight(int i) {
        ...
        boolean z = this.keyboardHeight >= AndroidUtilities.m1146dp(20.0f);
        boolean z2 = i >= AndroidUtilities.m1146dp(20.0f);
        if (z2 != z) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.toY = AndroidUtilities.m1146dp(20.0f) + i3;
        ((FrameLayout.LayoutParams) this.viewPagerContainer.getLayoutParams()).topMargin = AndroidUtilities.statusBarHeight;
        float fM1146dp = (((i3 + AndroidUtilities.m1146dp(20.0f)) + this.toHeight) + AndroidUtilities.m1146dp(24.0f)) - AndroidUtilities.statusBarHeight;
        this.bottomPadding = fM1146dp;
        this.maxSelfStoriesViewsOffset = size - fM1146dp;
    ...
    public void setOffset(float f) {
        ...
        if (f2 == 1.0f && this.progressToOpen != 1.0f) {
            if (this.storyViewer.storiesList != null) {
                ...
                this.storyViewer.storiesViewPager.setCurrentDate(jDay, messageObject.storyItem.f1766id);
