...
public class FiltersView extends RecyclerListView {
    ...
    public static final MediaFilterData[] filters = {new MediaFilterData(C2369R.drawable.search_media_filled, C2369R.string.SharedMediaTab2, new TLRPC.TL_inputMessagesFilterPhotoVideo(), 0), new MediaFilterData(C2369R.drawable.search_links_filled, C2369R.string.SharedLinksTab2, new TLRPC.TL_inputMessagesFilterUrl(), 2), new MediaFilterData(C2369R.drawable.search_files_filled, C2369R.string.SharedFilesTab2, new TLRPC.TL_inputMessagesFilterDocument(), 1), new MediaFilterData(C2369R.drawable.search_music_filled, C2369R.string.SharedMusicTab2, new TLRPC.TL_inputMessagesFilterMusic(), 3), new MediaFilterData(C2369R.drawable.search_voice_filled, C2369R.string.SharedVoiceTab2, new TLRPC.TL_inputMessagesFilterRoundVoice(), 5)};
    ...
    public FiltersView(Context context, Theme.ResourcesProvider resourcesProvider) {
                    ...
                    if (i3 == 4) {
                        ...
                        if (tLObject instanceof TLRPC.User) {
                            ...
                            if (tLObject2 instanceof TLRPC.User) {
                                return ((TLRPC.User) tLObject).f1734id == ((TLRPC.User) tLObject2).f1734id;
                            }
                        }
                        if (tLObject instanceof TLRPC.Chat) {
                            TLObject tLObject3 = mediaFilterData2.chat;
                            return (tLObject3 instanceof TLRPC.Chat) && ((TLRPC.Chat) tLObject).f1571id == ((TLRPC.Chat) tLObject3).f1571id;
                        }
                    } else {
                        if (i3 == 6) {
        ...
        addItemDecoration(new RecyclerView.ItemDecoration() { // from class: org.telegram.ui.Adapters.FiltersView.2
            ...
            public void getItemOffsets(Rect rect, View view, RecyclerView recyclerView, RecyclerView.State state) {
                ...
                rect.left = AndroidUtilities.m1146dp(8.0f);
                if (childAdapterPosition == state.getItemCount() - 1) {
                    rect.right = AndroidUtilities.m1146dp(10.0f);
                }
                if (childAdapterPosition == 0) {
                    rect.left = AndroidUtilities.m1146dp(10.0f);
                }
            }
        });
            ...
            protected void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
                ...
                viewPropertyAnimatorAnimate.setDuration(getRemoveDuration()).alpha(0.0f).scaleX(0.0f).scaleY(0.0f).setListener(new AnimatorListenerAdapter() { // from class: org.telegram.ui.Adapters.FiltersView.3.2
                    ...
                    public void onAnimationEnd(Animator animator) {
                        ...
                        ((DefaultItemAnimator) C25983.this).mRemoveAnimations.remove(viewHolder);
        ...
        setSelectorRadius(AndroidUtilities.m1146dp(28.0f));
    ...
    public void setUsersAndDates(ArrayList arrayList, ArrayList arrayList2, boolean z) {
        ...
        if (arrayList != null) {
            for (int i = 0; i < arrayList.size(); i++) {
                ...
                if (obj instanceof TLRPC.User) {
                    ...
                    MediaFilterData mediaFilterData = new MediaFilterData(C2369R.drawable.search_users_filled, name, (TLRPC.MessagesFilter) null, 4);
                    ...
                    MediaFilterData mediaFilterData2 = new MediaFilterData(C2369R.drawable.search_users_filled, str, (TLRPC.MessagesFilter) null, 4);
        ...
        if (arrayList2 != null) {
            for (int i2 = 0; i2 < arrayList2.size(); i2++) {
                ...
                MediaFilterData mediaFilterData3 = new MediaFilterData(C2369R.drawable.search_date_filled, dateData.title, (TLRPC.MessagesFilter) null, 6);
                mediaFilterData3.setDate(dateData);
                this.usersFilters.add(mediaFilterData3);
            }
        }
        if (z) {
            this.usersFilters.add(new MediaFilterData(C2369R.drawable.chats_archive, C2369R.string.ArchiveSearchFilter, (TLRPC.MessagesFilter) null, 7));
        }
        if (getAdapter() != null) {
    ...
    public static void fillTipDates(String str, ArrayList arrayList) {
        ...
        if (LocaleController.getString(C2369R.string.SearchTipToday).toLowerCase().startsWith(strTrim) || "today".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2369R.string.SearchTipToday), timeInMillis, calendar.getTimeInMillis() - 1));
            return;
        }
        if (LocaleController.getString(C2369R.string.SearchTipYesterday).toLowerCase().startsWith(strTrim) || "yesterday".startsWith(strTrim)) {
            ...
            arrayList.add(new DateData(LocaleController.getString(C2369R.string.SearchTipYesterday), timeInMillis2, calendar2.getTimeInMillis() - 86400001));
            return;
        }
    ...
    public static int getMonth(String str) {
        String[] strArr = {LocaleController.getString(C2369R.string.January).toLowerCase(), LocaleController.getString(C2369R.string.February).toLowerCase(), LocaleController.getString(C2369R.string.March).toLowerCase(), LocaleController.getString(C2369R.string.April).toLowerCase(), LocaleController.getString(C2369R.string.May).toLowerCase(), LocaleController.getString(C2369R.string.June).toLowerCase(), LocaleController.getString(C2369R.string.July).toLowerCase(), LocaleController.getString(C2369R.string.August).toLowerCase(), LocaleController.getString(C2369R.string.September).toLowerCase(), LocaleController.getString(C2369R.string.October).toLowerCase(), LocaleController.getString(C2369R.string.November).toLowerCase(), LocaleController.getString(C2369R.string.December).toLowerCase()};
    ...
    private class Adapter extends RecyclerListView.SelectionAdapter {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            RecyclerView.LayoutParams layoutParams = new RecyclerView.LayoutParams(-2, AndroidUtilities.m1146dp(32.0f));
            ((ViewGroup.MarginLayoutParams) layoutParams).topMargin = AndroidUtilities.m1146dp(6.0f);
    ...
    public static class FilterView extends FrameLayout {
        ...
        public void setData(MediaFilterData mediaFilterData) {
            ...
            if (mediaFilterData.filterType == 7) {
                CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1146dp(32.0f), C2369R.drawable.chats_archive);
                this.thumbDrawable = combinedDrawableCreateCircleDrawableWithIcon;
                combinedDrawableCreateCircleDrawableWithIcon.setIconSize(AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(16.0f));
            ...
            CombinedDrawable combinedDrawableCreateCircleDrawableWithIcon2 = Theme.createCircleDrawableWithIcon(AndroidUtilities.m1146dp(32.0f), mediaFilterData.iconResFilled);
