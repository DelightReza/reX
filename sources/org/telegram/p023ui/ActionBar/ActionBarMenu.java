...
public class ActionBarMenu extends LinearLayout {
    ...
    public ActionBarMenuItem addItem(int i, Drawable drawable) {
        return addItem(i, 0, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, drawable, AndroidUtilities.m1146dp(48.0f), null);
    }
    ...
    public ActionBarMenuItem addItem(int i, int i2, int i3, Theme.ResourcesProvider resourcesProvider) {
        return addItem(i, i2, null, i3, null, AndroidUtilities.m1146dp(48.0f), null, resourcesProvider);
    }
    ...
    public LazyItem lazilyAddItem(int i, int i2, Theme.ResourcesProvider resourcesProvider) {
        return lazilyAddItem(i, i2, null, this.isActionMode ? this.parentActionBar.itemsActionModeBackgroundColor : this.parentActionBar.itemsBackgroundColor, null, AndroidUtilities.m1146dp(48.0f), null, resourcesProvider);
    }
    ...
    public static class LazyItem {
        ...
        public void add() {
            ...
            if (this.parent.ids != null) {
                int iIndexOf = this.parent.ids.indexOf(Integer.valueOf(this.f1781id));
            ...
            ActionBarMenuItem actionBarMenuItemAddItemAt = this.parent.addItemAt(i, this.f1781id, this.icon, this.text, this.backgroundColor, this.drawable, this.width, this.title, this.resourcesProvider);
