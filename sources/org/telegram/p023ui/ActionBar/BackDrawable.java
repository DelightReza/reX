...
public class BackDrawable extends Drawable {
    ...
    public BackDrawable(boolean z) {
        ...
        this.prevPaint.setStrokeWidth(AndroidUtilities.m1146dp(2.0f));
    ...
    public void draw(Canvas canvas) {
        ...
        float f5 = 1.0f - f;
        canvas.drawLine(AndroidUtilities.m1146dp(AndroidUtilities.lerp(-6.75f, -8.0f, f)), 0.0f, AndroidUtilities.m1146dp(8.0f) - ((this.paint.getStrokeWidth() / 2.0f) * f5), 0.0f, this.paint);
        float fM1146dp = AndroidUtilities.m1146dp(-0.25f);
        float fM1146dp2 = AndroidUtilities.m1146dp(AndroidUtilities.lerp(7.0f, 8.0f, f)) - ((this.paint.getStrokeWidth() / 4.0f) * f5);
        float fM1146dp3 = AndroidUtilities.m1146dp(AndroidUtilities.lerp(-7.25f, 0.0f, f));
        canvas.drawLine(fM1146dp3, -fM1146dp, 0.0f, -fM1146dp2, this.paint);
        canvas.drawLine(fM1146dp3, fM1146dp, 0.0f, fM1146dp2, this.paint);
        canvas.restore();
    }
