...
public abstract class ActionBarMenuSlider extends FrameLayout {
    ...
    public void setDrawShadow(boolean z) {
        this.drawShadow = z;
        int iM1146dp = z ? AndroidUtilities.m1146dp(8.0f) : 0;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.drawShadow) {
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.shadowPaint);
        }
        if (this.drawBlur) {
            ...
            if (f < 1.0f) {
                ...
                canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.pseudoBlurPaint);
            }
            if (this.blurBitmap != null && this.value < 1.0f && f > 0.0f) {
                this.blurPaint.setAlpha((int) (f * 255.0f));
                canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.blurPaint);
            }
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.brightenBlurPaint);
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.darkenBlurPaint);
            this.fillPaint.setColor(-1);
        } else {
            canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.backgroundPaint);
        }
        drawStops(canvas);
        ...
        canvas.drawRoundRect(rectF, AndroidUtilities.m1146dp(this.roundRadiusDp), AndroidUtilities.m1146dp(this.roundRadiusDp), this.fillPaint);
        drawStops(canvas);
        if (!this.backgroundDark) {
    ...
    private void drawStops(Canvas canvas) {
        ...
        while (true) {
            ...
            float f = fArr[i];
            RectF rectF = AndroidUtilities.rectTmp;
            canvas.drawRect(rectF.left + (rectF.width() * f), rectF.top, rectF.left + (rectF.width() * f) + AndroidUtilities.m1146dp(0.66f), rectF.bottom, this.stopPaint);
            i++;
        }
    }
    ...
    private void drawText(Canvas canvas, boolean z) {
        ...
        this.leftTextDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m1146dp(20.0f), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m1146dp(20.0f), getMeasuredHeight() / 2);
        ...
        this.rightTextDrawable.setBounds(getPaddingLeft() + AndroidUtilities.m1146dp(20.0f), getMeasuredHeight() / 2, (getMeasuredWidth() - getPaddingRight()) - AndroidUtilities.m1146dp(20.0f), getMeasuredHeight() / 2);
    ...
    public static class SpeedSlider extends ActionBarMenuSlider {
        ...
        public SpeedSlider(Context context, Theme.ResourcesProvider resourcesProvider) {
            ...
            FloatSeekBarAccessibilityDelegate floatSeekBarAccessibilityDelegate = new FloatSeekBarAccessibilityDelegate(false) { // from class: org.telegram.ui.ActionBar.ActionBarMenuSlider.SpeedSlider.1
                ...
                public CharSequence getContentDescription(View view) {
                    return SpeedIconDrawable.formatNumber(SpeedSlider.this.getSpeed()) + "x  " + LocaleController.getString(C2369R.string.AccDescrSpeedSlider);
                }
            };
        ...
        @Override // org.telegram.p023ui.ActionBar.ActionBarMenuSlider
