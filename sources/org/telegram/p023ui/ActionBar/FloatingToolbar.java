...
public final class FloatingToolbar {
    ...
    public static final List premiumOptions = Arrays.asList(Integer.valueOf(C2369R.id.menu_bold), Integer.valueOf(C2369R.id.menu_italic), Integer.valueOf(C2369R.id.menu_strike), Integer.valueOf(C2369R.id.menu_link), Integer.valueOf(C2369R.id.menu_mono), Integer.valueOf(C2369R.id.menu_underline), Integer.valueOf(C2369R.id.menu_spoiler), Integer.valueOf(C2369R.id.menu_quote));
    ...
    private final Comparator mMenuItemComparator = new Comparator() { // from class: org.telegram.ui.ActionBar.FloatingToolbar$$ExternalSyntheticLambda1
        ...
        public final int compare(Object obj, Object obj2) {
            return FloatingToolbar.m4741$r8$lambda$oeoem8jsMsNfzaGiZfcKWwEphE((MenuItem) obj, (MenuItem) obj2);
        }
    };
    ...
    /* renamed from: $r8$lambda$oeoem8jsMsNfzaGiZfcK-WwEphE, reason: not valid java name */
    public static /* synthetic */ int m4741$r8$lambda$oeoem8jsMsNfzaGiZfcKWwEphE(MenuItem menuItem, MenuItem menuItem2) {
    ...
    private List getVisibleAndEnabledMenuItems(Menu menu) {
        ...
        for (int i = 0; menu != null && i < menu.size(); i++) {
            ...
            if (item.isVisible() && item.isEnabled()) {
                ...
                } else if ((item.getItemId() != C2369R.id.menu_quote || (callback0Return = this.quoteShowCallback) == null || ((Boolean) callback0Return.run()).booleanValue()) && item.getItemId() != 16908353 && (item.getItemId() != C2369R.id.menu_regular || this.premiumLockClickListener == null)) {
                    arrayList.add(item);
                }
            }
        }
    ...
    final class FloatingToolbarPopup {
        ...
        public FloatingToolbarPopup(Context context, View view) {
            ...
            this.mMarginHorizontal = AndroidUtilities.m1146dp(16.0f);
            this.mMarginVertical = AndroidUtilities.m1146dp(8.0f);
            this.mLineHeight = AndroidUtilities.m1146dp(48.0f);
            int iM1146dp = AndroidUtilities.m1146dp(8.0f);
            this.mIconTextSpacing = iM1146dp;
            ...
            Drawable drawableMutate = context.getDrawable(C2369R.drawable.ft_avd_tooverflow).mutate();
            this.mArrow = drawableMutate;
            drawableMutate.setAutoMirrored(true);
            Drawable drawableMutate2 = context.getDrawable(C2369R.drawable.ft_avd_toarrow).mutate();
            this.mOverflow = drawableMutate2;
            drawableMutate2.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) context.getDrawable(C2369R.drawable.ft_avd_toarrow_animation).mutate();
            this.mToArrow = animatedVectorDrawable;
            animatedVectorDrawable.setAutoMirrored(true);
            AnimatedVectorDrawable animatedVectorDrawable2 = (AnimatedVectorDrawable) context.getDrawable(C2369R.drawable.ft_avd_tooverflow_animation).mutate();
            ...
            imageButton.setLayoutParams(new ViewGroup.LayoutParams(AndroidUtilities.m1146dp(56.0f), AndroidUtilities.m1146dp(48.0f)));
            imageButton.setPaddingRelative(AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(12.0f), AndroidUtilities.m1146dp(16.0f), AndroidUtilities.m1146dp(12.0f));
            imageButton.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
            imageButton.setImageDrawable(drawableMutate2);
            TextView textView = new TextView(context);
            this.mOverflowButtonText = textView;
            textView.setText(LocaleController.getString(C2369R.string.Back));
            ...
            this.mOverflowPanelViewHelper = new OverflowPanelViewHelper(context, iM1146dp);
            ...
            this.mDismissAnimation = FloatingToolbar.createExitAnimation(viewGroup2, 150, new C25564(FloatingToolbar.this));
            this.mHideAnimation = FloatingToolbar.createExitAnimation(viewGroup2, 0, new C25575(FloatingToolbar.this));
        }
        ...
        class C25564 extends AnimatorListenerAdapter {
            final /* synthetic */ FloatingToolbar val$this$0;

            C25564(FloatingToolbar floatingToolbar) {
        ...
        class C25575 extends AnimatorListenerAdapter {
            final /* synthetic */ FloatingToolbar val$this$0;

            C25575(FloatingToolbar floatingToolbar) {
                this.val$this$0 = floatingToolbar;
            }
        ...
        public void setPanelsStatesAtRestingPosition() {
            ...
            if (this.mIsOverflowOpen) {
                ...
                this.mOverflowButton.setContentDescription(LocaleController.getString(C2369R.string.AccDescrMoreOptions));
                if (isInRTLMode()) {
        ...
        private int getAdjustedToolbarWidth(int i) {
            refreshViewPort();
            int iWidth = this.mViewPortOnScreen.width() - (AndroidUtilities.m1146dp(16.0f) * 2);
            if (i <= 0) {
                i = AndroidUtilities.m1146dp(400.0f);
            }
        ...
        public List layoutMainPanelItems(List list, int i) {
            ...
            while (it.hasNext()) {
                ...
                if (menuItem == null || FloatingToolbar.this.premiumLockClickListener == null || !FloatingToolbar.premiumOptions.contains(Integer.valueOf(menuItem.getItemId()))) {
                    ...
                    viewCreateMenuItemButton.setPaddingRelative((int) ((z ? 1.5d : 1.0d) * viewCreateMenuItemButton.getPaddingStart()), viewCreateMenuItemButton.getPaddingTop(), (int) ((!zHasNext ? 1.5d : 1.0d) * viewCreateMenuItemButton.getPaddingEnd()), viewCreateMenuItemButton.getPaddingBottom());
        ...
        /* renamed from: org.telegram.ui.ActionBar.FloatingToolbar$FloatingToolbarPopup$14 */
        class AnimationAnimationListenerC255314 implements Animation.AnimationListener {
            @Override // android.view.animation.Animation.AnimationListener
            public void onAnimationRepeat(Animation animation) {
            }

            AnimationAnimationListenerC255314() {
            }
        ...
        private Animation.AnimationListener createOverflowAnimationListener() {
            return new AnimationAnimationListenerC255314();
        }
        ...
        private final class OverflowPanelViewHelper {
            private final Context mContext;
            private final int mIconTextSpacing;
            private final int mSidePadding = AndroidUtilities.m1146dp(18.0f);
    ...
    public View createMenuItemButton(Context context, MenuItem menuItem, int i, boolean z, boolean z2) {
        ...
        linearLayout.setMinimumWidth(AndroidUtilities.m1146dp(48.0f));
        linearLayout.setMinimumHeight(AndroidUtilities.m1146dp(48.0f));
        linearLayout.setPaddingRelative(AndroidUtilities.m1146dp(16.0f), 0, AndroidUtilities.m1146dp(16.0f), 0);
        TextView textView = new TextView(context);
        ...
        textView.setPaddingRelative(AndroidUtilities.m1146dp(11.0f), 0, 0, 0);
        linearLayout.addView(textView, new LinearLayout.LayoutParams(-2, AndroidUtilities.m1146dp(48.0f)));
        linearLayout.addView(new Space(context), new LinearLayout.LayoutParams(-1, 1, 1.0f));
        ImageView imageView = new ImageView(context);
        imageView.setImageResource(C2369R.drawable.msg_mini_lock3);
    ...
    public ViewGroup createContentContainer(Context context) {
        ...
        relativeLayout.setElevation(AndroidUtilities.m1146dp(2.0f));
        relativeLayout.setFocusable(true);
        relativeLayout.setFocusableInTouchMode(true);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(0);
        float fM1146dp = AndroidUtilities.m1146dp(6.0f);
        gradientDrawable.setCornerRadii(new float[]{fM1146dp, fM1146dp, fM1146dp, fM1146dp, fM1146dp, fM1146dp, fM1146dp, fM1146dp});
    ...
    public static PopupWindow createPopupWindow(ViewGroup viewGroup) {
        LinearLayout linearLayout = new LinearLayout(viewGroup.getContext()) { // from class: org.telegram.ui.ActionBar.FloatingToolbar.2
            ...
            /* renamed from: p */
            private final int[] f1785p = new int[2];
            ...
            public boolean dispatchTouchEvent(MotionEvent motionEvent) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
                ...
                if (!zDispatchTouchEvent) {
                    getLocationOnScreen(this.f1785p);
                    int[] iArr = this.f1785p;
                    ...
                    if (motionEvent.getAction() == 0) {
                        ...
                        if (listAllGlobalViews != null && listAllGlobalViews.size() > 1) {
                            for (int size = listAllGlobalViews.size() - 2; size >= 0; size--) {
                                ...
                                if (!isParent(this, view)) {
                                    view.getLocationOnScreen(this.f1785p);
                                    int[] iArr2 = this.f1785p;
                        ...
                        if (view2 != null) {
                            view2.getLocationOnScreen(this.f1785p);
                            int[] iArr4 = this.f1785p;
