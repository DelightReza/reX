...
public class DownloadProgressIcon extends View implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadProgressIcon(int i, Context context) {
        ...
        RLottieDrawable rLottieDrawable = new RLottieDrawable(C2369R.raw.download_progress, "download_progress", AndroidUtilities.m1146dp(28.0f), AndroidUtilities.m1146dp(28.0f), true, null);
        ...
        RLottieDrawable rLottieDrawable2 = new RLottieDrawable(C2369R.raw.download_finish, "download_finish", AndroidUtilities.m1146dp(28.0f), AndroidUtilities.m1146dp(28.0f), true, null);
        ...
        this.downloadDrawable.setLayerColor("Shape Layer 3.**", Theme.getColor(i2));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int measuredHeight = (getMeasuredHeight() / 2) + AndroidUtilities.m1146dp(8.0f);
        float fM1146dp = AndroidUtilities.m1146dp(1.0f);
        float fM1146dp2 = AndroidUtilities.m1146dp(16.0f);
        RectF rectF = AndroidUtilities.rectTmp;
        float f5 = measuredHeight;
        float f6 = f5 - fM1146dp;
        float f7 = f5 + fM1146dp;
        rectF.set(fM1146dp2, f6, getMeasuredWidth() - fM1146dp2, f7);
        canvas.drawRoundRect(rectF, fM1146dp, fM1146dp, this.paint2);
        rectF.set(fM1146dp2, f6, ((getMeasuredWidth() - (2.0f * fM1146dp2)) * this.currentProgress) + fM1146dp2, f7);
        canvas.drawRoundRect(rectF, fM1146dp, fM1146dp, this.paint);
        canvas.save();
