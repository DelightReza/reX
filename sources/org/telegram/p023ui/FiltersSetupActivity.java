...
public class FiltersSetupActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public static class TextCell extends FrameLayout {
        ...
        protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
            ...
            if (LocaleController.isRTL) {
                iM1146dp = (getMeasuredWidth() - this.textView.getMeasuredWidth()) - AndroidUtilities.m1146dp(this.imageView.getVisibility() == 0 ? 64.0f : 23.0f);
            } else {
                iM1146dp = AndroidUtilities.m1146dp(this.imageView.getVisibility() == 0 ? 64.0f : 23.0f);
            }
            ...
            int iM1146dp2 = !LocaleController.isRTL ? AndroidUtilities.m1146dp(20.0f) : (i5 - this.imageView.getMeasuredWidth()) - AndroidUtilities.m1146dp(20.0f);
    ...
    public static class SuggestedFilterCell extends FrameLayout {
        ...
        @Override // android.widget.FrameLayout, android.view.View
        protected void onMeasure(int i, int i2) {
            setMeasuredDimension(View.MeasureSpec.getSize(i), AndroidUtilities.m1146dp(64.0f));
    ...
    public class FilterCell extends FrameLayout {
        ...
        public FilterCell(Context context) {
            ...
            imageView.setContentDescription(LocaleController.getString(C2369R.string.FilterReorder));
            ...
            final int iM1146dp = AndroidUtilities.m1146dp(1.0f);
            loadingDrawable.strokePaint.setStrokeWidth(iM1146dp);
            ...
            ImageView imageView2 = new ImageView(context) { // from class: org.telegram.ui.FiltersSetupActivity.FilterCell.1
                ...
                protected void onDraw(Canvas canvas) {
                    ...
                    if (FilterCell.this.shareLoading) {
                        ...
                        int i3 = iM1146dp;
                        loadingDrawable2.setBounds(i3 / 2, i3 / 2, getWidth() - (iM1146dp / 2), getHeight() - (iM1146dp / 2));
            ...
            imageView2.setContentDescription(LocaleController.getString(C2369R.string.FilterShare));
            imageView2.setVisibility(8);
            imageView2.setImageResource(C2369R.drawable.msg_link_folder);
            imageView2.setColorFilter(new PorterDuffColorFilter(Theme.getColor(i), mode));
            ...
            imageView3.setImageResource(C2369R.drawable.msg_actions);
        ...
        */
        protected void onDraw(android.graphics.Canvas r10) {
            ...
            L28:
                ...
                int r0 = r0 + (-1)
                float r7 = (float) r0
                android.graphics.Paint r8 = org.telegram.p023ui.ActionBar.Theme.dividerPaint
                r3 = r10
    ...
    public void updateRows(boolean z) {
        ...
        if (!arrayList.isEmpty() && dialogFilters.size() < 10) {
            this.items.add(ItemInner.asHeader(LocaleController.getString(C2369R.string.FilterRecommended)));
        ...
        if (!dialogFilters.isEmpty()) {
            ...
            this.items.add(ItemInner.asHeader(LocaleController.getString(C2369R.string.Filters)));
        ...
        if (dialogFilters.size() < getMessagesController().dialogFiltersLimitPremium) {
            this.items.add(ItemInner.asButton(LocaleController.getString(C2369R.string.CreateNewFilter)));
        }
        this.items.add(ItemInner.asShadow(null));
        this.folderTagsPosition = this.items.size();
        this.items.add(ItemInner.asCheck(LocaleController.getString(C2369R.string.FolderShowTags)));
        this.items.add(ItemInner.asShadow(!getUserConfig().isPremium() ? AndroidUtilities.replaceSingleTag(LocaleController.getString(C2369R.string.FolderShowTagsInfoPremium), Theme.key_windowBackgroundWhiteBlueHeader, 2, new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.lambda$updateRows$0();
            }
        }) : LocaleController.getString(C2369R.string.FolderShowTagsInfo)));
    ...
    public void onFragmentDestroy() {
        ...
        if (this.orderChanged) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                tL_messages_updateDialogFiltersOrder.order.add(Integer.valueOf(dialogFilters.get(i2).f1454id));
            }
    ...
    public View createView(final Context context) {
        ...
        this.actionBar.setTitle(LocaleController.getString(C2369R.string.Filters));
        this.actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() { // from class: org.telegram.ui.FiltersSetupActivity.1
            ...
            public void onItemClick(int i) {
                if (i == -1) {
                    FiltersSetupActivity.this.lambda$onBackPressed$371();
                }
            }
        });
        ...
        this.listView = new C51192(context);
    ...
    class C51192 extends RecyclerListView {
        C51192(Context context) {
            super(context);
        }
        ...
        protected void dispatchDraw(Canvas canvas) {
            if (!FiltersSetupActivity.this.adapter.canUseMD3()) {
    ...
    private static class ItemInner extends AdapterWithDiffUtils.Item {
        ...
        public boolean equals(Object obj) {
            ...
            if (i3 == 2) {
                ...
                if (dialogFilter != null && dialogFilter.f1454id != dialogFilter2.f1454id) {
                    return false;
                }
            }
            if (i3 == 5) {
                ...
                if (tL_dialogFilterSuggested != null && tL_dialogFilterSuggested.filter.f1578id != tL_dialogFilterSuggested2.filter.f1578id) {
                    return false;
                }
            }
            return true;
    ...
    class ListAdapter extends ListAdapterMD3Diff {
        ...
        public Theme.ResourcesProvider getResourcesProvider() {
            return ((BaseFragment) FiltersSetupActivity.this).resourceProvider;
        }
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$7(View view) {
            ...
            itemOptionsMakeOptions.add(C2369R.drawable.msg_edit, LocaleController.getString(C2369R.string.FilterEditItem), new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$onCreateViewHolder$1(currentFilter);
                }
            });
            itemOptionsMakeOptions.add(C2369R.drawable.msg_delete, (CharSequence) LocaleController.getString(C2369R.string.FilterDeleteItem), true, new Runnable() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda4
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$6(final MessagesController.DialogFilter dialogFilter) {
            if (dialogFilter.isChatlist()) {
                FolderBottomSheet.showForDeletion(FiltersSetupActivity.this, dialogFilter.f1454id, new Utilities.Callback() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda6
            ...
            builder.setPositiveButton(LocaleController.getString(C2369R.string.Delete), new AlertDialog.OnButtonClickListener() { // from class: org.telegram.ui.FiltersSetupActivity$ListAdapter$$ExternalSyntheticLambda7
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            ...
            if (i == 0) {
                ...
                FrameLayout hintInnerCell = new HintInnerCell(this.mContext, C2369R.raw.filters, AndroidUtilities.replaceTags(LocaleController.formatString("CreateNewFilterInfo", C2369R.string.CreateNewFilterInfo, new Object[0])));
                hintInnerCell.setBackgroundDrawable(Theme.getThemedDrawableByKey(this.mContext, C2369R.drawable.greydivider_top, Theme.key_windowBackgroundGrayShadow));
        ...
        public /* synthetic */ void lambda$onCreateViewHolder$9(SuggestedFilterCell suggestedFilterCell, View view) {
            ...
            dialogFilter.f1454id = 2;
            while (FiltersSetupActivity.this.getMessagesController().dialogFiltersById.get(dialogFilter.f1454id) != null) {
                dialogFilter.f1454id++;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) throws Resources.NotFoundException {
            ...
            if (itemViewType == 0) {
                ...
                textInfoPrivacyCell.setBackground(Theme.getThemedDrawableByKey(this.mContext, z ? C2369R.drawable.greydivider : C2369R.drawable.greydivider_bottom, Theme.key_windowBackgroundGrayShadow));
                ...
                textCheckCell.setCheckBoxIcon(FiltersSetupActivity.this.getUserConfig().isPremium() ? 0 : C2369R.drawable.permission_locked);
            }
