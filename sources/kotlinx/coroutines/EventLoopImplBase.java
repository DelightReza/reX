...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, null, runnable)) {
                    return true;
                }
                ...
                if (AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore)) {
                    return true;
                }
            } else {
                ...
                if (iAddLast == 1) {
                    AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore2.next());
                } else if (iAddLast == 2) {
                    return false;
                }
            }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (!(obj instanceof LockFreeTaskQueueCore)) {
                ...
                if (AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, obj, null)) {
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type java.lang.Runnable");
                    return (Runnable) obj;
                }
            } else {
                ...
                AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, obj, lockFreeTaskQueueCore.next());
            }
        }
    }
    ...
    private final void closeQueue() {
        ...
        while (true) {
            Object obj = atomicReferenceFieldUpdater.get(this);
            if (obj == null) {
                if (AbstractC0258xc40028dd.m81m(_queue$volatile$FU, this, null, EventLoop_commonKt.CLOSED_EMPTY)) {
                    return;
                }
            } else if (!(obj instanceof LockFreeTaskQueueCore)) {
                if (obj == EventLoop_commonKt.CLOSED_EMPTY) {
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        DelayedTaskQueue delayedTaskQueue = (DelayedTaskQueue) _delayed$volatile$FU.get(this);
        if (delayedTaskQueue == null) {
            AbstractC0258xc40028dd.m81m(_delayed$volatile$FU, this, null, new DelayedTaskQueue(j));
