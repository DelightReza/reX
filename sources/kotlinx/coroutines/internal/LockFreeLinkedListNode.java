...
public class LockFreeLinkedListNode {
    ...
    public final boolean addOneIfEmpty(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        while (getNext() == this) {
            if (AbstractC0258xc40028dd.m81m(_next$volatile$FU, this, this, lockFreeLinkedListNode)) {
    ...
    public final boolean addNext(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
        ...
        if (!AbstractC0258xc40028dd.m81m(_next$volatile$FU, this, lockFreeLinkedListNode2, lockFreeLinkedListNode)) {
            return false;
        }
    ...
    public final LockFreeLinkedListNode removeOrNext() {
        ...
        } while (!AbstractC0258xc40028dd.m81m(_next$volatile$FU, this, next, lockFreeLinkedListNode.removed()));
    ...
    private final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        } while (!AbstractC0258xc40028dd.m81m(_prev$volatile$FU, lockFreeLinkedListNode, lockFreeLinkedListNode2, this));
        if (isRemoved()) {
            lockFreeLinkedListNode.correctPrev();
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x003f, code lost:
        ...
        if (androidx.concurrent.futures.AbstractC0258xc40028dd.m81m(kotlinx.coroutines.internal.LockFreeLinkedListNode._next$volatile$FU, r3, r2, ((kotlinx.coroutines.internal.Removed) r4).ref) != false) goto L21;
     */
    /*
    ...
    */
    private final kotlinx.coroutines.internal.LockFreeLinkedListNode correctPrev() {
        ...
        L1a:
            ...
            boolean r0 = androidx.concurrent.futures.AbstractC0258xc40028dd.m81m(r1, r7, r0, r2)
            if (r0 != 0) goto L25
            goto L0
        L25:
            return r2
        ...
        L2d:
            ...
            boolean r2 = androidx.concurrent.futures.AbstractC0258xc40028dd.m81m(r5, r3, r2, r4)
            if (r2 != 0) goto L42
            goto L0
        L42:
            r2 = r3
