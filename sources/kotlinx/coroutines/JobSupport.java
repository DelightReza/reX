...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    public final void removeNode$kotlinx_coroutines_core(JobNode jobNode) {
        ...
        } while (!AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, state$kotlinx_coroutines_core, JobSupportKt.EMPTY_ACTIVE));
    }
    ...
    private final Object finalizeFinishingState(Finishing finishing, Object obj) throws Throwable {
        ...
        AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, finishing, JobSupportKt.boxIncomplete(obj));
    ...
    private final boolean tryFinalizeSimpleState(Incomplete incomplete, Object obj) throws Throwable {
        if (!AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, incomplete, JobSupportKt.boxIncomplete(obj))) {
            return false;
        }
        onCancelling(null);
        onCompletionInternal(obj);
    ...
    private final int startInternal(Object obj) {
        if (obj instanceof Empty) {
            ...
            if (!AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, obj, JobSupportKt.EMPTY_ACTIVE)) {
                return -1;
            }
            onStart();
            return 1;
        ...
        if (!AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, obj, ((InactiveNodeList) obj).getList())) {
            return -1;
        }
        onStart();
        return 1;
    ...
    public final DisposableHandle invokeOnCompletionInternal$kotlinx_coroutines_core(boolean z, JobNode jobNode) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                if (empty.isActive()) {
                    if (AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, state$kotlinx_coroutines_core, jobNode)) {
                        break;
                    }
                } else {
    ...
    private final void promoteEmptyToNodeList(Empty empty) {
        ...
        AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, empty, nodeList);
    }

    private final void promoteSingleToNodeList(JobNode jobNode) {
        jobNode.addOneIfEmpty(new NodeList());
        AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, jobNode, jobNode.getNextNode());
    }
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete, Throwable th) throws Throwable {
        ...
        if (!AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, incomplete, new Finishing(orPromoteCancellingList, false, th))) {
            return false;
        }
    ...
    private final Object tryMakeCompletingSlowPath(Incomplete incomplete, Object obj) throws Throwable {
        ...
        synchronized (finishing) {
            ...
            if (finishing != incomplete && !AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, incomplete, finishing)) {
                return JobSupportKt.COMPLETING_RETRY;
            }
    ...
    public final ChildHandle attachChild(ChildJob childJob) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                Empty empty = (Empty) state$kotlinx_coroutines_core;
                if (empty.isActive()) {
                    if (AbstractC0258xc40028dd.m81m(_state$volatile$FU, this, state$kotlinx_coroutines_core, childHandleNode)) {
