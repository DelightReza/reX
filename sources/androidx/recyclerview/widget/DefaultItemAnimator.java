...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        Runnable runnable3 = new Runnable() { // from class: androidx.recyclerview.widget.DefaultItemAnimator.3
            ...
            public void run() {
                ...
                for (int size3 = arrayList4.size() - 1; size3 >= 0; size3--) {
                    DefaultItemAnimator.this.animateAddImpl((RecyclerView.ViewHolder) arrayList4.get(size3), (r2.getAdapterPosition() - iMin) * DefaultItemAnimator.this.delayIncrement);
                }
                arrayList4.clear();
        ...
        if (this.delayAnimations && (!zIsEmpty || !zIsEmpty2 || !zIsEmpty3)) {
            ...
            long changeDuration = zIsEmpty3 ? 0L : getChangeDuration();
