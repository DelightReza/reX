...
public class ReportedVideoQualityNotSupportedQuirk implements VideoQualityQuirk, SurfaceProcessingQuirk {
    ...
    public boolean isProblematicVideoQuality(CameraInfoInternal cameraInfoInternal, Quality quality) {
        return (isHuaweiMate20() || isHuaweiMate20Pro()) ? quality == Quality.UHD : isVivoY91i() ? quality == Quality.f11HD || quality == Quality.FHD : isHuaweiP40Lite() ? cameraInfoInternal.getLensFacing() == 0 && (quality == Quality.FHD || quality == Quality.f11HD) : isOppoPht110() && cameraInfoInternal.getLensFacing() == 1 && quality == Quality.UHD;
    }
