...
class AndroidImageReaderProxy implements ImageReaderProxy {
                ...
                if (!androidImageReaderProxy.mIsImageAvailableListenerCleared) {
                    executor.execute(new Runnable() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda1
                        ...
                        public final void run() {
                            AndroidImageReaderProxy.m1431$r8$lambda$VU285rPvGaxlLdZyrpjv6_gV1k(this.f$0, onImageAvailableListener);
                        }
                    });
                }
            } catch (Throwable th) {
    ...
    public static /* synthetic */ void m1431$r8$lambda$VU285rPvGaxlLdZyrpjv6_gV1k(AndroidImageReaderProxy androidImageReaderProxy, ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
