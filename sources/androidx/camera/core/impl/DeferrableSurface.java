...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return DeferrableSurface.m1443$r8$lambda$2bNbZSrwzPE6VUuBbHBM9VrhXU(this.f$0, completer);
            }
        });
    ...
    public static /* synthetic */ Object m1443$r8$lambda$2bNbZSrwzPE6VUuBbHBM9VrhXU(DeferrableSurface deferrableSurface, CallbackToFutureAdapter.Completer completer) {
    ...
    public static /* synthetic */ void $r8$lambda$o2NHrpK5pP8NNndqchJRakLjc8U(DeferrableSurface deferrableSurface, String str) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            Logger.m45e("DeferrableSurface", "Unexpected surface termination for " + deferrableSurface + "\nStack Trace:\n" + str);
            synchronized (deferrableSurface.mLock) {
    ...
    private void printGlobalDebugCounts(String str, int i, int i2) {
        if (!DEBUG && Logger.isDebugEnabled("DeferrableSurface")) {
            Logger.m43d("DeferrableSurface", "DeferrableSurface usage statistics may be inaccurate since debug logging was not enabled at static initialization time. App restart may be required to enable accurate usage statistics.");
        }
        Logger.m43d("DeferrableSurface", str + "[total_surfaces=" + i + ", used_surfaces=" + i2 + "](" + this + "}");
    }
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (Logger.isDebugEnabled("DeferrableSurface")) {
                    ...
                    Logger.m43d("DeferrableSurface", "use count+1, useCount=" + this.mUseCount + " " + this);
                }
            } catch (Throwable th) {
                throw th;
            }
        ...
        synchronized (this.mLock) {
            try {
                if (this.mClosed) {
                    ...
                    if (Logger.isDebugEnabled("DeferrableSurface")) {
                        Logger.m43d("DeferrableSurface", "surface closed,  useCount=" + this.mUseCount + " closed=true " + this);
                    }
                }
            } catch (Throwable th) {
                throw th;
    ...
    public void decrementUseCount() {
        ...
        synchronized (this.mLock) {
            try {
                ...
                if (Logger.isDebugEnabled("DeferrableSurface")) {
                    Logger.m43d("DeferrableSurface", "use count-1,  useCount=" + this.mUseCount + " closed=" + this.mClosed + " " + this);
                    if (this.mUseCount == 0) {
