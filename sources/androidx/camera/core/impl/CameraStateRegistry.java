        ...
        synchronized (this.mLock) {
            try {
                ...
                if (Logger.isDebugEnabled("CameraStateRegistry")) {
                    ...
                    Logger.m43d("CameraStateRegistry", this.mDebugString.toString());
                }
                if (z) {
    ...
    private static class CameraRegistration {
        ...
        void notifyOnConfigureAvailableListener() {
            try {
                ...
                Logger.m46e("CameraStateRegistry", "Unable to notify camera to configure.", e);
            }
        }
        ...
        void notifyOnOpenAvailableListener() {
            try {
                ...
                Logger.m46e("CameraStateRegistry", "Unable to notify camera to open.", e);
            }
        }
    }
