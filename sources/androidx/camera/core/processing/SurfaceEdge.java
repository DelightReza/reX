...
public class SurfaceEdge {
    ...
    public SurfaceRequest createSurfaceRequest(CameraInternal cameraInternal, boolean z) {
        ...
        SurfaceRequest surfaceRequest = new SurfaceRequest(this.mStreamSpec.getResolution(), cameraInternal, z, this.mStreamSpec.getDynamicRange(), this.mStreamSpec.getSessionType(), this.mStreamSpec.getExpectedFrameRateRange(), new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda0
            ...
            public final void run() {
                SurfaceEdge.m1458$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(this.f$0);
            }
        });
        try {
    ...
    public static /* synthetic */ void m1458$r8$lambda$OUGeMRYPeF_WOgV3sPeeq2_z7c(final SurfaceEdge surfaceEdge) {
        ...
        CameraXExecutors.mainThreadExecutor().execute(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                SurfaceEdge.m1459$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(this.f$0);
            }
        });
    }

    /* renamed from: $r8$lambda$QHdR7T3HmMsEDLpE-k-RmCFFpf4, reason: not valid java name */
    public static /* synthetic */ void m1459$r8$lambda$QHdR7T3HmMsEDLpEkRmCFFpf4(SurfaceEdge surfaceEdge) {
    ...
    private void notifyTransformationInfoUpdate() {
        Threads.checkMainThread();
        SurfaceRequest.TransformationInfo transformationInfoM53of = SurfaceRequest.TransformationInfo.m53of(this.mCropRect, this.mRotationDegrees, this.mTargetRotation, hasCameraTransform(), this.mSensorToBufferTransform, this.mMirroring);
        SurfaceRequest surfaceRequest = this.mProviderSurfaceRequest;
        if (surfaceRequest != null) {
            surfaceRequest.updateTransformationInfo(transformationInfoM53of);
        }
        Iterator it = this.mTransformationUpdatesListeners.iterator();
        while (it.hasNext()) {
            ((Consumer) it.next()).accept(transformationInfoM53of);
        }
    }
    ...
    static class SettableSurface extends DeferrableSurface {
        ...
        public static /* synthetic */ Object m1461$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(SettableSurface settableSurface, CallbackToFutureAdapter.Completer completer) {
        ...
        SettableSurface(Size size, int i) {
            ...
            this.mSurfaceFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda1
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return SurfaceEdge.SettableSurface.m1461$r8$lambda$VdiGildDqQQQLDZiSabHKVcb7o(this.f$0, completer);
                }
            });
        }
        ...
        public void close() {
            ...
            Threads.runOnMain(new Runnable() { // from class: androidx.camera.core.processing.SurfaceEdge$SettableSurface$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    SurfaceEdge.SettableSurface.m1460$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(this.f$0);
                }
            });
        }

        /* renamed from: $r8$lambda$MbwWKPmNY-V-cJmML8QCwwbJ_Io, reason: not valid java name */
        public static /* synthetic */ void m1460$r8$lambda$MbwWKPmNYVcJmML8QCwwbJ_Io(SettableSurface settableSurface) {
