...
final class AutoValue_DualSurfaceProcessorNode_In extends DualSurfaceProcessorNode.AbstractC0219In {
    ...
    @Override // androidx.camera.core.processing.concurrent.DualSurfaceProcessorNode.AbstractC0219In
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof DualSurfaceProcessorNode.AbstractC0219In) {
            DualSurfaceProcessorNode.AbstractC0219In abstractC0219In = (DualSurfaceProcessorNode.AbstractC0219In) obj;
            if (this.primarySurfaceEdge.equals(abstractC0219In.getPrimarySurfaceEdge()) && this.secondarySurfaceEdge.equals(abstractC0219In.getSecondarySurfaceEdge()) && this.outConfigs.equals(abstractC0219In.getOutConfigs())) {
                return true;
            }
        }
        return false;
