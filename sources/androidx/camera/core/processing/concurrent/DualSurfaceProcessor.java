...
public class DualSurfaceProcessor implements SurfaceProcessorInternal, SurfaceTexture.OnFrameAvailableListener {
    ...
    public static /* synthetic */ void m1465$r8$lambda$HVJUM4Do99Q9JsClAV6N0JKx5I() {
    }
    ...
    public void onInputSurface(final SurfaceRequest surfaceRequest) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda1
            ...
            public final void run() throws ExecutionException, InterruptedException {
                DualSurfaceProcessor.m1469$r8$lambda$eYxu5ZhmaW5Q_3yYxnq9Fy4kTk(this.f$0, surfaceRequest);
            }
        };
    ...
    public static /* synthetic */ void m1469$r8$lambda$eYxu5ZhmaW5Q_3yYxnq9Fy4kTk(final DualSurfaceProcessor dualSurfaceProcessor, SurfaceRequest surfaceRequest) throws ExecutionException, InterruptedException {
        ...
        surfaceRequest.provideSurface(surface, dualSurfaceProcessor.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda8
            ...
            public final void accept(Object obj) {
                DualSurfaceProcessor.m1466$r8$lambda$NAKKUHmbm6lwk7NskA4M9WlNg(this.f$0, surfaceTexture, surface, (SurfaceRequest.Result) obj);
            }
        });
    ...
    public static /* synthetic */ void m1466$r8$lambda$NAKKUHmbm6lwk7NskA4M9WlNg(DualSurfaceProcessor dualSurfaceProcessor, SurfaceTexture surfaceTexture, Surface surface, SurfaceRequest.Result result) {
    ...
    public void onOutputSurface(final SurfaceOutput surfaceOutput) {
        ...
        Runnable runnable = new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda3
            ...
            public final void run() {
                DualSurfaceProcessor.m1468$r8$lambda$XjKCBi0iSlQAHKEbAfakln9aNU(this.f$0, surfaceOutput);
            }
        };
    ...
    public static /* synthetic */ void m1468$r8$lambda$XjKCBi0iSlQAHKEbAfakln9aNU(final DualSurfaceProcessor dualSurfaceProcessor, final SurfaceOutput surfaceOutput) {
        Surface surface = surfaceOutput.getSurface(dualSurfaceProcessor.mGlExecutor, new Consumer() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda5
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                DualSurfaceProcessor.m1467$r8$lambda$SSJVT35FEA6PJGDsDjTufRx9_M(this.f$0, surfaceOutput, (SurfaceOutput.Event) obj);
            }
        });
    ...
    public static /* synthetic */ void m1467$r8$lambda$SSJVT35FEA6PJGDsDjTufRx9_M(DualSurfaceProcessor dualSurfaceProcessor, SurfaceOutput surfaceOutput, SurfaceOutput.Event event) {
        dualSurfaceProcessor.getClass();
        surfaceOutput.close();
        ...
        for (Map.Entry entry : this.mOutputSurfaces.entrySet()) {
            ...
            if (surfaceOutput.getFormat() == 34) {
                try {
                    ...
                    Logger.m46e("DualSurfaceProcessor", "Failed to render with OpenGL.", e);
                }
            }
        }
    }
    ...
    public static /* synthetic */ Object $r8$lambda$xmFNEnzuXLtJLpm9XXaBYQZXSMI(final DualSurfaceProcessor dualSurfaceProcessor, final DynamicRange dynamicRange, final Map map, final CallbackToFutureAdapter.Completer completer) {
        ...
        dualSurfaceProcessor.executeSafely(new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda4
            ...
            public final void run() throws Throwable {
                DualSurfaceProcessor.m1470$r8$lambda$gvtYv8V6pqQmb0lqnGgcqf1W30(this.f$0, dynamicRange, map, completer);
            }
        });
    ...
    public static /* synthetic */ void m1470$r8$lambda$gvtYv8V6pqQmb0lqnGgcqf1W30(DualSurfaceProcessor dualSurfaceProcessor, DynamicRange dynamicRange, Map map, CallbackToFutureAdapter.Completer completer) throws Throwable {
        dualSurfaceProcessor.getClass();
        try {
    ...
    private void executeSafely(Runnable runnable) {
        executeSafely(runnable, new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                DualSurfaceProcessor.m1465$r8$lambda$HVJUM4Do99Q9JsClAV6N0JKx5I();
            }
        });
    }
    ...
    private void executeSafely(final Runnable runnable, final Runnable runnable2) {
        try {
            this.mGlExecutor.execute(new Runnable() { // from class: androidx.camera.core.processing.concurrent.DualSurfaceProcessor$$ExternalSyntheticLambda6
                @Override // java.lang.Runnable
                public final void run() {
                    DualSurfaceProcessor.m1464$r8$lambda$ZbwcPykT74fmw8U2V6XL8hhU5w(this.f$0, runnable2, runnable);
                }
            });
        } catch (RejectedExecutionException e) {
            Logger.m49w("DualSurfaceProcessor", "Unable to executor runnable", e);
            runnable2.run();
        }
    }

    /* renamed from: $r8$lambda$-ZbwcPykT74fmw8U2V6XL8hhU5w, reason: not valid java name */
    public static /* synthetic */ void m1464$r8$lambda$ZbwcPykT74fmw8U2V6XL8hhU5w(DualSurfaceProcessor dualSurfaceProcessor, Runnable runnable, Runnable runnable2) {
