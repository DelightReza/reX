...
class CaptureSessionRepository {
    ...
    private final CameraDevice.StateCallback mCameraStateCallback = new C01301();
    ...
    class C01301 extends CameraDevice.StateCallback {
        ...
        private void dispatchOnError(final int i) {
            ...
            CaptureSessionRepository.this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.CaptureSessionRepository$1$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    CaptureSessionRepository.C01301.m1409$r8$lambda$CL1hFGhJfY2YlX9P606ueCWeGY(linkedHashSet, i);
                }
            });
        }

        /* renamed from: $r8$lambda$-CL1hFGhJfY2YlX9P606ueCWeGY, reason: not valid java name */
        public static /* synthetic */ void m1409$r8$lambda$CL1hFGhJfY2YlX9P606ueCWeGY(LinkedHashSet linkedHashSet, int i) {
