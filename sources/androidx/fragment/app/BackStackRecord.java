...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0496Op c0496Op = (FragmentTransaction.C0496Op) this.mOps.get(i);
            switch (c0496Op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0496Op.mFragment);
            if (z) {
                if (c0496Op.mEnterAnim != 0 || c0496Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0496Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0496Op.mExitAnim));
                }
                if (c0496Op.mPopEnterAnim != 0 || c0496Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0496Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0496Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0496Op c0496Op = (FragmentTransaction.C0496Op) this.mOps.get(i2);
                Fragment fragment = c0496Op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "Bump nesting of " + c0496Op.mFragment + " to " + c0496Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (c0496Op.mCmd) {
                case 1:
                    fragment.setAnimations(c0496Op.mEnterAnim, c0496Op.mExitAnim, c0496Op.mPopEnterAnim, c0496Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0496Op.mCmd);
                case 3:
                    fragment.setAnimations(c0496Op.mEnterAnim, c0496Op.mExitAnim, c0496Op.mPopEnterAnim, c0496Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0496Op.mCurrentMaxState);
                    break;
            }
        }
    }
    ...
    void executePopOps() {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0496Op c0496Op = (FragmentTransaction.C0496Op) this.mOps.get(size);
            Fragment fragment = c0496Op.mFragment;
            if (fragment != null) {
                fragment.mBeingSaved = this.mBeingSaved;
            ...
            switch (c0496Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0496Op.mOldMaxState);
                    break;
            }
        }
    }
    ...
    */
    androidx.fragment.app.Fragment expandOps(java.util.ArrayList r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0496Op) r5
            int r6 = r5.mCmd
            r7 = 1
            if (r6 == r7) goto Lb6
            r8 = 2
    ...
    */
    androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0496Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
