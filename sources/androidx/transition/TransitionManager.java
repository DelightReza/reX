...
public abstract class TransitionManager {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo1603clone = transition.mo1603clone();
        sceneChangeSetup(viewGroup, transitionMo1603clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo1603clone);
    }
}
