    ...
    void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList arrayList, ArrayList arrayList2) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i4 = 0; i4 < sparseIntArray.size(); i4++) {
                AnimationInfo animationInfo2 = (AnimationInfo) runningAnimators.get((Animator) this.mAnimators.get(sparseIntArray.keyAt(i4)));
                animationInfo2.mAnimator.setStartDelay((sparseIntArray.valueAt(i4) - Long.MAX_VALUE) + animationInfo2.mAnimator.getStartDelay());
            }
        }
    }
