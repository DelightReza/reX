...
public class MediaRouteControllerDialogFragment extends DialogFragment {
    ...
    private void ensureRouteSelector() {
        if (this.mSelector == null) {
            ...
            if (arguments != null) {
                this.mSelector = MediaRouteSelector.fromBundle(arguments.getBundle(PluginsConstants.Settings.TYPE_SELECTOR));
            }
            if (this.mSelector == null) {
    ...
    public void setRouteSelector(MediaRouteSelector mediaRouteSelector) {
        ...
        arguments.putBundle(PluginsConstants.Settings.TYPE_SELECTOR, mediaRouteSelector.asBundle());
