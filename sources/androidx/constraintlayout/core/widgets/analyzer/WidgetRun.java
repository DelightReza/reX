...
public abstract class WidgetRun implements Dependency {
    ...
    protected final DependencyNode getTarget(ConstraintAnchor constraintAnchor) {
        ...
        int i = C02671.f20x6930e354[constraintAnchor2.mType.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C02671 {
        ...
        static final /* synthetic */ int[] f20x6930e354;
        ...
        static {
            ...
            try {
                f20x6930e354[ConstraintAnchor.Type.RIGHT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f20x6930e354[ConstraintAnchor.Type.TOP.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f20x6930e354[ConstraintAnchor.Type.BASELINE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f20x6930e354[ConstraintAnchor.Type.BOTTOM.ordinal()] = 5;
    ...
    protected final DependencyNode getTarget(ConstraintAnchor constraintAnchor, int i) {
        ...
        int i2 = C02671.f20x6930e354[constraintAnchor2.mType.ordinal()];
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 != 3) {
                    if (i2 != 5) {
