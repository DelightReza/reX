    ...
    private static void horizontalSolvingPass(int i, ConstraintWidget constraintWidget, BasicMeasure.Measurer measurer, boolean z) {
        ...
        if (anchor.getDependents() != null && anchor.hasFinalValue()) {
            ...
            while (it.hasNext()) {
                ...
                boolean z2 = (constraintAnchor5 == constraintWidget2.mLeft && (constraintAnchor4 = constraintWidget2.mRight.mTarget) != null && constraintAnchor4.hasFinalValue()) || (constraintAnchor5 == constraintWidget2.mRight && (constraintAnchor3 = constraintWidget2.mLeft.mTarget) != null && constraintAnchor3.hasFinalValue());
        ...
        if (anchor2.getDependents() != null && anchor2.hasFinalValue()) {
            ...
            while (it2.hasNext()) {
                ...
                boolean z3 = (constraintAnchor8 == constraintWidget3.mLeft && (constraintAnchor2 = constraintWidget3.mRight.mTarget) != null && constraintAnchor2.hasFinalValue()) || (constraintAnchor8 == constraintWidget3.mRight && (constraintAnchor = constraintWidget3.mLeft.mTarget) != null && constraintAnchor.hasFinalValue());
