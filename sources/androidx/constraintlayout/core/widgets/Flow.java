...
public class Flow extends VirtualLayout {
    ...
    private void measureChainWrap_new(ConstraintWidget[] constraintWidgetArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (i2 == 0) {
            ...
            while (i14 < i) {
                ...
                if (z2) {
                    ...
                    flow = flow2;
                    i13 = i14 > 0 ? i13 + flow.mVerticalGap + widgetHeight : widgetHeight;
                }
                widgetsList.add(constraintWidget2);
                i14++;
                i7 = i3;
        ...
        for (int i21 = 0; i21 < size; i21++) {
            WidgetsList widgetsList3 = (WidgetsList) flow3.mChainList.get(i21);
            if (i2 == 0) {
                if (i21 < size - 1) {
                    constraintAnchor7 = ((WidgetsList) flow3.mChainList.get(i21 + 1)).mBiggest.mTop;
                    paddingBottom2 = 0;
                } else {
                    constraintAnchor7 = flow3.mBottom;
                    paddingBottom2 = flow3.getPaddingBottom();
                ...
                int i24 = i17;
                if (i21 < size - 1) {
                    constraintAnchor = ((WidgetsList) flow3.mChainList.get(i21 + 1)).mBiggest.mLeft;
                    paddingRight2 = 0;
                } else {
                    constraintAnchor = flow3.mRight;
                    paddingRight2 = flow3.getPaddingRight();
