...
public class Barrier extends HelperWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z) {
        ...
        if (this.mResolved) {
            ...
            if (i6 == 0 || i6 == 1) {
                linearSystem.addEquality(this.mLeft.mSolverVariable, this.f14mX);
                linearSystem.addEquality(this.mRight.mSolverVariable, this.f14mX);
                return;
            } else {
                if (i6 == 2 || i6 == 3) {
                    linearSystem.addEquality(this.mTop.mSolverVariable, this.f15mY);
                    linearSystem.addEquality(this.mBottom.mSolverVariable, this.f15mY);
                    return;
                }
                return;
            }
