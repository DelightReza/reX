                                    ...
                                    for (int i9 = 1; i9 < this.mNumColumns; i9++) {
                                        ...
                                        if (f5 > 0.0f) {
                                            for (int i10 = 0; i10 < 9; i10++) {
                                                float f6 = solverVariable.mStrengthVector[i10] / f5;
    ...
    public void addEquality(SolverVariable solverVariable, int i) {
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i2 = 0; i2 < this.mVariablesID + 1; i2++) {
                ...
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f13id) {
