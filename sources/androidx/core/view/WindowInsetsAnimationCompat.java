...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(AbstractC0296x6f32a476.m100m(i, interpolator, j));
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM103m = C0299x30864cc7.m103m(list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM103m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM103m.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            AbstractC0298x6f32a478.m102m();
            return AbstractC0297x6f32a477.m101m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
