...
public class WindowInsetsCompat {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                if (z) {
                    ...
                    return Insets.m88of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m88of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i != 8) {
                if (i == 16) {
                ...
                if (i == 128) {
                    ...
                    if (displayCutout != null) {
                        return Insets.m88of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                    }
                    return Insets.NONE;
                }
                return Insets.NONE;
    ...
    static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        return (iMax == i && iMax2 == i2 && iMax3 == i3 && iMax4 == i4) ? insets : Insets.m88of(iMax, iMax2, iMax3, iMax4);
    }
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = AbstractC0304xad760192.m105m();
        }
        ...
        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            ...
            if (windowInsets != null) {
                builderM105m = AbstractC0303xad760191.m104m(windowInsets);
            } else {
                builderM105m = AbstractC0304xad760192.m105m();
            }
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat windowInsetsCompatBuild = new Builder().setStableInsets(Insets.m89of(rect)).setSystemWindowInsets(Insets.m89of(rect2)).build();
