...
public abstract class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).isRequestPinShortcutSupported();
        }
    ...
    public static boolean requestPinShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat, final IntentSender intentSender) throws PackageManager.NameNotFoundException {
        ...
        if (i >= 26) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).requestPinShortcut(shortcutInfoCompat.toShortcutInfo(), intentSender);
        }
    ...
    public static List getShortcuts(Context context, int i) {
        ...
        if (i2 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).getShortcuts(i));
        }
        if (i2 >= 25) {
            ShortcutManager shortcutManagerM87m = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m()));
            ArrayList arrayList = new ArrayList();
            if ((i & 1) != 0) {
                arrayList.addAll(shortcutManagerM87m.getManifestShortcuts());
            }
            if ((i & 2) != 0) {
                arrayList.addAll(shortcutManagerM87m.getDynamicShortcuts());
            }
            if ((i & 4) != 0) {
                arrayList.addAll(shortcutManagerM87m.getPinnedShortcuts());
            }
    ...
    public static boolean addDynamicShortcuts(Context context, List list) {
        ...
        if (i >= 25) {
            ...
            if (!ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).addDynamicShortcuts(arrayList)) {
                return false;
            }
        }
    ...
    public static int getMaxShortcutCountPerActivity(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            return ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).getMaxShortcutCountPerActivity();
        }
        return 5;
    }
    ...
    public static void reportShortcutUsed(Context context, String str) {
        ...
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).reportShortcutUsed(str);
        }
    ...
    public static List getDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            List<ShortcutInfo> dynamicShortcuts = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).getDynamicShortcuts();
            ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
            Iterator<ShortcutInfo> it = dynamicShortcuts.iterator();
            while (it.hasNext()) {
                arrayList.add(new ShortcutInfoCompat.Builder(context, ShortcutInfoCompat$$ExternalSyntheticApiModelOutline2.m85m(it.next())).build());
            }
            return arrayList;
        }
        try {
    ...
    public static boolean updateShortcuts(Context context, List list) {
        ...
        if (i >= 25) {
            ...
            if (!ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).updateShortcuts(arrayList)) {
                return false;
            }
        }
        getShortcutInfoSaverInstance(context).addShortcuts(listRemoveShortcutsExcludedFromSurface);
    ...
    public static void removeDynamicShortcuts(Context context, List list) {
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).removeDynamicShortcuts(list);
        }
    ...
    public static void removeAllDynamicShortcuts(Context context) {
        if (Build.VERSION.SDK_INT >= 25) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).removeAllDynamicShortcuts();
        }
    ...
    public static boolean pushDynamicShortcut(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        ...
        if (i >= 30) {
            ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m())).pushDynamicShortcut(shortcutInfoCompat.toShortcutInfo());
        } else if (i >= 25) {
            ShortcutManager shortcutManagerM87m = ShortcutManagerCompat$$ExternalSyntheticApiModelOutline1.m87m(context.getSystemService(ShortcutManagerCompat$$ExternalSyntheticApiModelOutline0.m86m()));
            if (shortcutManagerM87m.isRateLimitingActive()) {
                return false;
            }
            List<ShortcutInfo> dynamicShortcuts = shortcutManagerM87m.getDynamicShortcuts();
            if (dynamicShortcuts.size() >= maxShortcutCountPerActivity) {
                shortcutManagerM87m.removeDynamicShortcuts(Arrays.asList(Api25Impl.getShortcutInfoWithLowestRank(dynamicShortcuts)));
            }
            shortcutManagerM87m.addDynamicShortcuts(Arrays.asList(shortcutInfoCompat.toShortcutInfo()));
        }
