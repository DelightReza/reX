...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ShortcutInfoCompat$$ExternalSyntheticApiModelOutline1.m84m();
        ShortcutInfo.Builder intents = ShortcutInfoCompat$$ExternalSyntheticApiModelOutline0.m83m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List fromShortcuts(Context context, List list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, ShortcutInfoCompat$$ExternalSyntheticApiModelOutline2.m85m(it.next())).build());
        }
        return arrayList;
    }
