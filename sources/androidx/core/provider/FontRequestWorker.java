...
abstract class FontRequestWorker {
    ...
    static Typeface requestFontSync(final Context context, final FontRequest fontRequest, CallbackWrapper callbackWrapper, final int i, int i2) {
        final String strCreateCacheId = createCacheId(ImageCapture$$ExternalSyntheticBackport1.m42m(new Object[]{fontRequest}), i);
        ...
        if (i2 == -1) {
            TypefaceResult fontSync = getFontSync(strCreateCacheId, context, ImageCapture$$ExternalSyntheticBackport1.m42m(new Object[]{fontRequest}), i);
        ...
        try {
            TypefaceResult typefaceResult = (TypefaceResult) RequestExecutor.submit(DEFAULT_EXECUTOR_SERVICE, new Callable() { // from class: androidx.core.provider.FontRequestWorker.1
                ...
                public TypefaceResult call() {
                    return FontRequestWorker.getFontSync(strCreateCacheId, context, ImageCapture$$ExternalSyntheticBackport1.m42m(new Object[]{fontRequest}), i);
                }
            }, i2);
