            ...
            if (i >= 30) {
                ...
                if (historicalProcessExitReasons != null && !historicalProcessExitReasons.isEmpty()) {
                    ...
                    for (int i2 = 0; i2 < historicalProcessExitReasons.size(); i2++) {
                        ApplicationExitInfo applicationExitInfoM178m = ForceStopRunnable$$ExternalSyntheticApiModelOutline0.m178m(historicalProcessExitReasons.get(i2));
                        if (applicationExitInfoM178m.getReason() == 10 && applicationExitInfoM178m.getTimestamp() >= lastForceStopEventMillis) {
                            return true;
                        }
                    }
                }
        ...
        try {
            ...
            if (z) {
                for (WorkSpec workSpec : runningWork) {
                    workSpecDao.setState(WorkInfo$State.ENQUEUED, workSpec.f51id);
                    workSpecDao.markWorkSpecScheduled(workSpec.f51id, -1L);
                }
            }
