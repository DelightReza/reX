    ...
    protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration databaseConfiguration) {
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(16) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase supportSQLiteDatabase) {
                ...
                map2.put(PluginsConstants.Settings.TYPE_INPUT, new TableInfo.Column(PluginsConstants.Settings.TYPE_INPUT, "BLOB", true, 0, null, 1));
                ...
                map2.put("period_count", new TableInfo.Column("period_count", "INTEGER", true, 0, MVEL.VERSION_SUB, 1));
                map2.put("generation", new TableInfo.Column("generation", "INTEGER", true, 0, MVEL.VERSION_SUB, 1));
                ...
                map4.put("generation", new TableInfo.Column("generation", "INTEGER", true, 2, MVEL.VERSION_SUB, 1));
                ...
                map7.put(PluginsConstants.Settings.KEY, new TableInfo.Column(PluginsConstants.Settings.KEY, "TEXT", true, 1, null, 1));
