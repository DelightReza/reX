...
class SystemJobInfoConverter {
    ...
    JobInfo convert(WorkSpec workSpec, int i) {
        ...
        persistableBundle.putString("EXTRA_WORK_SPEC_ID", workSpec.f51id);
    ...
    private static JobInfo.TriggerContentUri convertContentUriTrigger(Constraints.ContentUriTrigger contentUriTrigger) {
        ...
        SystemJobInfoConverter$$ExternalSyntheticApiModelOutline1.m177m();
        return SystemJobInfoConverter$$ExternalSyntheticApiModelOutline0.m176m(contentUriTrigger.getUri(), zIsTriggeredForDescendants ? 1 : 0);
    }
    ...
    static int convertNetworkType(NetworkType networkType) {
        int i = C06921.$SwitchMap$androidx$work$NetworkType[networkType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2) {
