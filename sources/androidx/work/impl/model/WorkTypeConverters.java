...
public final class WorkTypeConverters {
    ...
    public static final byte[] setOfTriggersToByteArray(Set triggers) throws IOException {
    ...
    public static final Set byteArrayToSetOfTriggers(byte[] bytes) throws IOException {
