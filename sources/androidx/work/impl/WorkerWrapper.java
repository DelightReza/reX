...
public class WorkerWrapper implements Runnable {
    ...
    WorkerWrapper(Builder builder) {
        ...
        this.mWorkSpecId = workSpec.f51id;
        ...
        try {
            ...
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.WorkerWrapper$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    WorkerWrapper.m1604$r8$lambda$EZJOifd5Nt7S_Z6NFLZG0ICBm4(this.f$0, future);
                }
    ...
    public static /* synthetic */ void m1604$r8$lambda$EZJOifd5Nt7S_Z6NFLZG0ICBm4(WorkerWrapper workerWrapper, ListenableFuture listenableFuture) {
