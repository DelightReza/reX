...
class ELFAnalyser {
    ...
    private static Map<ArmAeabiAttributesTag, Object> parseFileAttribute(ByteBuffer byteBuffer) {
        ...
        while (byteBuffer.position() < byteBuffer.limit()) {
            ...
            int i = C15481.f406xd3185832[byValue.getParameterType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C15481 {
        ...
        static final /* synthetic */ int[] f406xd3185832;
        ...
        static {
            ...
            try {
                f406xd3185832[ArmAeabiAttributesTag.ParameterType.NTBS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f406xd3185832[ArmAeabiAttributesTag.ParameterType.ULEB128.ordinal()] = 3;
