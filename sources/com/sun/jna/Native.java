...
public final class Native implements Version {
    ...
    private static Object lookupField(Class<?> cls, String str, Class<?> cls2) throws NoSuchFieldException, SecurityException {
        try {
    ...
    /* JADX WARN: Removed duplicated region for block: B:62:0x01a0 A[FALL_THROUGH] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    public static void register(java.lang.Class<?> r29, com.sun.jna.NativeLibrary r30) throws java.lang.SecurityException {
        /*
    ...
    public static void main(String[] strArr) {
        ...
        if (r3 == null) {
            implementationVersion = "5.13.0 (package information missing)";
        } else {
