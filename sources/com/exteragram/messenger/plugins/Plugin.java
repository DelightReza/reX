...
public class Plugin {
    ...
    private String description = LocaleController.getString(C2369R.string.PluginNoDescription);
    private String author = LocaleController.getString(C2369R.string.PluginNoAuthor);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Plugin) {
            return ((Plugin) obj).f184id.equals(this.f184id);
        }
