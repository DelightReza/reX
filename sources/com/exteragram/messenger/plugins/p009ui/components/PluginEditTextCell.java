...
public class PluginEditTextCell extends EditTextCell {
    ...
    public /* synthetic */ void lambda$scheduleSave$1(final EditTextSetting editTextSetting, final String str, final String str2, final String str3) {
        ...
        Utilities.pluginsQueue.postRunnable(new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.PluginEditTextCell$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public static class Factory extends UItem.UItemFactory {
        ...
        /* renamed from: as */
        public static UItem m220as(Plugin plugin, EditTextSetting editTextSetting) {
    ...
    private void triggerOnChange(final PyObject pyObject, final String str, final Object obj) {
        Utilities.pluginsQueue.postRunnable(new Runnable() { // from class: com.exteragram.messenger.plugins.ui.components.PluginEditTextCell$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void lambda$triggerOnChange$2(PyObject pyObject, Object obj, String str) {
        if (pyObject != null) {
            try {
                ...
                FileLog.m1159e("Error executing on_change callback for " + this.pluginId + "/" + str, e);
            }
        }
    }
        ...
        try {
            ...
            return new InputFilter() { // from class: com.exteragram.messenger.plugins.ui.components.PluginEditTextCell$$ExternalSyntheticLambda2
                ...
                public final CharSequence filter(CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
                    return PluginEditTextCell.m1939$r8$lambda$21LFMDbklwashUcrD_hg0JMOJw(patternCompile, charSequence, i, i2, spanned, i3, i4);
                }
            };
        } catch (PatternSyntaxException e) {
            FileLog.m1159e("Invalid mask for EditText: " + str, e);
            return null;
        }
    }

    /* renamed from: $r8$lambda$21LFMD-bklwashUcrD_hg0JMOJw, reason: not valid java name */
    public static /* synthetic */ CharSequence m1939$r8$lambda$21LFMDbklwashUcrD_hg0JMOJw(Pattern pattern, CharSequence charSequence, int i, int i2, Spanned spanned, int i3, int i4) {
