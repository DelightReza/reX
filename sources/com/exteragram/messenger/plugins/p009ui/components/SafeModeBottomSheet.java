...
public class SafeModeBottomSheet extends BottomSheet {
    ...
    public SafeModeBottomSheet(BaseFragment baseFragment) {
        ...
        textView.setText(LocaleController.getString(C2369R.string.PluginsSafeMode));
        ...
        textView2.setText(LocaleController.getString(C2369R.string.PluginsSafeModeInfo));
        ...
        buttonWithCounterView.setText(LocaleController.getString(C2369R.string.Disable), false);
