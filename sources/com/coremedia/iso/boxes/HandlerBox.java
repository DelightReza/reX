...
public class HandlerBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_5 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "toString", "com.coremedia.iso.boxes.HandlerBox", "", "", "", "java.lang.String"), Opcodes.FCMPL);
    }
    ...
    static {
        ...
        map.put(PluginsConstants.Settings.HINT, "Hint Track");
    ...
    public void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.f141a = IsoTypeReader.readUInt32(byteBuffer);
        this.f142b = IsoTypeReader.readUInt32(byteBuffer);
        this.f143c = IsoTypeReader.readUInt32(byteBuffer);
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        IsoTypeWriter.writeUInt32(byteBuffer, this.f141a);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f142b);
        IsoTypeWriter.writeUInt32(byteBuffer, this.f143c);
        String str = this.name;
        if (str != null) {
