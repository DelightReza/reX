...
public class Xoroshiro128PlusRandom extends Random {
    ...
    public Xoroshiro128PlusRandom(long j) {
        ...
        this.f55s1 = jHash2;
        if (this.f54s0 == 0 && jHash2 == 0) {
            long jHash3 = MurmurHash3.hash(3735928559L);
            this.f54s0 = jHash3;
            this.f55s1 = MurmurHash3.hash(jHash3);
        }
    }

    @Override // java.util.Random
    public void setSeed(long j) {
        if (this.f54s0 != 0 || this.f55s1 != 0) {
    ...
    public long nextLong() {
        ...
        long j3 = j + j2;
        long j4 = j2 ^ j;
        this.f54s0 = (Long.rotateLeft(j, 55) ^ j4) ^ (j4 << 14);
        this.f55s1 = Long.rotateLeft(j4, 36);
        return j3;
    }
