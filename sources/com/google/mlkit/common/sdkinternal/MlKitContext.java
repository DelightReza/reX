...
public class MlKitContext {
    ...
    public static MlKitContext zzb(Context context, Executor executor) {
        ...
        synchronized (zza) {
            ...
            ComponentRuntime componentRuntimeBuild = ComponentRuntime.builder(executor).addLazyComponentRegistrars(ComponentDiscovery.forContext(contextZzc, MlKitComponentDiscoveryService.class).discoverLazy()).addComponent(Component.m449of(contextZzc, Context.class, new Class[0])).addComponent(Component.m449of(mlKitContext2, MlKitContext.class, new Class[0])).build();
