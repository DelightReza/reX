...
abstract class EventStoreConfig {
    static final EventStoreConfig DEFAULT = builder().setMaxStorageSizeInBytes(10485760).setLoadBatchSize(DataTypes.EMPTY).setCriticalSectionEnterTimeoutMs(XCallback.PRIORITY_HIGHEST).setEventCleanUpAge(604800000).setMaxBlobByteSizePerRow(81920).build();
