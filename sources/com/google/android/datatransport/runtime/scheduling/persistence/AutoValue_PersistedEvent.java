...
final class AutoValue_PersistedEvent extends PersistedEvent {
    ...
    public String toString() {
        return "PersistedEvent{id=" + this.f195id + ", transportContext=" + this.transportContext + ", event=" + this.event + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PersistedEvent) {
            ...
            if (this.f195id == persistedEvent.getId() && this.transportContext.equals(persistedEvent.getTransportContext()) && this.event.equals(persistedEvent.getEvent())) {
                return true;
            }
        }
        return false;
