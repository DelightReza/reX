...
final class CctTransportBackend implements TransportBackend {
    ...
    private static int getPackageVersionCode(Context context) {
        try {
            ...
            Logging.m253e("CctTransportBackend", "Unable to find version code for package", e);
            return -1;
        }
    }
    ...
    private BatchedLogRequest getRequestBody(BackendRequest backendRequest) {
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            for (EventInternal eventInternal3 : (List) entry.getValue()) {
                ...
                if (encoding.equals(Encoding.m249of("proto"))) {
                    builderProtoBuilder = LogEvent.protoBuilder(encodedPayload.getBytes());
                } else if (encoding.equals(Encoding.m249of("json"))) {
                    builderProtoBuilder = LogEvent.jsonBuilder(new String(encodedPayload.getBytes(), Charset.forName("UTF-8")));
                } else {
                    Logging.m255w("CctTransportBackend", "Received event of unsupported encoding %s. Skipping...", encoding);
                }
    ...
    public HttpResponse doSend(HttpRequest httpRequest) throws IOException {
        Logging.m254i("CctTransportBackend", "Making request to: %s", httpRequest.url);
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Logging.m254i("CctTransportBackend", "Status Code: %d", Integer.valueOf(responseCode));
                    Logging.m251d("CctTransportBackend", "Content-Type: %s", httpURLConnection.getHeaderField("Content-Type"));
                    Logging.m251d("CctTransportBackend", "Content-Encoding: %s", httpURLConnection.getHeaderField("Content-Encoding"));
            ...
            e = e;
            Logging.m253e("CctTransportBackend", "Couldn't encode request, returning with 400", e);
            return new HttpResponse(400, null, 0L);
        } catch (ConnectException e2) {
            e = e2;
            Logging.m253e("CctTransportBackend", "Couldn't open connection, returning with 500", e);
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(urlOrThrow, requestBody, aPIKey), new Function() { // from class: com.google.android.datatransport.cct.CctTransportBackend$$ExternalSyntheticLambda0
                ...
                public final Object shouldRetry(Object obj, Object obj2) {
                    return CctTransportBackend.m2105$r8$lambda$ZhERf3WZxxKL1vqOg2FJv71EaQ((CctTransportBackend.HttpRequest) obj, (CctTransportBackend.HttpResponse) obj2);
                }
            });
            int i = httpResponse.code;
            if (i == 200) {
                return BackendResponse.m250ok(httpResponse.nextRequestMillis);
            }
            if (i < 500 && i != 404) {
                if (i == 400) {
            ...
            Logging.m253e("CctTransportBackend", "Could not make request to the backend", e);
            return BackendResponse.transientError();
        }
    }

    /* renamed from: $r8$lambda$ZhERf3WZ-xxKL1vqOg2FJv71EaQ, reason: not valid java name */
    public static /* synthetic */ HttpRequest m2105$r8$lambda$ZhERf3WZxxKL1vqOg2FJv71EaQ(HttpRequest httpRequest, HttpResponse httpResponse) {
        URL url = httpResponse.redirectUrl;
        if (url == null) {
            return null;
        }
        Logging.m251d("CctTransportBackend", "Following redirect to: %s", url);
