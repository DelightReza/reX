...
public final class AutoBatchedLogRequestEncoder implements Configurator {
    ...
    private static final class BatchedLogRequestEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor LOGREQUEST_DESCRIPTOR = FieldDescriptor.m461of("logRequest");
    ...
    private static final class LogRequestEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor REQUESTTIMEMS_DESCRIPTOR = FieldDescriptor.m461of("requestTimeMs");
        private static final FieldDescriptor REQUESTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m461of("requestUptimeMs");
        private static final FieldDescriptor CLIENTINFO_DESCRIPTOR = FieldDescriptor.m461of("clientInfo");
        private static final FieldDescriptor LOGSOURCE_DESCRIPTOR = FieldDescriptor.m461of("logSource");
        private static final FieldDescriptor LOGSOURCENAME_DESCRIPTOR = FieldDescriptor.m461of("logSourceName");
        private static final FieldDescriptor LOGEVENT_DESCRIPTOR = FieldDescriptor.m461of("logEvent");
        private static final FieldDescriptor QOSTIER_DESCRIPTOR = FieldDescriptor.m461of("qosTier");
    ...
    private static final class ClientInfoEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor CLIENTTYPE_DESCRIPTOR = FieldDescriptor.m461of("clientType");
        private static final FieldDescriptor ANDROIDCLIENTINFO_DESCRIPTOR = FieldDescriptor.m461of("androidClientInfo");
    ...
    private static final class AndroidClientInfoEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor HARDWARE_DESCRIPTOR = FieldDescriptor.m461of("hardware");
        private static final FieldDescriptor DEVICE_DESCRIPTOR = FieldDescriptor.m461of("device");
        private static final FieldDescriptor PRODUCT_DESCRIPTOR = FieldDescriptor.m461of("product");
        private static final FieldDescriptor OSBUILD_DESCRIPTOR = FieldDescriptor.m461of("osBuild");
        private static final FieldDescriptor MANUFACTURER_DESCRIPTOR = FieldDescriptor.m461of("manufacturer");
        private static final FieldDescriptor FINGERPRINT_DESCRIPTOR = FieldDescriptor.m461of("fingerprint");
        private static final FieldDescriptor LOCALE_DESCRIPTOR = FieldDescriptor.m461of("locale");
        private static final FieldDescriptor COUNTRY_DESCRIPTOR = FieldDescriptor.m461of("country");
        private static final FieldDescriptor MCCMNC_DESCRIPTOR = FieldDescriptor.m461of("mccMnc");
        private static final FieldDescriptor APPLICATIONBUILD_DESCRIPTOR = FieldDescriptor.m461of("applicationBuild");
    ...
    private static final class LogEventEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor EVENTTIMEMS_DESCRIPTOR = FieldDescriptor.m461of("eventTimeMs");
        private static final FieldDescriptor EVENTCODE_DESCRIPTOR = FieldDescriptor.m461of("eventCode");
        private static final FieldDescriptor EVENTUPTIMEMS_DESCRIPTOR = FieldDescriptor.m461of("eventUptimeMs");
        private static final FieldDescriptor SOURCEEXTENSION_DESCRIPTOR = FieldDescriptor.m461of("sourceExtension");
        private static final FieldDescriptor SOURCEEXTENSIONJSONPROTO3_DESCRIPTOR = FieldDescriptor.m461of("sourceExtensionJsonProto3");
        private static final FieldDescriptor TIMEZONEOFFSETSECONDS_DESCRIPTOR = FieldDescriptor.m461of("timezoneOffsetSeconds");
        private static final FieldDescriptor NETWORKCONNECTIONINFO_DESCRIPTOR = FieldDescriptor.m461of("networkConnectionInfo");
    ...
    private static final class NetworkConnectionInfoEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor NETWORKTYPE_DESCRIPTOR = FieldDescriptor.m461of("networkType");
        private static final FieldDescriptor MOBILESUBTYPE_DESCRIPTOR = FieldDescriptor.m461of("mobileSubtype");
