...
public final class zzap {
    ...
    zzap(zzgd zzgdVar, String str, String str2, String str3, long j, long j2, Bundle bundle) {
        zzas zzasVar;
        ...
        if (bundle == null || bundle.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (next == null) {
                    ...
                    Object objZzA = zzgdVar.zzv().zzA(next, bundle2.get(next));
                    if (objZzA == null) {
                        zzgdVar.zzaA().zzk().zzb("Param value can't be null", zzgdVar.zzj().zze(next));
                        it.remove();
                    } else {
                        zzgdVar.zzv().zzP(bundle2, next, objZzA);
                    }
                }
            }
    ...
    final zzap zza(zzgd zzgdVar, long j) {
