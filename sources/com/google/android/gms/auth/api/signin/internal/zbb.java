    ...
    public final void run() throws IOException {
        ...
        try {
            ...
            if (responseCode == 200) {
                ...
                zba.m310e("Unable to revoke access!", new Object[0]);
            }
            zba.m309d("Response Code: " + responseCode, new Object[0]);
        } catch (IOException e) {
            zba.m310e("IOException when revoking access: ".concat(String.valueOf(e.toString())), new Object[0]);
        } catch (Exception e2) {
            zba.m310e("Exception when revoking access: ".concat(String.valueOf(e2.toString())), new Object[0]);
        }
