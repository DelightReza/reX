...
public final class zzbt extends GoogleApi implements zzr {
    ...
    static /* bridge */ /* synthetic */ void zzA(zzbt zzbtVar, zzab zzabVar) {
        ...
        Logger logger = zzg;
        logger.m297d("hasVolumeChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z), Boolean.valueOf(zzbtVar.zzk));
        ...
        logger.m297d("hasActiveInputChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z2), Boolean.valueOf(zzbtVar.zzk));
        ...
        logger.m297d("hasStandbyStateChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z3), Boolean.valueOf(zzbtVar.zzk));
    ...
    public final void zzS() {
        zzg.m297d("removing all MessageReceivedCallbacks", new Object[0]);
    ...
    static /* bridge */ /* synthetic */ void zzz(zzbt zzbtVar, com.google.android.gms.cast.internal.zza zzaVar) {
        ...
        zzg.m297d("hasChanged=%b, mFirstApplicationStatusUpdate=%b", Boolean.valueOf(z), Boolean.valueOf(zzbtVar.zzl));
        Cast.Listener listener = zzbtVar.zzx;
    ...
    public final Task zzh(final String str, final String str2) {
        ...
        zzg.m302w("Message send failed. Message exceeds maximum size", new Object[0]);
