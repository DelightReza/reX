...
public final class zzw extends GmsClient {
    ...
    static /* bridge */ /* synthetic */ void zzH(zzw zzwVar, zza zzaVar) {
        ...
        zze.m297d("hasChanged=%b, mFirstApplicationStatusUpdate=%b", Boolean.valueOf(z), Boolean.valueOf(zzwVar.zzq));
    ...
    static /* bridge */ /* synthetic */ void zzI(zzw zzwVar, zzab zzabVar) {
        ...
        Logger logger = zze;
        logger.m297d("hasVolumeChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z), Boolean.valueOf(zzwVar.zzr));
        Cast.Listener listener = zzwVar.zzj;
        ...
        logger.m297d("hasActiveInputChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z2), Boolean.valueOf(zzwVar.zzr));
        ...
        logger.m297d("hasStandbyStateChanged=%b, mFirstDeviceStatusUpdate=%b", Boolean.valueOf(z3), Boolean.valueOf(zzwVar.zzr));
    ...
    private final void zzZ() {
        zze.m297d("removing all MessageReceivedCallbacks", new Object[0]);
    ...
    public final void disconnect() {
        Logger logger = zze;
        logger.m297d("disconnect(); ServiceListener=%s, isConnected=%b", this.zzn, Boolean.valueOf(isConnected()));
        zzv zzvVar = this.zzn;
        this.zzn = null;
        if (zzvVar == null || zzvVar.zzq() == null) {
            logger.m297d("already disposed, so short-circuiting", new Object[0]);
            return;
        }
        zzZ();
        try {
            ...
            zze.m298d(e, "Error while disconnecting the controller interface", new Object[0]);
        }
    }
    ...
    protected final Bundle getGetServiceRequestExtraArgs() {
        ...
        zze.m297d("getRemoteService(): mLastApplicationId=%s, mLastSessionId=%s", this.zzy, this.zzz);
    ...
    protected final void onPostInitHandler(int i, IBinder iBinder, Bundle bundle, int i2) {
        zze.m297d("in onPostInitHandler; statusCode=%d", Integer.valueOf(i));
        if (i == 0 || i == 2300) {
            this.zzs = true;
            this.zzq = true;
            this.zzr = true;
