...
public abstract class zza {
    ...
    public static Calendar zzb(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            zza.m297d("Input string is empty or null", new Object[0]);
            return null;
        }
        String strZze = zze(str);
        if (TextUtils.isEmpty(strZze)) {
            zza.m297d("Invalid date format", new Object[0]);
            return null;
        }
        ...
        try {
            ...
            zza.m300e(e, "Error parsing string", new Object[0]);
            return null;
        }
    }
    ...
    private static String zze(String str) {
        ...
        try {
            ...
            zza.m300e(e, "Error extracting the date", new Object[0]);
            return null;
        }
    }
    ...
    private static String zzf(String str) {
        if (TextUtils.isEmpty(str)) {
            zza.m297d("string is empty or null", new Object[0]);
            return null;
        }
        int iIndexOf = str.indexOf(84);
        int i = iIndexOf + 1;
        if (iIndexOf != 8) {
            zza.m297d("T delimeter is not found", new Object[0]);
            return null;
        }
        try {
            ...
            zza.m300e(e, "Error extracting the time substring: %s", new Object[0]);
            return null;
        }
    }
