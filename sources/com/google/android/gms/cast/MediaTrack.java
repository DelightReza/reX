...
public final class MediaTrack extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final JSONObject zza() throws JSONException {
        ...
        try {
            ...
            int i = this.zzc;
            if (i == 1) {
                jSONObject.put(PluginsConstants.Settings.TYPE, "TEXT");
            } else if (i == 2) {
                jSONObject.put(PluginsConstants.Settings.TYPE, "AUDIO");
            } else if (i == 3) {
                jSONObject.put(PluginsConstants.Settings.TYPE, "VIDEO");
            }
            String str = this.zzd;
            if (str != null) {
