...
public class CastSession extends Session {
        ...
        try {
            if (task.isSuccessful()) {
                ...
                if (applicationConnectionResult.getStatus() != null && applicationConnectionResult.getStatus().isSuccess()) {
                    zzb.m297d("%s() -> success result", str);
                ...
                if (applicationConnectionResult.getStatus() != null) {
                    zzb.m297d("%s() -> failure result", str);
            ...
            zzb.m298d(e, "Unable to call %s on %s.", "methods", zzam.class.getSimpleName());
        }
    }
    ...
    private final void zzo(Bundle bundle) {
        ...
        zzb.m297d("Acquiring a connection to Google Play Services for %s", this.zzk);
    ...
    protected void end(boolean z) {
        ...
        if (zzamVar != null) {
            try {
                ...
                zzb.m298d(e, "Unable to call %s on %s.", "disconnectFromDevice", zzam.class.getSimpleName());
            }
    ...
    protected final void zzk(Bundle bundle) {
        ...
        this.zzk = fromBundle;
        zzb.m297d("update to device (%s) with name %s", fromBundle, true != z ? "unchanged" : "changed");
