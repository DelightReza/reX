...
public abstract class zzw {
    ...
    public static List zzf(com.google.android.gms.cast.framework.media.zzg zzgVar) {
        try {
            ...
            zza.m300e(e, "Unable to call %s on %s.", "getNotificationActions", com.google.android.gms.cast.framework.media.zzg.class.getSimpleName());
            return null;
        }
    }
    ...
    public static int[] zzg(com.google.android.gms.cast.framework.media.zzg zzgVar) {
        try {
            ...
            zza.m300e(e, "Unable to call %s on %s.", "getCompactViewActionIndices", com.google.android.gms.cast.framework.media.zzg.class.getSimpleName());
            return null;
        }
    }
}
