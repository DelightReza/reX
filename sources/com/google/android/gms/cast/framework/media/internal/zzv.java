    ...
    */
    private final void zzq(android.support.v4.media.session.PlaybackStateCompat.Builder r4, java.lang.String r5, com.google.android.gms.cast.framework.media.NotificationAction r6) {
        /*
            ...
            int r0 = r5.hashCode()
            switch(r0) {
                case -1699820260: goto La5;
                case -668151673: goto L73;
                case -124479363: goto L40;
                case 1362116196: goto L9;
                default: goto L7;
            }
        L7:
            goto Ldb
        L9:
            java.lang.String r0 = "com.google.android.gms.cast.framework.action.FORWARD"
            boolean r1 = r5.equals(r0)
            if (r1 == 0) goto Ldb
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzu
            if (r5 != 0) goto L3c
            com.google.android.gms.cast.framework.media.NotificationOptions r5 = r3.zzg
            if (r5 == 0) goto L3c
            long r1 = r5.getSkipStepMs()
            int r5 = com.google.android.gms.cast.framework.media.internal.zzw.zzb(r5, r1)
            com.google.android.gms.cast.framework.media.NotificationOptions r6 = r3.zzg
            int r6 = com.google.android.gms.cast.framework.media.internal.zzw.zza(r6, r1)
            android.content.Context r1 = r3.zzc
            ...
            r2.<init>(r0, r5, r6)
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r2.build()
            r3.zzu = r5
        L3c:
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzu
            goto Lf0
        L40:
            java.lang.String r0 = "com.google.android.gms.cast.framework.action.DISCONNECT"
            boolean r1 = r5.equals(r0)
            if (r1 == 0) goto Ldb
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzx
            if (r5 != 0) goto L6f
            com.google.android.gms.cast.framework.media.NotificationOptions r5 = r3.zzg
            if (r5 == 0) goto L6f
            android.content.Context r6 = r3.zzc
            ...
            com.google.android.gms.cast.framework.media.NotificationOptions r6 = r3.zzg
            int r6 = r6.getDisconnectDrawableResId()
            r1.<init>(r0, r5, r6)
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r1.build()
            r3.zzx = r5
        L6f:
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzx
            goto Lf0
        L73:
            java.lang.String r0 = "com.google.android.gms.cast.framework.action.STOP_CASTING"
            boolean r1 = r5.equals(r0)
            if (r1 == 0) goto Ldb
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzw
            if (r5 != 0) goto La2
            com.google.android.gms.cast.framework.media.NotificationOptions r5 = r3.zzg
            if (r5 == 0) goto La2
            android.content.Context r6 = r3.zzc
        ...
        La2:
            ...
            goto Lf0
        La5:
            java.lang.String r0 = "com.google.android.gms.cast.framework.action.REWIND"
            boolean r1 = r5.equals(r0)
            if (r1 == 0) goto Ldb
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r3.zzv
            if (r5 != 0) goto Ld8
            com.google.android.gms.cast.framework.media.NotificationOptions r5 = r3.zzg
            if (r5 == 0) goto Ld8
            long r1 = r5.getSkipStepMs()
            int r5 = com.google.android.gms.cast.framework.media.internal.zzw.zzd(r5, r1)
            com.google.android.gms.cast.framework.media.NotificationOptions r6 = r3.zzg
            int r6 = com.google.android.gms.cast.framework.media.internal.zzw.zzc(r6, r1)
            android.content.Context r1 = r3.zzc
            android.support.v4.media.session.PlaybackStateCompat$CustomAction$Builder r2 = new android.support.v4.media.session.PlaybackStateCompat$CustomAction$Builder
            android.content.res.Resources r1 = r1.getResources()
            java.lang.String r5 = r1.getString(r5)
        ...
        Ldb:
            ...
            java.lang.String r1 = r6.getContentDescription()
            int r6 = r6.getIconResId()
            r0.<init>(r5, r1, r6)
            android.support.v4.media.session.PlaybackStateCompat$CustomAction r5 = r0.build()
            goto Lf0
        Lef:
            r5 = 0
        Lf0:
            if (r5 == 0) goto Lf5
            r4.addCustomAction(r5)
        Lf5:
            return
        */
    ...
    private final void zzs() {
        zzo zzoVar = this.zzl;
        if (zzoVar != null) {
            zzb.m297d("Stopping media notification.", new Object[0]);
            zzoVar.zzc();
        }
    }
    ...
    public final void zzk(CastDevice castDevice) {
        zzb.m301i("update Cast device to %s", castDevice);
        this.zzq = castDevice;
        zzl(false);
    }
    ...
    public final void zzl(boolean z) {
        ...
        if (!remoteMediaClient.hasMediaSession()) {
            ...
            zzo zzoVar = this.zzl;
            if (zzoVar != null) {
                zzb.m297d("Update media notification.", new Object[0]);
    ...
    public final void zzh(RemoteMediaClient remoteMediaClient, CastDevice castDevice) {
        ...
        if (this.zzt || this.zzd == null || castMediaOptions == null || this.zzg == null || remoteMediaClient == null || castDevice == null || this.zzi == null) {
            zzb.m297d("skip attaching media session", new Object[0]);
            return;
        }
