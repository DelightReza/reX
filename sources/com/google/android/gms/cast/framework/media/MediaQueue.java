...
public class MediaQueue {
    ...
    final void zzm(RemoteMediaClient.MediaChannelResult mediaChannelResult) {
        ...
        if (statusCode != 0) {
            this.zzg.m302w(String.format("Error fetching queue item ids, statusCode=%s, statusMessage=%s", Integer.valueOf(statusCode), status.getStatusMessage()), new Object[0]);
        }
        this.zzm = null;
        if (this.zzf.isEmpty()) {
            return;
    ...
    final void zzn(RemoteMediaClient.MediaChannelResult mediaChannelResult) {
        ...
        int statusCode = status.getStatusCode();
        if (statusCode != 0) {
            this.zzg.m302w(String.format("Error fetching queue items, statusCode=%s, statusMessage=%s", Integer.valueOf(statusCode), status.getStatusMessage()), new Object[0]);
        }
        this.zzl = null;
        if (this.zzf.isEmpty()) {
            return;
