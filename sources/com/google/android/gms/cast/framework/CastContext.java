...
public class CastContext {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!castOptions.zza().isEmpty()) {
                            zzb.m301i("Setting Route Discovery for appIds: ".concat(String.valueOf(castOptions.zza())), new Object[0]);
    ...
    private static OptionsProvider zzf(Context context) {
        try {
            ...
            if (bundle == null) {
                zzb.m299e("Bundle is null", new Object[0]);
            }
    ...
    public MediaRouteSelector getMergedSelector() {
        ...
        try {
            ...
            zzb.m298d(e, "Unable to call %s on %s.", "getMergedSelectorAsBundle", zzaj.class.getSimpleName());
            return null;
        }
    }
