...
final class zzaa extends zzq {
    ...
    public final void zza() {
        ...
        try {
            ...
            CastSession.zzb.m298d(e, "Unable to call %s on %s.", "onConnected", zzam.class.getSimpleName());
        }
    ...
    public final void zzb(int i) {
        ...
        try {
            ...
            CastSession.zzb.m298d(e, "Unable to call %s on %s.", "onConnectionFailed", zzam.class.getSimpleName());
        }
    }
    ...
    public final void zzc(int i) {
        ...
        try {
            ...
            CastSession.zzb.m298d(e, "Unable to call %s on %s.", "onConnectionSuspended", zzam.class.getSimpleName());
        }
    }
    ...
    public final void zzd(int i) {
        ...
        try {
            ...
            CastSession.zzb.m298d(e, "Unable to call %s on %s.", "onDisconnected", zzam.class.getSimpleName());
        }
    }
}
