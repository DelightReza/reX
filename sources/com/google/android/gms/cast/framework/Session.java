...
public abstract class Session {
    ...
    public final String getSessionId() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "getSessionId", zzaw.class.getSimpleName());
            }
        }
        return null;
    }
    ...
    public boolean isConnected() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "isConnected", zzaw.class.getSimpleName());
            }
        }
        return false;
    }
    ...
    public boolean isConnecting() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "isConnecting", zzaw.class.getSimpleName());
            }
        }
        return false;
    }
    ...
    public boolean isResuming() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "isResuming", zzaw.class.getSimpleName());
            }
        }
        return false;
    }
    ...
    protected final void notifyFailedToResumeSession(int i) {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "notifyFailedToResumeSession", zzaw.class.getSimpleName());
        }
    }
    ...
    protected final void notifyFailedToStartSession(int i) {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "notifyFailedToStartSession", zzaw.class.getSimpleName());
        }
    }
    ...
    protected final void notifySessionEnded(int i) {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "notifySessionEnded", zzaw.class.getSimpleName());
        }
    }
    ...
    public final int zzm() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "getSessionStartType", zzaw.class.getSimpleName());
            }
        }
        return 0;
    }
    ...
    public final IObjectWrapper zzn() {
        ...
        if (zzawVar != null) {
            try {
                ...
                zza.m298d(e, "Unable to call %s on %s.", "getWrappedObject", zzaw.class.getSimpleName());
            }
        }
        return null;
    }
