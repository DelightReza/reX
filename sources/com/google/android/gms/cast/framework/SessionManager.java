...
public class SessionManager {
    ...
    public void endCurrentSession(boolean z) {
        ...
        try {
            zza.m301i("End session for %s", this.zzc.getPackageName());
            this.zzb.zzj(true, z);
        } catch (RemoteException e) {
            zza.m298d(e, "Unable to call %s on %s.", "endCurrentSession", zzay.class.getSimpleName());
        }
    }
    ...
    public Session getCurrentSession() {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "getWrappedCurrentSession", zzay.class.getSimpleName());
            return null;
        }
    }
    ...
    public final IObjectWrapper zzb() {
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "getWrappedThis", zzay.class.getSimpleName());
            return null;
        }
    }
    ...
    final void zzc(CastStateListener castStateListener) {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "addCastStateListener", zzay.class.getSimpleName());
        }
    }
    ...
    public void addSessionManagerListener(SessionManagerListener sessionManagerListener, Class cls) {
        ...
        try {
            ...
            zza.m298d(e, "Unable to call %s on %s.", "addSessionManagerListener", zzay.class.getSimpleName());
        }
    }
}
