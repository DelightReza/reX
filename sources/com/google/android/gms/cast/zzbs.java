...
final class zzbs extends zzah {
    ...
    public final void zzh(String str, byte[] bArr) {
        zzbt.zzg.m297d("IGNORING: Receive (type=binary, ns=%s) <%d bytes>", str, Integer.valueOf(bArr.length));
    }
    ...
    public final void zzn(String str, double d, boolean z) {
        zzbt.zzg.m297d("Deprecated callback: \"onStatusReceived\"", new Object[0]);
    }
    ...
    public final void zzp(final String str, final String str2) {
        zzbt.zzg.m297d("Receive (type=text, ns=%s) %s", str, str2);
        zzbt.zzo(this.zza).post(new Runnable() { // from class: com.google.android.gms.cast.zzbp
            ...
            public final void run() {
                ...
                if (messageReceivedCallback != null) {
                    ...
                    zzbt.zzg.m297d("Discarded message for unknown namespace '%s'", str3);
                }
            }
        });
    }
