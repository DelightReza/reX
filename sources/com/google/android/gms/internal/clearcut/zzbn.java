...
public abstract class zzbn extends zzba {
        ...
        public final void zzb(long j) throws zzc {
            if (zzbn.zzfy && zzag() >= 10) {
                while ((j & (-128)) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    zzfd.zza(bArr, i, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
        ...
        public final void zzo(int i) throws zzc {
            if (zzbn.zzfy && zzag() >= 10) {
                while ((i & (-128)) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    zzfd.zza(bArr, i2, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
    ...
    static final class zzd extends zzbn {
        ...
        public final void zzb(long j) throws zzc {
            while (((-128) & j) != 0) {
                try {
                    this.zzgd.put((byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new zzc(e);
                }
        ...
        public final void zzo(int i) throws zzc {
            while ((i & (-128)) != 0) {
                try {
                    this.zzgd.put((byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                } catch (BufferOverflowException e) {
                    throw new zzc(e);
                }
        ...
        public final void zzb(long j) throws zzc {
            ...
            if (this.zzgi <= this.zzgh) {
                while (true) {
                    ...
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((((int) j) & Opcodes.LAND) | 128));
                    j >>>= 7;
                }
            } else {
                while (true) {
        ...
        public final void zzo(int i) throws zzc {
            ...
            if (this.zzgi <= this.zzgh) {
                while ((i & (-128)) != 0) {
                    long j2 = this.zzgi;
                    this.zzgi = j2 + 1;
                    zzfd.zza(j2, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
                j = this.zzgi;
            } else {
                while (true) {
                    ...
                    this.zzgi = j + 1;
                    zzfd.zza(j, (byte) ((i & Opcodes.LAND) | 128));
                    i >>>= 7;
                }
            }
            this.zzgi = 1 + j;
