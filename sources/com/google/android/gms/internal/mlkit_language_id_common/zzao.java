...
final class zzao implements ObjectEncoderContext {
    ...
    static {
        FieldDescriptor.Builder builder = FieldDescriptor.builder(PluginsConstants.Settings.KEY);
    ...
    private final zzao zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
    ...
    private final void zzn(int i) throws IOException {
        while (true) {
            ...
            OutputStream outputStream = this.zze;
            if (j == 0) {
                outputStream.write(i & Opcodes.LAND);
                return;
            } else {
    ...
    private final void zzo(long j) throws IOException {
        while (true) {
            ...
            OutputStream outputStream = this.zze;
            if (j2 == 0) {
                outputStream.write(((int) j) & Opcodes.LAND);
                return;
            } else {
                outputStream.write((((int) j) & Opcodes.LAND) | 128);
                j >>>= 7;
            }
        }
    }
