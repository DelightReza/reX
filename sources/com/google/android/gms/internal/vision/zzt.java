    ...
    protected final Object zzd() {
        ...
        synchronized (this.zzb) {
            ...
            try {
                ...
                AbstractC1051L.m319d("Cannot load thick client module, fall back to load optional module %s", str);
                try {
                    dynamiteModuleLoad = DynamiteModule.load(this.zza, DynamiteModule.PREFER_REMOTE, str);
                } catch (DynamiteModule.LoadingException e) {
                    AbstractC1051L.m321e(e, "Error loading optional module %s", str);
                    if (!this.zzf) {
                        AbstractC1051L.m319d("Broadcasting download intent for dependency %s", this.zze);
