...
public enum zziv implements zzag {
    ...
    CLOUD_TEXT_DETECT(Opcodes.ISHR),
    ...
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(DataTypes.EMPTY),
    AGGREGATED_CUSTOM_MODEL_INFERENCE(201),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(202),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(VoIPService.ID_INCOMING_CALL_PRENOTIFICATION),
