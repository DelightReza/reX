...
public final class zzi implements SessionManagerListener {
    ...
    public final /* bridge */ /* synthetic */ void onSessionResumed(Session session, boolean z) {
        zzk.zza.m297d("onSessionResumed with wasSuspended = %b", Boolean.valueOf(z));
        this.zza.zzi = (CastSession) session;
        this.zza.zzs();
    ...
    public final /* bridge */ /* synthetic */ void onSessionResuming(Session session, String str) {
        zzk.zza.m297d("onSessionResuming with sessionId = %s", str);
        this.zza.zzi = (CastSession) session;
        zzk zzkVar = this.zza;
    ...
    public final /* bridge */ /* synthetic */ void onSessionStarted(Session session, String str) {
        zzk.zza.m297d("onSessionStarted with sessionId = %s", str);
        this.zza.zzi = (CastSession) session;
        this.zza.zzs();
        zzk zzkVar = this.zza;
        zzkVar.zzh.zzf = str;
    ...
    public final /* bridge */ /* synthetic */ void onSessionStarting(Session session) {
        zzk.zza.m297d("onSessionStarting", new Object[0]);
        this.zza.zzi = (CastSession) session;
        if (this.zza.zzh != null) {
            zzk.zza.m302w("Start a session while there's already an active session. Create a new one.", new Object[0]);
        }
        this.zza.zzt();
        zzk zzkVar = this.zza;
    ...
    public final /* bridge */ /* synthetic */ void onSessionSuspended(Session session, int i) {
        zzk.zza.m297d("onSessionSuspended with reason = %d", Integer.valueOf(i));
        this.zza.zzi = (CastSession) session;
        this.zza.zzs();
        Preconditions.checkNotNull(this.zza.zzh);
        zzk zzkVar = this.zza;
