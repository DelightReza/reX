...
public final class zzk {
    ...
    static /* bridge */ /* synthetic */ void zzm(zzk zzkVar, int i) {
        zza.m297d("log session ended with error = %d", Integer.valueOf(i));
        zzkVar.zzs();
    ...
    static /* bridge */ /* synthetic */ void zzn(zzk zzkVar, SharedPreferences sharedPreferences, String str) {
        boolean z = false;
        if (zzkVar.zzx(str)) {
            zza.m297d("Use the existing ApplicationAnalyticsSession if it is available and valid.", new Object[0]);
            Preconditions.checkNotNull(zzkVar.zzh);
            return;
        }
        zzkVar.zzh = zzl.zzb(sharedPreferences, zzkVar.zzc);
        if (zzkVar.zzx(str)) {
            zza.m297d("Use the restored ApplicationAnalyticsSession if it is valid.", new Object[0]);
            Preconditions.checkNotNull(zzkVar.zzh);
            zzl.zza = zzkVar.zzh.zzd + 1;
            return;
        }
        zza.m297d("The restored ApplicationAnalyticsSession is not valid, create a new one.", new Object[0]);
    ...
    public final void zzs() {
        if (!zzw()) {
            zza.m302w("The analyticsSession should not be null for logging. Create a dummy one.", new Object[0]);
            zzt();
            return;
        }
    ...
    public final void zzt() {
        zza.m297d("Create a new ApplicationAnalyticsSession based on CastSession", new Object[0]);
    ...
    private final boolean zzw() {
        String str;
        if (this.zzh == null) {
            zza.m297d("The analytics session is null when matching with application ID.", new Object[0]);
            return false;
        }
        String strZzq = zzq();
        if (strZzq == null || (str = this.zzh.zzb) == null || !TextUtils.equals(str, strZzq)) {
            zza.m297d("The analytics session doesn't match the application ID %s", strZzq);
            return false;
        }
        Preconditions.checkNotNull(this.zzh);
        return true;
    ...
    private final boolean zzx(String str) {
        ...
        zza.m297d("The analytics session doesn't match the receiver session ID %s.", str);
        return false;
    }
}
