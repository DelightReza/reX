...
public final class zzbn {
    ...
    public static /* synthetic */ void zze(zzbn zzbnVar) {
        zza.m301i("transfer with type = %d has timed out", Integer.valueOf(zzbnVar.zzf));
        zzbnVar.zzp(101);
    }
    ...
    static /* bridge */ /* synthetic */ void zzg(zzbn zzbnVar) {
        int i = zzbnVar.zzf;
        if (i == 0) {
            zza.m297d("No need to notify transferred if the transfer type is unknown", new Object[0]);
            return;
        }
        SessionState sessionState = zzbnVar.zzi;
        if (sessionState == null) {
            zza.m297d("No need to notify with null sessionState", new Object[0]);
            return;
        }
        zza.m297d("notify transferred with type = %d, sessionState = %s", Integer.valueOf(i), zzbnVar.zzi);
    ...
    static /* bridge */ /* synthetic */ void zzi(zzbn zzbnVar) {
        if (zzbnVar.zzi == null) {
            zza.m297d("skip restoring session state due to null SessionState", new Object[0]);
            return;
        }
        RemoteMediaClient remoteMediaClientZzo = zzbnVar.zzo();
        if (remoteMediaClientZzo == null) {
            zza.m297d("skip restoring session state due to null RemoteMediaClient", new Object[0]);
        } else {
            zza.m297d("resume SessionState to current session", new Object[0]);
    ...
    private final RemoteMediaClient zzo() {
        ...
        if (sessionManager == null) {
            zza.m297d("skip transferring as SessionManager is null", new Object[0]);
            return null;
        }
        ...
        zza.m297d("skip transferring as CastSession is null", new Object[0]);
        return null;
    }
    ...
    private final void zzp(int i) {
        ...
        zza.m297d("notify failed transfer with type = %d, reason = %d", Integer.valueOf(this.zzf), Integer.valueOf(i));
    ...
    final /* synthetic */ void zzk(Exception exc) {
        zza.m303w(exc, "Fail to store SessionState", new Object[0]);
        zzp(100);
    }
    ...
    public final void zzl(MediaRouter.RouteInfo routeInfo, MediaRouter.RouteInfo routeInfo2, CallbackToFutureAdapter.Completer completer) {
        ...
        if (new HashSet(this.zzc).isEmpty()) {
            zza.m297d("No need to prepare transfer without any callback", new Object[0]);
            completer.set(null);
            return;
        }
        if (routeInfo.getPlaybackType() != 1) {
            zza.m297d("No need to prepare transfer when transferring from local", new Object[0]);
            completer.set(null);
            return;
        }
        RemoteMediaClient remoteMediaClientZzo = zzo();
        if (remoteMediaClientZzo == null || !remoteMediaClientZzo.hasMediaSession()) {
            zza.m297d("No need to prepare transfer when there is no media session", new Object[0]);
            completer.set(null);
            return;
        }
        Logger logger = zza;
        logger.m297d("Prepare route transfer for changing endpoint", new Object[0]);
        ...
        this.zzf = i;
        this.zzh = completer;
        logger.m297d("notify transferring with type = %d", Integer.valueOf(i));
        Iterator it = new HashSet(this.zzc).iterator();
        while (it.hasNext()) {
    ...
    public final void zzm(SessionTransferCallback sessionTransferCallback) {
        zza.m297d("register callback = %s", sessionTransferCallback);
