...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    private void clearOutput() {
        updateOutput(new CueGroup(ImmutableList.m437of(), getPresentationTimeUs(this.lastRendererPositionUs)));
    }
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        Log.m287e("TextRenderer", "Subtitle decoding failed. streamFormat=" + this.streamFormat, subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
