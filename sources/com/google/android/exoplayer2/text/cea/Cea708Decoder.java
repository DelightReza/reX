...
public final class Cea708Decoder extends CeaDecoder {
            ...
            if (i == 2 || i == 3) {
                if (z) {
                    if (i == 3) {
                        ...
                        if (i3 != -1 && i2 != (i3 + 1) % 4) {
                            resetCueBuilders();
                            Log.m290w("Cea708Decoder", "Sequence number discontinuity. previous=" + this.previousSequenceNumber + " current=" + i2);
                        }
                        ...
                        if (dtvCcPacket2 == null) {
                            Log.m286e("Cea708Decoder", "Encountered DTVCC_PACKET_DATA before DTVCC_PACKET_START");
                        } else {
    ...
    private void processCurrentPacket() {
        ...
        if (dtvCcPacket.currentIndex != (dtvCcPacket.packetSize * 2) - 1) {
            Log.m285d("Cea708Decoder", "DtvCcPacket ended prematurely; size is " + ((this.currentDtvCcPacket.packetSize * 2) - 1) + ", but current index is " + this.currentDtvCcPacket.currentIndex + " (sequence number " + this.currentDtvCcPacket.sequenceNumber + ");");
        }
        ...
        while (true) {
            ...
            if (bits == 7) {
                ...
                if (bits < 7) {
                    Log.m290w("Cea708Decoder", "Invalid extended service number: " + bits);
                }
            }
            if (bits2 == 0) {
                if (bits != 0) {
                    Log.m290w("Cea708Decoder", "serviceNumber is non-zero (" + bits + ") when blockSize is 0");
                }
                    ...
                    if (bits3 == 16) {
                        ...
                        if (bits4 <= 31) {
                            ...
                            if (bits4 <= 127) {
                                ...
                                Log.m290w("Cea708Decoder", "Invalid extended command: " + bits4);
                            }
                            z = true;
                        }
                    } else if (bits3 <= 31) {
                        ...
                        if (bits3 <= 127) {
                            ...
                            Log.m290w("Cea708Decoder", "Invalid base command: " + bits3);
                        }
                        z = true;
                    }
                }
    ...
    private void handleC0Command(int i) {
        if (i != 0) {
            ...
            switch (i) {
                ...
                default:
                    if (i >= 17 && i <= 23) {
                        Log.m290w("Cea708Decoder", "Currently unsupported COMMAND_EXT1 Command: " + i);
                        this.captionChannelPacketData.skipBits(8);
                        break;
                    } else if (i >= 24 && i <= 31) {
                        Log.m290w("Cea708Decoder", "Currently unsupported COMMAND_P16 Command: " + i);
                        this.captionChannelPacketData.skipBits(16);
                        break;
                    } else {
                        Log.m290w("Cea708Decoder", "Invalid C0 command: " + i);
                        break;
                    }
                    break;
            }
    ...
    private void handleC1Command(int i) {
        ...
        switch (i) {
            ...
            case 150:
            default:
                Log.m290w("Cea708Decoder", "Invalid C1 command: " + i);
                break;
                ...
                default:
                    switch (i) {
                        ...
                        case Opcodes.LAND /* 127 */:
                            ...
                            break;
                        default:
                            Log.m290w("Cea708Decoder", "Invalid G2 character: " + i);
                            break;
                    }
            }
            return;
    ...
    private void handleG3Character(int i) {
        ...
        Log.m290w("Cea708Decoder", "Invalid G3 character: " + i);
