...
public abstract class WebvttCueParser {
    ...
    static {
        ...
        map.put(PluginsConstants.Settings.RED, Integer.valueOf(Color.rgb(255, 0, 0)));
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List list) {
        ...
        try {
            ...
            Log.m290w("WebvttCueParser", "Skipping cue with bad header: " + matcher.group());
            return null;
        }
    }
        ...
        while (matcher.find()) {
            ...
            try {
                if ("line".equals(str2)) {
                    ...
                    Log.m290w("WebvttCueParser", "Unknown cue setting " + str2 + ":" + str3);
                }
            } catch (NumberFormatException unused) {
                Log.m290w("WebvttCueParser", "Skipping bad cue setting: " + matcher.group());
            }
        }
    }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 0;
            default:
                Log.m290w("WebvttCueParser", "Invalid anchor value: " + str);
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m290w("WebvttCueParser", "Invalid 'vertical' value: " + str);
        return TLObject.FLAG_31;
    }
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (str) {
            ...
            case "start":
                return 1;
            default:
                Log.m290w("WebvttCueParser", "Invalid alignment value: " + str);
                return 2;
        }
    }
    ...
    private static void applyEntity(String str, SpannableStringBuilder spannableStringBuilder) {
        ...
        switch (str) {
            ...
            case "nbsp":
                ...
                break;
            default:
                Log.m290w("WebvttCueParser", "ignoring unsupported entity: '&" + str + ";'");
                break;
        }
    }
        ...
        private static Layout.Alignment convertTextAlignment(int i) {
            if (i != 1) {
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            Log.m290w("WebvttCueParser", "Unknown textAlignment: " + i);
                            return null;
                        }
                    }
                }
