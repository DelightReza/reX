...
final class SsaStyle {
    ...
    public static SsaStyle fromStyleLine(String str, Format format) {
        ...
        int i = format.length;
        if (length != i) {
            Log.m290w("SsaStyle", Util.formatInvariant("Skipping malformed 'Style:' line (expected %s values, found %s): '%s'", Integer.valueOf(i), Integer.valueOf(strArrSplit.length), str));
            return null;
        }
        try {
            ...
            Log.m291w("SsaStyle", "Skipping malformed 'Style:' line: '" + str + "'", e);
            return null;
        }
    }
    ...
    public static int parseAlignment(String str) throws NumberFormatException {
        ...
        Log.m290w("SsaStyle", "Ignoring unknown alignment: " + str);
        return -1;
    }
    ...
    private static int parseBorderStyle(String str) throws NumberFormatException {
        ...
        Log.m290w("SsaStyle", "Ignoring unknown BorderStyle: " + str);
        return -1;
    }
    ...
    public static Integer parseColor(String str) throws NumberFormatException {
        ...
        try {
            ...
            Log.m291w("SsaStyle", "Failed to parse color expression: '" + str + "'", e);
            return null;
        }
    }
    ...
    private static float parseFontSize(String str) {
        try {
            ...
            Log.m291w("SsaStyle", "Failed to parse font size: '" + str + "'", e);
    ...
    private static boolean parseBooleanValue(String str) throws NumberFormatException {
        try {
            ...
            Log.m291w("SsaStyle", "Failed to parse boolean value: '" + str + "'", e);
            return false;
        }
    }
    ...
    static final class Overrides {
        ...
        private static PointF parsePosition(String str) {
            ...
            if (zFind) {
                if (zFind2) {
                    Log.m288i("SsaStyle.Overrides", "Override has both \\pos(x,y) and \\move(x1,y1,x2,y2); using \\pos values. override='" + str + "'");
                }
