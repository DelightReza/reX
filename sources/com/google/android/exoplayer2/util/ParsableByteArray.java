...
public final class ParsableByteArray {
    ...
    /* renamed from: LF */
    private static final char[] f223LF = {'\n'};
    private static final ImmutableSet SUPPORTED_CHARSETS_FOR_READLINE = ImmutableSet.m447of((Object) Charsets.US_ASCII, (Object) Charsets.UTF_8, (Object) Charsets.UTF_16, (Object) Charsets.UTF_16BE, (Object) Charsets.UTF_16LE);
    private byte[] data;
    private int limit;
    ...
    */
    ...
    private void skipLineTerminator(Charset charset) {
        if (readCharacterIfInList(charset, CR_AND_LF) == '\r') {
            readCharacterIfInList(charset, f223LF);
        }
    }
