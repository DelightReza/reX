...
final class MediaPeriodHolder {
    ...
    public TrackSelectorResult selectTracks(float f, Timeline timeline) {
        TrackSelectorResult trackSelectorResultSelectTracks = this.trackSelector.selectTracks(this.rendererCapabilities, getTrackGroups(), this.info.f200id, timeline);
    ...
    private static void releaseMediaPeriod(MediaSourceList mediaSourceList, MediaPeriod mediaPeriod) {
        try {
            ...
            Log.m287e("MediaPeriodHolder", "Period release failed.", e);
        }
    }
}
