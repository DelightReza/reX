...
public final class TrackGroupArray implements Bundleable {
    ...
    public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.source.TrackGroupArray$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return TrackGroupArray.m2518$r8$lambda$1S9rBhP1Lx6SEltOcjGNddKmPg(bundle);
        }
    };
    ...
    /* renamed from: $r8$lambda$1S9rBhP1-Lx6SEltOcjGNddKmPg, reason: not valid java name */
    public static /* synthetic */ TrackGroupArray m2518$r8$lambda$1S9rBhP1Lx6SEltOcjGNddKmPg(Bundle bundle) {
        ...
        while (i < this.trackGroups.size()) {
            ...
            for (int i3 = i2; i3 < this.trackGroups.size(); i3++) {
                if (((TrackGroup) this.trackGroups.get(i)).equals(this.trackGroups.get(i3))) {
                    Log.m287e("TrackGroupArray", "", new IllegalArgumentException("Multiple identical TrackGroups added to one TrackGroupArray."));
                }
            }
            i = i2;
        }
