    ...
    */
    protected void onChildSourceInfoRefreshed(com.google.android.exoplayer2.Timeline r15) {
        ...
        L36:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r7 = r7.f210id
        ...
        L98:
            ...
            com.google.android.exoplayer2.source.MediaSource$MediaPeriodId r15 = r15.f210id
    ...
    private void setPreparePositionOverrideToUnpreparedMaskingPeriod(long j) {
        ...
        int indexOfPeriod = this.timeline.getIndexOfPeriod(maskingMediaPeriod.f210id.periodUid);
        if (indexOfPeriod == -1) {
            return;
        }
