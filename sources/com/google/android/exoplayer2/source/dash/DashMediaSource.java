...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public MediaPeriod createPeriod(MediaSource.MediaPeriodId mediaPeriodId, Allocator allocator, long j) {
        ...
        this.periodsById.put(dashMediaPeriod.f214id, dashMediaPeriod);
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        this.periodsById.remove(dashMediaPeriod.f214id);
    }
    ...
    void onManifestLoadCompleted(ParsingLoadable parsingLoadable, long j, long j2) {
        ...
        if (dashManifest.dynamic) {
            if (periodCount - i > dashManifest.getPeriodCount()) {
                Log.m290w("DashMediaSource", "Loaded out of sync manifest");
            } else {
                long j4 = this.expiredManifestPublishTimeUs;
                if (j4 != -9223372036854775807L && dashManifest.publishTimeMs * 1000 <= j4) {
                    Log.m290w("DashMediaSource", "Loaded stale dynamic manifest: " + dashManifest.publishTimeMs + ", " + this.expiredManifestPublishTimeUs);
                } else {
                    this.staleManifestReloadAttempt = 0;
                }
            }
    ...
    public void onUtcTimestampResolutionError(IOException iOException) {
        Log.m287e("DashMediaSource", "Failed to resolve time offset.", iOException);
        processManifest(true);
    }
    ...
    */
    ...
    private static final class DashTimeline extends Timeline {
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(z ? this.manifest.getPeriod(i).f217id : null, z ? Integer.valueOf(this.firstPeriodId + i) : null, 0, this.manifest.getPeriodDurationUs(i), Util.msToUs(this.manifest.getPeriod(i).startMs - this.manifest.getPeriod(0).startMs) - this.offsetInFirstPeriodUs);
        }
