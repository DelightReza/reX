    ...
    public static final class SegmentTemplate extends MultiSegmentBase {
        ...
        public RangedUri getInitialization(Representation representation) {
            ...
            if (urlTemplate != null) {
                ...
                return new RangedUri(urlTemplate.buildUri(format.f196id, 0L, format.bitrate, 0L), 0L, -1L);
            }
        ...
        public RangedUri getSegmentUrl(Representation representation, long j) {
            ...
            Format format = representation.format;
            return new RangedUri(urlTemplate.buildUri(format.f196id, j, format.bitrate, j3), 0L, -1L);
        }
