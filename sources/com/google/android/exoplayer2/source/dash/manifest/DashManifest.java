...
public class DashManifest implements FilterableManifest {
    ...
    public final DashManifest copy(List list) {
        ...
        while (true) {
            ...
            if (((StreamKey) linkedList.peek()).periodIndex != i) {
                ...
                arrayList.add(new Period(period.f217id, period.startMs - j, copyAdaptationSets(period.adaptationSets, linkedList), period.eventStreams));
            }
            i++;
        }
    ...
    private static ArrayList copyAdaptationSets(List list, LinkedList linkedList) {
        ...
        do {
            ...
            arrayList.add(new AdaptationSet(adaptationSet.f215id, adaptationSet.type, arrayList2, adaptationSet.accessibilityDescriptors, adaptationSet.essentialProperties, adaptationSet.supplementalProperties));
