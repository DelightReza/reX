...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    private SingleSampleMediaSource(String str, MediaItem.SubtitleConfiguration subtitleConfiguration, DataSource.Factory factory, long j, LoadErrorHandlingPolicy loadErrorHandlingPolicy, boolean z, Object obj) {
        ...
        MediaItem mediaItemBuild = new MediaItem.Builder().setUri(Uri.EMPTY).setMediaId(subtitleConfiguration.uri.toString()).setSubtitleConfigurations(ImmutableList.m438of((Object) subtitleConfiguration)).setTag(obj).build();
        ...
        String str2 = subtitleConfiguration.f198id;
