...
public final class TrackGroup implements Bundleable {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            this.hashCode = ((527 + this.f212id.hashCode()) * 31) + Arrays.hashCode(this.formats);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && TrackGroup.class == obj.getClass()) {
            ...
            if (this.f212id.equals(trackGroup.f212id) && Arrays.equals(this.formats, trackGroup.formats)) {
                return true;
            }
        }
        return false;
    ...
    public Bundle toBundle() {
        ...
        bundle.putString(FIELD_ID, this.f212id);
        return bundle;
    }
    ...
    private static void logErrorMessage(String str, String str2, String str3, int i) {
        Log.m287e("TrackGroup", "", new IllegalStateException("Different " + str + " combined in one TrackGroup: '" + str2 + "' (track 0) and '" + str3 + "' (track " + i + ")"));
    }
}
