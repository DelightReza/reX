...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    protected void onStreamChanged(Format[] formatArr, long j, long j2) {
        ...
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.m290w("MediaCodecRenderer", "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
        ...
        if (i == 2) {
            ...
            if (i2 >= 23) {
                try {
                    ...
                    Log.m291w("MediaCodecRenderer", "Failed to update the DRM session, releasing the codec instead.", e);
                    releaseCodec();
                    return true;
                }
            }
    ...
    */
    private void maybeInitCodecWithFallback(android.media.MediaCrypto r8, boolean r9) throws java.lang.Exception {
        ...
        L61:
            ...
            com.google.android.exoplayer2.util.Log.m290w(r4, r3)     // Catch: java.lang.Exception -> L74
            r5 = 50
        ...
        L77:
            ...
            com.google.android.exoplayer2.util.Log.m291w(r4, r5, r3)
            ...
            goto La7
        La1:
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r2 = com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.DecoderInitializationException.m2479$$Nest$mcopyWithFallbackException(r2, r4)
    ...
    private List getAvailableCodecInfos(boolean z) {
        ...
        if (!decoderInfos2.isEmpty()) {
            Log.m290w("MediaCodecRenderer", "Drm session requires secure decoder for " + this.inputFormat.sampleMimeType + ", but no secure decoder available. Trying to proceed with " + decoderInfos2 + ".");
        }
    ...
    private void initCodec(MediaCodecInfo mediaCodecInfo, MediaCrypto mediaCrypto) {
        ...
        try {
            ...
            if (!mediaCodecInfo.isFormatSupported(this.inputFormat)) {
                Log.m290w("MediaCodecRenderer", Util.formatInvariant("Format exceeds selected codec's capabilities [%s, %s]", Format.toLogString(this.inputFormat), str));
            }
            this.codecInfo = mediaCodecInfo;
