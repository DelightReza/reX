...
public final class MediaCodecInfo {
    ...
    private void logNoSupport(String str) {
        Log.m285d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }

    private void logAssumedSupport(String str) {
        Log.m285d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + "]");
    }
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i) {
        ...
        Log.m290w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i + " to " + i2 + "]");
        return i2;
    }
    ...
    private static final class Api29 {
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i2, double d) {
            ...
            MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline1.m275m();
            MediaCodecInfo.VideoCapabilities.PerformancePoint performancePointM274m = MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline0.m274m(i, i2, (int) d);
            for (int i3 = 0; i3 < supportedPerformancePoints.size(); i3++) {
                if (MediaCodecInfo$Api29$$ExternalSyntheticApiModelOutline2.m276m(supportedPerformancePoints.get(i3)).covers(performancePointM274m)) {
                    return 2;
                }
            }
            return 1;
