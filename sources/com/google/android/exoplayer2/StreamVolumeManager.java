...
final class StreamVolumeManager {
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener) {
        ...
        try {
            ...
            Log.m291w("StreamVolumeManager", "Error registering stream volume receiver", e);
        }
    }
    ...
    public void release() {
        ...
        if (volumeChangeReceiver != null) {
            try {
                ...
                Log.m291w("StreamVolumeManager", "Error unregistering stream volume receiver", e);
            }
            this.receiver = null;
        }
    }
    ...
    private static int getVolumeFromManager(AudioManager audioManager, int i) {
        try {
            ...
            Log.m291w("StreamVolumeManager", "Could not retrieve stream volume for stream type " + i, e);
