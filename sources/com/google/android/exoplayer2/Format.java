...
public final class Format implements Bundleable {
    ...
    public static class Builder {
        ...
        public Builder setId(int i) {
            this.f197id = Integer.toString(i);
            return this;
        }
    ...
    public String toString() {
        return "Format(" + this.f196id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public static String toLogString(Format format) {
        ...
        if (format.drmInitData != null) {
            ...
            while (true) {
                ...
                if (uuid.equals(AbstractC0933C.COMMON_PSSH_UUID)) {
                    linkedHashSet.add("cenc");
                } else if (uuid.equals(AbstractC0933C.CLEARKEY_UUID)) {
                    linkedHashSet.add("clearkey");
                } else if (uuid.equals(AbstractC0933C.PLAYREADY_UUID)) {
                    linkedHashSet.add("playready");
                } else if (uuid.equals(AbstractC0933C.WIDEVINE_UUID)) {
                    linkedHashSet.add("widevine");
                } else if (uuid.equals(AbstractC0933C.UUID_NIL)) {
            ...
            sb.append(", drm=[");
            Joiner.m429on(',').appendTo(sb, linkedHashSet);
            sb.append(']');
        }
        ...
        if (format.selectionFlags != 0) {
            ...
            if ((format.selectionFlags & 1) != 0) {
                arrayList.add(PluginsConstants.Settings.DEFAULT);
            }
            if ((format.selectionFlags & 2) != 0) {
                arrayList.add("forced");
            }
            sb.append(", selectionFlags=[");
            Joiner.m429on(',').appendTo(sb, arrayList);
            sb.append("]");
        }
        if (format.roleFlags != 0) {
            ...
            sb.append(", roleFlags=[");
            Joiner.m429on(',').appendTo(sb, arrayList2);
            sb.append("]");
        }
        return sb.toString();
    }
    ...
    public Bundle toBundle(boolean z) {
        ...
        bundle.putString(FIELD_ID, this.f196id);
