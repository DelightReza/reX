    ...
    private final class LoadTask extends Handler implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                if (!this.released) {
                    Log.m287e("LoadTask", "Unexpected error loading stream", e2);
                ...
                Log.m287e("LoadTask", "Unexpected exception loading stream", e3);
                obtainMessage(2, new UnexpectedLoaderException(e3)).sendToTarget();
            } catch (OutOfMemoryError e4) {
                if (this.released) {
                    return;
                }
                Log.m287e("LoadTask", "OutOfMemory error loading stream", e4);
        ...
        public void handleMessage(Message message) {
            ...
            if (i2 == 1) {
                try {
                    ...
                    Log.m287e("LoadTask", "Unexpected exception handling load completed", e);
