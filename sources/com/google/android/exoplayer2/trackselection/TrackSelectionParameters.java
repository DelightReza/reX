...
public class TrackSelectionParameters implements Bundleable {
    ...
    public static class Builder {
        ...
        public Builder() {
            ...
            this.preferredVideoMimeTypes = ImmutableList.m437of();
            this.preferredVideoRoleFlags = 0;
            this.preferredAudioLanguages = ImmutableList.m437of();
            ...
            this.preferredAudioMimeTypes = ImmutableList.m437of();
            this.preferredTextLanguages = ImmutableList.m437of();
        ...
        private void m282x58dbf263(Context context) {
            CaptioningManager captioningManager;
            if ((Util.SDK_INT >= 23 || Looper.myLooper() != null) && (captioningManager = (CaptioningManager) context.getSystemService("captioning")) != null && captioningManager.isEnabled()) {
                this.preferredTextRoleFlags = 1088;
                Locale locale = captioningManager.getLocale();
                if (locale != null) {
                    this.preferredTextLanguages = ImmutableList.m438of((Object) Util.getLocaleLanguageTag(locale));
                }
            }
        }
