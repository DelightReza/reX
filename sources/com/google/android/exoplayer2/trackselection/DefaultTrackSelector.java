...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    private DefaultTrackSelector(TrackSelectionParameters trackSelectionParameters, ExoTrackSelection.Factory factory, Context context) {
        ...
        if (this.parameters.constrainAudioChannelCountToDeviceCapabilities && context == null) {
            Log.m290w("DefaultTrackSelector", "Audio channel count constraints cannot be applied without reference to Context. Build the track selector instance with one of the non-deprecated constructors that take a Context argument.");
        }
    }
    ...
    public /* synthetic */ List lambda$selectAudioTrack$3(Parameters parameters, boolean z, int i, TrackGroup trackGroup, int[] iArr) {
        return AudioTrackInfo.createForTrackGroup(i, trackGroup, parameters, iArr, z, new Predicate() { // from class: com.google.android.exoplayer2.trackselection.DefaultTrackSelector$$ExternalSyntheticLambda8
            ...
            /* renamed from: or */
            public /* synthetic */ java.util.function.Predicate m278or(java.util.function.Predicate predicate) {
    ...
    private Pair selectTracksForType(int i, MappingTrackSelector.MappedTrackInfo mappedTrackInfo, int[][][] iArr, TrackInfo.Factory factory, Comparator comparator) {
        int i2;
        RandomAccess randomAccessM438of;
                    ...
                    while (i5 < trackGroup.length) {
                        ...
                        if (zArr[i5] || selectionEligibility == 0) {
                            ...
                            if (selectionEligibility == 1) {
                                randomAccessM438of = ImmutableList.m438of((Object) trackInfo);
                            } else {
                                ArrayList arrayList2 = new ArrayList();
                                ...
                                randomAccessM438of = arrayList2;
                            }
                            i2 = rendererCount;
                            arrayList.add(randomAccessM438of);
                        }
                        i5++;
                        rendererCount = i2;
                    }
    ...
    */
    ...
    static final class TextTrackInfo extends TrackInfo implements Comparable {
        ...
        public TextTrackInfo(int i, TrackGroup trackGroup, int i2, Parameters parameters, int i3, String str) {
            ImmutableList immutableListM438of;
            int formatLanguageScore;
            super(i, trackGroup, i2);
            int i4 = 0;
            this.isWithinRendererCapabilities = DefaultTrackSelector.isSupported(i3, false);
            ...
            if (parameters.preferredTextLanguages.isEmpty()) {
                immutableListM438of = ImmutableList.m438of((Object) "");
            } else {
                immutableListM438of = parameters.preferredTextLanguages;
            }
            int i6 = 0;
            while (true) {
                if (i6 >= immutableListM438of.size()) {
                    i6 = ConnectionsManager.DEFAULT_DATACENTER_ID;
                    formatLanguageScore = 0;
                    break;
                } else {
                    formatLanguageScore = DefaultTrackSelector.getFormatLanguageScore(this.format, (String) immutableListM438of.get(i6), parameters.selectUndeterminedTextLanguage);
                    if (formatLanguageScore > 0) {
                        break;
                    } else {
                        i6++;
    ...
    private static class SpatializerWrapperV32 {
        ...
        public void ensureInitialized(final DefaultTrackSelector defaultTrackSelector, Looper looper) {
            if (this.listener == null && this.handler == null) {
                ...
                spatializer.addOnSpatializerStateChangedListener(new MediaRoute2Provider$$ExternalSyntheticLambda2(handler), this.listener);
            }
        }
