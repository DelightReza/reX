...
public final class PlaybackParameters implements Bundleable {
    ...
    public static final Bundleable.Creator CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.PlaybackParameters$$ExternalSyntheticLambda0
        ...
        public final Bundleable fromBundle(Bundle bundle) {
            return PlaybackParameters.m2287$r8$lambda$Emm7RfmlhRqcQf5RbiZCuXgDco(bundle);
        }
    };
    ...
    /* renamed from: $r8$lambda$Emm-7RfmlhRqcQf5RbiZCuXgDco, reason: not valid java name */
    public static /* synthetic */ PlaybackParameters m2287$r8$lambda$Emm7RfmlhRqcQf5RbiZCuXgDco(Bundle bundle) {
