...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        AudioFocusRequest.Builder builderM256m;
        AudioFocusRequest audioFocusRequest = this.audioFocusRequest;
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                AudioFocusManager$$ExternalSyntheticApiModelOutline1.m257m();
                builderM256m = NowPlayingCard$$ExternalSyntheticApiModelOutline0.m210m(this.focusGainToRequest);
            } else {
                AudioFocusManager$$ExternalSyntheticApiModelOutline1.m257m();
                builderM256m = AudioFocusManager$$ExternalSyntheticApiModelOutline0.m256m(this.audioFocusRequest);
            }
            this.audioFocusRequest = builderM256m.setAudioAttributes(((AudioAttributes) Assertions.checkNotNull(this.audioAttributes)).getAudioAttributesV21().audioAttributes).setWillPauseWhenDucked(willPauseWhenDucked()).setOnAudioFocusChangeListener(this.focusListener).build();
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes) {
        ...
        switch (audioAttributes.usage) {
            case 0:
                Log.m290w("AudioFocusManager", "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 15:
            default:
                Log.m290w("AudioFocusManager", "Unidentified audio usage: " + audioAttributes.usage);
                return 0;
            case 16:
                return 4;
        }
    ...
    public void handlePlatformAudioFocusChange(int i) {
        ...
        if (i == -1) {
            ...
            Log.m290w("AudioFocusManager", "Unknown focus change type: " + i);
        }
    }
