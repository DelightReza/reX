...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && EventMessage.class == obj.getClass()) {
            ...
            if (this.durationMs == eventMessage.durationMs && this.f207id == eventMessage.f207id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f207id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
