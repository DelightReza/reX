...
public final class H263Reader implements ElementaryStreamReader {
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i, String str) {
        ...
        if (bits == 15) {
            ...
            if (bits3 == 0) {
                Log.m290w("H263Reader", "Invalid aspect ratio");
            } else {
                f = bits2 / bits3;
            }
        } else {
        ...
        if (parsableBitArray.readBits(2) != 0) {
            Log.m290w("H263Reader", "Unhandled video object layer shape");
        }
        parsableBitArray.skipBit();
        ...
        if (parsableBitArray.readBit()) {
            if (bits4 == 0) {
                Log.m290w("H263Reader", "Invalid vop_increment_time_resolution");
            } else {
                int i2 = 0;
                ...
                if (i3 != 1) {
                    if (i3 != 2) {
                        if (i3 != 3) {
                            ...
                            Log.m290w("H263Reader", "Unexpected start code value");
                            reset();
                        } else {
