...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return FragmentedMp4Extractor.m2443$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM();
        }
    ...
    /* renamed from: $r8$lambda$EbWg24HAil-uodvRuBK7KGHbPlM, reason: not valid java name */
    public static /* synthetic */ Extractor[] m2443$r8$lambda$EbWg24HAiluodvRuBK7KGHbPlM() {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f205id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f205id)));
        ...
        while (i < size2) {
            ...
            ((TrackBundle) this.trackBundles.get(track2.f205id)).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f205id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (fullAtomVersion == 0) {
            ...
            if (fullAtomVersion != 1) {
                Log.m290w("FragmentedMp4Extractor", "Skipping unsupported emsg version: " + fullAtomVersion);
                return;
            }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws ParserException {
        ...
        if (nextTrackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m290w("FragmentedMp4Extractor", "Ignoring negative offset to sample data.");
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (uuid == null) {
                    Log.m290w("FragmentedMp4Extractor", "Skipped pssh atom (failed to extract uuid)");
                } else {
