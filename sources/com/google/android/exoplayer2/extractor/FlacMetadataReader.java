...
public abstract class FlacMetadataReader {
    ...
    public static boolean readMetadataBlock(ExtractorInput extractorInput, FlacStreamMetadataHolder flacStreamMetadataHolder) {
        ...
        if (bits == 6) {
            ...
            flacStreamMetadataHolder.flacStreamMetadata = flacStreamMetadata.copyWithPictureFrames(ImmutableList.m438of((Object) PictureFrame.fromPictureBlock(parsableByteArray)));
            return bit;
        }
