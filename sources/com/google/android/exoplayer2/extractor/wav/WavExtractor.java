...
public final class WavExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.wav.WavExtractor$$ExternalSyntheticLambda0
        ...
        public final Extractor[] createExtractors() {
            return WavExtractor.m2472$r8$lambda$hJhS_tAOYd6XskUkvwF6Vj5ae0();
        }
    ...
    /* renamed from: $r8$lambda$hJhS_-tAOYd6XskUkvwF6Vj5ae0, reason: not valid java name */
    public static /* synthetic */ Extractor[] m2472$r8$lambda$hJhS_tAOYd6XskUkvwF6Vj5ae0() {
    ...
    private void skipToSampleData(ExtractorInput extractorInput) throws ParserException {
        ...
        if (length != -1 && this.dataEndPosition > length) {
            Log.m290w("WavExtractor", "Data exceeds input length: " + this.dataEndPosition + ", " + length);
    ...
    private static final class ImaAdPcmOutputWriter implements OutputWriter {
        ...
        private static final int[] STEP_TABLE = {7, 8, 9, 10, 11, 12, 13, 14, 16, 17, 19, 21, 23, 25, 28, 31, 34, 37, 41, 45, 50, 55, 60, 66, 73, 80, 88, 97, 107, Opcodes.FNEG, Opcodes.IXOR, Opcodes.D2L, Opcodes.IFGT, Opcodes.LRETURN, Opcodes.ARRAYLENGTH, 209, 230, 253, 279, 307, 337, 371, 408, 449, 494, 544, 598, 658, 724, 796, 876, 963, 1060, 1166, 1282, 1411, 1552, 1707, 1878, 2066, 2272, 2499, 2749, 3024, 3327, 3660, 4026, 4428, 4871, 5358, 5894, 6484, 7132, 7845, 8630, 9493, 10442, 11487, 12635, 13899, 15289, 16818, 18500, 20350, 22385, 24623, 27086, 29794, 32767};
