...
public abstract class DecoderAudioRenderer extends BaseRenderer implements MediaClock {
    ...
    public void render(long j, long j2) throws ExoPlaybackException {
        ...
        if (this.decoder != null) {
            try {
                ...
                Log.m287e(TAG, "Audio codec error", e6);
    ...
    protected void onStreamChanged(Format[] formatArr, long j, long j2) {
        ...
        if (i == this.pendingOutputStreamOffsetsUs.length) {
            Log.m290w(TAG, "Too many stream changes, so dropping offset: " + this.pendingOutputStreamOffsetsUs[this.pendingOutputStreamOffsetCount - 1]);
        } else {
    ...
    private void maybeInitDecoder() throws ExoPlaybackException {
        ...
        try {
            ...
            Log.m287e(TAG, "Audio codec error", e);
    ...
    private final class AudioSinkListener implements AudioSink.Listener {
        ...
        public void onAudioSinkError(Exception exc) {
            Log.m287e(DecoderAudioRenderer.TAG, "Audio sink error", exc);
    ...
    private static final class Api23 {
        public static void setAudioSinkPreferredDevice(AudioSink audioSink, Object obj) {
            audioSink.setPreferredDevice(DecoderAudioRenderer$Api23$$ExternalSyntheticApiModelOutline0.m267m(obj));
        }
    }
}
