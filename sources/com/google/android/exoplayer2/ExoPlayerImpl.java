...
final class ExoPlayerImpl extends BasePlayer implements ExoPlayer {
    ...
    public ExoPlayerImpl(ExoPlayer.Builder builder, Player player) {
        ...
        try {
            Log.m288i("ExoPlayerImpl", "Init " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.18.3] [" + Util.DEVICE_DEBUG_INFO + "]");
    ...
    public void seekTo(int i, long j, int i2, boolean z) {
        ...
        if (timeline.isEmpty() || i < timeline.getWindowCount()) {
            this.pendingOperationAcks++;
            if (isPlayingAd()) {
                Log.m290w("ExoPlayerImpl", "seekTo ignored because an ad is playing");
    ...
    public void stop(boolean z) {
        ...
        stopInternal(z, null);
        this.currentCueGroup = new CueGroup(ImmutableList.m437of(), this.playbackInfo.positionUs);
    }

    @Override // com.google.android.exoplayer2.Player
    public void release() {
        AudioTrack audioTrack;
        Log.m288i("ExoPlayerImpl", "Release " + Integer.toHexString(System.identityHashCode(this)) + " [ExoPlayerLib/2.18.3] [" + Util.DEVICE_DEBUG_INFO + "] [" + ExoPlayerLibraryInfo.registeredModules() + "]");
        verifyApplicationThread();
    ...
    public void setVideoTextureView(TextureView textureView) {
        ...
        if (textureView.getSurfaceTextureListener() != null) {
            Log.m290w("ExoPlayerImpl", "Replacing existing SurfaceTextureListener.");
        }
    ...
    */
    ...
    private PlaybackInfo maskTimelineAndPosition(PlaybackInfo playbackInfo, Timeline timeline, Pair pair) {
        ...
        if (timeline.isEmpty()) {
            ...
            PlaybackInfo playbackInfoCopyWithLoadingMediaPeriodId = playbackInfoCopyWithTimeline.copyWithNewPosition(dummyPeriodForEmptyTimeline, jMsToUs, jMsToUs, jMsToUs, 0L, TrackGroupArray.EMPTY, this.emptyTrackSelectorResult, ImmutableList.m437of()).copyWithLoadingMediaPeriodId(dummyPeriodForEmptyTimeline);
            playbackInfoCopyWithLoadingMediaPeriodId.bufferedPositionUs = playbackInfoCopyWithLoadingMediaPeriodId.positionUs;
    ...
    private void removeSurfaceCallbacks() {
        ...
        if (textureView != null) {
            if (textureView.getSurfaceTextureListener() != this.componentListener) {
                Log.m290w("ExoPlayerImpl", "SurfaceTextureListener already unset or replaced.");
            } else {
    ...
    private void verifyApplicationThread() {
        ...
        if (Thread.currentThread() != getApplicationLooper().getThread()) {
            ...
            Log.m291w("ExoPlayerImpl", invariant, this.hasNotifiedFullWrongThreadWarning ? null : new IllegalStateException());
    ...
    private static final class Api31 {
        public static PlayerId registerMediaMetricsListener(Context context, ExoPlayerImpl exoPlayerImpl, boolean z) {
            ...
            if (mediaMetricsListenerCreate == null) {
                Log.m290w("ExoPlayerImpl", "MediaMetricsService unavailable.");
