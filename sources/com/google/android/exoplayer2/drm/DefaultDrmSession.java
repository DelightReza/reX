...
class DefaultDrmSession implements DrmSession {
    ...
    public void acquire(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        if (this.referenceCount < 0) {
            Log.m286e("DefaultDrmSession", "Session reference count less than zero: " + this.referenceCount);
    ...
    public void release(DrmSessionEventListener.EventDispatcher eventDispatcher) {
        ...
        if (i <= 0) {
            Log.m286e("DefaultDrmSession", "release() called on a session that's already fully released.");
            return;
        }
        int i2 = i - 1;
    ...
    private void doLicense(boolean z) {
        ...
        if (this.state == 4 || restoreKeys()) {
            ...
            Log.m285d("DefaultDrmSession", "Offline license has expired or will expire soon. Remaining seconds: " + licenseDurationRemainingSec);
            postKeyRequest(bArr, 2, z);
        }
    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!AbstractC0933C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void onError(final Exception exc, int i) {
        ...
        Log.m287e("DefaultDrmSession", "DRM session error", exc);
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                ...
                Log.m291w("DefaultDrmSession", "Key/provisioning request produced an unexpected exception. Not retrying.", e2);
