...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static MediaMetricsListener create(Context context) {
        MediaMetricsManager mediaMetricsManagerM265m = MediaMetricsListener$$ExternalSyntheticApiModelOutline6.m265m(context.getSystemService("media_metrics"));
        if (mediaMetricsManagerM265m == null) {
            return null;
        }
        return new MediaMetricsListener(context, mediaMetricsManagerM265m.createPlaybackSession());
    }
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ...
        if (mediaPeriodId == null || !mediaPeriodId.isAd()) {
            ...
            this.metricsBuilder = MediaMetricsListener$$ExternalSyntheticApiModelOutline4.m263m().setPlayerName("ExoPlayerLib").setPlayerVersion("2.18.3");
    ...
    private void maybeUpdateMetricsBuilderValues(Player player, AnalyticsListener.Events events) {
        ...
        if (events.contains(2) && this.metricsBuilder != null && (drmInitData = getDrmInitData(player.getCurrentTracks().getGroups())) != null) {
            MediaMetricsListener$$ExternalSyntheticApiModelOutline5.m264m(Util.castNonNull(this.metricsBuilder)).setDrmType(getDrmType(drmInitData));
        }
    ...
    private void maybeReportPlaybackError(long j) throws NumberFormatException {
        ...
        this.playbackSession.reportPlaybackErrorEvent(MediaMetricsListener$$ExternalSyntheticApiModelOutline1.m260m().setTimeSinceCreatedMillis(j - this.startTimeMs).setErrorCode(errorInfo.errorCode).setSubErrorCode(errorInfo.subErrorCode).setException(playbackException).build());
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType != this.currentNetworkType) {
            ...
            this.playbackSession.reportNetworkEvent(MediaMetricsListener$$ExternalSyntheticApiModelOutline3.m262m().setNetworkType(networkType).setTimeSinceCreatedMillis(j - this.startTimeMs).build());
        }
    }
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != iResolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            this.playbackSession.reportPlaybackStateEvent(MediaMetricsListener$$ExternalSyntheticApiModelOutline0.m259m().setState(this.currentPlaybackState).setTimeSinceCreatedMillis(j - this.startTimeMs).build());
        }
    }
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        TrackChangeEvent.Builder timeSinceCreatedMillis = MediaMetricsListener$$ExternalSyntheticApiModelOutline2.m261m(i).setTimeSinceCreatedMillis(j - this.startTimeMs);
        if (format != null) {
    ...
    private static ErrorInfo getErrorInfo(PlaybackException playbackException, Context context, boolean z) throws NumberFormatException {
        ...
        if (th instanceof DrmSession.DrmSessionException) {
            ...
            if (i2 >= 23 && MediaMetricsListener$$ExternalSyntheticApiModelOutline7.m266m(th2)) {
    ...
    private static int getDrmType(DrmInitData drmInitData) {
        for (int i = 0; i < drmInitData.schemeDataCount; i++) {
            ...
            if (uuid.equals(AbstractC0933C.WIDEVINE_UUID)) {
                return 3;
            }
            if (uuid.equals(AbstractC0933C.PLAYREADY_UUID)) {
                return 2;
            }
            if (uuid.equals(AbstractC0933C.CLEARKEY_UUID)) {
                return 6;
            }
        }
        return 1;
