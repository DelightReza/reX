...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet, int i) {
        ...
        setOutlineProvider(new ViewOutlineProvider() { // from class: com.google.android.material.timepicker.ClockFaceView.2
        ...
        this.valueAccessibilityDelegate = new AccessibilityDelegateCompat() { // from class: com.google.android.material.timepicker.ClockFaceView.3
    ...
    protected void updateLayoutParams() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    @Override // com.google.android.material.timepicker.RadialViewGroup
    public void setRadius(int i) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (i != getRadius()) {
            super.setRadius(i);
    ...
    private int getSelectedIndex() {
        for (int i = 0; i < this.textViewPool.size(); i++) {
            TextView textView = (TextView) this.textViewPool.valueAt(i);
