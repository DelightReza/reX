...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i, int i2) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (Build.VERSION.SDK_INT < 23) {
            textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, R$styleable.Chip_android_textColor));
        }
    ...
    private void drawDebug(Canvas canvas, Rect rect) {
        ...
        if (paint != null) {
            ...
            this.debugPaint.setColor(ColorUtils.setAlphaComponent(Opcodes.V_PREVIEW, Opcodes.LAND));
