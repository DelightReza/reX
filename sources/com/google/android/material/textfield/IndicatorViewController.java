...
final class IndicatorViewController {
    ...
    public IndicatorViewController(TextInputLayout textInputLayout) {
        ...
        this.captionFadeInAnimationDuration = MotionUtils.resolveThemeDuration(context, R$attr.motionDurationMedium4, Opcodes.GOTO);
        this.captionFadeOutAnimationDuration = MotionUtils.resolveThemeDuration(context, R$attr.motionDurationShort4, Opcodes.GOTO);
