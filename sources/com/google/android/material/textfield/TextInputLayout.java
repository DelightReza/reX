...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private void updateCollapsingTextDimens(int i) throws NoSuchMethodException, SecurityException {
    ...
    private void updateEditTextHeight(int i) throws NoSuchMethodException, SecurityException {
        if (this.editText == null) {
            return;
        }
            ...
            try {
                height = StaticLayoutBuilderCompat.obtain(this.placeholderText, textPaint, i).setIsRtl(getLayoutDirection() == 1).setIncludePad(true).setLineSpacing(this.placeholderTextView.getLineSpacingExtra(), this.placeholderTextView.getLineSpacingMultiplier()).setStaticLayoutBuilderConfigurer(new StaticLayoutBuilderConfigurer() { // from class: com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda2
                    ...
                    public final void configure(StaticLayout.Builder builder) {
                        TextInputLayout.m2709$r8$lambda$i0Jcz4Bf4UX4sNHgXUgOqqaBI(this.f$0, builder);
                    }
    ...
    /* renamed from: $r8$lambda$i0Jcz4Bf4UX4s-NHgXUgOqqaB-I, reason: not valid java name */
    public static /* synthetic */ void m2709$r8$lambda$i0Jcz4Bf4UX4sNHgXUgOqqaBI(TextInputLayout textInputLayout, StaticLayout.Builder builder) {
        if (Build.VERSION.SDK_INT >= 23) {
            builder.setBreakStrategy(textInputLayout.placeholderTextView.getBreakStrategy());
        } else {
    ...
    void animateToExpansionFraction(float f) {
        ...
        if (this.animator == null) {
            ...
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), R$attr.motionDurationMedium4, Opcodes.GOTO));
