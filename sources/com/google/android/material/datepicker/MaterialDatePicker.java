...
public class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final void onCreate(Bundle bundle) throws Resources.NotFoundException {
        ...
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(bundle.getParcelable("DATE_SELECTOR_KEY"));
        this.calendarConstraints = (CalendarConstraints) bundle.getParcelable("CALENDAR_CONSTRAINTS_KEY");
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(bundle.getParcelable("DAY_VIEW_DECORATOR_KEY"));
    ...
    /* JADX WARN: Type inference failed for: r3v4, types: [com.google.android.material.datepicker.PickerFragment] */
    /* JADX WARN: Type inference failed for: r3v7, types: [com.google.android.material.datepicker.MaterialCalendar] */
    /* JADX WARN: Type inference failed for: r3v8, types: [com.google.android.material.datepicker.MaterialTextInputPicker] */
    private void startPickerFragment() {
        ...
        ?? NewInstance = fragmentFindFragmentByTag instanceof PickerFragment ? (PickerFragment) fragmentFindFragmentByTag : 0;
        if (NewInstance == 0) {
            if (this.inputMode == 1) {
                getDateSelector();
                NewInstance = MaterialTextInputPicker.newInstance(null, themeResId, this.calendarConstraints);
            } else {
                getDateSelector();
                NewInstance = MaterialCalendar.newInstance(null, themeResId, this.calendarConstraints, null);
                this.calendar = NewInstance;
            }
        }
        this.pickerFragment = NewInstance;
        NewInstance.addOnSelectionChangedListener(new OnSelectionChangedListener() { // from class: com.google.android.material.datepicker.MaterialDatePicker.2
        });
        updateTitle();
    ...
    private DateSelector getDateSelector() {
        WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m4m(getArguments().getParcelable("DATE_SELECTOR_KEY"));
        return null;
    }
