...
final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final FieldDescriptor MAP_KEY_DESC = FieldDescriptor.builder(PluginsConstants.Settings.KEY).withProperty(AtProtobuf.builder().tag(1).build()).build();
    ...
    private static final ObjectEncoder DEFAULT_MAP_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.proto.ProtobufDataEncoderContext$$ExternalSyntheticLambda0
        ...
        public final void encode(Object obj, Object obj2) {
            ProtobufDataEncoderContext.m2750$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs((Map.Entry) obj, (ObjectEncoderContext) obj2);
        }
    };

    /* renamed from: $r8$lambda$HMpWU6Ryr444SahjVbEVRqty-xs, reason: not valid java name */
    public static /* synthetic */ void m2750$r8$lambda$HMpWU6Ryr444SahjVbEVRqtyxs(Map.Entry entry, ObjectEncoderContext objectEncoderContext) {
    ...
    static /* synthetic */ class C13411 {
        ...
        static {
            ...
            try {
                f376x531607dd[Protobuf.IntEncoding.SIGNED.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f376x531607dd[Protobuf.IntEncoding.FIXED.ordinal()] = 3;
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            ...
            int i2 = C13411.f376x531607dd[protobuf.intEncoding().ordinal()];
            if (i2 == 1) {
    ...
    ProtobufDataEncoderContext add(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            Protobuf protobuf = getProtobuf(fieldDescriptor);
            int i = C13411.f376x531607dd[protobuf.intEncoding().ordinal()];
            if (i == 1) {
                writeVarInt32(protobuf.tag() << 3);
                writeVarInt64(j);
                return this;
