...
public class AnalyticsDeferredProxy {
    ...
    public static /* synthetic */ void $r8$lambda$9OFGxA2N0nOG8dDPC_xdm7JYRUo(AnalyticsDeferredProxy analyticsDeferredProxy, Provider provider) {
        ...
        Logger.getLogger().m451d("AnalyticsConnector now available.");
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            Logger.getLogger().m451d("Registered Firebase Analytics listener.");
        ...
        Logger.getLogger().m459w("Could not register Firebase Analytics listener; a listener is already registered.");
    }
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        Logger.getLogger().m451d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
        ...
        if (analyticsConnectorHandleRegisterAnalyticsConnectorListener2 != null) {
            Logger.getLogger().m459w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
        }
