...
public abstract class Utils {
    ...
    public static Task race(Task task, Task task2) {
        ...
        Continuation continuation = new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.Utils$$ExternalSyntheticLambda3
            ...
            public final Object then(Task task3) {
                return Utils.m2742$r8$lambda$fNSdSg4hoYBdxTuelQo0XNfdA(taskCompletionSource, task3);
            }
        };
    ...
    public static /* synthetic */ Void m2742$r8$lambda$fNSdSg4hoYBdxTuelQo0XNfdA(TaskCompletionSource taskCompletionSource, Task task) {
    ...
    public static Task callTask(final Executor executor, final Callable callable) {
        ...
        executor.execute(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.Utils$$ExternalSyntheticLambda1
            ...
            public final void run() {
                Utils.m2743$r8$lambda$kWusQGH24kVwU03QEe1Xf63uWY(callable, executor, taskCompletionSource);
            }
        });
        return taskCompletionSource.getTask();
    }
    ...
    public static /* synthetic */ void m2743$r8$lambda$kWusQGH24kVwU03QEe1Xf63uWY(Callable callable, Executor executor, final TaskCompletionSource taskCompletionSource) {
        try {
            ((Task) callable.call()).continueWith(executor, new Continuation() { // from class: com.google.firebase.crashlytics.internal.common.Utils$$ExternalSyntheticLambda4
                ...
                public final Object then(Task task) {
                    return Utils.m2741$r8$lambda$YlsqxsjAEowli87HCBuZ6Mr9C4(taskCompletionSource, task);
                }
            });
        } catch (Exception e) {
    ...
    public static /* synthetic */ Object m2741$r8$lambda$YlsqxsjAEowli87HCBuZ6Mr9C4(TaskCompletionSource taskCompletionSource, Task task) {
        if (task.isSuccessful()) {
