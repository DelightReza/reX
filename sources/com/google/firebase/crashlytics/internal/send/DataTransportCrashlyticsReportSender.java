...
public class DataTransportCrashlyticsReportSender {
    ...
    public static DataTransportCrashlyticsReportSender create(Context context, SettingsProvider settingsProvider, OnDemandCounter onDemandCounter) {
        ...
        Encoding encodingM249of = Encoding.m249of("json");
        Transformer transformer = DEFAULT_TRANSFORM;
        return new DataTransportCrashlyticsReportSender(new ReportQueue(transportFactoryNewFactory.getTransport("FIREBASE_CRASHLYTICS_REPORT", CrashlyticsReport.class, encodingM249of, transformer), settingsProvider.getSettingsSync(), onDemandCounter), transformer);
    }
