...
class QueueFileLogStore implements FileLogStore {
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Logger.getLogger().m454e("A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void openLogFile() {
        if (this.logFile == null) {
            try {
                ...
                Logger.getLogger().m454e("Could not open log file: " + this.workingFile, e);
            }
        }
    }
    ...
    private void doWriteToLog(long j, String str) {
        ...
        try {
            ...
            Logger.getLogger().m454e("There was a problem writing to the Crashlytics log.", e);
        }
    }
}
