...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    /* renamed from: os */
    private final CrashlyticsReport.Session.OperatingSystem f372os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f372os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof CrashlyticsReport.Session) {
            ...
            if (this.generator.equals(session.getGenerator()) && this.identifier.equals(session.getIdentifier()) && this.startedAt == session.getStartedAt() && ((l = this.endedAt) != null ? l.equals(session.getEndedAt()) : session.getEndedAt() == null) && this.crashed == session.isCrashed() && this.app.equals(session.getApp()) && ((user = this.user) != null ? user.equals(session.getUser()) : session.getUser() == null) && ((operatingSystem = this.f372os) != null ? operatingSystem.equals(session.getOs()) : session.getOs() == null) && ((device = this.device) != null ? device.equals(session.getDevice()) : session.getDevice() == null) && ((immutableList = this.events) != null ? immutableList.equals(session.getEvents()) : session.getEvents() == null) && this.generatorType == session.getGeneratorType()) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f372os;
        ...
        ImmutableList immutableList = this.events;
    ...
    static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f373os;
        ...
        public CrashlyticsReport.Session build() {
            ...
            return new AutoValue_CrashlyticsReport_Session(this.generator, this.identifier, this.startedAt.longValue(), this.endedAt, this.crashed.booleanValue(), this.app, this.user, this.f373os, this.device, this.events, this.generatorType.intValue());
        }
    }
}
