...
final class C1329xc2f5febc extends CrashlyticsReport.Session.Event.Application.Execution.Exception {
    ...
    private C1329xc2f5febc(String str, String str2, ImmutableList immutableList, CrashlyticsReport.Session.Event.Application.Execution.Exception exception, int i) {
        this.type = str;
        this.reason = str2;
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.Execution.Exception.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.Execution.Exception build() {
            ...
            return new C1329xc2f5febc(this.type, this.reason, this.frames, this.causedBy, this.overflowCount.intValue());
        }
    }
}
