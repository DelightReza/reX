...
final class C1318xb26d2aa8 extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch {
    private final String arch;
    private final String buildId;
    private final String libraryName;

    private C1318xb26d2aa8(String str, String str2, String str3) {
        this.arch = str;
    ...
    static final class Builder extends CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch.Builder {
        ...
        public CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch build() {
            ...
            return new C1318xb26d2aa8(this.arch, this.libraryName, this.buildId);
        }
    }
}
