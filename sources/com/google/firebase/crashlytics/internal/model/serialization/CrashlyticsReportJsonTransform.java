...
public class CrashlyticsReportJsonTransform {
    ...
    private static CrashlyticsReport.Session.Event.Application.Execution.Exception parseEventExecutionException(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                case "frames":
                    builder.setFrames(parseArray(jsonReader, new CrashlyticsReportJsonTransform$$ExternalSyntheticLambda6()));
                    break;
                case "reason":
    ...
    public static CrashlyticsReport.CustomAttribute parseCustomAttribute(JsonReader jsonReader) throws IOException {
        ...
        while (jsonReader.hasNext()) {
            String strNextName = jsonReader.nextName();
            strNextName.getClass();
            if (strNextName.equals(PluginsConstants.Settings.KEY)) {
    ...
    private static ImmutableList parseArray(JsonReader jsonReader, ObjectParser objectParser) throws IOException {
