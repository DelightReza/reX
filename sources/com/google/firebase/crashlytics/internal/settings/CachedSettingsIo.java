...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() throws Throwable {
        ...
        Logger.getLogger().m451d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m454e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m457v("Settings file does not exist.");
                    jSONObject = null;
                }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) throws Throwable {
        ...
        Logger.getLogger().m457v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m454e("Failed to cache settings", e);
