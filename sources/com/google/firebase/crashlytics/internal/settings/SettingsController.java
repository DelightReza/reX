...
public class SettingsController implements SettingsProvider {
    ...
    public Task loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, Executor executor) throws Throwable {
                ...
                if (cachedSettings != null) {
                    ...
                    if (settingsJson != null) {
                        ...
                        if (!SettingsCacheBehavior.IGNORE_CACHE_EXPIRATION.equals(settingsCacheBehavior) && settingsJson.isExpired(currentTimeMillis)) {
                            Logger.getLogger().m457v("Cached settings have expired.");
                            return null;
                        }
                        try {
                            Logger.getLogger().m457v("Returning cached settings.");
                            return settingsJson;
                        } catch (Exception e) {
                            e = e;
                            settings = settingsJson;
                            Logger.getLogger().m454e("Failed to get cached settings", e);
                            return settings;
                        }
                    }
                    Logger.getLogger().m454e("Failed to parse cached settings data.", null);
                    return null;
                }
                Logger.getLogger().m451d("No cached settings data found.");
            }
            return null;
        } catch (Exception e2) {
            e = e2;
    ...
    public void logSettings(JSONObject jSONObject, String str) {
        Logger.getLogger().m451d(str + jSONObject.toString());
    }
