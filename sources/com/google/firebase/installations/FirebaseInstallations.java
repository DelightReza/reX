...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C13453.f377xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C13453.f378xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C13453 {
        ...
        static {
            ...
            try {
                f378xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f378xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            ...
            try {
                f377xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
