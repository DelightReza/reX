...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                EnhancedIntentService.m2753$r8$lambda$9b4qTh6k1amVzUe1kAE6oojA28(this.f$0, intent, taskCompletionSource);
            }
        });
    ...
    public static /* synthetic */ void m2753$r8$lambda$9b4qTh6k1amVzUe1kAE6oojA28(EnhancedIntentService enhancedIntentService, Intent intent, TaskCompletionSource taskCompletionSource) {
