    ...
    public Task startMessagingService(final Context context, final Intent intent) {
        ...
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.messaging.FcmBroadcastProcessor$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return FcmBroadcastProcessor.m2754$r8$lambda$7tuBEF0Y9HKYiHL1KguBHpRmY(context, intent, z2, task);
            }
        });
    }

    /* renamed from: $r8$lambda$-7tuBEF0Y9HKY-iHL1KguBHpRmY, reason: not valid java name */
    public static /* synthetic */ Task m2754$r8$lambda$7tuBEF0Y9HKYiHL1KguBHpRmY(Context context, Intent intent, boolean z, Task task) {
