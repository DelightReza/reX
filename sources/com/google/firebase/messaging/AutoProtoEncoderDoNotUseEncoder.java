...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor MESSAGINGCLIENTEVENTEXTENSION_DESCRIPTOR = FieldDescriptor.m461of("messagingClientEventExtension");
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder {
        ...
        private static final FieldDescriptor PRIORITY_DESCRIPTOR = FieldDescriptor.builder(PluginsConstants.MenuItemProperties.PRIORITY).withProperty(AtProtobuf.builder().tag(8).build()).build();
