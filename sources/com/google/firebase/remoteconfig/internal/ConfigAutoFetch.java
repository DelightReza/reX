...
public class ConfigAutoFetch {
    ...
    private String parseAndValidateConfigUpdateMessage(String str) {
        int iIndexOf = str.indexOf(Opcodes.LSHR);
        int iLastIndexOf = str.lastIndexOf(Opcodes.LUSHR);
    ...
    */
            ...
            try {
                ...
                return Tasks.whenAllComplete((Task<?>[]) new Task[]{taskFetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigAutoFetch$$ExternalSyntheticLambda0
                    ...
                    public final Object then(Task task2) {
                        return ConfigAutoFetch.m2766$r8$lambda$ANmcpkzunHxZeIZpnwJj9GhHSM(this.f$0, taskFetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
                    }
                });
            } catch (Throwable th) {
                th = th;
    ...
    public static /* synthetic */ Task m2766$r8$lambda$ANmcpkzunHxZeIZpnwJj9GhHSM(ConfigAutoFetch configAutoFetch, Task task, Task task2, long j, int i, Task task3) throws JSONException {
