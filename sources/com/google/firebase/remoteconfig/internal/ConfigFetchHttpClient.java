...
import androidx.core.content.p000pm.PackageInfoCompat;
...
public class ConfigFetchHttpClient {
    ...
    @Keep
    ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date) throws JSONException, FirebaseRemoteConfigClientException, IOException {
    ...
    private JSONObject createFetchRequestBody(String str, String str2, Map map, Long l) throws PackageManager.NameNotFoundException, FirebaseRemoteConfigClientException {
