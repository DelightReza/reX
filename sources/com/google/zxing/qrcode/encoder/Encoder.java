...
public abstract class Encoder {
    ...
    */
    public static com.google.zxing.qrcode.encoder.QRCode encode(java.lang.String r6, com.google.zxing.qrcode.decoder.ErrorCorrectionLevel r7, java.util.Map r8) throws java.lang.NumberFormatException, com.google.zxing.WriterException, java.io.UnsupportedEncodingException {
        /*
            if (r8 == 0) goto Lc
        ...
        L81:
            ...
            throw r6
        L89:
            com.google.zxing.qrcode.decoder.Version r1 = recommendVersion(r7, r2, r3, r0)
        L8d:
        ...
        La0:
            ...
            com.google.zxing.qrcode.decoder.Version$ECBlocks r6 = r1.getECBlocksForLevel(r7)
            ...
            com.google.zxing.common.BitArray r6 = interleaveWithECBytes(r5, r3, r0, r6)
        ...
        Lfe:
            ...
            com.google.zxing.qrcode.encoder.MatrixUtil.buildMatrix(r6, r7, r1, r8, r3)
            r0.setMatrix(r3)
            return r0
        */
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException, UnsupportedEncodingException {
        int i = C14551.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
