...
public class DeletedMessagePreviewCell extends LinearLayout {
    ...
    public DeletedMessagePreviewCell(Context context, INavigationLayout iNavigationLayout) {
        ...
        MessageObject[] messageObjectArr = {new MessageObject(UserConfig.selectedAccount, tL_message, true, false), messageObject};
        ...
        tL_message.message = Deobfuscator$AyuGram4A$TMessagesProj.getString(-2019306328861834790L);
        int i = iCurrentTimeMillis - 3480;
        tL_message.date = i;
        ...
        tL_peerUser.user_id = 1L;
        tL_message.from_id = new TLRPC.TL_peerUser();
        TLRPC.TL_message tL_message2 = new TLRPC.TL_message();
        tL_message2.message = Deobfuscator$AyuGram4A$TMessagesProj.getString(-2019306479185690150L);
        tL_message2.date = i;
        ...
        tL_message2.ayuDeleted = true;
        MessageObject messageObject = new MessageObject(UserConfig.selectedAccount, tL_message2, true, false);
        messageObject.customReplyName = Deobfuscator$AyuGram4A$TMessagesProj.getString(-2019306676754185766L);
        ...
        while (true) {
            ...
            this.cells[i2].setDelegate(new ChatMessageCell.ChatMessageCellDelegate() { // from class: com.radolyn.ayugram.preferences.components.DeletedMessagePreviewCell.1
                ...
                public void didPressReplyMessage(ChatMessageCell chatMessageCell, int i3, float f, float f2, boolean z) {
                    DeletedMessagePreviewCell.this.progress = 0;
                    chatMessageCell.invalidate();
                    AndroidUtilities.cancelRunOnUIThread(DeletedMessagePreviewCell.this.cancelProgress);
                    AndroidUtilities.runOnUIThread(DeletedMessagePreviewCell.this.cancelProgress, 5000L);
                }

                @Override // org.telegram.ui.Cells.ChatMessageCell.ChatMessageCellDelegate
                public boolean isProgressLoading(ChatMessageCell chatMessageCell, int i3) {
                    return i3 == DeletedMessagePreviewCell.this.progress;
                }
            });
        ...
        chatMessageCellArr[1].setForceSemiTransparent(Integer.valueOf(AyuConfig.semiTransparentDeletedMessages ? 3 : 4));
    }
    ...
    public void invalidateTime() {
        MessageObject messageObject = this.messageObjects[1];
        messageObject.messageOwner.ayuDeleted = false;
        this.cells[1].setMessageObject(messageObject, null, false, false, false);
        MessageObject messageObject2 = this.messageObjects[1];
        messageObject2.messageOwner.ayuDeleted = true;
        this.cells[1].setMessageObject(messageObject2, null, false, false, false);
        this.cells[1].invalidate();
    }

    public void animateSemiTransparency(boolean z) {
        this.cells[1].setForceSemiTransparent(null);
        this.cells[1].setIgnoreDeletedAlpha(true);
        MessageObject messageObject = this.messageObjects[1];
        messageObject.messageOwner.ayuDeleted = false;
        this.cells[1].setMessageObject(messageObject, null, false, false, false);
        this.cells[1].setForceSemiTransparent(Integer.valueOf(z ? 1 : 2));
        this.cells[1].setIgnoreDeletedAlpha(false);
        MessageObject messageObject2 = this.messageObjects[1];
        messageObject2.messageOwner.ayuDeleted = true;
        this.cells[1].setMessageObject(messageObject2, null, false, false, false);
        this.cells[1].invalidate();
