...
class SVGParser {
    ...
    private enum SVGElem {
        ...
        static {
            for (SVGElem sVGElem : values()) {
                if (sVGElem == SWITCH) {
                    cache.put(PluginsConstants.Settings.TYPE_SWITCH, sVGElem);
    ...
    private static class ColourKeywords {
        ...
        static {
            ...
            map.put(PluginsConstants.Settings.RED, Integer.valueOf(Opcodes.V_PREVIEW));
    ...
    private static class FontWeightKeywords {
        ...
        static {
            ...
            map.put("lighter", -1);
            map.put("100", 100);
            map.put("200", Integer.valueOf(DataTypes.EMPTY));
            map.put("300", Integer.valueOf(DataTypes.UNIT));
            map.put("400", 400);
            map.put("500", 500);
            map.put("600", 600);
            map.put("700", 700);
    ...
    SVG parse(InputStream inputStream, boolean z) throws IOException {
    ...
    private class SAXHandler extends DefaultHandler2 {
        ...
        /* synthetic */ SAXHandler(SVGParser sVGParser, C07321 c07321) {
            this();
        }
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) throws SVGParseException {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            ...
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[sVGElemFromString.ordinal()]) {
                case 1:
                    svg(attributes);
                    break;
                case 2:
    ...
    public void endElement(String str, String str2, String str3) {
        ...
        if ("http://www.w3.org/2000/svg".equals(str) || "".equals(str)) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGElem[SVGElem.fromString(str2).ordinal()];
    ...
    private void parseAttributesSVG(SVG.Svg svg, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                svg.f83x = parseLength(strTrim);
            } else if (i2 == 2) {
                svg.f84y = parseLength(strTrim);
            } else if (i2 == 3) {
    ...
    /* renamed from: g */
    private void m179g(Attributes attributes) throws SVGParseException {
    ...
    private void parseAttributesUse(SVG.Use use, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                use.f107x = parseLength(strTrim);
            } else if (i2 == 2) {
                use.f108y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                use.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesImage(SVG.Image image, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                image.f68x = parseLength(strTrim);
            } else if (i2 == 2) {
                image.f69y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                image.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesRect(SVG.Rect rect, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                rect.f81x = parseLength(strTrim);
            } else if (i2 == 2) {
                rect.f82y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                rect.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesCircle(SVG.Circle circle, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 12:
                    circle.f61cx = parseLength(strTrim);
                    break;
                case 13:
                    circle.f62cy = parseLength(strTrim);
                    break;
                case 14:
                    SVG.Length length = parseLength(strTrim);
                    circle.f63r = length;
    ...
    private void parseAttributesEllipse(SVG.Ellipse ellipse, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                ...
                case 11:
                    SVG.Length length2 = parseLength(strTrim);
                    ellipse.f67ry = length2;
                    if (length2.isNegative()) {
                        throw new SVGParseException("Invalid <ellipse> element. ry cannot be negative");
                    }
                    break;
                case 12:
                    ellipse.f64cx = parseLength(strTrim);
                    break;
                case 13:
                    ellipse.f65cy = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesLine(SVG.Line line, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    line.f70x1 = parseLength(strTrim);
                    break;
                case 16:
                    line.f72y1 = parseLength(strTrim);
                    break;
                case 17:
                    line.f71x2 = parseLength(strTrim);
                    break;
                case 18:
                    line.f73y2 = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    private void parseAttributesTextPosition(SVG.TextPositionedContainer textPositionedContainer, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                textPositionedContainer.f97x = parseLengthList(strTrim);
            } else if (i2 == 2) {
                textPositionedContainer.f98y = parseLengthList(strTrim);
            } else if (i2 == 19) {
                textPositionedContainer.f95dx = parseLengthList(strTrim);
            } else if (i2 == 20) {
                textPositionedContainer.f96dy = parseLengthList(strTrim);
            }
        }
    }
    ...
    private void parseAttributesTRef(SVG.TRef tRef, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 6 && ("".equals(attributes.getURI(i)) || "http://www.w3.org/1999/xlink".equals(attributes.getURI(i)))) {
                tRef.href = strTrim;
            }
        }
    }
    ...
    */
    private void parseAttributesGradient(com.caverock.androidsvg.SVG.GradientElement r5, org.xml.sax.Attributes r6) throws com.caverock.androidsvg.SVGParseException {
        ...
        L1:
            ...
            int[] r2 = com.caverock.androidsvg.SVGParser.C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr
    ...
    private void parseAttributesLinearGradient(SVG.SvgLinearGradient svgLinearGradient, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()]) {
                case 15:
                    svgLinearGradient.f86x1 = parseLength(strTrim);
                    break;
                case 16:
                    svgLinearGradient.f88y1 = parseLength(strTrim);
                    break;
                case 17:
                    svgLinearGradient.f87x2 = parseLength(strTrim);
                    break;
                case 18:
                    svgLinearGradient.f89y2 = parseLength(strTrim);
                    break;
            }
        }
    }
    ...
    */
    ...
    private void parseAttributesStop(SVG.Stop stop, Attributes attributes) {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 37) {
    ...
    private void parseAttributesClipPath(SVG.ClipPath clipPath, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            String strTrim = attributes.getValue(i).trim();
            if (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()] == 38) {
    ...
    */
    ...
    private void parseAttributesMask(SVG.Mask mask, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            int i2 = C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(attributes.getLocalName(i)).ordinal()];
            if (i2 == 1) {
                mask.f74x = parseLength(strTrim);
            } else if (i2 == 2) {
                mask.f75y = parseLength(strTrim);
            } else if (i2 == 3) {
                SVG.Length length = parseLength(strTrim);
                mask.width = length;
                if (length.isNegative()) {
    ...
    private void parseAttributesCore(SVG.SvgElementBase svgElementBase, Attributes attributes) throws SVGParseException {
        for (int i = 0; i < attributes.getLength(); i++) {
            ...
            if (qName.equals("id") || qName.equals("xml:id")) {
                svgElementBase.f85id = attributes.getValue(i).trim();
                return;
            }
            if (qName.equals("xml:space")) {
                String strTrim = attributes.getValue(i).trim();
                if (PluginsConstants.Settings.DEFAULT.equals(strTrim)) {
    ...
    static void processStyleProperty(SVG.Style style, String str, String str2) {
        ...
        try {
            switch (C07321.$SwitchMap$com$caverock$androidsvg$SVGParser$SVGAttr[SVGAttr.fromString(str).ordinal()]) {
                case 47:
                ...
                case TypeReference.METHOD_INVOCATION_TYPE_ARGUMENT /* 73 */:
                    if (str2.indexOf(Opcodes.IUSHR) < 0) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:118:0x0282 A[SYNTHETIC] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
