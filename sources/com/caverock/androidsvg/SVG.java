...
public class SVG {
    ...
    static class Length implements Cloneable {
        ...
        float floatValueX(SVGAndroidRenderer sVGAndroidRenderer) {
            switch (C07301.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()]) {
                case 9:
        ...
        float floatValue(float f) {
            int i = C07301.$SwitchMap$com$caverock$androidsvg$SVG$Unit[this.unit.ordinal()];
            if (i == 1) {
                return this.value;
            }
            switch (i) {
    ...
    static class Switch extends Group {
        ...
        @Override // com.caverock.androidsvg.SVG.Group, com.caverock.androidsvg.SVG.SvgObject
        String getNodeName() {
            return PluginsConstants.Settings.TYPE_SWITCH;
        }
    }
    ...
    static class Mask extends SvgConditionalContainer implements NotDirectlyRendered {
        ...
        @Override // com.caverock.androidsvg.SVG.SvgObject
        String getNodeName() {
            return PluginsConstants.Settings.MASK;
        }
    }
    ...
    SvgElementBase getElementById(String str) {
        ...
        if (str.equals(this.rootElement.f85id)) {
            return this.rootElement;
        }
    ...
    private SvgElementBase getElementById(SvgContainer svgContainer, String str) {
        ...
        if (str.equals(svgElementBase.f85id)) {
            return svgElementBase;
        }
        for (Object obj : svgContainer.getChildren()) {
            if (obj instanceof SvgElementBase) {
                SvgElementBase svgElementBase2 = (SvgElementBase) obj;
                if (str.equals(svgElementBase2.f85id)) {
