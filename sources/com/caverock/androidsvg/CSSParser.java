...
class CSSParser {
        ...
        public String toString() {
            ...
            if (list != null) {
                for (Attrib attrib : list) {
                    ...
                    int i = C07291.$SwitchMap$com$caverock$androidsvg$CSSParser$AttribOp[attrib.operation.ordinal()];
                    if (i == 1) {
    ...
    static class Selector {
        ...
        /* synthetic */ Selector(C07291 c07291) {
            this();
        }
    ...
    private static class CSSTextScanner extends SVGParser.TextScanner {
        ...
        public List nextSelectorGroup() {
            ...
            Selector selector = new Selector(c07291);
            while (!empty() && nextSimpleSelector(selector)) {
                if (skipCommaWhitespace()) {
                    arrayList.add(selector);
                    selector = new Selector(c07291);
                }
            }
            if (!selector.isEmpty()) {
                arrayList.add(selector);
        ...
        */
        ...
        private void parsePseudoClass(Selector selector, SimpleSelector simpleSelector) throws CSSParseException {
            ...
            C07291 c07291 = null;
            switch (C07291.$SwitchMap$com$caverock$androidsvg$CSSParser$PseudoClassIdents[pseudoClassIdentsFromString.ordinal()]) {
                case 1:
                ...
                case 6:
                    ...
                    return;
                case 7:
                    pseudoClassOnlyChild = new PseudoClassRoot(c07291);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 8:
                    pseudoClassOnlyChild = new PseudoClassEmpty(c07291);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 9:
                ...
                case 12:
                    ...
                    pseudoClassAnPlusB = new PseudoClassAnPlusB(anPlusBNextAnPlusB.f56a, anPlusBNextAnPlusB.f57b, z, z2, simpleSelector.tag);
                    selector.addedAttributeOrPseudo();
                    pseudoClassOnlyChild = pseudoClassAnPlusB;
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 13:
                    ...
                    return;
                case 14:
                    pseudoClassOnlyChild = new PseudoClassTarget(c07291);
                    selector.addedAttributeOrPseudo();
                    simpleSelector.addPseudo(pseudoClassOnlyChild);
                    return;
                case 15:
    ...
    static class RuleMatchContext {
        ...
        public String toString() {
            ...
            return svgElementBase != null ? String.format("<%s id=\"%s\">", svgElementBase.getNodeName(), this.targetElement.f85id) : "";
        }
    }
    ...
    private static boolean selectorMatch(RuleMatchContext ruleMatchContext, SimpleSelector simpleSelector, List list, int i, SVG.SvgElementBase svgElementBase) {
        ...
        if (list3 != null) {
            for (Attrib attrib : list3) {
                ...
                str2.getClass();
                if (str2.equals("id")) {
                    if (!attrib.value.equals(svgElementBase.f85id)) {
                        return false;
                    }
    ...
    private static class PseudoClassAnPlusB implements PseudoClass {
        ...
        public boolean matches(RuleMatchContext ruleMatchContext, SVG.SvgElementBase svgElementBase) {
            ...
            int i5 = this.f60b;
            return (i3 - i5) % i4 == 0 && (Integer.signum(i3 - i5) == 0 || Integer.signum(i3 - this.f60b) == Integer.signum(this.f59a));
        }

        public String toString() {
            String str = this.isFromStart ? "" : "last-";
            return this.isOfType ? String.format("nth-%schild(%dn%+d of type <%s>)", str, Integer.valueOf(this.f59a), Integer.valueOf(this.f60b), this.nodeName) : String.format("nth-%schild(%dn%+d)", str, Integer.valueOf(this.f59a), Integer.valueOf(this.f60b));
        }
    }
    ...
    private static class PseudoClassRoot implements PseudoClass {
        ...
        /* synthetic */ PseudoClassRoot(C07291 c07291) {
            this();
        }
    ...
    private static class PseudoClassEmpty implements PseudoClass {
        ...
        /* synthetic */ PseudoClassEmpty(C07291 c07291) {
            this();
        }
    ...
    private static class PseudoClassTarget implements PseudoClass {
        ...
        /* synthetic */ PseudoClassTarget(C07291 c07291) {
            this();
        }
