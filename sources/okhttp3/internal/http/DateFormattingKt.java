...
public abstract class DateFormattingKt {
    ...
    private static final DateFormattingKt$STANDARD_DATE_FORMAT$1 STANDARD_DATE_FORMAT = new ThreadLocal() { // from class: okhttp3.internal.http.DateFormattingKt$STANDARD_DATE_FORMAT$1
