...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    public final List allSubjectAltNames(X509Certificate certificate) throws CertificateParsingException {
        Intrinsics.checkNotNullParameter(certificate, "certificate");
        return CollectionsKt.plus((Collection) getSubjectAltNames(certificate, 7), (Iterable) getSubjectAltNames(certificate, 2));
    }

    private final List getSubjectAltNames(X509Certificate x509Certificate, int i) throws CertificateParsingException {
        Object obj;
        try {
